...
/** api: (define)
 *  module = GeoExt.form
 *  cl***REMOVED*** = FormPanel
 *  base_link = `Ext.form.FormPanel <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.form.FormPanel>`_
 */
...
GeoExt.form.FormPanel = Ext.extend(Ext.form.FormPanel, {
     ...
     *  Create the internal :cl***REMOVED***:`GeoExt.form.BasicForm` instance.
     */
    createForm: function() {
    ...
    /** api: method[search]
     *  :param options: ``Object`` The options p***REMOVED***ed to the
     *      :cl***REMOVED***:`GeoExt.form.SearchAction` constructor.
     *
