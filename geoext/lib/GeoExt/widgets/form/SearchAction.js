...
/** api: (define)
 *  module = GeoExt.form
 *  cl***REMOVED*** = SearchAction
 *  base_link = `Ext.form.Action <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.form.Action>`_
 */
...
/** api: constructor
 *  .. cl***REMOVED***:: SearchAction(form, options)
 *
 ...
 *      * options ``Object`` Options p***REMOVED***ed to the protocol'read method
 ...
 *      and p***REMOVED***es this filter to its protocol's read method. The form fields
 ...
 *      objects, but use :cl***REMOVED***:`GeoExt.form.FormPanel` instead.
 */
GeoExt.form.SearchAction = Ext.extend(Ext.form.Action, {
    ...
    constructor: function(form, options) {
        GeoExt.form.SearchAction.supercl***REMOVED***.constructor.call(this, form, options);
    },
