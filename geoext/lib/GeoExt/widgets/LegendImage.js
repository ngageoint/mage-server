...
GeoExt.LegendImage = Ext.extend(Ext.BoxComponent, {
    ...
    /** api: config[imgCls]
     *  ``String``  Optional css cl***REMOVED*** to apply to img tag
     */
    imgCls: null,
    ...
    initComponent: function() {
        GeoExt.LegendImage.supercl***REMOVED***.initComponent.call(this);
        if(this.defaultImgSrc === null) {
            this.defaultImgSrc = Ext.BLANK_IMAGE_URL;
        }
        this.autoEl = {
            tag: "img",
            "cl***REMOVED***": (this.imgCls ? this.imgCls : ""),
    ...
    onRender: function(ct, position) {
        GeoExt.LegendImage.supercl***REMOVED***.onRender.call(this, ct, position);
        if(this.url) {
    ...
    onDestroy: function() {
        ...
        GeoExt.LegendImage.supercl***REMOVED***.onDestroy.apply(this, arguments);
    },
