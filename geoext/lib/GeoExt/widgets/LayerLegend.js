...
/** api: (define)
 *  module = GeoExt
 *  cl***REMOVED*** = LayerLegend
 *  base_link = `Ext.Container <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.Container>`_
 */

Ext.namespace('GeoExt');

/** api: constructor
 *  .. cl***REMOVED***:: LayerLegend(config)
 *
 *      Base cl***REMOVED*** for components of :cl***REMOVED***:`GeoExt.LegendPanel`.
 */
GeoExt.LayerLegend = Ext.extend(Ext.Container, {

    /** api: config[layerRecord]
     *  :cl***REMOVED***:`GeoExt.data.LayerRecord`  The layer record for the legend
     */
    layerRecord: null,
     ...
     *  set, the value of ``showTitle`` will be ignored (***REMOVED***umed to be true).
     */
    legendTitle: null,

    /** api: config[labelCls]
     *  ``String``
     *  Optional css cl***REMOVED*** to use for the layer title labels.
     */
    labelCls: null,
    
    /** private: property[layerStore]
     *  :cl***REMOVED***:`GeoExt.data.LayerStore`
     */
    layerStore: null,
    ...
    initComponent: function() {
        GeoExt.LayerLegend.supercl***REMOVED***.initComponent.call(this);
        this.autoEl = {};
        this.add({
            xtype: "label",
    ...
    onStoreRemove: function(store, record, index) {
        // to be implemented by subcl***REMOVED***es if needed
    },
     ...
     *  :arg record: :cl***REMOVED***:GeoExt.data.LayerRecord
     *  :returns: ``String``
     *
    ...
    beforeDestroy: function() {
        ...
        GeoExt.LayerLegend.supercl***REMOVED***.beforeDestroy.apply(this, arguments);
    },
    ...
    onDestroy: function() {
        ...
        GeoExt.LayerLegend.supercl***REMOVED***.onDestroy.apply(this, arguments);
    }

});

/** cl***REMOVED***: method[getTypes]
 *  :param layerRecord: cl***REMOVED***:`GeoExt.data.LayerRecord` A layer record to get
 ...
 *  :param layerRecord: :cl***REMOVED***:`GeoExt.data.LayerRecord` The layer record
...
/** cl***REMOVED***: constant[GeoExt.LayerLegend.types]
 *  An object containing a name-cl***REMOVED*** mapping of LayerLegend subcl***REMOVED***es.
 *  To register as LayerLegend, a subcl***REMOVED*** should add itself to this object:
 *  
