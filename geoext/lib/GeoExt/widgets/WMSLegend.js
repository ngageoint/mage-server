 ...
 *  :cl***REMOVED***:`GeoExt.data.WMSCapabilitiesReader`). If not provided, a
...
GeoExt.WMSLegend = Ext.extend(GeoExt.LayerLegend, {
     ...
     *  rendered with. We make this ***REMOVED***umption by default. To be strictly WMS
    ...
    initComponent: function() {
        GeoExt.WMSLegend.supercl***REMOVED***.initComponent.call(this);
    ...
    update: function() {
        ...
        // The following check byp***REMOVED*** the update if map is not set.
        if(!(layer && layer.map)) {
            return;
        }
        GeoExt.WMSLegend.supercl***REMOVED***.update.apply(this, arguments);
    ...
    beforeDestroy: function() {
        ...
        GeoExt.WMSLegend.supercl***REMOVED***.beforeDestroy.apply(this, arguments);
    }
