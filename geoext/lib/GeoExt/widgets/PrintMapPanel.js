 ...
 *  and pans in the :cl***REMOVED***:`GeoExt.PrintMapPanel`, the print page will update
 *  its scale and center accordingly. If the scale on the print page changes
 *  (e.g. by setting it using a combo box with a
 *  :cl***REMOVED***:`GeoExt.plugins.PrintPageField`), the extent of the
 *  :cl***REMOVED***:`GeoExt.PrintMapPanel` will be updated to match the page bounds.
 *  
...
GeoExt.PrintMapPanel = Ext.extend(GeoExt.MapPanel, {
     ...
     *  :cl***REMOVED***:`GeoExt.MapPanel` or ``OpenLayers.Map`` The map that is to be
     *  printed.
     */
     ...
     *  :cl***REMOVED***:`GeoExt.data.PrintProvider` or ``Object`` PrintProvider to use
     ...
     *    of :cl***REMOVED***:`GeoExt.data.PrintProvider`, the capabilities must be
     *    loaded before PrintMapPanel initialization.
     */
    
    /** api: property[printProvider]
     *  :cl***REMOVED***:`GeoExt.data.PrintProvider` PrintProvider for this
     *  PrintMapPanel.
     */
    printProvider: null,
    
    /** api: property[printPage]
     *  :cl***REMOVED***:`GeoExt.data.PrintPage` PrintPage for this PrintMapPanel.
     *  Read-only.
     */
    printPage: null,
     ...
     *  would generate a preview in this :cl***REMOVED***:`GeoExt.PrintMapPanel` with a
     ...
     *  that can properly be previewed with this :cl***REMOVED***:`GeoExt.PrintMapPanel`.
     */
    previewScales: null,
    ...
    initComponent: function() {
        ...
        GeoExt.PrintMapPanel.supercl***REMOVED***.initComponent.call(this);
    },
    ...
    afterRender: function() {
        GeoExt.PrintMapPanel.supercl***REMOVED***.afterRender.apply(this, arguments);
        this.syncSize();
        if (!this.ownerCt) {
            this.bind();
        } else {
     ...
     *      the :cl***REMOVED***:`GeoExt.data.PrintProvider` :: ``print``  method.
     *  
    ...
    beforeDestroy: function() {
        ...
        GeoExt.PrintMapPanel.supercl***REMOVED***.beforeDestroy.apply(this, arguments);
    }
});
