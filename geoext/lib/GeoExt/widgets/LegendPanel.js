...
GeoExt.LegendPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        GeoExt.LegendPanel.supercl***REMOVED***.initComponent.call(this);
    },
     ...
     */
    onRender: function() {
        GeoExt.LegendPanel.supercl***REMOVED***.onRender.apply(this, arguments);
        if(!this.layerStore) {
    ...
    onDestroy: function() {
        ...
        GeoExt.LegendPanel.supercl***REMOVED***.onDestroy.apply(this, arguments);
    }
});
