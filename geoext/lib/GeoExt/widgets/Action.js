 ...
 *  module = GeoExt
 *  cl***REMOVED*** = Action
 *  base_link = `Ext.Action <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.Action>`_
 */
...
GeoExt.Action = Ext.extend(Ext.Action, {
     ...
     *  ``Function`` References the function the user p***REMOVED***es through
    ...
    setDisabled : function(v) {
        ...
        return GeoExt.Action.supercl***REMOVED***.setDisabled.apply(this, arguments);
    }
