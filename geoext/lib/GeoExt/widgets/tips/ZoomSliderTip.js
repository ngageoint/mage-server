...
/** api: constructor
 *  .. cl***REMOVED***:: ZoomSliderTip(config)
 *   
 *      Create a slider tip displaying :cl***REMOVED***:`GeoExt.ZoomSlider` values.
 */
GeoExt.ZoomSliderTip = Ext.extend(GeoExt.SliderTip, {
    ...
    init: function(slider) {
        ...
        GeoExt.ZoomSliderTip.supercl***REMOVED***.init.call(this, slider);
    },
