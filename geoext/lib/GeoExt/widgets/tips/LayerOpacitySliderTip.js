...
/** api: (define)
 *  module = GeoExt
 *  cl***REMOVED*** = LayerOpacitySliderTip
 *  base_link = `Ext.Tip <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.Tip>`_
 */
...
/** api: constructor
 *  .. cl***REMOVED***:: LayerOpacitySliderTip(config)
 *
 *      Create a slider tip displaying :cl***REMOVED***:`GeoExt.LayerOpacitySlider` values.
 */
GeoExt.LayerOpacitySliderTip = Ext.extend(GeoExt.SliderTip, {
    ...
    init: function(slider) {
        ...
        GeoExt.LayerOpacitySliderTip.supercl***REMOVED***.init.call(this, slider);
    },
