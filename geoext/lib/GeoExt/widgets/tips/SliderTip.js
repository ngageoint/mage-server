...
/** api: (define)
 *  module = GeoExt
 *  cl***REMOVED*** = SliderTip
 *  base_link = `Ext.Tip <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.slider.Tip>`_
 */
...
GeoExt.SliderTip = Ext.extend(Ext.slider.Tip, {
    ...
    init: function(slider) {
        GeoExt.SliderTip.supercl***REMOVED***.init.apply(this, arguments);
        if (this.hover) {
    ...
    onSlide: function(slider, e, thumb) {
        this.dragging = true;
        return GeoExt.SliderTip.supercl***REMOVED***.onSlide.apply(this, arguments);
    }
