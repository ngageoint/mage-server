...
/** api: (define)
 *  module = GeoExt
 *  cl***REMOVED*** = FeatureRenderer
 *  base_link = `Ext.BoxComponent <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.BoxComponent>`_
 */
Ext.namespace('GeoExt');

/** api: constructor
 *  .. cl***REMOVED***:: FeatureRenderer(config)
 *   
...
GeoExt.FeatureRenderer = Ext.extend(Ext.BoxComponent, {
     ...
     * ``Array(String)`` 
     *  List of supported Renderer cl***REMOVED***es. Add to this list to add support for 
    ...
    initComponent: function() {
        GeoExt.FeatureRenderer.supercl***REMOVED***.initComponent.apply(this, arguments);
        Ext.applyIf(this, {
        ...
        this.addEvents(
             ...
             *  Listener arguments:
             *  
             *  * renderer - :cl***REMOVED***:`GeoExt.FeatureRenderer` This feature renderer.
             */
            "click"
        );
    },
    ...
    onRender: function(ct, position) {
        ...
        GeoExt.FeatureRenderer.supercl***REMOVED***.onRender.apply(this, arguments);
    ...
    afterRender: function() {
        GeoExt.FeatureRenderer.supercl***REMOVED***.afterRender.apply(this, arguments);
    ...
    onResize: function(w, h) {
        ...
        GeoExt.FeatureRenderer.supercl***REMOVED***.onResize.apply(this, arguments);
    },
    ...
    setRendererDimensions: function() {
         ...
         * 3) if no width or height, ***REMOVED***ume a resolution of 1
         */
    ...
    /** private: method[***REMOVED***ignRenderer]
     *  Iterate through the available renderer implementations and selects 
     *  and ***REMOVED***ign the first one whose ``supported`` method returns ``true``.
     */
    ***REMOVED***ignRenderer: function()  {
