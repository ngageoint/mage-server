 ...
 *  module = GeoExt
 *  cl***REMOVED*** = MapPanel
 *  base_link = `Ext.Panel <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.Panel>`_
 */
...
GeoExt.MapPanel = Ext.extend(Ext.Panel, {
    ...
    /** api: property[layers]
     *  :cl***REMOVED***:`GeoExt.data.LayerStore`  A store containing
     *  :cl***REMOVED***:`GeoExt.data.LayerRecord` objects.
     */
    layers: null,
     ...
     *  none was provided in the config options p***REMOVED***ed to the
     *  constructor.
     */
    initComponent: function(){
        ...
        GeoExt.MapPanel.supercl***REMOVED***.initComponent.call(this);
    ...
    afterRender: function() {
        GeoExt.MapPanel.supercl***REMOVED***.afterRender.apply(this, arguments);
        if(!this.ownerCt) {
            this.renderMap();
        } else {
     ...
     */
    onResize: function() {
        GeoExt.MapPanel.supercl***REMOVED***.onResize.apply(this, arguments);
        this.updateMapSize();
    },
    ...
    onBeforeAdd: function(item) {
        ...
        GeoExt.MapPanel.supercl***REMOVED***.onBeforeAdd.apply(this, arguments);
    },
    ...
    remove: function(item, autoDestroy) {
        ...
        GeoExt.MapPanel.supercl***REMOVED***.remove.apply(this, arguments);
    },
    ...
    beforeDestroy: function() {
        ...
        // if the map panel was p***REMOVED***ed a map instance, this map instance
        ...
        delete this.map;
        GeoExt.MapPanel.supercl***REMOVED***.beforeDestroy.apply(this, arguments);
    }
