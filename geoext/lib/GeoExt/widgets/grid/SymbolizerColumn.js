 ...
 */
 ...
 /** api: (define)
  *  module = GeoExt.grid
  *  cl***REMOVED*** = SymbolizerColumn
  *  base_link = `Ext.grid.Column <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.grid.Column>`_
  */

Ext.namespace('GeoExt.grid');

/** api: constructor
 *  .. cl***REMOVED***:: SymbolizerColumn(config)
 *
