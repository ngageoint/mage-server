...
/** api: (define)
 *  module = GeoExt.grid
 *  cl***REMOVED*** = FeatureSelectionModel
 *  base_link = `Ext.grid.RowSelectionModel <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.grid.RowSelectionModel>`_
 */
...
GeoExt.grid.FeatureSelectionModelMixin = function() {
    return {
         ...
         *  ``Boolean`` If true, and if the constructor is p***REMOVED***ed neither a
         ...
         *  p***REMOVED***ed as config to the SelectFeature constructor, and the "layer"
        ...
        /** private: property[supercl***REMOVED***]
         *  ``Ext.grid.AbstractSelectionModel`` Our supercl***REMOVED***.
         */
        supercl***REMOVED***: null,
        ...
        constructor: function(config) {
            ...
            this.supercl***REMOVED*** = arguments.callee.supercl***REMOVED***;
            this.supercl***REMOVED***.constructor.call(this, config);
        },
         ...
         */
        initEvents: function() {
            this.supercl***REMOVED***.initEvents.call(this);
         ...
         *      property referencing the configuration object to p***REMOVED*** to the
