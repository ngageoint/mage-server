...
/** api: constructor
 *  .. cl***REMOVED***:: VectorLegend(config)
 *
...
GeoExt.VectorLegend = Ext.extend(GeoExt.LayerLegend, {
     ...
     *  :cl***REMOVED***:`GeoExt.data.LayerRecord`
     ...
     *  ``Number`` 
     *  The current scale denominator of any map ***REMOVED***ociated with this
    ...
    initComponent: function() {
        GeoExt.VectorLegend.supercl***REMOVED***.initComponent.call(this);
        if (this.layerRecord) {
        ...
        this.addEvents(
             ...
             *  Listener arguments:
             *  
             *  * comp - :cl***REMOVED***:`GeoExt.VectorLegend`` This component.
     ...
     *  method ***REMOVED***umes the rule is in the rules array, and
    ...
    selectRuleEntry: function(rule) {
        ...
        if (newSelection) {
            var ruleEntry = this.getRuleEntry(rule);
            ruleEntry.body.addCl***REMOVED***("x-grid3-row-selected");
    ...
    unselect: function() {
        this.rulesContainer.items.each(function(item, i) {
            if (this.rules[i] == this.selectedRule) {
                item.body.removeCl***REMOVED***("x-grid3-row-selected");
    ...
    addDD: function(component) {
        ...
        new Ext.dd.DragSource(component.getEl(), {
            ...
            onDragOut: function(e, targetId) {
                ...
                target.removeCl***REMOVED***("gx-ruledrag-insert-above");
                target.removeCl***REMOVED***("gx-ruledrag-insert-below");
     ...
     */
    update: function() {
        GeoExt.VectorLegend.supercl***REMOVED***.update.apply(this, arguments);
        if (this.symbolType && this.rules) {
            ...
            if (this.selectedRule) {
                this.getRuleEntry(this.selectedRule).body.addCl***REMOVED***("x-grid3-row-selected");
            }
        }
    },
    ...
    beforeDestroy: function() {
        ...
        delete this.map;
        delete this.rules;
        GeoExt.VectorLegend.supercl***REMOVED***.beforeDestroy.apply(this, arguments);
    },
