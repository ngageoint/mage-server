...
GeoExt.tree.LayerNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
    ...
    constructor: function(config) {
        GeoExt.tree.LayerNodeUI.supercl***REMOVED***.constructor.apply(this, arguments);
    },
    ...
    onClick: function(e) {
        if(e.getTarget('.x-tree-node-cb', 1)) {
            ...
            GeoExt.tree.LayerNodeUI.supercl***REMOVED***.onClick.apply(this, arguments);
        }
    },
    ...
    toggleCheck: function(value) {
        ...
        GeoExt.tree.LayerNodeUI.supercl***REMOVED***.toggleCheck.call(this, value);
...
/** api: (define)
 *  module = GeoExt.tree
 *  cl***REMOVED*** = LayerNode
 *  base_link = `Ext.tree.TreeNode <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.tree.TreeNode>`_
 */

/** api: constructor
 *  .. cl***REMOVED***:: LayerNode(config)
 * 
 *      A subcl***REMOVED*** of ``Ext.tree.TreeNode`` that is connected to an
...
GeoExt.tree.LayerNode = Ext.extend(Ext.tree.AsyncTreeNode, {
     ...
     *  :cl***REMOVED***:`GeoExt.data.LayerStore` ``or "auto"``
     ...
     *  :cl***REMOVED***:`GeoExt.MapPanel`, take the first one it finds and take its layer
     ...
     *  ``OpenLayers.Layer`` or :cl***REMOVED***:`GeoExt.data.LayerRecord` (like
     *  :cl***REMOVED***:`GeoExt.tree.LayerParamsLoader`) will actually generate child
     *  nodes here. If provided as ``Object``, a
     *  :cl***REMOVED***:`GeoExt.tree.LayerParamLoader` instance will be created, with
    ...
    constructor: function(config) {
        ...
        GeoExt.tree.LayerNode.supercl***REMOVED***.constructor.apply(this, arguments);
    },
    ...
    render: function(bulkRender) {
        ...
        if(!layer) {
            ...
            if(i != -1) {
                // if we found the layer, we can ***REMOVED***ign it and everything
                // will be fine
        ...
        GeoExt.tree.LayerNode.supercl***REMOVED***.render.apply(this, arguments);
    },
    ...
    destroy: function() {
        ...
        GeoExt.tree.LayerNode.supercl***REMOVED***.destroy.apply(this, arguments);
    }
});
