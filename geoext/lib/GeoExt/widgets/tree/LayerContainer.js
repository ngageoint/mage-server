 ...
 *  base_link = `Ext.tree.AsyncTreeNode <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.tree.AsyncTreeNode>`_
 */
...
GeoExt.tree.LayerContainer = Ext.extend(Ext.tree.AsyncTreeNode, {
    ...
    constructor: function(config) {
        ...
        GeoExt.tree.LayerContainer.supercl***REMOVED***.constructor.call(this, config);
    },
    ...
    destroy: function() {
        ...
        GeoExt.tree.LayerContainer.supercl***REMOVED***.destroy.apply(this, arguments);
    }
});
