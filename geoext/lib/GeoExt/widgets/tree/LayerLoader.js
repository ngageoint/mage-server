 ...
 *  .. cl***REMOVED***:: LayerLoader
 * 
 *      A loader that will load all layers of a :cl***REMOVED***:`GeoExt.data.LayerStore`
...
GeoExt.tree.LayerLoader = function(config) {
    ...
    this.addEvents(
         ...
         *  Listener arguments:
         *  
         *  * loader - :cl***REMOVED***:`GeoExt.tree.LayerLoader` this loader
    ...
    GeoExt.tree.LayerLoader.supercl***REMOVED***.constructor.call(this);
};
...
Ext.extend(GeoExt.tree.LayerLoader, Ext.util.Observable, {
     ...
     *  :param node: :cl***REMOVED***:`GeoExt.tree.LayerNode`
     */
