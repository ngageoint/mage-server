 ...
 *  .. cl***REMOVED***:: LayerParamNode
 * 
 *  A subcl***REMOVED*** of ``Ext.tree.TreeNode`` that represents a value of a list of
...
GeoExt.tree.LayerParamNode = Ext.extend(Ext.tree.TreeNode, {
     ...
     *  :cl***REMOVED***:`GeoExt.data.LayerStore` Only used if layer is provided as
    ...
    constructor: function(attributes) {
        ...
        GeoExt.tree.LayerParamNode.supercl***REMOVED***.constructor.apply(this, arguments);
     ...
     *  :param items: ``Array``
     *  :return: ``Object`` The params object to p***REMOVED*** to mergeNewParams
     */
     ...
     *  :param node: :cl***REMOVED***:`GeoExt.tree.LayerParamNode``
    ...
    destroy: function() {
        ...
        GeoExt.tree.LayerParamNode.supercl***REMOVED***.destroy.apply(this, arguments);
    }
});
