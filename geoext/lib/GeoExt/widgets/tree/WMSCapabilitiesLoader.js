...
/** api: (define)
 *  module = GeoExt.tree
 *  cl***REMOVED*** = WMSCapabilitiesLoader
 *  base_link = `Ext.tree.TreeLoader <http://www.dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.tree.TreeLoader>`_
 */
...
GeoExt.tree.WMSCapabilitiesLoader = function(config) {
    ...
    GeoExt.tree.WMSCapabilitiesLoader.supercl***REMOVED***.constructor.call(this);
};
...
Ext.extend(GeoExt.tree.WMSCapabilitiesLoader, Ext.tree.TreeLoader, {
    ...
    getParams: function(node) {
        return {'***REMOVED***': 'WMS', 'request': 'GetCapabilities'};
    },
