...
/** api: (define)
 *  module = GeoExt.tree
 *  cl***REMOVED*** = TreeNodeUIEventMixin
 */
 ...
 */
  ...
  *  :cl***REMOVED***:`GeoExt.tree.TreeNodeUIEventMixin`:
  *
  *  .. code-block:: javascript
  *
  *      var UICl***REMOVED*** = Ext.extend(
  *          Ext.tree.TreeNodeUI,
...
GeoExt.tree.TreeNodeUIEventMixin = function(){
    return {
        ...
        constructor: function(node) {
            ...
            this.supercl***REMOVED***.constructor.apply(this, arguments);
        ...
        render: function(bulkRender) {
            if(!this.rendered) {
                this.supercl***REMOVED***.render.apply(this, arguments);
        ...
        onClick: function(e) {
            if(this.fireEvent("rawclicknode", this.node, e) !== false) {
                this.supercl***REMOVED***.onClick.apply(this, arguments);
            }
        }
    };
};
