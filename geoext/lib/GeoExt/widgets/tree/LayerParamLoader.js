...
GeoExt.tree.LayerParamLoader = function(config) {
    ...
    GeoExt.tree.LayerParamLoader.supercl***REMOVED***.constructor.call(this);
};
...
Ext.extend(GeoExt.tree.LayerParamLoader, Ext.util.Observable, {
     ...
     *  :param node: :cl***REMOVED***:`GeoExt.tree.LayerNode`` The node that the param
