 ...
 *  module = GeoExt
 *  cl***REMOVED*** = Popup
 *  base_link = `Ext.Window <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.Window>`_
 */
...
GeoExt.Popup = Ext.extend(Ext.Window, {
    ...
    /** api: config[map]
     *  ``OpenLayers.Map`` or :cl***REMOVED***:`GeoExt.MapPanel`
    ...
    /** api: config[popupCls]
     *  ``String`` CSS cl***REMOVED*** name for the popup DOM elements.  Default is
     *  "gx-popup".
     */
    popupCls: "gx-popup",

    /** api: config[ancCls]
     *  ``String``  CSS cl***REMOVED*** name for the popup's anchor.
     */
    ancCls: null,
    ...
    initComponent: function() {
        ...
        GeoExt.Popup.supercl***REMOVED***.initComponent.call(this);
    },
    ...
    onRender: function(ct, position) {
        GeoExt.Popup.supercl***REMOVED***.onRender.call(this, ct, position);
    ...
    initTools : function() {
        ...
        GeoExt.Popup.supercl***REMOVED***.initTools.call(this);
    },
     ...
     */
    show: function() {
        GeoExt.Popup.supercl***REMOVED***.show.apply(this, arguments);
        if(this.anchored) {
            this.position();
    ...
    maximize: function() {
        ...
        GeoExt.Popup.supercl***REMOVED***.maximize.apply(this, arguments);
    },
    ...
    setSize: function(w, h) {
        ...
        GeoExt.Popup.supercl***REMOVED***.setSize.call(this, w, h);
    },
    ...
    position: function() {
        ...
        if(this.isVisible()) {
            ...
            if (ancPos.indexOf("bottom") > -1 || locationPx.y > mapBox.height / 2) {
                // bottom
                this.anc.removeCl***REMOVED***("top");
                top -= elSize.height + ancSize.height;
            } else {
                // top
                this.anc.addCl***REMOVED***("top");
    ...
    unanchorPopup: function() {
        ...
        this.draggable = true;
        this.header.addCl***REMOVED***("x-window-draggable");
    ...
    panIntoView: function() {
        ...
        //***REMOVED***umed viewport takes up whole body element of map panel
    ...
    beforeDestroy: function() {
        ...
        GeoExt.Popup.supercl***REMOVED***.beforeDestroy.call(this);
    }
});
