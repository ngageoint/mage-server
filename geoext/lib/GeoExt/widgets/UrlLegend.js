...
GeoExt.UrlLegend = Ext.extend(GeoExt.LayerLegend, {
    ...
    initComponent: function() {
        GeoExt.UrlLegend.supercl***REMOVED***.initComponent.call(this);
     ...
     */
    update: function() {
        GeoExt.UrlLegend.supercl***REMOVED***.update.apply(this, arguments);
