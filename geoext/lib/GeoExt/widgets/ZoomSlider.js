...
/** api: (define)
 *  module = GeoExt
 *  cl***REMOVED*** = ZoomSlider
 *  base_link = `Ext.slider.SingleSlider <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.slider.SingleSlider>`_
 */
...
GeoExt.ZoomSlider = Ext.extend(Ext.slider.SingleSlider, {
    ...
    /** api: config[baseCls]
     *  ``String``
     *  The CSS cl***REMOVED*** name for the slider elements.  Default is "gx-zoomslider".
     */
    ...
    initComponent: function() {
        GeoExt.ZoomSlider.supercl***REMOVED***.initComponent.call(this);
     ...
     *  Override onRender to set base css cl***REMOVED***.
     */
    onRender: function() {
        GeoExt.ZoomSlider.supercl***REMOVED***.onRender.apply(this, arguments);
        this.el.addCl***REMOVED***(this.baseCls);
    },
    ...
    afterRender : function(){
        Ext.slider.SingleSlider.supercl***REMOVED***.afterRender.apply(this, arguments);
        this.update();
    },
    
    /** private: method[addToMapPanel]
     *  :param panel: :cl***REMOVED***:`GeoExt.MapPanel`
     *  
     ...
     *  
     *  Get the zoom level for the ***REMOVED***ociated map based on the slider value.
     */
    getZoom: function() {
     ...
     *  
     *  Get the scale denominator for the ***REMOVED***ociated map based on the slider value.
     */
    getScale: function() {
     ...
     *  
     *  Get the resolution for the ***REMOVED***ociated map based on the slider value.
     */
