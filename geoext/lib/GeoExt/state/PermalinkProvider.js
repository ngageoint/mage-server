...
/** api: (define)
 *  module = GeoExt.state
 *  cl***REMOVED*** = PermalinkProvider
 *  base_link = `Ext.state.Provider <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.state.Provider>`_
 */
...
/** api: constructor
 *  .. cl***REMOVED***:: PermalinkProvider(config)
 *
 *      Create a permalink provider.
 *
 */
GeoExt.state.PermalinkProvider = function(config) {
    GeoExt.state.PermalinkProvider.supercl***REMOVED***.constructor.apply(this, arguments);
