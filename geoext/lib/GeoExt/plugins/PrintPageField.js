 ...
 *  with a :cl***REMOVED***:`GeoExt.data.PrintPage`. The field name has to match the
...
GeoExt.plugins.PrintPageField = Ext.extend(Ext.util.Observable, {
    ...
    constructor: function(config) {
        ...
        GeoExt.plugins.PrintPageField.supercl***REMOVED***.constructor.apply(this, arguments);
    },
     ...
     *  :param printPage: :cl***REMOVED***:`GeoExt.data.PrintPage`
     *  
    ...
    /** private: method[onPageChange]
     *  :param printProvider: :cl***REMOVED***:`GeoExt.data.PrintProvider`
