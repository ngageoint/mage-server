 ...
 *  cl***REMOVED*** = TreeNodeRadioButton
 */
 ...
 *  with the :cl***REMOVED***:`GeoExt.Tree.TreeNodeUIEventMixin`, in particular
 *  :cl***REMOVED***:`GeoExt.tree.LayerNodeUI` nodes.
 *
...
GeoExt.plugins.TreeNodeRadioButton = Ext.extend(Ext.util.Observable, {
    ...
    constructor: function(config) {
        ...
        GeoExt.plugins.TreeNodeRadioButton.supercl***REMOVED***.constructor.apply(this, arguments);
    },
    ...
    onRenderNode: function(node) {
        ...
        if(a.radioGroup && !a.radio) {
            a.radio = Ext.DomHelper.insertBefore(node.ui.anchor,
                ['<input type="radio" cl***REMOVED***="gx-tree-radio" name="',
