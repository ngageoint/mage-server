 ...
 *  level, use :cl***REMOVED***:`GeoExt.plugins.PrintPageField`):
 * 
 ...
 *  with a :cl***REMOVED***:`GeoExt.data.PrintProvider`.
 */
GeoExt.plugins.PrintProviderField = Ext.extend(Ext.util.Observable, {
    ...
    constructor: function(config) {
        ...
        GeoExt.plugins.PrintProviderField.supercl***REMOVED***.constructor.apply(this, arguments);
    },
