 ...
 *  :cl***REMOVED***:`GeoExt.MapPanel`.
 */
GeoExt.plugins.PrintExtent = Ext.extend(Ext.util.Observable, {

    /** private: initialConfig
     *  ``Object`` Holds the initial config object p***REMOVED***ed to the
     *  constructor.
     */
    initialConfig: null,

    /** api: config[printProvider]
     *  :cl***REMOVED***:`GeoExt.data.PrintProvider` The print provider this form
    ...
    /** api: config[pages]
     *  Array of :cl***REMOVED***:`GeoExt.data.PrintPage` The pages that this plugin
     ...
     */
    /** api: property[pages]
     *  Array of :cl***REMOVED***:`GeoExt.data.PrintPage` The pages that this component
     *  controls. Read-only.
     */
    pages: null,

    /** api: property[page]
     *  :cl***REMOVED***:`GeoExt.data.PrintPage` The page currently set for
     *  transformation.
     */
    page: null,
    ...
    constructor: function(config) {
        ...
        this.addEvents(
             ...
             *  
             *  Listener arguments:
             *  * printPage - :cl***REMOVED***:`GeoExt.data.PrintPage` this printPage
             */
            "selectpage"
        );

        GeoExt.plugins.PrintExtent.supercl***REMOVED***.constructor.apply(this, arguments);
    },

    /** api: method[print]
     *  :param options: ``Object`` Options to send to the PrintProvider's
     *      print method. See :cl***REMOVED***:`GeoExt.data.PrintProvider` :: ``print``.
     *  
    ...
    /** private: method[init]
     *  :param mapPanel: cl***REMOVED***:`GeoExt.MapPanel`
     *  
    ...
    /** api: method[addPage]
     *  :param page: :cl***REMOVED***:`GeoExt.data.PrintPage` The page to add
     *       to this plugin. If not provided, a page that fits the current
     *       extent is created.
     *  :return: page :cl***REMOVED***:``GeoExt.data.PrintPage``
     *  
     ...
     *  :param page: :cl***REMOVED***:`GeoExt.data.PrintPage` The page to remove
     *       from this plugin.
     *       
     ...
     *  :param page: :cl***REMOVED***:`GeoExt.data.PrintPage` The page to select
     *  
