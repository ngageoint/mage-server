...
GeoExt.plugins.AttributeForm.prototype = {
     ...
     *  :cl***REMOVED***:`GeoExt.data.AttributeReader`. If set form items
     *  will be created from the attribute records in the form. In
     *  most cases this store will be a :cl***REMOVED***:`GeoExt.data.AttributeStore`.
     */
     ...
     *  ``Object`` Options to p***REMOVED*** on to :meth:`GeoExt.form.recordToField`.
     */

    /** private: method[init]
     *  :param formPanel: cl***REMOVED***:`Ext.form.FormPanel`
     *
     ...
     *  is to be bound to.
     *
     *  Bind the panel to the attribute store p***REMOVED***ed as a parameter.
     */
    bind: function(store) {
        this.unbind();
        store.on({
