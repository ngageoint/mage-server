...
/** api: (define)
 *  module = GeoExt.data
 *  cl***REMOVED*** = ProtocolProxy
 *  base_link = `Ext.data.DataProxy <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.data.DataProxy>`_
 */
Ext.namespace('GeoExt', 'GeoExt.data');

GeoExt.data.ProtocolProxy = function(config) {
    Ext.apply(this, config);
    GeoExt.data.ProtocolProxy.supercl***REMOVED***.constructor.apply(this, arguments);
};
...
Ext.extend(GeoExt.data.ProtocolProxy, Ext.data.DataProxy, {
     ...
     *  ``Boolean``
     *  Should options.params be set directly on options before p***REMOVED***ing it into
     ...
     *  :param callback: ``Function`` The function into which to p***REMOVED*** the block
     *      of ``Ext.data.Records``. The function is p***REMOVED***ed the Record block
     *      object, the ``args`` argument p***REMOVED***ed to the load function, and a
     *      boolean success indicator.
     *  :param scope: ``Object`` The scope in which to call the callback.
     *  :param arg: ``Object`` An optional argument which is p***REMOVED***ed to the
