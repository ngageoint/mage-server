 ...
 *      :cl***REMOVED***:`GeoExt.MapPanel` object.
 *
...
GeoExt.data.ScaleStore = Ext.extend(Ext.data.Store, {
    ...
    constructor: function(config) {
        ...
        GeoExt.data.ScaleStore.supercl***REMOVED***.constructor.call(this, config);
    ...
    /** api: method[bind]
     *  :param map: :cl***REMOVED***:`GeoExt.MapPanel` or ``OpenLayers.Map`` Panel or map
    ...
    destroy: function() {
        this.unbind();
        GeoExt.data.ScaleStore.supercl***REMOVED***.destroy.apply(this, arguments);
    }
});
