 ...
 *  :cl***REMOVED***:`GeoExt.data.PrintProvider`. The extent of the page is stored as
...
GeoExt.data.PrintPage = Ext.extend(Ext.util.Observable, {
     ...
     * :cl***REMOVED***:`GeoExt.data.PrintProvider` The print provider to use with
     * this page.
     */
    
    /** private: property[printProvider]
     *  :cl***REMOVED***:`GeoExt.data.PrintProvider`
     */
    printProvider: null,
     ...
     *  printProvider will send to the print ***REMOVED*** for this page.
     */
    ...
    constructor: function(config) {
        ...
        GeoExt.data.PrintPage.supercl***REMOVED***.constructor.apply(this, arguments);
     ...
     *  :param map: ``OpenLayers.Map`` or :cl***REMOVED***:`GeoExt.MapPanel` the map to
     ...
     *      If not found, "dd" will be ***REMOVED***umed.
     * 
    ...
    /** api: method[fit]
     *  :param fitTo: :cl***REMOVED***:`GeoExt.MapPanel` or ``OpenLayers.Map`` or ``OpenLayers.Feature.Vector``
     ...
     *      map. If not provided, "dd" will be ***REMOVED***umed.
