...
/**
 * Cl***REMOVED***: GeoExt.data.FeatureStoreMixin
 ...
 * 
 * This cl***REMOVED*** can not be instantiated directly. Instead, it is meant to extend
 * {Ext.data.Store} or a subcl***REMOVED*** of it:
 * (start code)
 ...
 * (end)
 * 
 * For convenience, a {<GeoExt.data.FeatureStore>} cl***REMOVED*** is available as a
...
GeoExt.data.FeatureStoreMixin = function() {
    return {
        ...
        onFeatureModified: function(evt) {
            if(!this._updating) {
                ...
                if(record !== undefined) {
                    ...
                    // "tra***REMOVED***ction", "update" will be triggered by
                    // endEdit
        ...
        destroy: function() {
            this.unbind();
            GeoExt.data.FeatureStore.supercl***REMOVED***.destroy.call(this);
        }
