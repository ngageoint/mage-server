 ...
 *      :cl***REMOVED***:`GeoExt.data.LayerRecord` objects from a WFS GetCapabilities
 *      response.
 */
GeoExt.data.WFSCapabilitiesReader = function(meta, recordType) {
    ...
    GeoExt.data.WFSCapabilitiesReader.supercl***REMOVED***.constructor.call(
