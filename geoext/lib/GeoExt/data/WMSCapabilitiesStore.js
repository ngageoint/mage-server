...
/** api: (define)
 *  module = GeoExt.data
 *  cl***REMOVED*** = WMSCapabilitiesStore
 ...
 *  .. cl***REMOVED***:: WMSCapabilitiesStore
 *  
 *      Small helper cl***REMOVED*** to make creating stores for remote WMS layer data
 *      easier.  The store is pre-configured with a built-in
 *      ``Ext.data.HttpProxy`` and :cl***REMOVED***:`GeoExt.data.WMSCapabilitiesReader`.
 ...
 *      :cl***REMOVED***:`GeoExt.data.LayerStore` and configure as needed.
 */
...
GeoExt.data.WMSCapabilitiesStore = function(c) {
    c = c || {};
    GeoExt.data.WMSCapabilitiesStore.supercl***REMOVED***.constructor.call(
        this,
        Ext.apply(c, {
