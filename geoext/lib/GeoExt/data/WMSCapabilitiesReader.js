 ...
 *      :cl***REMOVED***:`GeoExt.data.LayerRecord` objects from a WMS GetCapabilities
 *      response.
 */
GeoExt.data.WMSCapabilitiesReader = function(meta, recordType) {
    ...
    GeoExt.data.WMSCapabilitiesReader.supercl***REMOVED***.constructor.call(
...
Ext.extend(GeoExt.data.WMSCapabilitiesReader, Ext.data.DataReader, {
     ...
     *  ``String`` CSS cl***REMOVED*** name for the attribution DOM elements.
     *  Element cl***REMOVED*** names append "-link", "-image", and "-title" as
    ...
    /** private: method[***REMOVED***ExceptionFormat]
     *  :param formats: ``Array`` An array of ***REMOVED*** exception format strings.
     *  :return: ``String`` The (supposedly) best ***REMOVED*** exception format.
     */
    ***REMOVED***ExceptionFormat: function(formats) {
    ...
    readRecords: function(data) {
        ...
        var exceptions = this.***REMOVED***ExceptionFormat(formats);
        var records = [];
    ...
    attributionMarkup : function(attribution){
        ...
        if (attribution.logo){
            markup.push("<img cl***REMOVED***='"+this.attributionCls+"-image' "
                        + "src='" + attribution.logo.href + "' />");
        }
        
        if (attribution.title) {
            markup.push("<span cl***REMOVED***='"+ this.attributionCls + "-title'>"
                        + attribution.title
                        + "</span>");
        }
