...
/** api: (define)
 *  module = GeoExt.data
 *  cl***REMOVED*** = LayerRecord
 *  base_link = `Ext.data.Record <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.data.Record>`_
 */
 ...
 *  :return: cl***REMOVED***:`GeoExt.data.LayerRecord` A new layer record.
 *  
...
/** api: cl***REMOVED***method[create]
 *  :param o: ``Array`` Field definition as in ``Ext.data.Record.create``. Can
 *      be omitted if no additional fields are required.
 *  :return: ``Function`` A specialized :cl***REMOVED***:`GeoExt.data.LayerRecord`
 *      constructor.
 *  
 *  Creates a constructor for a :cl***REMOVED***:`GeoExt.data.LayerRecord`, optionally
