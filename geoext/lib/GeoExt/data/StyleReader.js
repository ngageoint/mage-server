...
/** api: (define)
 *  module = GeoExt.data
 *  cl***REMOVED*** = StyleReader
 *  base_link = `Ext.data.JsonReader <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.data.JsonReader>`_
 */
...
GeoExt.data.StyleReader = Ext.extend(Ext.data.JsonReader, {
    ...
    onMetaChange: function() {
        GeoExt.data.StyleReader.supercl***REMOVED***.onMetaChange.apply(this, arguments);
    ...
    readRecords: function(o) {
        ...
        data[type] = o[type];
        return GeoExt.data.StyleReader.supercl***REMOVED***.readRecords.call(this, data);
    }
});
