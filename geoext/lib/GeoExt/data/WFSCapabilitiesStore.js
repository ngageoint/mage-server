...
/** api: (define)
 *  module = GeoExt.data
 *  cl***REMOVED*** = WFSCapabilitiesStore
 ...
 *  .. cl***REMOVED***:: WFSCapabilitiesStore
 *  
 *      Small helper cl***REMOVED*** to make creating stores for remote WFS layer data
 *      easier.  The store is pre-configured with a built-in
 *      ``Ext.data.HttpProxy`` and :cl***REMOVED***:`GeoExt.data.WFSCapabilitiesReader`.
...
GeoExt.data.WFSCapabilitiesStore = function(c) {
    c = c || {};
    GeoExt.data.WFSCapabilitiesStore.supercl***REMOVED***.constructor.call(
        this,
        Ext.apply(c, {
