 ...
 * @require OpenLayers/BaseTypes/Cl***REMOVED***.js
 */

/** api: (define)
 *  module = GeoExt.data
 *  cl***REMOVED*** = PrintProvider
 *  base_link = `Ext.util.Observable <http://dev.sencha.com/deploy/dev/docs/?cl***REMOVED***=Ext.util.Observable>`_
 */
Ext.namespace("GeoExt.data");

/** api: example
 *  Minimal code to print as much of the current map extent as possible as
 *  soon as the print ***REMOVED*** capabilities are loaded, using the first layout
 *  reported by the print ***REMOVED***:
 * 
 ...
 *  one or more instances of :cl***REMOVED***:`GeoExt.data.PrintPage` are also required
...
GeoExt.data.PrintProvider = Ext.extend(Ext.util.Observable, {
    ...
    /** api: config[url]
     *  ``String`` Base url of the print ***REMOVED***. Only required if
     ...
     *  extension installed. This property requires that the print ***REMOVED*** is
     *  at the same origin as the application (or accessible via proxy).
     */
    
    /** private:  property[url]
     *  ``String`` Base url of the print ***REMOVED***. Will always have a trailing
     *  "/".
     */
    url: null,
     ...
     *  ``Object`` Capabilities of the print ***REMOVED***. Only required if ``url``
     *  is not provided. This is the object returned by the ``info.json``
     *  endpoint of the print ***REMOVED***, and is usually obtained by including a
     *  script tag pointing to
     *  http://path/to/print***REMOVED***/info.json?var=myvar in the head of the
     *  html document, making the capabilities accessible as ``window.myvar``.
     *  This property should be used when no local print ***REMOVED*** or proxy is
     ...
     *  ``Object`` Capabilities as returned from the print ***REMOVED***.
     */
    capabilities: null,
    
    /** api: config[method]
     *  ``String`` Either ``POST`` or ``GET`` (case-sensitive). Method to use
     *  when sending print requests to the servlet. If the print ***REMOVED*** is at
     *  the same origin as the application (or accessible via proxy), then
     *  ``POST`` is recommended. Use ``GET`` when accessing a remote print
     *  ***REMOVED*** with no proxy available, but expect issues with character
     ...
     * ***REMOVED***. Prevent character encoding issues, especially when using IE.
     ...
     *  ***REMOVED***. Optional. This is e.g. useful for complex layout definitions
     ...
     *  request to the ***REMOVED***. Optional. 
     */
    ...
    constructor: function(config) {
        ...
        this.addEvents(
             ...
             *  Listener arguments:
             *
             *  * printProvider - :cl***REMOVED***:`GeoExt.data.PrintProvider` this
             *    PrintProvider
             ...
             *  * pages - Array of :cl***REMOVED***:`GeoExt.data.PrintPage` the print
             *    pages being printed
        ...
        GeoExt.data.PrintProvider.supercl***REMOVED***.constructor.apply(this, arguments);
     ...
     *  :param pages: ``Array`` of :cl***REMOVED***:`GeoExt.data.PrintPage` or
     *      :cl***REMOVED***:`GeoExt.data.PrintPage` page(s) to print.
     *  :param options: ``Object`` of additional options, see below.
     *  
     *  Sends the print command to the print ***REMOVED*** and opens a new window
     *  with the resulting PDF.
     *  
     *  Valid properties for the ``options`` argument:
     *
     *      * ``legend`` - :cl***REMOVED***:`GeoExt.LegendPanel` If provided, the legend
     ...
     *              maxIconWidth: 0
     *              maxIconHeight: 0
     *              cl***REMOVED***Indentation: 0
     *              layerSpace: 5
     *              layerFontSize: 10
     *
     *      * ``overview`` - :cl***REMOVED***:`OpenLayers.Control.OverviewMap` If provided,
     *        the layers for the overview map in the printout will be taken from
     *        the OverviewMap control. If not provided, the print ***REMOVED*** will
     ...
     *
     *  Loads the capabilities from the print ***REMOVED***. If this instance is
     ...
     *  :return: ``Object``
     * 
     *  Encodes a layer for the print ***REMOVED***.
     */
