        ...
        bbar: ["->", {
            ...
            handler: function() {
                ...
                if(record) {
                    ...
                    // Ext 3.X does not allow circular references in objects p***REMOVED***ed 
                    // to record.set 
...
Ext.onReady(function() {
    ...
    wms = new OpenLayers.Layer.WMS(
        "Global Imagery",
        "http://maps.opengeo.org/geowebcache/***REMOVED***/wms",
        {layers: "bluemarble"}
    );
...
OpenLayers.Control.Click = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {                
...
Ext.onReady(function() {
    // The printProvider that connects us to the print ***REMOVED***
...
Ext.onReady(function() {
    ...
    var formPanel = new Ext.form.FormPanel({
        ...
        items: [{
            ...
            tpl: '<tpl for="."><div cl***REMOVED***="x-combo-list-item">{name} dpi</div></tpl>',
            typeAhead: true,
            mode: "local",
            triggerAction: "all",
            plugins: new GeoExt.plugins.PrintProviderField({
...
Ext.onReady(function() {
    ...
    formPanel.addButton({
        text: "search",
        handler: function() {
            // trigger search request, the options p***REMOVED***ed to doAction
            // are p***REMOVED***ed to the protocol's read method, so one
...
// custom layer node UI cl***REMOVED***
                    ...
                    actions: [{
                        ...
                        update: function(el) { 
                            ...
                            if (map.getLayerIndex(layer) == map.layers.length - 1) { 
                                el.addCl***REMOVED***('disabled'); 
                            } else { 
                                el.removeCl***REMOVED***('disabled'); 
                            } 
                        } 
                    }, { 
                        action: "down", 
            ...
            loader: {
                ...
                createNode: function(attr) {
                    ...
                    attr.component = {
                        ...
                        showTitle: false,
                        // custom cl***REMOVED*** for css positioning
...
Ext.onReady(function() {
    ...
    // create our own layer node UI cl***REMOVED***, using the TreeNodeUIEventMixin
    ...
    var treeConfig = [{
        ...
        // and ***REMOVED***ign them the group "foo".
        loader: {
            baseAttrs: {
                radioGroup: "foo",
        ...
        isLeaf: false,
        // create subnodes for the layers in the LAYERS param. If we ***REMOVED***ign
        // a loader to a LayerNode and do not provide a loader cl***REMOVED***, a
        // LayerParamLoader will be ***REMOVED***umed.
        loader: {
            param: "LAYERS"
        }
    }];
...
Ext.onReady(function() {
    ...
    var zoomSelector = new Ext.form.ComboBox({
        ...
        tpl: '<tpl for="."><div cl***REMOVED***="x-combo-list-item">1 : {[parseInt(values.scale)]}</div></tpl>',
        editable: false,
