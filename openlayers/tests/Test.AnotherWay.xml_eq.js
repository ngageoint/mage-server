...
(function() {
    ...
    /**
     * Function ***REMOVED***ertElementNodesEqual
     ...
     */
    function ***REMOVED***ertElementNodesEqual(got, expected, options) {
        var testPrefix = (options && options.prefix === true);
        
        // compare types
        ***REMOVED***ertEqual(got.nodeType, expected.nodeType, "Node type mismatch");
        ...
        ***REMOVED***ertEqual(gotName, expName, "Node name mismatch");
    ...
    proto.xml_eq = function(got, expected, msg, options) {
        ...
        try {
            ***REMOVED***ertElementNodesEqual(got, expected, options);
            this.ok(true, msg);
        } catch(err) {
            this.fail(msg + ": " + err);
        }
