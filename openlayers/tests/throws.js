/*
  ...
  head element after the AnotherWay cl***REMOVED***es are created:
  ...
  This was inspired by the `***REMOVED***ertRaises` method of Python's unittest
  library.
...
function (fn, expectedException, doc) {
    /*
       ...
       Note: This function does not preserve the stack field ***REMOVED***ociated
