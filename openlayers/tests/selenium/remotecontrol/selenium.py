...
cl***REMOVED*** selenium:
    ...
    *   \ **name**\ =\ *name*:
        ...
        *   name=username
        ...
        The name may optionally be followed by one or more \ *element-filters*, separated from the name by whitespace.  If the \ *filterType* is not specified, \ **value**\  is ***REMOVED***umed.
    ...
    *   \ **xpath**\ =\ *xpathExpression*: 
        ...
        *   xpath=//a[contains(@href,'#id1')]/@cl***REMOVED***
        *   xpath=(//table[@cl***REMOVED***='stylee'])//th[text()='theHeaderText']/../td
    ...
    *   \ **css**\ =\ *cssSelectorSyntax*:
        ...
        *   css=span#firstChild + span
        ...
        Currently the css selector locator supports all css1, css2 and css3 selectors except namespace in css3, some pseudo cl***REMOVED***es(:nth-of-type, :nth-last-of-type, :first-of-type, :last-of-type, :only-of-type, :visited, :hover, :active, :focus, :indeterminate) and pseudo elements(::first-line, ::first-letter, ::selection, ::before, ::after). 
    ...
    *   \ **exact:**\ \ *string*:
    ...
    If no pattern prefix is specified, Selenium ***REMOVED***umes that it's a "glob"
    pattern.
...
### From here on, everything's auto-generated from XML
    ...
    def select(self,selectLocator,optionLocator):
        ...
        Select element (e.g. for selecting a specific option, or for ***REMOVED***erting
    ...
    def select_window(self,windowID):
        ...
        *   \ **name**\ =\ *myWindow*:
            ...
            parameter "windowName" p***REMOVED***ed to the JavaScript method window.open(url, windowName, windowFeatures, replaceFlag)
            (which Selenium intercepts).
            
        *   \ **var**\ =\ *variableName*:
            Some pop-up windows are unnamed (anonymous), but are ***REMOVED***ociated with a JavaScript variable name in the current
        ...
        1.) if windowID is null, (or the string "null") then it is ***REMOVED***umed the user is referring to the original window instantiated by the browser).
        
        2.) if the value of the "windowID" parameter is a JavaScript variable name in the current application window, then it is ***REMOVED***umed
    ...
    def get_expression(self,expression):
        ...
        It is used to generate commands like ***REMOVED***ertExpression and waitForExpression.
    ...
    def ***REMOVED***ign_id(self,locator,identifier):
        """
        ...
        """
        self.do_command("***REMOVED***ignId", [locator,identifier,])


    def allow_native_xpath(self,allow):
        """
        Specifies whether Selenium should use the native in-browser implementation
        of XPath (if any native version is available); if you p***REMOVED*** "false" to
    ...
    def add_location_strategy(self,strategyName,functionDefinition):
        ...
        run your function, p***REMOVED***ing you the string "blah", and click on the element 
        that your function
        returns, or throw an "Element not found" error if your function returns null.
        
        We'll p***REMOVED*** three arguments to your function:
        
        *   locator: the string the user p***REMOVED***ed in
    ...
    def key_down_native(self,keycode):
        ...
        This function uses the java.awt.Robot cl***REMOVED*** to send a keystroke; this more accurately simulates typing
