...
(function() {
    ...
    var layerPanel = new OpenLayers.Control.Panel({
        displayCl***REMOVED***: "layerPanel",
        autoActivate: true
    });
    var aerialButton = new OpenLayers.Control({
        type: OpenLayers.Control.TYPE_TOOL,
        displayCl***REMOVED***: "aerialButton",
        eventListeners: {
            activate: function() {
    ...
    if (/Android 4\.0.*Safari\/.*/.test(navigator.userAgent)) {
        defaults.cl***REMOVED***Name = "nofade";
    }
    ...
    OpenLayers.Request.GET({
        ...
        success: function(request) {
            ...
            labels = format.createLayer(caps, OpenLayers.Util.applyDefaults(
                {layer:"beschriftung", cl***REMOVED***Name:"nofade", isBaseLayer: false},
                defaults
            ));
...
(function() {
    ...
    if (android) {
        ...
        // make this really ***REMOVED***ing difficult. Thus, once we are scrolled, the
