...
/**
 * Cl***REMOVED***: OpenLayers.Control.KeyboardClick
 *
 ...
 */
OpenLayers.Control.KeyboardClick = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
    ...
    activate: function() {
        ...
        var keyboardDefaults = this.map.getControlsByCl***REMOVED***(
...
/**
 * Cl***REMOVED***: OpenLayers.Handler.KeyboardPoint
 *
 * A custom handler that displays a vector point that can be moved
 * using the arrow keys of the keyboard.
 */
OpenLayers.Handler.KeyboardPoint = OpenLayers.Cl***REMOVED***(OpenLayers.Handler, {
