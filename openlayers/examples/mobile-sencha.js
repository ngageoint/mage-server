...
/**
 * Custom cl***REMOVED*** for the Search 
 */
App.SearchFormPopupPanel = Ext.extend(Ext.Panel, {
    ...
    doSearch: function(searchfield, evt){
        ...
        this.store.load({
            params: {
                featureCl***REMOVED***: this.featureCl***REMOVED***,
    ...
    initComponent: function(){
        ...
        App.SearchFormPopupPanel.supercl***REMOVED***.initComponent.call(this);
    }
});
...
App.LayerList = Ext.extend(Ext.List, {
    ...
    initComponent: function(){
        ...
        this.itemTpl = new Ext.XTemplate(
            ...
            '</tpl>', 
            '<span cl***REMOVED***="gx-layer-item">{name}</span>'
        );
        this.listeners = {
        ...
        App.LayerList.supercl***REMOVED***.initComponent.call(this);
    },
