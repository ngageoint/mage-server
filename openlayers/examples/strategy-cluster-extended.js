/**
 * Cl***REMOVED***: OpenLayers.Strategy.AttributeCluster
 * Strategy for vector feature clustering based on feature attributes.
 *
 * Inherits from:
 *  - <OpenLayers.Strategy.Cluster>
 */
OpenLayers.Strategy.AttributeCluster = OpenLayers.Cl***REMOVED***(OpenLayers.Strategy.Cluster, {
    /**
...
/**
 * Cl***REMOVED***: OpenLayers.Strategy.RuleCluster
 * Strategy for vector feature clustering according to a given rule.
 *
 * Inherits from:
 *  - <OpenLayers.Strategy.Cluster>
 */
OpenLayers.Strategy.RuleCluster = OpenLayers.Cl***REMOVED***(OpenLayers.Strategy.Cluster, {
    /**
    ...
    var changeStrategy = function() {
        ...
        switch(this.value) {
            ...
            case 'attribute-cluster':
                // use the custom cl***REMOVED***: only cluster features of the same clazz
                strategies.push(new OpenLayers.Strategy.AttributeCluster({
                    attribute:'clazz'
                }));
                break;
            case 'rule-cluster':
                // use the custom cl***REMOVED***: only cluster features that have a 
