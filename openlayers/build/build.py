...
def build(config_file = None, output_file = None, options = None):
    ...
    if use_compressor == "jsmin":
        ...
        if len(merged) > 1000000: # The maximum file size for this web ***REMOVED*** is 1000 KB.
        ...
        try:
            ...
            print "\nAbnormal termination."
            sys.exit("ERROR: Closure Compilation using Web ***REMOVED*** failed!\n%s" % E)
        if len(minimized) <= 2:
            print "\nAbnormal termination due to compilation errors."
            sys.exit("ERROR: Closure Compilation using Web ***REMOVED*** failed!")
        else:
            print "Closure Compilation using Web ***REMOVED*** has completed successfully."
