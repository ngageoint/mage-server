...
/**
 * Cl***REMOVED***: OpenLayers.Control.Panel
 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.Panel = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
    /**
     * Property: controls
     ...
     *     If not provided, <OpenLayers.Control.TYPE_TOOL> is ***REMOVED***umed.
     ...
     * olControl[Name]ItemActive cl***REMOVED***, otherwise with the
     * olControl[Name]ItemInactive cl***REMOVED***.
     *
     * Parameters:
    ...
    addControls: function(controls) {
        ...
        for (var i=0, len=controls.length; i<len; i++) {
            ...
            OpenLayers.Element.addCl***REMOVED***(element, 
                                        control.displayCl***REMOVED*** + "ItemInactive");
            OpenLayers.Element.addCl***REMOVED***(element, "olButton");
     ...
     * markup is needed this function can be overridden in specific cl***REMOVED***es,
     ...
     */
     iconOn: function() {
        ...
        var re = new RegExp("\\b(" + this.displayCl***REMOVED*** + "Item)Inactive\\b");
        d.cl***REMOVED***Name = d.cl***REMOVED***Name.replace(re, "$1Active");
    },
     ...
     */
     iconOff: function() {
        var d = this.panel_div; // "this" refers to a control on panel!
        var re = new RegExp("\\b(" + this.displayCl***REMOVED*** + "Item)Active\\b");
        d.cl***REMOVED***Name = d.cl***REMOVED***Name.replace(re, "$1Inactive");
    },
     ...
     *
     * Parameters:
     * match - {String | Object} A control cl***REMOVED*** name.  The type can also be a
