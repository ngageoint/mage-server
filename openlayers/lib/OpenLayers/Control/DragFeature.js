...
/**
 * Cl***REMOVED***: OpenLayers.Control.DragFeature
 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.DragFeature = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {

    /**
     * APIProperty: geometryTypes
     * {Array(String)} To restrict dragging to a limited set of geometry types,
     *     send a list of strings corresponding to the geometry cl***REMOVED*** names.
     */
    geometryTypes: null,
    ...
    /**
     * APIMethod: destroy
     * Take care of things that are not handled in supercl***REMOVED***
     */
    destroy: function() {
        this.layer = null;
    ...
    deactivate: function() {
        ...
        OpenLayers.Element.removeCl***REMOVED***(
            this.map.viewPortDiv, this.displayCl***REMOVED*** + "Over"
        );
    ...
    overFeature: function(feature) {
        ...
        if(!this.handlers.drag.dragging) {
            ...
            activated = true;
            this.over = true;
            OpenLayers.Element.addCl***REMOVED***(this.map.viewPortDiv, this.displayCl***REMOVED*** + "Over");
