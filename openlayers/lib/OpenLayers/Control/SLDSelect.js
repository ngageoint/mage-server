...
/**
 * Cl***REMOVED***: OpenLayers.Control.SLDSelect
 * Perform selections on WMS layers using Styled Layer Descriptor (SLD)
 *
 * Inherits from:
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.SLDSelect = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
     ...
     *
     * Parameters:
     * handler - {<OpenLayers.Cl***REMOVED***>} A sketch handler cl***REMOVED***. This determines
     ...
     *     type selection, use <OpenLayers.Handler.RegularPolygon> and p***REMOVED***
