...
/**
 * Cl***REMOVED***: OpenLayers.Control.NavigationHistory
 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.NavigationHistory = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
    ...
    initialize: function(options) {
        ...
        var previousOptions = {
            ...
            displayCl***REMOVED***: this.displayCl***REMOVED*** + " " + this.displayCl***REMOVED*** + "Previous"
        };
        ...
        var nextOptions = {
            ...
            displayCl***REMOVED***: this.displayCl***REMOVED*** + " " + this.displayCl***REMOVED*** + "Next"
        };
