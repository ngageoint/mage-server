...
/**
 * Cl***REMOVED***: OpenLayers.Control.UTFGrid
 *
 * This Control provides behavior ***REMOVED***ociated with UTFGrid Layers.
 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.UTFGrid = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
     ...
     * The default opts p***REMOVED***ed to the handler constructors
     */
     ...
     *
     * P***REMOVED***es the attributes to the callback
     *
     * Parameters:
