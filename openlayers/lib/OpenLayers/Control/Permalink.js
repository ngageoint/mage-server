...
/**
 * Cl***REMOVED***: OpenLayers.Control.Permalink
 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.Permalink = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
    
    /**
     * APIProperty: argParserCl***REMOVED***
     * {Cl***REMOVED***} The ArgParser control cl***REMOVED*** (not instance) to use with this
     *     control.
     */
    argParserCl***REMOVED***: OpenLayers.Control.ArgParser,
    ...
    setMap: function(map) {
        ...
        for(var i=0, len=this.map.controls.length; i<len; i++) {
            ...
            if (control.CLASS_NAME == this.argParserCl***REMOVED***.CLASS_NAME) {
        ...
        if (i == this.map.controls.length) {
            this.map.addControl(new this.argParserCl***REMOVED***(
