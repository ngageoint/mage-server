...
/**
 * Cl***REMOVED***: OpenLayers.Control.Geolocate
 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.Geolocate = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
     ...
     * {Object} Options to p***REMOVED*** to the navigator's geolocation API. See
     *     <http://dev.w3.org/geo/api/spec-source.html>. No specific
     *     option is p***REMOVED***ed to the geolocation API by default.
     */
