...
/**
 * Cl***REMOVED***: OpenLayers.Control.DragPan
 * The DragPan control pans the map with a drag of the mouse.
 *
 * Inherits from:
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.DragPan = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
     ...
     *     object will be p***REMOVED***ed to the {<OpenLayers.Kinetic>}
