...
/**
 * Cl***REMOVED***: OpenLayers.Control.CacheWrite
 ...
 * that the terms of ***REMOVED*** of the tile provider allow local storage of tiles.
 *
 * Inherits from:
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.CacheWrite = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
