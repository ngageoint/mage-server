...
/**
 * Cl***REMOVED***: OpenLayers.Control.TransformFeature
 * Control to transform features with a standard transformation box.
 *
 * Inherits From:
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.TransformFeature = OpenLayers.Cl***REMOVED***(OpenLayers.Control, {
     ...
     *     types, send a list of strings corresponding to the geometry cl***REMOVED***
     *     names.
     */
    geometryTypes: null,
     ...
     *     To be p***REMOVED***ed with the constructor or set when the control is not
     *     active.
     */
    rotate: true,
