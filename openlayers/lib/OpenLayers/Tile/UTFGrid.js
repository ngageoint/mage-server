...
/**
 * Cl***REMOVED***: OpenLayers.Tile.UTFGrid
 ...
 *  - <OpenLayers.Tile>
 */
OpenLayers.Tile.UTFGrid = OpenLayers.Cl***REMOVED***(OpenLayers.Tile, {
     ...
     * Get feature information ***REMOVED***ociated with a pixel offset.  If the pixel
    ...
    /**
     * Method: getFeatureId
     * Get the identifier for the feature ***REMOVED***ociated with a pixel offset.
     *
     * Parameters:
     * i - {Number} X-axis pixel offset (from top left of tile)
     * j - {Number} Y-axis pixel offset (from top left of tile)
