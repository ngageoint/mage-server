...
OpenLayers.Lang["sk"] = OpenLayers.Util.applyDefaults({
    ...
    'commitSuccess': "Tra***REMOVED***kcia WFS: ÚSPEŠNÁ ${response}",

    'commitFailed': "Tra***REMOVED***kcia WFS: ZLYHALA ${response}",
