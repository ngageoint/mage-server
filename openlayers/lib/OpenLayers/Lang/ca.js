...
OpenLayers.Lang.ca = {
    ...
    'minZoomLevelError':
        ...
        "p***REMOVED***at. No podem, però, eliminar-la sense trencar " +
    ...
    'commitSuccess': "Tra***REMOVED***cció WFS: CORRECTA ${response}",

    'commitFailed': "Tra***REMOVED***cció WFS: HA FALLAT ${response}",
    ...
    'reprojectDeprecated':
        ...
        "però ara aquesta funcionalitat s'hauria d'***REMOVED***olir mitjançant el suport " +
