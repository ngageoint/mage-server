...
OpenLayers.Lang["gl"] = OpenLayers.Util.applyDefaults({
    ...
    'browserNotSupported': "O seu navegador non soporta a renderización de vectores. Os renderizadores soporta***REMOVED*** actualmente son:\n${renderers}",
