...
OpenLayers.Lang.es = {
    ...
    'browserNotSupported':
        "Su navegador no soporta renderización vectorial. Los renderizadores soporta***REMOVED*** actualmente son:\n${renderers}",
    ...
    'commitFailed': "Tra***REMOVED***cción WFS: FALLÓ ${response}",

    'googleWarning':
        "La capa Google no pudo ser cargada correctamente.<br><br>" +
        "Para evitar este me***REMOVED***je, seleccione una nueva Capa Base " +
