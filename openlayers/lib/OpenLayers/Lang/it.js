...
OpenLayers.Lang.it = {
    ...
    'minZoomLevelError':
        ...
        "un retaggio del p***REMOVED***ato. Non possiamo comunque rimuoverla " +
    ...
    'commitSuccess': "Tra***REMOVED***zione WFS: SUCCESS ${response}",

    'commitFailed': "Tra***REMOVED***zione WFS: FAILED ${response}",
