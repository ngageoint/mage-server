...
OpenLayers.Lang["fr"] = OpenLayers.Util.applyDefaults({
    ...
    'minZoomLevelError': "La propriété minZoomLevel doit seulement être utilisée pour des couches FixedZoomLevels-descendent. Le fait que cette couche WFS vérifie la présence de minZoomLevel est une relique du p***REMOVED***é. Nous ne pouvons toutefois la supprimer sans c***REMOVED***er des applications qui pourraient en dépendre. C\'est pourquoi nous la déprécions -- la vérification du minZoomLevel sera supprimée en version 3.0. A la place, merci d\'utiliser les paramètres de résolutions min/max tel que décrit sur : http://trac.openlayers.org/wiki/SettingZoomLevels",

    'commitSuccess': "Tra***REMOVED***ction WFS : SUCCES ${response}",

    'commitFailed': "Tra***REMOVED***ction WFS : ECHEC ${response}",
