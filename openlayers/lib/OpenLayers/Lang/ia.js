...
OpenLayers.Lang["ia"] = OpenLayers.Util.applyDefaults({
    ...
    'unhandledRequest': "Le respo***REMOVED*** a un requesta non esseva maneate: ${statusText}",
    ...
    'minZoomLevelError': "Le proprietate minZoomLevel es solmente pro uso con le stratos descendente de FixedZoomLevels. Le facto que iste strato WFS verifica minZoomLevel es un reliquia del p***REMOVED***ato. Nonobstante, si nos lo remove immediatemente, nos pote rumper applicationes a base de OL que depende de illo. Ergo nos lo declara obsolete; le verification de minZoomLevel in b***REMOVED***o essera removite in version 3.0. Per favor usa in su loco le configuration de resolutiones min/max como describite a: http://trac.openlayers.org/wiki/SettingZoomLevels",

    'commitSuccess': "Tra***REMOVED***ction WFS: SUCCESSO ${response}",

    'commitFailed': "Tra***REMOVED***ction WFS: FALLEVA ${response}",
