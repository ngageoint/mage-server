 ...
 * 
 */
OpenLayers.Icon = OpenLayers.Cl***REMOVED***({
     ...
     * 
     * Returns:
     * {DOMElement} A new DOM Image of this icon set at the location p***REMOVED***ed-in
     */
    draw: function(px) {
    ...
    /**
     * Method: moveTo
     * move icon to p***REMOVED***ed in px.
     *
     * Parameters:
     ...
     */
    moveTo: function (px) {
        //if no px p***REMOVED***ed in, use stored location
        if (px != null) {
            this.px = px;
        }
