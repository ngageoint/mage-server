...
/**
 * Cl***REMOVED***: OpenLayers.Strategy.Fixed
 * A simple strategy that requests features once and never requests new data.
 *
 * Inherits from:
 *  - <OpenLayers.Strategy>
 */
OpenLayers.Strategy.Fixed = OpenLayers.Cl***REMOVED***(OpenLayers.Strategy, {
     ...
     *
     * Parameters:
     * options - {Object} options to p***REMOVED*** to protocol read.
     */
     ...
     * resp - {<OpenLayers.Protocol.Response>} The response object p***REMOVED***ed
     *      by the protocol.
     */
