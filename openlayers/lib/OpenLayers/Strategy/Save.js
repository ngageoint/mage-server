...
/**
 * Cl***REMOVED***: OpenLayers.Strategy.Save
 ...
 *  - <OpenLayers.Strategy>
 */
OpenLayers.Strategy.Save = OpenLayers.Cl***REMOVED***(OpenLayers.Strategy, {
     ...
     * success - Triggered after a successful tra***REMOVED***ction
     * fail - Triggered after a failed tra***REMOVED***ction
     * 
     */
    ...
    /**
     * APIMethod: save
     * Tell the layer protocol to commit u***REMOVED***ved features.  If the layer
     ...
     *     features in the layer.  Features are ***REMOVED***umed to be in the map
     *     projection.
     */
