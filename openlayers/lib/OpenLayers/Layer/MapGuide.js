...
/**
 * Cl***REMOVED***: OpenLayers.Layer.MapGuide
 ...
 */
OpenLayers.Layer.MapGuide = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.Grid, {
     ...
     *          the p***REMOVED***ed-in bounds and appropriate tile size specified 
     *          as parameters.
     */
     ...
     * This is why it is subcl***REMOVED***ed here.
     *
     * Parameters:
    ...
    getFullRequestString:function(newParams, altUrl) {
        // use layer's url unless altUrl p***REMOVED***ed in
