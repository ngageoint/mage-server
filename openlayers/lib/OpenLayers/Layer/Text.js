...
/**
 * Cl***REMOVED***: OpenLayers.Layer.Text
 ...
 */
OpenLayers.Layer.Text = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.Markers, {

    /**
     * APIProperty: location 
     * {String} URL of text file.  Must be specified in the "options" argument
     *   of the constructor. Can not be changed once p***REMOVED***ed in. 
     */
    location:null,
