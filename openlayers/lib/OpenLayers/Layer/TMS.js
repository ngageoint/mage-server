...
/**
 * Cl***REMOVED***: OpenLayers.Layer.TMS
 * Create a layer for accessing tiles from ***REMOVED***s that conform with the 
 ...
 *         "http://tilecache.osgeo.org/wms-c/Basic.py/", // ***REMOVED*** endpoint
 ...
 */
OpenLayers.Layer.TMS = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.Grid, {

    /**
     * APIProperty: ***REMOVED***Version
    ...
    ***REMOVED***Version: "1.0.0",
     ...
     * {String} The identifier for the <TileMap> as advertised by the ***REMOVED***.  
     *     For example, if the ***REMOVED*** advertises a <TileMap> with 
     ...
     *     "extension" attribute.  For example, if the ***REMOVED*** advertises a 
     ...
     *     level 3 of your cache.  Default is 0 (***REMOVED***umes cache level and map
     ...
     *
     * Parameters:
     * obj - {Object} Should only be provided by subcl***REMOVED***es that call this
     *     method.
     * 
     * Returns:
     ...
     *          p***REMOVED***ed-in bounds and appropriate tile size specified as 
     *          parameters
     */
    getURL: function (bounds) {
        ...
        var path = this.***REMOVED***Version + "/" + this.layername + "/" + z + "/" + x + "/" + y + "." + this.type; 
        var url = this.url;
