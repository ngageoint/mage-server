...
/** 
 * Cl***REMOVED***: OpenLayers.Layer.ArcGISCache   
 ...
 * of the tile to compe***REMOVED***te for this behavior.  This must be done as zoom levels change
 * and before tiles are requested, which is why methods from base cl***REMOVED***es are overridden.
 *
 ...
 * layer. (ie. http://***REMOVED***s.arcgisonline.com/ArcGIS/rest/***REMOVED***s/World_Street_Map/MapServer)
 ...
 */    
OpenLayers.Layer.ArcGISCache = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.XYZ, {  
    ...
    * Creates a new instance of this cl***REMOVED*** 
    * 
    * Parameters: 
    * name - {String} 
    * url - {String} 
    ...
    * 
    * Parameters: 
    * [obj] - {Object} optional object to ***REMOVED***ign the cloned instance to.
    *  
    * Returns: 
