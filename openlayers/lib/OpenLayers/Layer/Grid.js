 ...
 * Base cl***REMOVED*** for layers that use a lattice of tiles.  Create a new grid
 * layer with the <OpenLayers.Layer.Grid> constructor.
 *
 * Inherits from:
 *  - <OpenLayers.Layer.HTTPRequest>
 */
OpenLayers.Layer.Grid = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.HTTPRequest, {
     ...
     *  created by this Layer, if supported by the tile cl***REMOVED***.
     */
    tileOptions: null,

    /**
     * APIProperty: tileCl***REMOVED***
     * {<OpenLayers.Tile>} The tile cl***REMOVED*** to use for this layer.
     *     Defaults is OpenLayers.Tile.Image.
     */
    tileCl***REMOVED***: OpenLayers.Tile.Image,
     ...
     * {Array(Number}} This property is documented in subcl***REMOVED***es as
     *     an API property.
     */
     ...
     *     olTileImage cl***REMOVED*** are used. Default is 0 for <singleTile> layers,
     *     2500 for tiled layers. See <cl***REMOVED***Name> for more information on
     *     tile animation.
     */
    removeBackBufferDelay: null,

    /**
     * APIProperty: cl***REMOVED***Name
     * {String} Name of the cl***REMOVED*** added to the layer div. If not set in the
     *     options p***REMOVED***ed to the constructor then cl***REMOVED***Name defaults to
    ...
    initialize: function(name, url, params, options) {
        ...
        if (this.cl***REMOVED***Name === null) {
            this.cl***REMOVED***Name = this.singleTile ? 'olLayerGridSingleTile' :
                                               'olLayerGrid';
        }
    ...
    setMap: function(map) {
        ...
        OpenLayers.Element.addCl***REMOVED***(this.div, this.cl***REMOVED***Name);
    },
    ...
    createBackBuffer: function() {
        ...
        if(this.grid.length > 0) {
            ...
            backBuffer.cl***REMOVED***Name = 'olBackBuffer';
     ...
     *     potential specific implementations in sub-cl***REMOVED***es.)
     *
     * Returns:
     * {<OpenLayers.Bounds>}
     */
    ...
    addTile: function(bounds, position) {
        var tile = new this.tileCl***REMOVED***(
