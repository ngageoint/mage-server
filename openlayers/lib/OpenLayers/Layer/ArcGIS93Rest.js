...
/**
 * Cl***REMOVED***: OpenLayers.Layer.ArcGIS93Rest
 ...
 *     specifically, the URL provided to this layer should be an export ***REMOVED***
 *     URL: http://sampleserver1.arcgisonline.com/ArcGIS/SDK/REST/export.html 
 * 
 * Inherits from:
 *  - <OpenLayers.Layer.Grid>
 */
OpenLayers.Layer.ArcGIS93Rest = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.Grid, {
     ...
     *                                    "http://sampleserver1.arcgisonline.com/ArcGIS/rest/***REMOVED***s/Specialty/ESRI_StateCityHighway_USA/MapServer/export", 
     *                                    {
     *                                      layers: "0,1,2"
     *                                    });
     * (end)
     ...
     * url - {String} Base url for the ArcGIS server REST ***REMOVED***
     ...
     *     before calling changeParams on the super cl***REMOVED***.
     * 
