...
/**
 * Cl***REMOVED***: OpenLayers.Layer.FixedZoomLevels
 *   Some Layers will already have established zoom levels (like google 
 *    or ve). Instead of trying to determine them and populate a resolutions[]
 *    Array with those values, we will hijack the resolution functionality
 *    here.
 * 
 *   When you subcl***REMOVED*** FixedZoomLevels: 
 * 
 ...
 *    the resolutions[] array, we call OpenLayers.Layer.getExent(), p***REMOVED***ing in
 ...
 *
 */
OpenLayers.Layer.FixedZoomLevels = OpenLayers.Cl***REMOVED***({
  ...
  /********************************************************/
     ...
     */
    initialize: function() {
        //this cl***REMOVED*** is only just to add the following functions... 
    ...
    initResolutions: function() {
        ...
        // should be set as a default on the Layer.WMS cl***REMOVED***. If someone
     ...
     * 
     * Returns:
     * {Integer} An OpenLayers Zoom level, translated from the p***REMOVED***ed in zoom
