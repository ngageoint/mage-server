...
/**
 * Cl***REMOVED***: OpenLayers.Layer.GeoRSS
 * Add GeoRSS Point features to your map. 
 * 
 * Inherits from:
 *  - <OpenLayers.Layer.Markers>
 */
OpenLayers.Layer.GeoRSS = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.Markers, {
    ...
    parseData: function(ajaxRequest) {
        ...
        for (var i=0, len=features.length; i<len; i++) {
            ...
            if (title || description) {
                ...
                var contentHTML = '<div cl***REMOVED***="olLayerGeoRSSClose">[x]</div>'; 
                contentHTML += '<div cl***REMOVED***="olLayerGeoRSSTitle">';
                if (link) {
                    contentHTML += '<a cl***REMOVED***="link" href="'+link+'" target="_blank">';
                }
                contentHTML += title;
                if (link) {
                    contentHTML += '</a>';
                ...
                contentHTML += '</div>';
                contentHTML += '<div style="" cl***REMOVED***="olLayerGeoRSSDescription">';
