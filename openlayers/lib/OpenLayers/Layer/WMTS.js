...
/**
 * Cl***REMOVED***: OpenLayers.Layer.WMTS
 * Instances of the WMTS cl***REMOVED*** allow viewing of tiles from a ***REMOVED*** that 
 *     implements the OGC WMTS specification version 1.0.0.
 * 
 * Inherits from:
 *  - <OpenLayers.Layer.Grid>
 */
OpenLayers.Layer.WMTS = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.Grid, {
     ...
     * ***REMOVED***. Must be provided. Array is only supported for base URLs, not
    ...
    /**
     * APIProperty: layer
     * {String} The layer identifier advertised by the WMTS ***REMOVED***.  Must be 
     *     provided.
     */
    layer: null,
     ...
     *     identifiers will be ***REMOVED***umed to be integers corresponding to the 
     ...
     * url - {String} The base url for the ***REMOVED***.  See the <url> property.
    ...
    getURL: function(bounds) {
        ...
        if (!this.tileFullExtent || this.tileFullExtent.intersectsBounds(bounds)) {            
            ...
            if (this.requestEncoding.toUpperCase() === "REST") {
                ...
                // ***REMOVED***emble all required parameters
                params = {
                    SERVICE: "WMTS",
                    REQUEST: "GetTile",
