...
/** 
 * Cl***REMOVED***: OpenLayers.Layer.Bing
 ...
 */
OpenLayers.Layer.Bing = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.XYZ, {
     ...
     * {String}
     */
    attributionTemplate: '<span cl***REMOVED***="olBingAttribution ${type}">' +
