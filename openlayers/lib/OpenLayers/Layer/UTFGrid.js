...
/** 
 * Cl***REMOVED***: OpenLayers.Layer.UTFGrid
 ...
 */
OpenLayers.Layer.UTFGrid = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.XYZ, {
     ...
     *
     * Parameters:
     * obj - {Object} Only used by a subcl***REMOVED*** of this layer.
     * 
     * Returns:
     ...
     * Get details about a feature ***REMOVED***ociated with a map location.  The object
     ...
     * Get the identifier for the feature ***REMOVED***ociated with a map location.
     *
     * Parameters:
     * location - {<OpenLayers.LonLat>} map location
     *
