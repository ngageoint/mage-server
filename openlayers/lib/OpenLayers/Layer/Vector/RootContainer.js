...
/**
 * Cl***REMOVED***: OpenLayers.Layer.Vector.RootContainer
 * A special layer type to combine multiple vector layers inside a single
 *     renderer root container. This cl***REMOVED*** is not supposed to be instantiated
 *     from user space, it is a helper cl***REMOVED*** for controls that require event
 *     processing for multiple vector layers.
 *
 * Inherits from:
 *  - <OpenLayers.Layer.Vector>
 */
OpenLayers.Layer.Vector.RootContainer = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.Vector, {
