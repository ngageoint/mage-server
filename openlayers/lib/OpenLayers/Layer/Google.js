...
/**
 * Cl***REMOVED***: OpenLayers.Layer.Google
 * 
 ...
 */
OpenLayers.Layer.Google = OpenLayers.Cl***REMOVED***(
    OpenLayers.Layer.EventPane, 
    OpenLayers.Layer.FixedZoomLevels, {
    ...
    clone: function() {
        /**
         * This method isn't intended to be called by a subcl***REMOVED*** and it
         * doesn't call the same method on the supercl***REMOVED***.  We don't call
  ...
  //
     ...
     *                       p***REMOVED***ed-in MapObject Bounds.
...
OpenLayers.Layer.Google.v2 = {
    ...
    loadMapObject:function() {
        ...
        if (cache) {
            ...
            try {
                ...
                termsOfUse.cl***REMOVED***Name = "olLayerGoogleCopyright";
                ...
                poweredBy.cl***REMOVED***Name = "olLayerGooglePoweredBy gmnoprint";
     ...
     * Display the GMap container and ***REMOVED***ociated elements.
     * 
     * Parameters:
