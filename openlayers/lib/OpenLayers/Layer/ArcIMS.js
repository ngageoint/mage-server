...
/**
 * Cl***REMOVED***: OpenLayers.Layer.ArcIMS
 ...
 */
OpenLayers.Layer.ArcIMS = OpenLayers.Cl***REMOVED***(OpenLayers.Layer.Grid, {
    ...
    initialize: function(name, url, options) {
        ...
        this.params = OpenLayers.Util.applyDefaults(
            {ServiceName: options.***REMOVED***Name},
            this.DEFAULT_PARAMS
        );
     ...
     *     filter features or layers in the ArcIMS ***REMOVED***.
     *
     * Parameters:
    ...
    getFeatureInfo: function(geometry, layer, options) {
        ...
        if (geometry instanceof OpenLayers.LonLat) {
            ...
            // use the polygon ***REMOVED***igned, and empty the envelope
        ...
        // set the get_feature query to be the same as the layer p***REMOVED***ed in
