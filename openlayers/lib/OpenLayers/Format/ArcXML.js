...
/**
 * Cl***REMOVED***: OpenLayers.Format.ArcXML
 ...
 */
OpenLayers.Format.ArcXML = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
     ...
     * Create a new parser/writer for ArcXML.  Create an instance of this cl***REMOVED***
     *    to begin authoring a request to an ArcIMS ***REMOVED***.  This is used
     ...
     * the value is ***REMOVED***umed to be the SRID.  If it's a {OpenLayers.Projection} 
            ...
            if (rtype == "IMAGE") {
                ...
                if (response.features.featurecount > 0) {
                    ...
                    for (var fn = 0; fn < featureList.length; fn++) {
                        ...
                        if (geom.length > 0) {
                            // if there is a polygon, create an openlayers polygon, and ***REMOVED***ign
...
OpenLayers.Format.ArcXML.Request = OpenLayers.Cl***REMOVED***({
...
OpenLayers.Format.ArcXML.Response = OpenLayers.Cl***REMOVED***({  
    initialize: function(params) {
        var defaults = {
            image: {
                envelope:null,
