...
/**
 * Cl***REMOVED***: OpenLayers.Format.XML.VersionedOGC
 * Base cl***REMOVED*** for versioned formats, i.e. a format which supports multiple
 * versions.
 * 
 * Inherits from:
 *  - <OpenLayers.Format.XML>
 */
OpenLayers.Format.XML.VersionedOGC = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
    
    /**
     * APIProperty: defaultVersion
     * {String} Version number to ***REMOVED***ume if none found.
     */
    defaultVersion: null,
    ...
    initialize: function(options) {
        ...
        var cl***REMOVED***Name = this.CLASS_NAME;
        this.name = cl***REMOVED***Name.substring(cl***REMOVED***Name.lastIndexOf(".")+1);
    },

    /**
     * Method: getVersion
     * Returns the version to use. Subcl***REMOVED***es can override this function
