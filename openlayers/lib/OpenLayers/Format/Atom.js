...
/**
 * Cl***REMOVED***: OpenLayers.Format.Atom
 ...
 */
OpenLayers.Format.Atom = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
     ...
     *
     * Returns:
     * {String} an Atom entry document if p***REMOVED***ed one feature node, or a feed
     * document if p***REMOVED***ed an array of feature nodes.
     */
