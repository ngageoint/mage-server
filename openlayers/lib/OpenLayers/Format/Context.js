...
/**
 * Cl***REMOVED***: OpenLayers.Format.Context
 * Base cl***REMOVED*** for both Format.WMC and Format.OWSContext
 *
 * Inherits from:
 *  - <OpenLayers.Format.XML.VersionedOGC>
 */
OpenLayers.Format.Context = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML.VersionedOGC, {
            ...
            if(options.map instanceof OpenLayers.Map) {
                ...
                if(OpenLayers.Util.isElement(mapOptions) ||
                   typeof mapOptions == "string") {
                    // we ***REMOVED***ume mapOptions references a div
                    // element
    ...
    getLayerFromContext: function(layerContext) {
        ...
        var layer = null;
        var ***REMOVED*** = layerContext.***REMOVED***;
        if (***REMOVED*** == OpenLayers.Format.Context.***REMOVED***Types.WFS) {
        ...
        } else if (***REMOVED*** == OpenLayers.Format.Context.***REMOVED***Types.KML) {
        ...
        } else if (***REMOVED*** == OpenLayers.Format.Context.***REMOVED***Types.GML) {
...
/**
 * Constant: OpenLayers.Format.Context.***REMOVED***Types
 * Enumeration for ***REMOVED*** types
 */
OpenLayers.Format.Context.***REMOVED***Types = {
    "WMS": "urn:ogc:***REMOVED***Type:WMS",
    "WFS": "urn:ogc:***REMOVED***Type:WFS",
    "WCS": "urn:ogc:***REMOVED***Type:WCS",
    "GML": "urn:ogc:***REMOVED***Type:GML",
    "SLD": "urn:ogc:***REMOVED***Type:SLD",
    "FES": "urn:ogc:***REMOVED***Type:FES",
    "KML": "urn:ogc:***REMOVED***Type:KML"
};
