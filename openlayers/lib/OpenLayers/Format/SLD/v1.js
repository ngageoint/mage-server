...
/**
 * Cl***REMOVED***: OpenLayers.Format.SLD.v1
 * Supercl***REMOVED*** for SLD version 1 parsers.
 *
 * Inherits from:
 *  - <OpenLayers.Format.Filter.v1_0_0>
 */
OpenLayers.Format.SLD.v1 = OpenLayers.Cl***REMOVED***(OpenLayers.Format.Filter.v1_0_0, {
     ...
     *     OpenLayers.Style2 cl***REMOVED*** allows collections of rules with multiple
        ...
        "sld": {
            ...
            "Stroke": function(symbolizer) {
                ...
                if(symbolizer.strokeDashstyle != undefined && symbolizer.strokeDashstyle !== "solid") {
                    // ***REMOVED***umes valid stroke-dasharray value
                    this.writeNode(
                        "CssParameter", 
