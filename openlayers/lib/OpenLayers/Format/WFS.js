...
/**
 * Cl***REMOVED***: OpenLayers.Format.WFS
 * Read/Write WFS. 
 *
 * Inherits from:
 *  - <OpenLayers.Format.GML>
 */
OpenLayers.Format.WFS = OpenLayers.Cl***REMOVED***(OpenLayers.Format.GML, {
     ...
     * for this format is subcl***REMOVED***ed entirely from GML: There is a writer 
     * only, which uses most of the code from the GML layer, and wraps
     * it in tra***REMOVED***ctional elements.
     * 
     * Parameters: 
     * options - {Object} 
    ...
    /**
     * Method: write 
     * Takes a feature list, and generates a WFS-T Tra***REMOVED***ction 
     *
     * Parameters:
    ...
    write: function(features) {
        ...
        var tra***REMOVED***ction = this.createElementNS(this.wfsns, 'wfs:Tra***REMOVED***ction');
        tra***REMOVED***ction.setAttribute("version","1.0.0");
        tra***REMOVED***ction.setAttribute("***REMOVED***","WFS");
        for (var i=0; i < features.length; i++) {
            switch (features[i].state) {
                case OpenLayers.State.INSERT:
                    tra***REMOVED***ction.appendChild(this.insert(features[i]));
                    break;
                case OpenLayers.State.UPDATE:
                    tra***REMOVED***ction.appendChild(this.update(features[i]));
                    break;
                case OpenLayers.State.DELETE:
                    tra***REMOVED***ction.appendChild(this.remove(features[i]));
                    break;
            }
        }
        
        return OpenLayers.Format.XML.prototype.write.apply(this,[tra***REMOVED***ction]);
    },
    ...
    /**
     * Method: insert 
     * Takes a feature, and generates a WFS-T Tra***REMOVED***ction "Insert" 
     *
     * Parameters: 
     * feature - {<OpenLayers.Feature.Vector>} 
     */
    ...
    /**
     * Method: update
     * Takes a feature, and generates a WFS-T Tra***REMOVED***ction "Update" 
     *
     * Parameters:
     * feature - {<OpenLayers.Feature.Vector>} 
     */
    ...
    /**
     * Method: remove 
     * Takes a feature, and generates a WFS-T Tra***REMOVED***ction "Delete" 
     *
     * Parameters:
     * feature - {<OpenLayers.Feature.Vector>} 
     */
