...
/**
 * Cl***REMOVED***: OpenLayers.Format.OWSContext.v0_3_1
 * Read and write OWSContext version 0.3.1.
 *
 * Inherits from:
 *  - <OpenLayers.Format.XML>
 */
OpenLayers.Format.OWSContext.v0_3_1 = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
    ...
    readers: {
        ...
        "owc": { 
            ...
            "Layer": function(node, obj) {
                var layerContext = {
                    ...
                    /* A category layer is a dummy layer meant for creating
                       ...
                       OpenLayers sense. The ***REMOVED***umption we make here is that
            ...
            "Server": function(node, obj) {
                ...
                if ((!obj.***REMOVED*** && !obj.version) || 
                    (obj.***REMOVED*** != 
                        OpenLayers.Format.Context.***REMOVED***Types.WMS)) {
                            obj.***REMOVED*** = node.getAttribute("***REMOVED***");
    ...
    writers: {
        "owc": {
            ...
            "_WFS": function(layer) {
                ...
                this.writeNode("ows:Title", layer.name, node);
                this.writeNode("Server", {***REMOVED***: 
                    OpenLayers.Format.Context.***REMOVED***Types.WFS, 
            ...
            "_GML": function(layer) {
                ...
                this.writeNode("ows:Title", layer.name, node);
                this.writeNode("Server", {***REMOVED***: 
                    OpenLayers.Format.Context.***REMOVED***Types.GML, 
            ...
            "_KML": function(layer) {
                ...
                this.writeNode("ows:Title", layer.name, node);
                this.writeNode("Server", {***REMOVED***: 
                    OpenLayers.Format.Context.***REMOVED***Types.KML,
