...
/**
 * Cl***REMOVED***: OpenLayers.Format.WMTSCapabilities.v1_0_0
 * Read WMTS Capabilities version 1.0.0.
 * 
 * Inherits from:
 *  - <OpenLayers.Format.WMTSCapabilities>
 */
OpenLayers.Format.WMTSCapabilities.v1_0_0 = OpenLayers.Cl***REMOVED***(
     ...
     *
     * Returns:
     * {Object} Information about the SOS ***REMOVED***.
     */
    read: function(data) {
    ...
    readers: {        
        "wmts": {
            ...
            "ServiceMetadataURL": function(node, obj) {
                obj.***REMOVED***MetadataUrl = {};
                obj.***REMOVED***MetadataUrl.href = node.getAttribute("xlink:href");
