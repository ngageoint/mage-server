...
/**
 * Cl***REMOVED***: OpenLayers.Format.OWSContext
 ...
 */
OpenLayers.Format.OWSContext = OpenLayers.Cl***REMOVED***(OpenLayers.Format.Context,{
    
    /**
     * APIProperty: defaultVersion
     * {String} Version number to ***REMOVED***ume if none found.  Default is "0.3.1".
     */
