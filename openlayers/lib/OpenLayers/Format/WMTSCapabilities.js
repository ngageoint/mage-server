...
/**
 * Cl***REMOVED***: OpenLayers.Format.WMTSCapabilities
 * Read WMTS Capabilities.
 *
 * Inherits from:
 *  - <OpenLayers.Format.XML.VersionedOGC>
 */
OpenLayers.Format.WMTSCapabilities = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML.VersionedOGC, {
     ...
     *     ***REMOVED***umed to correspond to a CRS with y,x axis order:
     *
     ...
     * the ***REMOVED*** (offering and observedProperty mostly).
     *
     * Parameters:
