...
/**
 * Cl***REMOVED***: OpenLayers.Format.QueryStringFilter
...
OpenLayers.Format.QueryStringFilter = (function() {
     ...
     * string known to the web ***REMOVED***.
     *
     * Parameters:
    ...
    return OpenLayers.Cl***REMOVED***(OpenLayers.Format, {
        ...
        write: function(filter, params) {
            params = params || {};
            var cl***REMOVED***Name = filter.CLASS_NAME;
            var filterType = cl***REMOVED***Name.substring(cl***REMOVED***Name.lastIndexOf(".") + 1);
            switch (filterType) {
                case "Spatial":
                    switch (filter.type) {
