...
/**
 * Cl***REMOVED***: OpenLayers.Format.Filter.v1
 * Supercl***REMOVED*** for Filter version 1 parsers.
 *
 * Inherits from:
 *  - <OpenLayers.Format.XML>
 */
OpenLayers.Format.Filter.v1 = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
    ...
    readers: {
        "ogc": {
            ...
            "Filter": function(node, parent) {
                // Filters correspond to subcl***REMOVED***es of OpenLayers.Filter.
                // Since they contain information we don't persist, we
                // create a temporary object and then p***REMOVED*** on the filter
