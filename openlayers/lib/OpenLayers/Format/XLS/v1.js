...
/**
 * Cl***REMOVED***: OpenLayers.Format.XLS.v1
 * Supercl***REMOVED*** for XLS version 1 parsers. Only supports GeocodeRequest for now.
 *
 * Inherits from:
 *  - <OpenLayers.Format.XML>
 */
OpenLayers.Format.XLS.v1 = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
