...
/**
 * Cl***REMOVED***: OpenLayers.Format.WPSExecute version 1.0.0
 *
 * Inherits from:
 *  - <OpenLayers.Format.XML>
 */
OpenLayers.Format.WPSExecute = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML,
        ...
        "wps": {
            "ExecuteResponse": function(node, obj) {
                obj.executeResponse = {
                    ...
                    ***REMOVED***Instance: node.getAttribute("***REMOVED***Instance"),
