...
/**
 * Cl***REMOVED***: OpenLayers.Format.ArcXML.Features
 ...
 */
OpenLayers.Format.ArcXML.Features = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {

    /**
     * Constructor: OpenLayers.Format.ArcXML.Features
     * Create a new parser/writer for ArcXML Features.  Create an instance of this cl***REMOVED***
