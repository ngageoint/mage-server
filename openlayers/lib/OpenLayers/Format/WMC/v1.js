...
/**
 * Cl***REMOVED***: OpenLayers.Format.WMC.v1
 * Supercl***REMOVED*** for WMC version 1 parsers.
 *
 * Inherits from:
 *  - <OpenLayers.Format.XML>
 */
OpenLayers.Format.WMC.v1 = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
        ...
        if (styles && OpenLayers.Util.isArray(styles)) {
            ...
            for (var i=0, len=styles.length; i<len; i++) {
                ...
                if(s.href) { // [1]
                    ...
                    // read in body as xml doc - ***REMOVED***ume proper namespace declarations
