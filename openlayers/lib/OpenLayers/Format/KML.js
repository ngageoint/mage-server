...
/**
 * Cl***REMOVED***: OpenLayers.Format.KML
 ...
 */
OpenLayers.Format.KML = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
    ...
    parseGeometry: {
        ...
        polygon: function(node) {
            ...
            if(numRings > 0) {
                // this ***REMOVED***umes exterior ring first, inner rings after
                var ring;
    ...
    parseAttributes: function(node) {
        ...
        // ***REMOVED***ume attribute nodes are type 1 children with a type 3 or 4 child
    ...
    buildGeometryNode: function(geometry) {
        ...
        var type = cl***REMOVED***Name.substring(cl***REMOVED***Name.lastIndexOf(".") + 1);
