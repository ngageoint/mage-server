...
/**
 * Cl***REMOVED***: OpenLayers.Format.WMSGetFeatureInfo
 * Cl***REMOVED*** to read GetFeatureInfo responses from Web Mapping Services
 *
 * Inherits from:
 *  - <OpenLayers.Format.XML>
 */
OpenLayers.Format.WMSGetFeatureInfo = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
     ...
     * Recursively searches p***REMOVED***ed xml node and all it's descendant levels for 
     *     nodes whose tagName contains the p***REMOVED***ed search string. This returns an 
     ...
     * 
     * Notes:
     * Assumes that attributes are direct child xml nodes of the p***REMOVED***ed node
