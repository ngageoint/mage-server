...
/**
 * Cl***REMOVED***: OpenLayers.Format.WMSCapabilities.v1
 * Abstract cl***REMOVED*** not to be instantiated directly. Creates
 * the common parts for both WMS 1.1.X and WMS 1.3.X.
 * 
 * Inherits from:
 *  - <OpenLayers.Format.XML>
 */
OpenLayers.Format.WMSCapabilities.v1 = OpenLayers.Cl***REMOVED***(
    OpenLayers.Format.XML, {
     ...
     * Create an instance of one of the subcl***REMOVED***es.
     *
     * Parameters:
    ...
    read: function(data) {
        ...
        if (capabilities.***REMOVED*** === undefined) {
    ...
    readers: {
        "wms": {
            "Service": function(node, obj) {
                obj.***REMOVED*** = {};
                this.readChildNodes(node, obj.***REMOVED***);
            },
            ...
            "BoundingBox": function(node, obj) {
                ...
                // return the bbox so that descendant cl***REMOVED***es can set the
