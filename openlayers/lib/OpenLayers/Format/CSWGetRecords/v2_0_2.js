...
/**
 * Cl***REMOVED***: OpenLayers.Format.CSWGetRecords.v2_0_2
 *     A format for creating CSWGetRecords v2.0.2 tra***REMOVED***ctions. 
 ...
 */
OpenLayers.Format.CSWGetRecords.v2_0_2 = OpenLayers.Cl***REMOVED***(OpenLayers.Format.XML, {
     ...
     * A cl***REMOVED*** for parsing and generating CSWGetRecords v2.0.2 tra***REMOVED***ctions.
     *
     * Parameters:
     * options - {Object} Optional object whose properties will be set on the
     *     instance.
     *
     * Valid options properties (documented as cl***REMOVED*** properties):
     * - requestId
     * - resultType
     * - outputFormat
     * - outputSchema
