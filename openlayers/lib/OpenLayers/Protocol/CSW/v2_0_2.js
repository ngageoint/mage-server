...
/**
 * Cl***REMOVED***: OpenLayers.Protocol.CSW.v2_0_2
 * CS-W (Catalogue ***REMOVED***s for the Web) version 2.0.2 protocol.
 *
 * Inherits from:
 *  - <OpenLayers.Protocol>
 */
OpenLayers.Protocol.CSW.v2_0_2 = OpenLayers.Cl***REMOVED***(OpenLayers.Protocol, {
     ...
     * A cl***REMOVED*** for CSW version 2.0.2 protocol management.
     *
     * Parameters:
