...
/**
 * Cl***REMOVED***: OpenLayers.Protocol.Script
 * A basic Script protocol for vector layers.  Create a new instance with the
 *     <OpenLayers.Protocol.Script> constructor.  A script protocol is used to
 *     get around the same origin policy.  It works with ***REMOVED***s that return
 ...
 *  - <OpenLayers.Protocol>
 */
OpenLayers.Protocol.Script = OpenLayers.Cl***REMOVED***(OpenLayers.Protocol, {

    /**
     * APIProperty: url
     * {String} Service URL.  The ***REMOVED*** is expected to return serialized 
     *     features wrapped in a named callback (where the callback name is
     *     generated by this protocol).
     *     Read-only, set through the options p***REMOVED***ed to the constructor.
     */
    url: null,
     ...
     * {String} The name of the query string parameter that the ***REMOVED*** 
     ...
     * {String} Where a ***REMOVED*** requires that the callback query string 
     ...
     *     through the options p***REMOVED***ed to the constructor.
     */
    scope: null,
     ...
     * A cl***REMOVED*** for giving layers generic Script protocol.
     *
     * Parameters:
     ...
     *     references the injected script.  This object is also p***REMOVED***ed to the
     ...
     * Remove a script node ***REMOVED***ociated with a response from the document.  Also
     ...
     *
     * Parameters:
     * response - {<OpenLayers.Protocol.Response>} The response object to p***REMOVED*** to
     *     the user callback.
...
(function() {
     ...
     *     that is the JSON returned by the ***REMOVED***.
     *
     * Returns:
