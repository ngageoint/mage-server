...
/**
 * Cl***REMOVED***: OpenLayers.Handler.Feature 
 * Handler to respond to mouse events related to a drawn feature.  Callbacks
 *     with the following keys will be notified of the following events
 *     ***REMOVED***ociated with features: click, clickout, over, out, and dblclick.
 *
 ...
 *  - <OpenLayers.Handler>
 */
OpenLayers.Handler.Feature = OpenLayers.Cl***REMOVED***(OpenLayers.Handler, {
     ...
     * of strings corresponding to the geometry cl***REMOVED*** names.
     * 
     * @type Array(String)
     */
    geometryTypes: null,
     ...
     * Return true if the geometry type of the p***REMOVED***ed feature matches
