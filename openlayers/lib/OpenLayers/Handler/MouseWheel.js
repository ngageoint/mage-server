...
/**
 * Cl***REMOVED***: OpenLayers.Handler.MouseWheel
 * Handler for wheel up/down events.
 * 
 * Inherits from:
 *  - <OpenLayers.Handler>
 */
OpenLayers.Handler.MouseWheel = OpenLayers.Cl***REMOVED***(OpenLayers.Handler, {
    /** 
    ...
    onWheelEvent: function(e){
        ...
        while((elem != null) && !overMapDiv && !overScrollableDiv) {
            ...
            if (!allowScroll) {
                allowScroll = OpenLayers.Element.hasCl***REMOVED***(elem, 'olScrollable');
                if (!allowScroll) {
