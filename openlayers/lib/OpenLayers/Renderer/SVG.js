...
/**
 * Cl***REMOVED***: OpenLayers.Renderer.SVG
 * 
 * Inherits:
 *  - <OpenLayers.Renderer.Elements>
 */
OpenLayers.Renderer.SVG = OpenLayers.Cl***REMOVED***(OpenLayers.Renderer.Elements, {
    ...
    drawText: function(featureId, style, location) {
        ...
        for (var i = 0; i < numRows; i++) {
            ...
            if (style.labelSelect === true) {
                ...
                tspan._geometryCl***REMOVED*** = location.CLASS_NAME;
            }
     ...
     *     getShortString), or an empty string if both p***REMOVED***ed componets are at
     *     the same point.
     */
