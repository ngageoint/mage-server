...
/**
 * Cl***REMOVED***: OpenLayers.Renderer.VML
 * Render vector features in browsers with VML capability.  Construct a new
 * VML renderer with the <OpenLayers.Renderer.VML> constructor.
 * 
 * Note that for all calculations in this cl***REMOVED***, we use (num | 0) to truncate a 
 ...
 */
OpenLayers.Renderer.VML = OpenLayers.Cl***REMOVED***(OpenLayers.Renderer.Elements, {
    ...
    setStyle: function(node, style, options, geometry) {
        ...
        if (node._geometryCl***REMOVED*** === "OpenLayers.Geometry.Point") {
            if (style.externalGraphic) {
        ...
        if ((rotation !== undefined || node._rotation !== undefined)) {
            ...
            if (style.externalGraphic) {
                ...
                // in graphicRotate
                fill.opacity = 0;
            } else if(node._geometryCl***REMOVED*** === "OpenLayers.Geometry.Point") {
    ...
    graphicRotate: function(node, xOffset, yOffset, style) {
        ...
        // events on images:
        // - Use the fill as usual (like for u***REMOVED***tated images) to handle
        //   events
    ...
    drawText: function(featureId, style, location) {
        ...
        if(style.labelSelect === true) {
            ...
            textbox._geometryCl***REMOVED*** = location.CLASS_NAME;
        }
