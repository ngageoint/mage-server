...
/**
 * Cl***REMOVED***: OpenLayers.WPSProcess
 ...
 */
OpenLayers.WPSProcess = OpenLayers.Cl***REMOVED***({
                ...
                (function callback() {
                    ...
                    OpenLayers.Request.POST({
                        ...
                        success: function(response) {
                            ...
                            //TODO For now we ***REMOVED***ume a spatial output
...
/**
 * Cl***REMOVED***: OpenLayers.WPSProcess.ChainLink
 * Type for chaining processes.
 */
OpenLayers.WPSProcess.ChainLink = OpenLayers.Cl***REMOVED***({
