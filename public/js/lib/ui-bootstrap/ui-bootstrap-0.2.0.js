...
angular.module('ui.bootstrap.buttons', [])
    ...
    link:function (scope, element, attrs, ngModelCtrl) {
      ...
      scope.$watch(function () {
        ...
        if (angular.equals(modelValue, value)){
          element.addCl***REMOVED***(activeCl***REMOVED***);
        } else {
          element.removeCl***REMOVED***(activeCl***REMOVED***);
        }
      });
  ...
  return {
    ...
    link:function (scope, element, attrs, ngModelCtrl) {
      ...
      element.bind(toggleEvent, function () {
        scope.$apply(function () {
          ngModelCtrl.$setViewValue(element.hasCl***REMOVED***(activeCl***REMOVED***) ? falseValue : trueValue);
        });
      });
    }
  };
...
dialogModule.provider("$dialog", function(){
  ...
  var defaults = {
    backdrop: true,
    dialogCl***REMOVED***: 'modal',
    backdropCl***REMOVED***: 'modal-backdrop',
    transitionCl***REMOVED***: 'fade',
    triggerCl***REMOVED***: 'in',
    dialogOpenCl***REMOVED***: 'modal-open',  
    resolve:{},
    backdropFade: false,
    dialogFade:false,
  ...
  // Returns the actual `$dialog` ***REMOVED*** that is injected in controllers
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
		...
		function createElement(clazz) {
			...
			el.addCl***REMOVED***(clazz);
			return el;
		}

    // The `Dialog` cl***REMOVED*** represents a modal dialog. The dialog cl***REMOVED*** can be invoked by providing an options object
    ...
    //     var d = new Dialog('path/to/dialog.html', MyDialogController);
      ...
      this.backdropEl = createElement(options.backdropCl***REMOVED***);
      if(options.backdropFade){
        this.backdropEl.addCl***REMOVED***(options.transitionCl***REMOVED***);
        this.backdropEl.removeCl***REMOVED***(options.triggerCl***REMOVED***);
      }

      this.modalEl = createElement(options.dialogCl***REMOVED***);
      if(options.dialogFade){
        this.modalEl.addCl***REMOVED***(options.transitionCl***REMOVED***);
        this.modalEl.removeCl***REMOVED***(options.triggerCl***REMOVED***);
      }
    ...
    Dialog.prototype.open = function(templateUrl, controller){
      ...
      this._loadResolves().then(function(locals) {
        ...
        body.addCl***REMOVED***(self.options.dialogOpenCl***REMOVED***);

        // trigger tranisitions
        setTimeout(function(){
          if(self.options.dialogFade){ self.modalEl.addCl***REMOVED***(self.options.triggerCl***REMOVED***); }
          if(self.options.backdropFade){ self.backdropEl.addCl***REMOVED***(self.options.triggerCl***REMOVED***); }
        });
    ...
    Dialog.prototype.close = function(result){
      ...
      body.removeCl***REMOVED***(self.options.dialogOpenCl***REMOVED***);
      if(fadingElements.length > 0){
        for (var i = fadingElements.length - 1; i >= 0; i--) {
          $transition(fadingElements[i], removeTriggerCl***REMOVED***).then(onCloseComplete);
        }
        return;
      }
      ...
      function removeTriggerCl***REMOVED***(el){
        el.removeCl***REMOVED***(self.options.triggerCl***REMOVED***);
      }
    ...
    // Loads all `options.resolve` members to be used as locals for the controller ***REMOVED***ociated with the dialog.
    ...
    // The actual `$dialog` ***REMOVED*** that is injected in controllers.
    return {
      ...
      //
      // * `result`: the result to p***REMOVED*** to the `close` method of the dialog when the button is clicked
      // * `label`: the label of the button
      // * `cssCl***REMOVED***`: additional css cl***REMOVED***(es) to apply to the button for styling
  ...
  return {
    ...
    link: function(scope, elm, attrs) {
      ...
      if (attrs.close) {
        ...
        setClosed = function() {         
          if (angular.isFunction($parse(shownExpr).***REMOVED***ign)) {
            $parse(shownExpr).***REMOVED***ign(scope, false); 
          }
        };
      }
...
.directive('tabs', function() {
  return {
    ...
    templateUrl: 'js/lib/ui-bootstrap/template/tabs/tabs.html',
    replace: true
  };
})
  ...
  return {
    ...
    link: function(scope, element, attrs, tabsCtrl) {
      ...
      if (attrs.active) {
        ...
        setSelected = getSelected.***REMOVED***ign;
        scope.$watch(
    ...
    templateUrl: 'js/lib/ui-bootstrap/template/tabs/pane.html',
    replace: true
  };
}]);
