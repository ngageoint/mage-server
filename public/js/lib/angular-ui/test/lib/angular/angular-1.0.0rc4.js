...
/**
 * HTML cl***REMOVED*** which is the only cl***REMOVED*** which can be used in ng-bind to inline HTML for security
 * reasons.
 *
 * @constructor
 * @param html raw (u***REMOVED***fe) html
 * @param {string=} option If set to 'usafe', get method will return raw (u***REMOVED***fe/u***REMOVED***nitized) html
 */
function HTML(html, option) {
  this.html = html;
  this.get = lowercase(option) == 'u***REMOVED***fe'
    ? valueFn(html)
...
function setupModuleLoader(window) {
  ...
  return ensure(ensure(window, 'angular', Object), 'module', function() {
     ...
     * # Module
     *
     * A module is a collocation of ***REMOVED***s, directives, filters, and configure information. Module
    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * @description
           * See {@link angular.module.AUTO.$provide#***REMOVED*** $provide.***REMOVED***()}.
           */
 ...
 *   retrieves controller ***REMOVED***ociated with the `ng-controller` directive. If `name` is provided as
...
function JQLiteRemoveCl***REMOVED***(element, selector) {
  if (selector) {
    forEach(selector.split(' '), function(cssCl***REMOVED***) {
...
function JQLiteAddCl***REMOVED***(element, selector) {
  if (selector) {
    forEach(selector.split(' '), function(cssCl***REMOVED***) {
...
/**
 * @ngdoc method
 * @name angular.module.AUTO.$provide#***REMOVED***
 * @methodOf angular.module.AUTO.$provide
 * @description
 *
...
function Browser(window, document, body, $log, $sniffer) {
   ...
   * {@link angular.module.ng.$location $location ***REMOVED***} to change url.
   *
   ...
   *
   * NOTE: this api is intended for use only by the $location ***REMOVED***. Please use the
   * {@link angular.module.ng.$location $location ***REMOVED***} to monitor url changes in angular apps.
   *
  ...
  this.$get = [
    ...
    var LOCAL_MODE = {
      ...
      accessor: function(localName, mode, parentScope, scope, attr) {
        ...
        if (exp) {
          getter = $parse(exp);
          setter = getter.***REMOVED***ign || function() {
            throw Error("Expression '" + exp + "' not ***REMOVED***ignable.");
          };
        }
      ...
      return function(scope, cloneConnectFn){
        ***REMOVED***ertArg(scope, 'scope');
        ...
        var element = cloneConnectFn
          ...
          : templateElement;
        safeAddCl***REMOVED***(element.data('$scope', scope), 'ng-scope');
    ...
    function applyDirectivesToNode(directives, templateNode, templateAttrs, transcludeFn, rootElement) {
      ...
      for(var i = 0, ii = directives.length; i < ii; i++) {
        ...
        if (directiveValue = directive.scope) {
          ***REMOVED***ertNoDuplicate('isolated scope', newIsolatedScopeDirective, directive, element);
          if (isObject(directiveValue)) {
            safeAddCl***REMOVED***(element, 'ng-isolate-scope');
            newIsolatedScopeDirective = directive;
          }
          safeAddCl***REMOVED***(element, 'ng-scope');
        ...
        if (directiveValue = directive.transclude) {
          ***REMOVED***ertNoDuplicate('transclusion', transcludeDirective, directive, element);
        ...
        if (directiveValue = directive.template) {
          ***REMOVED***ertNoDuplicate('template', templateDirective, directive, element);
 ...
 * @description
 * The {@link angular.module.ng.$controller $controller ***REMOVED***} is used by Angular to create new
 * controllers.
 *
 ...
 * {@link angular.module.ng.$exceptionHandler $exceptionHandler} ***REMOVED***.
 *
...
function $InterpolateProvider() {
  ...
  this.$get = ['$parse', function($parse) {
     ...
     * HTML {@link angular.module.ng.$compile $compile} ***REMOVED*** for data binding. See
 ...
 *
 * @description
 * The $location ***REMOVED*** parses the URL in the browser address bar (based on the {@link https://developer.mozilla.org/en/window.location window.location}) and makes the URL available to your application. Changes to the URL in the address bar are reflected into $location ***REMOVED*** and changes to $location are reflected into the browser address bar.
 *
 ...
 *
 * For more information see {@link guide/dev_guide.***REMOVED***s.$location Developer Guide: Angular Services: Using $location}
 */
 ...
 * **Properties**
 *
 * - promise â€“ `{Promise}` â€“ promise object ***REMOVED***ociated with this deferred.
 *
 *
 * # The Promise API
 *
...
function $RouteProvider(){
   ...
   *    Object properties:
   *
   *    - `controller` â€“ `{function()=}` â€“ Controller fn that should be ***REMOVED***ociated with newly
   *      created scope.
  ...
  this.$get = ['$rootScope', '$location', '$routeParams',
     ...
     *
     * The `$route` ***REMOVED*** is typically used in conjunction with {@link angular.module.ng.$compileProvider.directive.ng-view ng-view}
     * directive and the {@link angular.module.ng.$routeParams $routeParams} ***REMOVED***.
     *
     * @example
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
       ...
       * @returns {function()} Returns a deregistration function for this listener.
       *
       * The event listener function format is: `function(event)`. The `event` object p***REMOVED***ed into the
       ...
       *
       * Any exception emmited from the {@link angular.module.ng.$rootScope.Scope#$on listeners} will be p***REMOVED***ed
       * onto the {@link angular.module.ng.$exceptionHandler $exceptionHandler} ***REMOVED***.
       *
 ...
 *   then serialized back to properly escaped html string. This means that no u***REMOVED***fe input can make
 ...
 * @example
   <doc:example>
       ...
       <div ng-controller="Ctrl">
          Snippet: <textarea ng-model="snippet" cols="60" rows="3"></textarea>
           <table>
             ...
             <tr id="html-u***REMOVED***fe-filter">
               <td>u***REMOVED***fe html filter</td>
               <td><pre>&lt;div ng-bind-html-u***REMOVED***fe="snippet"&gt;<br/>&lt;/div&gt;</pre></td>
               <td><div ng-bind-html-u***REMOVED***fe="snippet"></div></td>
             </tr>
           </table>
         </div>
     </doc:source>
     <doc:scenario>
       ...
       it('should inline raw snippet if filtered as u***REMOVED***fe', function() {
         expect(using('#html-u***REMOVED***fe-filter').element("div").html()).
           toBe("<p style=\"color:blue\">an html\n" +
                "<em onmouseover=\"this.textContent='PWN3D!'\">click here</em>\n" +
                "snippet</p>");
       });
       ...
       it('should update', function() {
         ...
         expect(using('#html-u***REMOVED***fe-filter').binding("snippet")).toBe('new <b>text</b>');
       });
     </doc:scenario>
   </doc:example>
 */
...
var validAttrs = extend({}, uriAttrs, makeMap(
    'abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,cl***REMOVED***,clear,'+
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *
     * # General usage
     * The `$http` ***REMOVED*** is a function which takes a single argument â€” a configuration object â€”
 ...
 *
 * @description
 * HTTP backend used by the {@link angular.module.ng.$http ***REMOVED***} that delegates to
...
function linkyFilter() {
  ...
  return function(text) {
    ...
    while ((match = raw.match(LINKY_URL_REGEXP))) {
      ...
      url = match[0];
      // if we did not match ftp/http/mailto then ***REMOVED***ume mailto
...
/**
 * @ngdoc directive
 * @name angular.module.ng.$compileProvider.directive.ng-bind-html-u***REMOVED***fe
 *
 * @description
 ...
 *
 * @element ANY
 * @param {expression} ng-bind-html-u***REMOVED***fe {@link guide/dev_guide.expressions Expression} to evaluate.
 */
var ngBindHtmlU***REMOVED***feDirective = ngDirective(function(scope, element, attr) {
  element.addCl***REMOVED***('ng-binding').data('$binding', attr.ngBindHtmlU***REMOVED***fe);
  scope.$watch(attr.ngBindHtmlU***REMOVED***fe, function(value) {
 ...
 * {@link angular.module.ng.$sanitize $sanitize} ***REMOVED*** and innerHTML the result into the current
 * element.
 *
 * See {@link angular.module.ng.$sanitize $sanitize} docs for examples.
 *
    ...
    scope.$watch(attr[name], function(newVal, oldVal) {
      if (selector === true || scope.$index % 2 === selector) {
        if (oldVal && (newVal !== oldVal)) {
           ...
           element.removeCl***REMOVED***(isArray(oldVal) ? oldVal.join(' ') : oldVal);
         }
         if (isObject(newVal) && !isArray(newVal))
            newVal = map(newVal, function(v, k) { if (v) return k });
         if (newVal) element.addCl***REMOVED***(isArray(newVal) ? newVal.join(' ') : newVal);      }
    }, true);
  });
}
...
/**
 * @ngdoc directive
 * @name angular.module.ng.$compileProvider.directive.ng-cl***REMOVED***
 *
 * @description
 * The `ng-cl***REMOVED***` allows you to set CSS cl***REMOVED*** on HTML element dynamically by databinding an
 ...
 *
 * When the expression changes, the previously added cl***REMOVED***es are removed and only then the cl***REMOVED***es
 * new cl***REMOVED***es are added.
 *
 * @element ANY
 * @param {expression} ng-cl***REMOVED*** {@link guide/dev_guide.expressions Expression} to eval. The result
...
/**
 * @ngdoc directive
 * @name angular.module.ng.$compileProvider.directive.ng-cl***REMOVED***-odd
 *
 * @description
 * The `ng-cl***REMOVED***-odd` and `ng-cl***REMOVED***-even` works exactly as
 * {@link angular.module.ng.$compileProvider.directive.ng-cl***REMOVED*** ng-cl***REMOVED***}, except it works in conjunction with `ng-repeat` and
 ...
 *
 * @element ANY
 * @param {expression} ng-cl***REMOVED***-odd {@link guide/dev_guide.expressions Expression} to eval. The result
     ...
     <doc:source>
        <ol ng-init="names=['John', 'Mary', 'Cate', 'Suz']">
          <li ng-repeat="name in names">
           <span ng-cl***REMOVED***-odd="'ng-format-negative'"
                 ng-cl***REMOVED***-even="'ng-invalid'">
             {{name}} &nbsp; &nbsp; &nbsp;
           </span>
          </li>
        </ol>
...
/**
 * @ngdoc directive
 * @name angular.module.ng.$compileProvider.directive.ng-cl***REMOVED***-even
 *
 * @description
 * The `ng-cl***REMOVED***-odd` and `ng-cl***REMOVED***-even` works exactly as
 * {@link angular.module.ng.$compileProvider.directive.ng-cl***REMOVED*** ng-cl***REMOVED***}, except it works in
 ...
 *
 * @element ANY
 * @param {expression} ng-cl***REMOVED***-even {@link guide/dev_guide.expressions Expression} to eval. The
 ...
 * cl***REMOVED*** `ng-cloak` in addition to `ng-cloak` directive as shown in the example below.
 *
 * @element ANY
 *
 * @example
 ...
 *
 * @description
 * The `ng-controller` directive ***REMOVED***igns behavior to a scope. This is a key aspect of how angular
 ...
 * * Controller â€” The `ng-controller` directive specifies a Controller cl***REMOVED***; the cl***REMOVED*** has
 ...
 * * `ng-switch-default`: the default case when no other c***REMOVED***es match.
 *
 * @example
    <doc:example>
      <doc:source>
 ...
 * @description
 * # Overview
 * `ng-view` is a directive that complements the {@link angular.module.ng.$route $route} ***REMOVED*** by
 ...
 *     strings
 *   * {@link angular.module.ng.$compileProvider.directive.ng-repeat ng-repeat} u***REMOVED***lls after the select binds causing
