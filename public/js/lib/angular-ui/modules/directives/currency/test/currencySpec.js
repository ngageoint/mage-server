  ...
  describe('use on a div element with two-way binding', function () {
    it('should have ui-currency-pos style non-zero positive model number ', function () {
      inject(function ($compile) {
        ...
        expect(element.hasCl***REMOVED***('ui-currency-pos')).toBeTruthy();
        expect(element.hasCl***REMOVED***('ui-currency-neg')).toBeFalsy();
        expect(element.hasCl***REMOVED***('ui-currency-zero')).toBeFalsy();
      });
    });
    it('should have ui-currency-neg style when negative model number', function () {
      inject(function ($compile) {
        ...
        expect(element.hasCl***REMOVED***('ui-currency-pos')).toBeFalsy();
        expect(element.hasCl***REMOVED***('ui-currency-neg')).toBeTruthy();
      });
    });
    it('should have ui-currency-zero style when zero model number', function () {
      inject(function ($compile) {
        ...
        expect(element.hasCl***REMOVED***('ui-currency-pos')).toBeFalsy();
        expect(element.hasCl***REMOVED***('ui-currency-neg')).toBeFalsy();
        expect(element.hasCl***REMOVED***('ui-currency-zero')).toBeTruthy();
      });
    });
    ...
    it('should have user-defined positive style when provided in uiCurrency attr', function () {
      inject(function ($compile) {
        ...
        expect(element.hasCl***REMOVED***('pstyle')).toBeTruthy();
      });
    });
