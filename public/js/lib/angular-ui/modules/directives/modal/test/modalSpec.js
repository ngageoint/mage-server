describe('modal', function () {
  ...
  it('should add "modal hide" cl***REMOVED*** for you', function () {
    expect(elm.hasCl***REMOVED***("modal hide")).toBe(true);
  });
  ...
  describe('model change', function () {
    it('should open modal', function () {
      ...
      $timeout.flush();
      expect(elm.hasCl***REMOVED***('in')).toBe(true);
    });
    ...
    it('should close modal', function () {
      ...
      $timeout.flush();
      expect(elm.hasCl***REMOVED***('in')).toBe(false);
    });
  });
