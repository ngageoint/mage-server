describe('highlight', function () {
  ...
  describe('case insensitive', function () {
    it('should highlight a matching phrase', function () {
      expect(highlightFilter(testPhrase, 'highlight')).toEqual('Prefix <span cl***REMOVED***="ui-match">Highlight</span> Suffix');
    });
    ...
    it('should work correctly for number filters', function () {
      expect(highlightFilter('3210123', 0)).toEqual('321<span cl***REMOVED***="ui-match">0</span>123');
    });
  ...
  describe('case sensitive', function () {
    it('should highlight a matching phrase', function () {
      expect(highlightFilter(testPhrase, 'Highlight', true)).toEqual('Prefix <span cl***REMOVED***="ui-match">Highlight</span> Suffix');
    });
    it('should highlight nothing if no match found', function () {
    ...
    it('should work correctly for number filters', function () {
      expect(highlightFilter('3210123', 0, true)).toEqual('321<span cl***REMOVED***="ui-match">0</span>123');
    });
    it('should work correctly for number text', function () {
      expect(highlightFilter(3210123, '0', true)).toEqual('321<span cl***REMOVED***="ui-match">0</span>123');
    });
  ...
  it('should highlight nothing if empty filter string p***REMOVED***ed - issue #114', function () {
