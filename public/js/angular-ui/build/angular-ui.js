 ...
 *    Set {ngChange:false} to disable p***REMOVED***through support for change events ( since angular watches 'input' events, not 'change' events )
 *
...
.directive('uiModal', ['$timeout', function($timeout) {
  return {
    ...
    link: function(scope, elm, attrs, model) {
      //helper so you don't have to type cl***REMOVED***="modal hide"
      elm.addCl***REMOVED***('modal hide');
