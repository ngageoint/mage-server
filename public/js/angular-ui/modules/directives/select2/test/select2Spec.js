...
describe('uiSelect2', function () {
  ...
  describe('with a select element', function () {
    ...
    it('should observe the disabled attribute', function () {
      ...
      //expect(element.next().hasCl***REMOVED***('select2-container-disabled')).toBe(false);
      //scope.$apply(function(){
      //  scope.disabled = true;
      //});
      //expect(element.next().hasCl***REMOVED***('select2-container-disabled')).toBe(true);
      //scope.$apply(function(){
    ...
    it('should observe the multiple attribute', function () {
      ...
      //expect(element.next().hasCl***REMOVED***('select2-container-multi')).toBe(false);
      //scope.$apply(function(){
      //  scope.multiple = true;
      //});
      //expect(element.next().hasCl***REMOVED***('select2-container-multi')).toBe(true);
      //scope.$apply(function(){
