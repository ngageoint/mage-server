...
2. Follow the coding conventions of the original repository. Changes to one of the JavaScript source files are required to p***REMOVED*** the [JSLint](http://jslint.com/) validation tool.
