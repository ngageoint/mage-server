...
(function (factory) {
    ...
    angular.module('blueimp.fileupload', [])
        ...
        // The fileUpload ***REMOVED*** provides configuration options
            ...
            $config = this.defaults = {
                ...
                add: function (e, data) {
                    ...
                    var scope = data.scope(),
                        filesCopy = [];
                    if (data.errorFiles) {
                        scope.errorFiles = scope.errorFiles || [];
                        angular.forEach(data.errorFiles, function(file) {
        ...
        .controller('FileUploadController', [
            ...
            function ($scope, $element, $attrs, $window, fileUpload) {
                console.info('file upload controller');
                var uploadMethods = {
                    progress: function () {
                ...
                $scope.submit = function () {
                    console.info("angular upload what is this",this);
                ...
                $scope.$watch(
                    'fileUpload',
                    function (newOptions) {
                        console.info('watching the attrs.fileupload');
                        if (newOptions) {
