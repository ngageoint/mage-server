...
/*jslint nomen: true, regexp: true, unparam: true, ***REMOVED***: true */
...
(function (port) {
    ...
    var path = require('path'),
        ...
        options = {
            ...
            // to prevent executing any scripts in the context of the ***REMOVED*** domain:
            ...
            /* Uncomment and edit this section to provide the ***REMOVED*** via HTTPS:
            ssl: {
    ...
    fileServer.respond = function (pathname, status, _headers, files, stat, req, res, finish) {
        ...
        if (!options.inlineFileTypes.test(files[0])) {
            // Force a download dialog for u***REMOVED***fe file extensions:
