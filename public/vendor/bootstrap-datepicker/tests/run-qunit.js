...
page.open(openPath, function(status){
    if (status !== "success") {
        ...
        waitFor(function(){
            ...
            // reach into page context and pull out coverage info. stringify to p***REMOVED*** context boundaries.
            ...
            if (coverageInfo.key){
                ...
                for (var idx=0; idx < lineCoverage.length; idx++) {
                    ...
                    colorized += '<div cl***REMOVED***="code' + hitmiss + '">' + htmlLine + '</div>\n';
                };
            ...
            var failedNum = page.evaluate(function(){
                ...
                try {
                    return el.getElementsByCl***REMOVED***Name('failed')[0].innerHTML;
                } catch (e) { }
                return 10000;
            });
