...
```html
<input type="text" value="02-16-2012" cl***REMOVED***="datepicker">
```
```javascript
...
```html
<input type="text" value="02/16/12" data-date-format="mm/dd/yy" cl***REMOVED***="datepicker" >
```
```javascript
$('.datepicker').datepicker();
```
...
```html
<div cl***REMOVED***="input-append date datepicker" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
    <input size="16" type="text" value="12-02-2012" readonly><span cl***REMOVED***="add-on"><i cl***REMOVED***="icon-th"></i></span>
</div>
```
```javascript
$('.datepicker').datepicker();
...
```html
<div cl***REMOVED***="alert alert-error" id="alert">
...
<table cl***REMOVED***="table">
    <thead>
        <tr>
          <th>
              Start date
              <a href="#" cl***REMOVED***="btn small" id="date-start" data-date-format="yyyy-mm-dd" data-date="2012-02-20">Change</a>
          </th>
          <th>
              End date
              <a href="#" cl***REMOVED***="btn small" id="date-end" data-date-format="yyyy-mm-dd" data-date="2012-02-25">Change</a>
          </th>
        </tr>
    </thead>
    <tbody>
...
```javascript
var datepicker = $.fn.datepicker.noConflict(); // return $.fn.datepicker to previously ***REMOVED***igned value
 ...
 * A String representing additional CSS cl***REMOVED***es to apply to the date's cell
 * An object with the following properties:
   * `enabled`: same as the Boolean value above
   * `cl***REMOVED***es`: same as the String value above
...
```html
<div cl***REMOVED***="input-append date datepicker" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
    <input cl***REMOVED***="span2" size="16" type="text" value="12-02-2012"><span cl***REMOVED***="add-on"><i cl***REMOVED***="icon-th"></i></span>
</div>
```
...
```html
<div cl***REMOVED***="input-daterange" id="datepicker">
    <input cl***REMOVED***="input-small" name="start" value="2012-04-05" />
    <span cl***REMOVED***="add-on">to</span>
    <input cl***REMOVED***="input-small" name="end" value="2012-04-07" />
</div>
```
...
If `date` is provided and is a Date objects, it is ***REMOVED***umed to be a "local" date object, and will be converted to UTC for internal use.
