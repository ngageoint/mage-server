      ...
      return {
        ...
        link: function(scope, element, attrs, ngModel) {
          ...
          setConfigOptions = function() {
            ...
            if (attrs.iconCl***REMOVED*** && attrs.iconCl***REMOVED***.length) {
              return scope.buttonIconHtml = $sce.trustAsHtml("<i ng-show='iconCl***REMOVED***' cl***REMOVED***='" + attrs.iconCl***REMOVED*** + "'></i>");
            }
          };
