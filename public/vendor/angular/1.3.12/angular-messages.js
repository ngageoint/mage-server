 ...
 * cl***REMOVED*** will be added to the element. The `.ng-inactive` CSS cl***REMOVED*** will be applied when there are no
 * animations present. Therefore, CSS transitions and keyframes as well as JavaScript animations can
 * hook into the animations whenever these cl***REMOVED***es are added/removed.
 *
 * Let's say that our HTML code for our messages container looks like so:
 *
 * ```html
 * <div ng-messages="myMessages" cl***REMOVED***="my-messages">
 *   <div ng-message="alert" cl***REMOVED***="some-message">...</div>
 *   <div ng-message="fail" cl***REMOVED***="some-message">...</div>
 * </div>
 * ```
 *
...
angular.module('ngMessages', [])
  ...
  .directive('ngMessages', ['$compile', '$animate', '$templateRequest',
    ...
    return {
      restrict: 'AE',
      controller: function() {
        this.$renderNgMessageCl***REMOVED***es = angular.noop;
        ...
        this.renderMessages = function(values, multiple) {
          ...
          this.renderElementCl***REMOVED***es(found);
      ...
      link: function($scope, element, $attrs, ctrl) {
        ctrl.renderElementCl***REMOVED***es = function(bool) {
          bool ? $animate.setCl***REMOVED***(element, ACTIVE_CLASS, INACTIVE_CLASS)
               : $animate.setCl***REMOVED***(element, INACTIVE_CLASS, ACTIVE_CLASS);
        };
