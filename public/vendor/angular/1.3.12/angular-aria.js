 ...
 * of ***REMOVED***istive technologies, such as screen readers.
 *
...
function $AriaProvider() {
   ...
   * @description
   *
   * The $aria ***REMOVED*** contains helper methods for applying common
   * [ARIA](http://www.w3.org/TR/wai-aria/) attributes to HTML directives.
   *
   * ngAria injects common accessibility attributes that tell ***REMOVED***istive technologies when HTML
   ...
   * solely managing accessibility attributes. The internal `$aria` ***REMOVED*** is used to watch the
  ...
  return {
    ...
    link: function(scope, elem, attr, ngMessages) {
      if (!elem.attr('aria-live')) {
        elem.attr('aria-live', '***REMOVED***ertive');
      }
    }
  };
})
