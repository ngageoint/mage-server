 ...
 * | {@link ng.directive:ngCl***REMOVED***#usage_animations ngCl***REMOVED***}           | add and remove                                     |
 * | {@link ng.directive:ngShow#usage_animations ngShow & ngHide}    | add and remove (the ng-hide cl***REMOVED*** value)           |
...
angular.module('ngAnimate', ['ng'])
  ...
  .config(['$provide', '$animateProvider', function($provide, $animateProvider) {
    ...
    $provide.decorator('$animate', ['$delegate', '$injector', '$sniffer', '$rootElement', '$$asyncCallback', '$rootScope', '$document',
      ...
      // to p***REMOVED*** then the structural animation would render its animation on page load.
      ...
      function animationRunner(element, animationEvent, cl***REMOVED***Name) {
        ...
        var cl***REMOVED***NameAdd, cl***REMOVED***NameRemove;
        if(angular.isArray(cl***REMOVED***Name)) {
        ...
        function run(fns, cancellations, allCompleteFn) {
          ...
          forEach(animations, function(animation, index) {
            ...
            switch(animation.event) {
              case 'setCl***REMOVED***':
                cancellations.push(animation.fn(element, cl***REMOVED***NameAdd, cl***REMOVED***NameRemove, progress));
                break;
              case 'addCl***REMOVED***':
                cancellations.push(animation.fn(element, cl***REMOVED***NameAdd || cl***REMOVED***Name,     progress));
                break;
              case 'removeCl***REMOVED***':
                cancellations.push(animation.fn(element, cl***REMOVED***NameRemove || cl***REMOVED***Name,  progress));
                break;
              default:
      ...
      return {
         ...
         * | 3. $animate runs any JavaScript-defined animations on the element                            | cl***REMOVED***="my-animation ng-animate"             |
         * | 4. the .ng-enter cl***REMOVED*** is added to the element                                               | cl***REMOVED***="my-animation ng-animate ng-enter"    |
         * | 5. $animate scans the element styles to get the CSS transition/animation duration and delay  | cl***REMOVED***="my-animation ng-animate ng-enter"    |
         * | 6. $animate waits for 10ms (this performs a reflow)                                          | cl***REMOVED***="my-animation ng-animate ng-enter"    |
         * | 7. the .ng-enter-active and .ng-animate-active cl***REMOVED***es are added (this triggers the CSS transition/animation) | cl***REMOVED***="my-animation ng-animate ng-animate-active ng-enter ng-enter-active" |
         * | 8. $animate waits for X milliseconds for the animation to complete                           | cl***REMOVED***="my-animation ng-animate ng-animate-active ng-enter ng-enter-active" |
         * | 9. The animation ends and all generated CSS cl***REMOVED***es are removed from the element             | cl***REMOVED***="my-animation"                        |
         * | 10. The doneCallback() callback is fired (if provided)                                       | cl***REMOVED***="my-animation"                        |
         *
        ...
        */
         ...
         * | 2. $animate runs any JavaScript-defined animations on the element                            | cl***REMOVED***="my-animation ng-animate"             |
         * | 3. the .ng-leave cl***REMOVED*** is added to the element                                               | cl***REMOVED***="my-animation ng-animate ng-leave"    |
         * | 4. $animate scans the element styles to get the CSS transition/animation duration and delay  | cl***REMOVED***="my-animation ng-animate ng-leave"    |
         * | 5. $animate waits for 10ms (this performs a reflow)                                          | cl***REMOVED***="my-animation ng-animate ng-leave"    |
         * | 6. the .ng-leave-active and .ng-animate-active cl***REMOVED***es is added (this triggers the CSS transition/animation) | cl***REMOVED***="my-animation ng-animate ng-animate-active ng-leave ng-leave-active" |
         * | 7. $animate waits for X milliseconds for the animation to complete                           | cl***REMOVED***="my-animation ng-animate ng-animate-active ng-leave ng-leave-active" |
        ...
        */
         ...
         * | 3. $animate runs any JavaScript-defined animations on the element                            | cl***REMOVED***="my-animation ng-animate"             |
         * | 4. the .ng-move cl***REMOVED*** is added to the element                                                | cl***REMOVED***="my-animation ng-animate ng-move"     |
         * | 5. $animate scans the element styles to get the CSS transition/animation duration and delay  | cl***REMOVED***="my-animation ng-animate ng-move"     |
         * | 6. $animate waits for 10ms (this performs a reflow)                                          | cl***REMOVED***="my-animation ng-animate ng-move"     |
         * | 7. the .ng-move-active and .ng-animate-active cl***REMOVED***es is added (this triggers the CSS transition/animation) | cl***REMOVED***="my-animation ng-animate ng-animate-active ng-move ng-move-active" |
         * | 8. $animate waits for X milliseconds for the animation to complete                           | cl***REMOVED***="my-animation ng-animate ng-animate-active ng-move ng-move-active" |
         * | 9. The animation ends and all generated CSS cl***REMOVED***es are removed from the element             | cl***REMOVED***="my-animation"                        |
         * | 10. The doneCallback() callback is fired (if provided)                                       | cl***REMOVED***="my-animation"                        |
         *
        ...
        */
         ...
         * or keyframes are defined on the -add or base CSS cl***REMOVED***).
         *
         ...
         * | 2. $animate runs any JavaScript-defined animations on the element                              | cl***REMOVED***="my-animation ng-animate"             |
         * | 3. the .super-add cl***REMOVED*** are added to the element                                               | cl***REMOVED***="my-animation ng-animate super-add"   |
         * | 4. $animate scans the element styles to get the CSS transition/animation duration and delay    | cl***REMOVED***="my-animation ng-animate super-add"   |
         * | 5. $animate waits for 10ms (this performs a reflow)                                            | cl***REMOVED***="my-animation ng-animate super-add"   |
         * | 6. the .super, .super-add-active and .ng-animate-active cl***REMOVED***es are added (this triggers the CSS transition/animation) | cl***REMOVED***="my-animation ng-animate ng-animate-active super super-add super-add-active"          |
         * | 7. $animate waits for X milliseconds for the animation to complete                             | cl***REMOVED***="my-animation super super-add super-add-active"  |
         ...
         * | 10. The doneCallback() callback is fired (if provided)                                         | cl***REMOVED***="my-animation super"                  |
         *
         * @param {DOMElement} element the element that will be animated
         * @param {string} cl***REMOVED***Name the CSS cl***REMOVED*** that will be added to the element and then animated
         * @param {function()=} doneCallback the callback function that will be called once the animation is complete
        */
        addCl***REMOVED*** : function(element, cl***REMOVED***Name, doneCallback) {
          element = stripCommentsFromElement(element);
          performAnimation('addCl***REMOVED***', cl***REMOVED***Name, element, null, null, function() {
            $delegate.addCl***REMOVED***(element, cl***REMOVED***Name);
          }, doneCallback);
        },
         ...
         * | 2. $animate runs any JavaScript-defined animations on the element                             | cl***REMOVED***="my-animation super ng-animate"       |
         * | 3. the .super-remove cl***REMOVED*** are added to the element                                           | cl***REMOVED***="my-animation super ng-animate super-remove"|
         * | 4. $animate scans the element styles to get the CSS transition/animation duration and delay   | cl***REMOVED***="my-animation super ng-animate super-remove"   |
         * | 5. $animate waits for 10ms (this performs a reflow)                                           | cl***REMOVED***="my-animation super ng-animate super-remove"   |
         * | 6. the .super-remove-active and .ng-animate-active cl***REMOVED***es are added and .super is removed (this triggers the CSS transition/animation) | cl***REMOVED***="my-animation ng-animate ng-animate-active super-remove super-remove-active"          |
         * | 7. $animate waits for X milliseconds for the animation to complete                            | cl***REMOVED***="my-animation ng-animate ng-animate-active super-remove super-remove-active"   |
         * | 8. The animation ends and all generated CSS cl***REMOVED***es are removed from the element              | cl***REMOVED***="my-animation"                        |
         * | 9. The doneCallback() callback is fired (if provided)                                         | cl***REMOVED***="my-animation"                        |
         *
         *
         * @param {DOMElement} element the element that will be animated
         ...
         * @param {function()=} doneCallback the callback function that will be called once the animation is complete
        */
        removeCl***REMOVED*** : function(element, cl***REMOVED***Name, doneCallback) {
          element = stripCommentsFromElement(element);
          performAnimation('removeCl***REMOVED***', cl***REMOVED***Name, element, null, null, function() {
            $delegate.removeCl***REMOVED***(element, cl***REMOVED***Name);
          }, doneCallback);
        },
           ...
           */
        setCl***REMOVED*** : function(element, add, remove, doneCallback) {
          element = stripCommentsFromElement(element);
          performAnimation('setCl***REMOVED***', [add, remove], element, null, null, function() {
            $delegate.setCl***REMOVED***(element, add, remove);
          }, doneCallback);
        },
      ...
      */
      function performAnimation(animationEvent, cl***REMOVED***Name, element, parentElement, afterElement, domOperation, doneCallback) {

        var runner = animationRunner(element, animationEvent, cl***REMOVED***Name);
        if(!runner) {
          fireDOMOperation();
        ...
        var skipAnimations = runner.isCl***REMOVED***Based ?
          ngAnimateState.disabled || (lastAnimation && !lastAnimation.isCl***REMOVED***Based) :
          false;
        ...
        if(runner.isCl***REMOVED***Based && !runner.isSetCl***REMOVED***Operation && !skipAnimation) {
        ...
        element.addCl***REMOVED***(NG_ANIMATE_CLASS_NAME);
      ...
      function cleanup(element, cl***REMOVED***Name) {
        if(isMatchingElement(element, $rootElement)) {
          ...
          if(removeAnimations || !data.totalActive) {
            element.removeCl***REMOVED***(NG_ANIMATE_CLASS_NAME);
    ...
    $animateProvider.register('', ['$window', '$sniffer', '$timeout', '$$animateReflow',
      ...
      function animateSetup(animationEvent, element, cl***REMOVED***Name, calculationDecorator) {
        ...
        if(itemIndex > 0) {
          ...
          applyCl***REMOVED***es && element.addCl***REMOVED***(staggerCl***REMOVED***Name);

          stagger = getElementAnimationDetails(element, staggerCacheKey);

          applyCl***REMOVED***es && element.removeCl***REMOVED***(staggerCl***REMOVED***Name);
        }

        /* the animation itself may need to add/remove special CSS cl***REMOVED***es
        ...
        var isCurrentlyAnimating = formerData.running > 0 || animationEvent == 'setCl***REMOVED***';
        if(transitionDuration > 0) {
          blockTransitions(element, cl***REMOVED***Name, isCurrentlyAnimating);
        }
      ...
      function isStructuralAnimation(cl***REMOVED***Name) {
        return cl***REMOVED***Name == 'ng-enter' || cl***REMOVED***Name == 'ng-move' || cl***REMOVED***Name == 'ng-leave';
      }

      function blockTransitions(element, cl***REMOVED***Name, isAnimating) {
        if(isStructuralAnimation(cl***REMOVED***Name) || !isAnimating) {
          extractElementNode(element).style[TRANSITION_PROP + PROPERTY_KEY] = 'none';
        } else {
          element.addCl***REMOVED***(NG_ANIMATE_BLOCK_CLASS_NAME);
        }
      }
      ...
      function unblockTransitions(element, cl***REMOVED***Name) {
        var prop = TRANSITION_PROP + PROPERTY_KEY;
        var node = extractElementNode(element);
        if(node.style[prop] && node.style[prop].length > 0) {
          node.style[prop] = '';
        }
        element.removeCl***REMOVED***(NG_ANIMATE_BLOCK_CLASS_NAME);
      }
      ...
      function animateRun(animationEvent, element, cl***REMOVED***Name, activeAnimationComplete) {
        var node = extractElementNode(element);
        var elementData = element.data(NG_ANIMATE_CSS_DATA_KEY);
      ...
      function animateBefore(animationEvent, element, cl***REMOVED***Name, calculationDecorator) {
        if(animateSetup(animationEvent, element, cl***REMOVED***Name, calculationDecorator)) {
          return function(cancelled) {
      ...
      function animateAfter(animationEvent, element, cl***REMOVED***Name, afterAnimationComplete) {
        if(element.data(NG_ANIMATE_CSS_DATA_KEY)) {
          return animateRun(animationEvent, element, cl***REMOVED***Name, afterAnimationComplete);
        } else {
          animateClose(element, cl***REMOVED***Name);
      ...
      function animate(animationEvent, element, cl***REMOVED***Name, animationComplete) {
        //If the animateSetup function doesn't bother returning a
        //cancellation function then it means that there is no animation
        //to perform at all
        var preReflowCancellation = animateBefore(animationEvent, element, cl***REMOVED***Name);
        ...
        afterReflow(element, function() {
          unblockTransitions(element, cl***REMOVED***Name);
          unblockKeyframeAnimations(element);
          //once the reflow is complete then we point cancel to
          //the new cancellation function which will remove all of the
          //animation properties from the active animation
          cancel = animateAfter(animationEvent, element, cl***REMOVED***Name, animationComplete);
        });
      ...
      return {
        ...
        beforeSetCl***REMOVED*** : function(element, add, remove, animationCompleted) {
          var cl***REMOVED***Name = suffixCl***REMOVED***es(remove, '-remove') + ' ' +
                          suffixCl***REMOVED***es(add, '-add');
          var cancellationMethod = animateBefore('setCl***REMOVED***', element, cl***REMOVED***Name, function(fn) {
            /* when cl***REMOVED***es are removed from an element then the transition style
             * that is applied is the transition defined on the element without the
             * CSS cl***REMOVED*** being there. This is how CSS3 functions outside of ngAnimate.
             * http://plnkr.co/edit/j8OzgTNxHTb4n3zLyjGW?p=preview */
            var kl***REMOVED*** = element.attr('cl***REMOVED***');
            element.removeCl***REMOVED***(remove);
            element.addCl***REMOVED***(add);
            var timings = fn();
            element.attr('cl***REMOVED***', kl***REMOVED***);
            return timings;
          });
        ...
        beforeAddCl***REMOVED*** : function(element, cl***REMOVED***Name, animationCompleted) {
          var cancellationMethod = animateBefore('addCl***REMOVED***', element, suffixCl***REMOVED***es(cl***REMOVED***Name, '-add'), function(fn) {

            /* when a CSS cl***REMOVED*** is added to an element then the transition style that
             * is applied is the transition defined on the element when the CSS cl***REMOVED***
        ...
        setCl***REMOVED*** : function(element, add, remove, animationCompleted) {
          remove = suffixCl***REMOVED***es(remove, '-remove');
          add = suffixCl***REMOVED***es(add, '-add');
          var cl***REMOVED***Name = remove + ' ' + add;
          return animateAfter('setCl***REMOVED***', element, cl***REMOVED***Name, animationCompleted);
        },

        addCl***REMOVED*** : function(element, cl***REMOVED***Name, animationCompleted) {
          return animateAfter('addCl***REMOVED***', element, suffixCl***REMOVED***es(cl***REMOVED***Name, '-add'), animationCompleted);
        },

        beforeRemoveCl***REMOVED*** : function(element, cl***REMOVED***Name, animationCompleted) {
          var cancellationMethod = animateBefore('removeCl***REMOVED***', element, suffixCl***REMOVED***es(cl***REMOVED***Name, '-remove'), function(fn) {
            /* when cl***REMOVED***es are removed from an element then the transition style
             * that is applied is the transition defined on the element without the
             * CSS cl***REMOVED*** being there. This is how CSS3 functions outside of ngAnimate.
             * http://plnkr.co/edit/j8OzgTNxHTb4n3zLyjGW?p=preview */
        ...
        removeCl***REMOVED*** : function(element, cl***REMOVED***Name, animationCompleted) {
          return animateAfter('removeCl***REMOVED***', element, suffixCl***REMOVED***es(cl***REMOVED***Name, '-remove'), animationCompleted);
        }
      };
