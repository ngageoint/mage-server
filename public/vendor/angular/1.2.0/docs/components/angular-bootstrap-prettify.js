...
directive.jsFiddle = function(getEmbeddedTemplate, escape, script) {
  return {
    ...
    link: function(scope, element, attr) {
      var name = '',
        stylesheet = '<link rel="stylesheet" href="http://twitter.github.com/bootstrap/***REMOVED***ets/css/bootstrap.css">\n',
        fields = {
          html: '',
          css: '',
          js: ''
      ...
      setHtmlIe8SafeWay(element,
        '<form cl***REMOVED***="jsfiddle" method="post" action="http://jsfiddle.net/api/post/library/pure/" target="_blank">' +
          ...
          '<button cl***REMOVED***="btn btn-primary"><i cl***REMOVED***="icon-white icon-pencil"></i> Edit Me</button>' +
          '</form>');
...
***REMOVED***.templateMerge = ['reindentCode', function(indentCode) {
...
***REMOVED***.getEmbeddedTemplate = ['reindentCode', function(reindentCode) {
  return function (id) {
...
angular.module('bootstrapPrettify', []).directive(directive).factory(***REMOVED***);
