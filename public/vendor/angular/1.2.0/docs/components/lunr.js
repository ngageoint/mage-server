 ...
 * with the default pipeline functions and the p***REMOVED***ed config function.
 *
 ...
 *
 * Additional data can be p***REMOVED***ed to the event handler as arguments to `emit`
 ...
 *
 * When run the pipeline will call each function in turn, p***REMOVED***ing a token, the
 * index of that token in the original list of all tokens and finally a list of
 * all the original tokens.
 *
 * The output of functions in the pipeline will be p***REMOVED***ed to the next function
 ...
 *
 * This function ***REMOVED***umes that the element to search for does not already exist
 * in the sorted set.
 *
 ...
 * of this set and the p***REMOVED***ed set.
 *
 ...
 * in the index.
 *
 * An optional boost param can be p***REMOVED***ed to affect how much tokens in this field
 ...
 * the document has been added to. This event can be silenced by p***REMOVED***ing false
 ...
 *
 * The document p***REMOVED***ed only needs to have the same ref property value as the
 * document that was added to the index, they could be completely different
 * objects.
 *
 * A 'remove' event is emitted with the document that has been removed and the index
 * the document has been removed from. This event can be silenced by p***REMOVED***ing false
 ...
 * This event can be silenced by p***REMOVED***ing false as the second argument to update. Only
...
/**
 * Searches the index using the p***REMOVED***ed query.
 *
 * Queries should be a string, multiple words are allowed and will lead to an
 * AND based query, e.g. `idx.search('foo bar')` will run a search for
 * documents containing both 'foo' and 'bar'.
 *
 * All query tokens are p***REMOVED***ed through the same pipeline that document tokens
 * are p***REMOVED***ed through, so any language processing involved will be run on every
 * query term.
 *
 ...
 * p***REMOVED***ed documentRef.
 *
 * The vector contains the tf-idf score for each token contained in the
 * document with the p***REMOVED***ed documentRef.  The vector will contain an element
 ...
 * contained in the list will not be p***REMOVED***ed through the filter.
 *
 * This is intended to be used in the Pipeline. If the token does not p***REMOVED*** the
 * filter then undefined will be returned.
 *
 * @module
 * @param {String} token The token to p***REMOVED*** through the filter
 * @returns {String}
 * @see lunr.Pipeline
 */
...
/**
 * Find all the possible suffixes of the p***REMOVED***ed token using tokens
