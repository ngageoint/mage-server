...
a.touches:[a],c=b[0].clientX,b=b[0].clientY;1>c&&1>b||l(k,c,b)||(a.stopPropagation(),a.preventDefault(),a.target&&a.target.blur())}}function r(d){d=d.touches&&d.touches.length?d.touches:[d];var b=d[0].clientX,c=d[0].clientY;k.push(b,c);a(function(){for(var a=0;a<k.length;a+=2)if(k[a]==b&&k[a+1]==c){k.splice(a,a+2);break}},e,!1)}var e=2500,g=25,p="ng-click-active",m,k;return function(a,b,g){function h(){q=!1;b.removeCl***REMOVED***(p)}var e=f(g.ngClick),q=!1,s,t,w,x;b.on("touchstart",function(a){q=!0;s=a.target?
a.target:a.srcElement;3==s.nodeType&&(s=s.parentNode);b.addCl***REMOVED***(p);t=Date.now();a=a.touches&&a.touches.length?a.touches:[a];a=a[0].originalEvent||a[0];w=a.clientX;x=a.clientY});b.on("touchmove",function(a){h()});b.on("touchcancel",function(a){h()});b.on("touchend",function(a){var d=Date.now()-t,e=a.changedTouches&&a.changedTouches.length?a.changedTouches:a.touches&&a.touches.length?a.touches:[a],f=e[0].originalEvent||e[0],e=f.clientX,f=f.clientY,p=Math.sqrt(Math.pow(e-w,2)+Math.pow(f-x,2));q&&(750>
d&&12>p)&&(k||(c[0].addEventListener("click",n,!0),c[0].addEventListener("touchstart",r,!0),k=[]),m=Date.now(),l(k,e,f),s&&s.blur(),v.isDefined(g.disabled)&&!1!==g.disabled||b.triggerHandler("click",a));h()});b.onclick=function(a){};b.on("click",function(b){a.$apply(function(){e(a,{$event:b})})});b.on("mousedown",function(a){b.addCl***REMOVED***(p)});b.on("mousemove mouseup",function(a){b.removeCl***REMOVED***(p)})}}]);t("ngSwipeLeft",-1,"swipeleft");t("ngSwipeRight",1,"swiperight")})(window,window.angular);
/*
