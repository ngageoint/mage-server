var deps = {
	Core: {
		src: ['Leaflet.js',
		      ...
		      'map/Map.js'],
		desc: 'The core of the library, including OOP, events, DOM facilities, basic units, projections (EPSG:3857 and EPSG:4326) and the base Map cl***REMOVED***.'
	},
	...
	TileLayer: {
		...
		desc: 'The base cl***REMOVED*** for displaying tile layers on the map.',
		heading: 'Layers'
	},
