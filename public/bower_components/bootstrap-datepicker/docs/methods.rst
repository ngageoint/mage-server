...
If ``date`` is provided and is a Date object, it is ***REMOVED***umed to be a "local" date object, and will be converted to UTC for internal use.
...
Sets the internal date.  ``date`` is ***REMOVED***umed to be a "local" date object, and will be converted to UTC for internal use.
...
Sets the internal date.  ``date`` is ***REMOVED***umed to be a UTC date object, and will not be converted.
...
Sets the internal date list; accepts multiple dates or a single array of dates as arguments.  Each ``date`` is ***REMOVED***umed to be a "local" date object, and will be converted to UTC for internal use.  For use with multidate pickers.
...
Sets the internal date list.  Each ``date`` is ***REMOVED***umed to be a UTC date object, and will not be converted.  For use with multidate pickers.
