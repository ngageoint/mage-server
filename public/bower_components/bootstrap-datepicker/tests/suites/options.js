...
test('Today Highlight: today\'s date is not highlighted by default', patch_date(function(Date){
    ...
    var input = $('<input />')
        ...
        ok(!target.hasCl***REMOVED***('today'), 'Today is not marked with "today" cl***REMOVED***');
        target = picker.find('.datepicker-days tbody td:contains(14)');
        ok(!target.hasCl***REMOVED***('today'), 'Yesterday is not marked with "today" cl***REMOVED***');
        target = picker.find('.datepicker-days tbody td:contains(16)');
        ok(!target.hasCl***REMOVED***('today'), 'Tomorrow is not marked with "today" cl***REMOVED***');
}));
...
test('Today Highlight: today\'s date is highlighted when not active', patch_date(function(Date){
    ...
    var input = $('<input />')
        ...
        target = picker.find('.datepicker-days tbody td:contains(15)');
        ok(target.hasCl***REMOVED***('today'), 'Today is marked with "today" cl***REMOVED***');
        target = picker.find('.datepicker-days tbody td:contains(14)');
        ok(!target.hasCl***REMOVED***('today'), 'Yesterday is not marked with "today" cl***REMOVED***');
        target = picker.find('.datepicker-days tbody td:contains(16)');
        ok(!target.hasCl***REMOVED***('today'), 'Tomorrow is not marked with "today" cl***REMOVED***');
...
test('DaysOfWeekDisabled', function(){
    ...
    ok(target.hasCl***REMOVED***('disabled'), 'Day of week is disabled');
    target = picker.find('.datepicker-days tbody td:nth(24)');
    ok(!target.hasCl***REMOVED***('disabled'), 'Day of week is enabled');
...
test('BeforeShowDay', function(){
    ...
    var beforeShowDay = function(date) {
        ...
        if (dateTime == dateTime25th) {
            ...
            return {enabled: false, cl***REMOVED***es:'test27'};
        }
    ...
    ok(!target.hasCl***REMOVED***('disabled'), '25th is enabled');
    target = picker.find('.datepicker-days tbody td:nth(26)');
    ok(target.hasCl***REMOVED***('test26'), '26th has test26 cl***REMOVED***');
    ok(!target.hasCl***REMOVED***('disabled'), '26th is enabled');
    target = picker.find('.datepicker-days tbody td:nth(27)');
    ok(target.hasCl***REMOVED***('test27'), '27th has test27 cl***REMOVED***');
    ok(target.hasCl***REMOVED***('disabled'), '27th is disabled');
    target = picker.find('.datepicker-days tbody td:nth(28)');
    ok(target.hasCl***REMOVED***('disabled'), '28th is disabled');
    target = picker.find('.datepicker-days tbody td:nth(29)');
    ok(!target.hasCl***REMOVED***('disabled'), '29th is enabled');
});
...
test('startDate', function(){
    ...
    input.focus();
    target = picker.find('.datepicker-days tbody td:nth(25)');
    ok(target.hasCl***REMOVED***('disabled'), 'Previous day is disabled');
    target = picker.find('.datepicker-days tbody td:nth(26)');
    ok(!target.hasCl***REMOVED***('disabled'), 'Specified date is enabled');
    target = picker.find('.datepicker-days tbody td:nth(27)');
    ok(!target.hasCl***REMOVED***('disabled'), 'Next day is enabled');
});
...
test('endDate', function(){
    ...
    input.focus();
    target = picker.find('.datepicker-days tbody td:nth(25)');
    ok(!target.hasCl***REMOVED***('disabled'), 'Previous day is enabled');
    target = picker.find('.datepicker-days tbody td:nth(26)');
    ok(!target.hasCl***REMOVED***('disabled'), 'Specified date is enabled');
    target = picker.find('.datepicker-days tbody td:nth(27)');
    ok(target.hasCl***REMOVED***('disabled'), 'Next day is disabled');
});
