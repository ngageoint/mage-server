describe('Array', function() {
    ...
    describe('forEach', function() {
        ...
        it('should p***REMOVED*** the right parameters', function() {
    ...
    describe('some', function() {
        ...
        it('should p***REMOVED*** the correct values along to the callback', function() {
            var callback = jasmine.createSpy('callback');
            var array = ['1'];
            array.some(callback);
            expect(callback).toHaveBeenCalledWith('1', 0, array);
    ...
    describe('filter', function() {
        ...
        describe('Array object', function() {
            ...
            it('should skip non-set values', function() {
                var p***REMOVED***edValues = {};
                testSubject = [1,2,3,4];
                delete testSubject[1];
                testSubject.filter(function(o, i) {
                    p***REMOVED***edValues[i] = o;
                    return true;
                });
                expect(p***REMOVED***edValues).toExactlyMatch(testSubject);
            });
            it('should p***REMOVED*** the right context to the filter', function() {
                var p***REMOVED***edValues = {};
                testSubject = [1,2,3,4];
                delete testSubject[1];
                testSubject.filter(function(o, i) {
    ...
    describe('reduce', function() {
        ...
        describe('Array', function() {
            it('should p***REMOVED*** the correct arguments to the callback', function() {
            ...
            it('should not directly affect the p***REMOVED***ed array', function() {
                var copy = testSubject.slice();
        ...
        describe('Array-like objects', function() {
            ...
            it('should not affect elements added to the array after it has begun', function() {
                ...
                expect(arr).toEqual({
                    ...
                    3: 6,
                    4: 5,
                    length: 3 // does not get updated on property ***REMOVED***ignment
                });
                expect(i).toBe(2);
            });
            it('should work as expected for empty arrays', function() {
