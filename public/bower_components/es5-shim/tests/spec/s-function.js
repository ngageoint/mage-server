...
describe('Function', function() {
    ...
    describe('bind', function() {
        ...
        it('p***REMOVED***es the correct arguments as a constructor', function() {
        ...
        it('returns the value that instance of original "cl***REMOVED***" when called as a constructor', function() {
            var cl***REMOVED***A = function(x) {
                this.name = x || "A";
            }
            var cl***REMOVED***B = cl***REMOVED***A.bind(null, "B");
            
            var result = new cl***REMOVED***B;
            expect(result instanceof cl***REMOVED***A).toBe(true);
            expect(result instanceof cl***REMOVED***B).toBe(true);
        });
    });
});
