$(function () {
    ...
    module("bootstrap-popover")
      ...
      test("should respect custom cl***REMOVED***es", function() {
        ...
        var popover = $('<a href="#">@fat</a>')
          ...
          .popover({
            title: 'Test'
          , content: 'Test'
          , template: '<div cl***REMOVED***="popover foobar"><div cl***REMOVED***="arrow"></div><div cl***REMOVED***="inner"><h3 cl***REMOVED***="title"></h3><div cl***REMOVED***="content"><p></p></div></div></div>'
          })

        popover.popover('show')

        ok($('.popover').length, 'popover was inserted')
        ok($('.popover').hasCl***REMOVED***('foobar'), 'custom cl***REMOVED*** is present')
      ...
      test("should destroy popover", function () {
        ...
        ok(!popover.hasCl***REMOVED***('in'), 'popover is hidden')
