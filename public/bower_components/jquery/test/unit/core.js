...
test( "globalEval", function() {
	...
	equal( window.globalEvalTest, 1, "Test variable ***REMOVED***ignments are global" );
...
asyncTest("isPlainObject", function() {
	...
	ok( p***REMOVED***, "Does not throw exceptions on host objects" );
...
test("jQuery.makeArray", function(){
	...
	ok( jQuery.makeArray(document.getElementById("form")).length >= 13,
		"P***REMOVED*** makeArray a form (treat as elements)" );
});
...
test("jQuery.proxy", function(){
	...
	var fn = function() {
		equal( Array.prototype.join.call( arguments, "," ), "arg1,arg2,arg3", "args p***REMOVED***ed" );
		equal( this.foo, "bar", "this-object p***REMOVED***ed" );
	};
