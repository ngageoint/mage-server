...
function dataTests (elem) {
	...
	equal( jQuery.data(elem, "foo"), "baz", "Data is not unset by p***REMOVED***ing undefined to jQuery.data" );
	...
	strictEqual( jQuery.data(elem, "foo"), "foo1", "P***REMOVED***ing an object extends the data object instead of replacing it" );
...
test("jQuery.data(div)", 25, function() {
	...
	// ***REMOVED***ert that nothing else was put in there, and that that
	// one stayed there.
...
test("Expando cleanup", 4, function() {
	...
	function ***REMOVED***ertExpandoAbsent(message) {
	...
	***REMOVED***ertExpandoAbsent("There is no expando on new elements");
	...
	***REMOVED***ertExpandoAbsent("Removing the last item in the data store deletes the expando");
...
test("jQuery.acceptData", function() {
	...
	flash.setAttribute("cl***REMOVED***id", "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000");
	ok( jQuery.acceptData( flash ), "flash" );

	var applet = document.createElement("object");
	applet.setAttribute("cl***REMOVED***id", "clsid:8AD9C840-044E-11D1-B3E9-00805F499D93");
...
test("data-* attributes", function() {
	...
	child
		...
		.attr("data-pointbad2", "-.")
		.attr("data-big***REMOVED***num", "123456789123456789123456789")
	...
	strictEqual( child.data("big***REMOVED***num"), "123456789123456789123456789", "Bad big***REMOVED*** number read from attribute");
	...
	var metadata = "<ol><li cl***REMOVED***='test test2' data-foo='bar' data-bar='baz' data-arr='[1,2]'>Some stuff</li><li cl***REMOVED***='test test2' data-test='bar' data-bar='baz'>Some stuff</li><li cl***REMOVED***='test test2' data-zoooo='bar' data-bar='{\"test\":\"baz\"}'>Some stuff</li><li cl***REMOVED***='test test2' data-number=true data-stuff='[2,8]'>Some stuff</li></ol>",
...
test( "jQuery.fn.removeData supports removal of hyphenated properties via array (#12786)", function( ***REMOVED***ert ) {
	expect( 4 );
	...
	// When data is batch ***REMOVED***igned (via plain object), the properties
	// are not camel cased as they are with (property, value) calls
	compare = {
		// From batch ***REMOVED***ignment .data({ "a-a": 1 })
		"a-a": 1,
		// From property, value ***REMOVED***ignment .data( "b-b", 1 )
		"bB": 1
	};

	// Mixed ***REMOVED***ignment
