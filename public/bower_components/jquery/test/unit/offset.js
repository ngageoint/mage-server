...
/*
	...
	not be p***REMOVED***ed with the jQuery object across the windows. To differentiate this, the
	testIframe callbacks use the "$" symbol to refer to the jQuery object p***REMOVED***ed from
...
testIframe("offset/fixed", "fixed", function( $ ) {
	...
	jQuery.each( tests, function() {
		if ( !supportsScroll ) {
			...
			// need to have same number of ***REMOVED***ertions
