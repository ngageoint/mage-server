...
test("bind(), namespaced events, cloned events", 18, function() {
	...
	jQuery("<a href='#fail' cl***REMOVED***='test'>test</a>").on( "click", function(){ return false; }).appendTo("#qunit-fixture");
...
test( "Namespace preserved when p***REMOVED***ed an Event (#12739)", function() {
	expect( 4 );
