...
/*
	======== local reference =======
	p***REMOVED*** and fn can be used to test p***REMOVED***ing functions to setters
...
test("p***REMOVED***ing undefined is a setter #5571", function() {
	expect(4);
...
testIframe( "dimensions/documentSmall", "window vs. small document", function( jQuery, window, document ) {
	...
	if ( document.body.offsetWidth >= document.documentElement.offsetWidth ) {
		...
		// all tests should have at least one ***REMOVED***ertion
		expect( 1 );
