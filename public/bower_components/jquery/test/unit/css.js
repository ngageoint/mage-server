...
test("css(String, Function)", function() {
	...
	jQuery("<div id='cssFunctionTest'><div cl***REMOVED***='cssFunction'></div>" +
				 "<div cl***REMOVED***='cssFunction'></div>" +
				 "<div cl***REMOVED***='cssFunction'></div></div>")
		.appendTo("body");
...
test( "show() resolves correct default display for detached nodes", function(){
	...
	div = jQuery("<div cl***REMOVED***='hidden'>");
	...
	span = jQuery("<span cl***REMOVED***='hidden'/>");
	...
	div = jQuery("<div><div cl***REMOVED***='hidden'></div></div>").children("div");
	div.show().appendTo("#qunit-fixture");
...
test( "css opacity consistency across browsers (#12685)", function() {
	...
	var fixture = jQuery("#qunit-fixture"),
		...
		el = jQuery("<div cl***REMOVED***='opacityWithSpaces_t12685'></div>").appendTo(fixture);

	equal( Math.round( el.css("opacity") * 100 ), 10, "opacity from style sheet (filter:alpha with spaces)" );
	el.removeCl***REMOVED***("opacityWithSpaces_t12685").addCl***REMOVED***("opacityNoSpaces_t12685");
