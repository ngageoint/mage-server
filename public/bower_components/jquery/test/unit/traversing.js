...
test("is(String|undefined)", function() {
	...
	ok( jQuery("#mark").is(".blog"), "Check for cl***REMOVED***: Expected cl***REMOVED*** 'blog'" );
	ok( !jQuery("#mark").is(".link"), "Check for cl***REMOVED***: Did not expect cl***REMOVED*** 'link'" );
	ok( jQuery("#simon").is(".blog.link"), "Check for multiple cl***REMOVED***es: Expected cl***REMOVED***es 'blog' and 'link'" );
	ok( !jQuery("#simon").is(".blogTest"), "Check for multiple cl***REMOVED***es: Expected cl***REMOVED***es 'blog' and 'link', but not 'blogTest'" );
	...
	ok( jQuery("#text2").is(":disabled"), "Check for pseudocl***REMOVED***: Expected to be disabled" );
	ok( !jQuery("#text1").is(":disabled"), "Check for pseudocl***REMOVED***: Expected not disabled" );
	ok( jQuery("#radio2").is(":checked"), "Check for pseudocl***REMOVED***: Expected to be checked" );
	ok( !jQuery("#radio1").is(":checked"), "Check for pseudocl***REMOVED***: Expected not checked" );
	...
	ok( !jQuery("#foo").is({ plain: "object" }), "Check p***REMOVED***ing invalid object" );
...
test("is(jQuery)", function() {
	...
	ok( jQuery("#mark").is( jQuery(".blog") ), "Check for cl***REMOVED***: Expected cl***REMOVED*** 'blog'" );
	ok( !jQuery("#mark").is( jQuery(".link") ), "Check for cl***REMOVED***: Did not expect cl***REMOVED*** 'link'" );
	ok( jQuery("#simon").is( jQuery(".blog.link") ), "Check for multiple cl***REMOVED***es: Expected cl***REMOVED***es 'blog' and 'link'" );
	ok( !jQuery("#simon").is( jQuery(".blogTest") ), "Check for multiple cl***REMOVED***es: Expected cl***REMOVED***es 'blog' and 'link', but not 'blogTest'" );
	...
	ok( !jQuery("#text1").is( jQuery("input:disabled") ), "Check for pseudocl***REMOVED***: Expected not disabled" );
	ok( jQuery("#radio2").is( jQuery("input:checked") ), "Check for pseudocl***REMOVED***: Expected to be checked" );
	ok( !jQuery("#radio1").is( jQuery("input:checked") ), "Check for pseudocl***REMOVED***: Expected not checked" );
	...
	ok( jQuery("#mark").is( jQuery(".blog")[0] ), "Check for cl***REMOVED***: Expected cl***REMOVED*** 'blog'" );
	ok( !jQuery("#mark").is( jQuery(".link")[0] ), "Check for cl***REMOVED***: Did not expect cl***REMOVED*** 'link'" );
	ok( jQuery("#simon").is( jQuery(".blog.link")[0] ), "Check for multiple cl***REMOVED***es: Expected cl***REMOVED***es 'blog' and 'link'" );
	ok( !jQuery("#simon").is( jQuery(".blogTest")[0] ), "Check for multiple cl***REMOVED***es: Expected cl***REMOVED***es 'blog' and 'link', but not 'blogTest'" );
});
...
test("is() with positional selectors", function() {
	...
	var html = jQuery(
				"<p id='posp'><a cl***REMOVED***='firsta' href='#'><em>first</em></a><a cl***REMOVED***='seconda' href='#'><b>test</b></a><em></em></p>"
			).appendTo( "body" ),
...
test("index(Object|String|undefined)", function() {
	...
	// P***REMOVED***ing a jQuery object
	// enabled since [5500]
	equal( elements.index( elements ), 0, "P***REMOVED*** in a jQuery object" );
	equal( elements.index( elements.eq(1) ), 1, "P***REMOVED*** in a jQuery object" );
	equal( jQuery("#form :radio").index( jQuery("#radio2") ), 1, "P***REMOVED*** in a jQuery object" );

	// P***REMOVED***ing a selector or nothing
	// enabled since [6330]
...
test("filter() with positional selectors", function() {
	...
	var html = jQuery( "" +
		"<p id='posp'>" +
			"<a cl***REMOVED***='firsta' href='#'>" +
				"<em>first</em>" +
			"</a>" +
			"<a cl***REMOVED***='seconda' href='#'>" +
				"<b>test</b>" +
			"</a>" +
			"<em></em>" +
		"</p>" ).appendTo( "body" ),
...
test("not(Selector|undefined)", function() {
	...
	deepEqual( jQuery("p").not(".result").get(), q("firstp", "ap", "sndp", "en", "sap", "first"), "not('.cl***REMOVED***')" );
...
test("nextUntil([String])", function() {
	...
	deepEqual( jQuery("#text1").nextUntil("[cl***REMOVED***=foo]").get(), jQuery("#text1").nextAll().get(), "Non-element nodes must be skipped, since they have no attributes" );
});
...
test("index(no arg) #10977", function() {
	...
	var $list = jQuery("<ul id='indextest'><li>THIS ONE</li><li cl***REMOVED***='one'>a</li><li cl***REMOVED***='two'>b</li><li cl***REMOVED***='three'>c</li></ul>");
