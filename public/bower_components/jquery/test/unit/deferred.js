...
jQuery.each( [ "", " - new operator" ], function( _, withNew ) {
	...
	test( "jQuery.Deferred" + withNew, function() {
		...
		createDeferred(function( defer ) {
			ok( this === defer, "Defer p***REMOVED***ed as this & first argument" );
			this.resolve("done");
		}).done(function( value ) {
			strictEqual( value, "done", "P***REMOVED***ed function executed" );
		});
...
test( "jQuery.Deferred.then - context", function() {
	...
	piped2.done(function( value ) {
		strictEqual( this, piped2, "default context gets updated to latest promise in the chain (without p***REMOVED***ing function)" );
		strictEqual( value, 2, "proper value received (without p***REMOVED***ing function)" );
	});
});
