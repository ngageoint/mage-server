...
test("text()", function() {
	expect(5);
	var expected = "This link has cl***REMOVED***=\"blog\": Simon Willison's Weblog";
...
var testWrap = function(val) {
	...
	var result = jQuery("#first").wrap(val( "<div cl***REMOVED***='red'><span></span></div>" )).text();
...
var testWrapAll = function(val) {
	...
	var result = jQuery("#firstp,#first").wrapAll(val( "<div cl***REMOVED***='red'><div cl***REMOVED***='tmp'></div></div>" ));
...
var testWrapInner = function(val) {
	...
	var result = jQuery("#first").wrapInner(val("<div cl***REMOVED***='red'><div id='tmp'></div></div>"));
...
var testAppendForObject = function(valueObj, isFragment) {
	var expected = "This link has cl***REMOVED***=\"blog\": Simon Willison's WeblogTry them out:";
	...
	QUnit.reset();
	expected = "This link has cl***REMOVED***=\"blog\": Simon Willison's WeblogTry them out:GoogleYahoo";
	obj = getObj();
...
var testAppend = function(valueObj) {
	...
	ok( p***REMOVED***, "Test for appending a DOM node to the contents of an IFrame" );
...
test("append the same fragment with events (Bug #6997, 5566)", function () {
	...
	element = jQuery("<a cl***REMOVED***='test6997'></a>").click(function () {
	...
	element = jQuery("<li cl***REMOVED***='test6997'></li>").click(function () {
...
var testPrepend = function(val) {
	...
	QUnit.reset();
	var expected = "Try them out:This link has cl***REMOVED***=\"blog\": Simon Willison's Weblog";
...
var testReplaceWith = function(val) {
	...
	var $div = jQuery("<div cl***REMOVED***='replacewith'></div>").appendTo("body");
	// TODO: Work on jQuery(...) inline script execution
	//$div.replaceWith("<div cl***REMOVED***='replacewith'></div><script>" +
...
test("clone() (#8070)", function () {
	...
	jQuery("<select cl***REMOVED***='test8070'></select><select cl***REMOVED***='test8070'></select>").appendTo("#qunit-fixture");
...
test("clone()", function() {
	...
	equal( "This is a normal link: Yahoo", jQuery("#en").text(), "Re***REMOVED***ert text for #en" );
	...
	(function checkForAttributes( $ ) {
		...
		var parameters = ["height", "width", "cl***REMOVED***id"],
...
var testHtml = function(valueObj) {
	...
	ok( /^\xA0$|^&nbsp;$/.test( space ), "Make sure entities are p***REMOVED***ed through correctly." );
	equal( jQuery("<div/>").html(valueObj("&amp;"))[0].innerHTML, "&amp;", "Make sure entities are p***REMOVED***ed through correctly." );
...
test("jQuery.cleanData", function() {
	...
	function getDiv() {
		var div = jQuery("<div cl***REMOVED***='outer'><div cl***REMOVED***='inner'></div></div>").click(function(){
...
test("Ensure oldIE creates a new set on appendTo (#8894)", function() {
	strictEqual( jQuery("<div/>").clone().addCl***REMOVED***("test").appendTo("<div/>").end().hasCl***REMOVED***("test"), false, "Check jQuery.fn.appendTo after jQuery.clone" );
	strictEqual( jQuery("<div/>").find("p").end().addCl***REMOVED***("test").appendTo("<div/>").end().hasCl***REMOVED***("test"), false, "Check jQuery.fn.appendTo after jQuery.fn.find" );
	strictEqual( jQuery("<div/>").text("test").addCl***REMOVED***("test").appendTo("<div/>").end().hasCl***REMOVED***("test"), false, "Check jQuery.fn.appendTo after jQuery.fn.text" );
	strictEqual( jQuery("<bdi/>").clone().addCl***REMOVED***("test").appendTo("<div/>").end().hasCl***REMOVED***("test"), false, "Check jQuery.fn.appendTo after clone html5 element" );
