...
/*
	======== local reference =======
	manipulationBareObj and manipulationFunctionReturningObj can be used to test p***REMOVED***ing functions to setters
...
test( "text()", function() {
	...
	expected = "This link has cl***REMOVED***=\"blog\": Simon Willison's Weblog";
...
test( "text(Function) with incoming value", function() {
	...
	var old = "This link has cl***REMOVED***=\"blog\": Simon Willison's Weblog";
...
var testWrap = function( val ) {
	...
	result = jQuery("#first").wrap( val("<div cl***REMOVED***='red'><span></span></div>") ).text();

	equal( defaultText, result, "Check for wrapping of on-the-fly html" );
	ok( jQuery("#first").parent().parent().is(".red"), "Check if wrapper has cl***REMOVED*** 'red'" );
...
test( "wrap(String) consecutive elements (#10177)", function() {
	...
	targets.wrap("<div cl***REMOVED***='wrapper'></div>");
...
var testWrapAll = function( val ) {
	...
	result = jQuery("#firstp,#first").wrapAll( val("<div cl***REMOVED***='red'><div cl***REMOVED***='tmp'></div></div>") );

	equal( result.parent().length, 1, "Check for wrapping of on-the-fly html" );
	ok( jQuery("#first").parent().parent().is(".red"), "Check if wrapper has cl***REMOVED*** 'red'" );
	ok( jQuery("#firstp").parent().parent().is(".red"), "Check if wrapper has cl***REMOVED*** 'red'" );
...
var testWrapInner = function( val ) {
	...
	result = jQuery("#first").wrapInner( val("<div cl***REMOVED***='red'><div id='tmp'></div></div>") );
...
test( "unwrap()", function() {
	...
	jQuery("body").append("  <div id='unwrap' style='display: none;'> <div id='unwrap1'> <span cl***REMOVED***='unwrap'>a</span> <span cl***REMOVED***='unwrap'>b</span> </div> <div id='unwrap2'> <span cl***REMOVED***='unwrap'>c</span> <span cl***REMOVED***='unwrap'>d</span> </div> <div id='unwrap3'> <b><span cl***REMOVED***='unwrap unwrap3'>e</span></b> <b><span cl***REMOVED***='unwrap unwrap3'>f</span></b> </div> </div>");
...
var testAppendForObject = function( valueObj, isFragment ) {
	var $base,
		...
		text = "This link has cl***REMOVED***=\"blog\": Simon Willison's Weblog",
...
test( "append(Function) with incoming value", function() {
	...
	QUnit.reset();
	expected = "This link has cl***REMOVED***=\"blog\": Simon Willison's WeblogTry them out:";
	old = jQuery("#sap").html();
	...
	QUnit.reset();
	expected = "This link has cl***REMOVED***=\"blog\": Simon Willison's WeblogTry them out:Yahoo";
	old = jQuery("#sap").html();
	...
	QUnit.reset();
	expected = "This link has cl***REMOVED***=\"blog\": Simon Willison's WeblogYahooTry them out:";
	old = jQuery("#sap").html();
...
test( "replaceWith([]) where replacing element requires cloning", function () {
	...
	jQuery("#qunit-fixture").append(
		"<div cl***REMOVED***='replaceable'></div><div cl***REMOVED***='replaceable'></div>"
	);
	// replacing set needs to be cloned so it can cover 3 replacements
	jQuery("#qunit-fixture .replaceable").replaceWith(
		jQuery("<span cl***REMOVED***='replaced'></span><span cl***REMOVED***='replaced'></span>")
	);
...
test( "append the same fragment with events (Bug #6997, 5566)", function() {
	...
	element = jQuery("<a cl***REMOVED***='test6997'></a>").on( "click", function() {
	...
	element = jQuery("<li cl***REMOVED***='test6997'></li>").on( "click", function() {
...
test( "appendTo(String|Element|Array<Element>|jQuery)", function() {
	...
	div.addCl***REMOVED***("test");

	ok( jQuery("#qunit-fixture div:last").hasCl***REMOVED***("test"), "appendTo element was modified after the insertion" );
	ok( jQuery("#moretests div:last").hasCl***REMOVED***("test"), "appendTo element was modified after the insertion" );
...
var testPrepend = function( val ) {
	...
	QUnit.reset();
	expected = "Try them out:This link has cl***REMOVED***=\"blog\": Simon Willison's Weblog";
	jQuery("#sap").prepend( val(document.getElementById("first")) );
	equal( jQuery("#sap").text(), expected, "Check for prepending of element" );

	QUnit.reset();
	expected = "Try them out:YahooThis link has cl***REMOVED***=\"blog\": Simon Willison's Weblog";
	...
	QUnit.reset();
	expected = "YahooTry them out:This link has cl***REMOVED***=\"blog\": Simon Willison's Weblog";
	jQuery("#sap").prepend( val(jQuery("#yahoo, #first")) );
	equal( jQuery("#sap").text(), expected, "Check for prepending of jQuery object" );

	QUnit.reset();
	expected = "Try them out:GoogleYahooThis link has cl***REMOVED***=\"blog\": Simon Willison's Weblog";
...
var testReplaceWith = function( val ) {
	...
	$div = jQuery("<div cl***REMOVED***='replacewith'></div>").appendTo("#qunit-fixture");
	$div.replaceWith( val("<div cl***REMOVED***='replacewith'></div><script>" +
...
test( "append to multiple elements (#8070)", function() {
	...
	var selects = jQuery("<select cl***REMOVED***='test8070'></select><select cl***REMOVED***='test8070'></select>").appendTo("#qunit-fixture");
...
test( "clone()", function() {
	...
	equal( jQuery("#en").text(), "This is a normal link: Yahoo", "Re***REMOVED***ert text for #en" );
	...
	// cl***REMOVED***id instantiation it is the only kind that IE has trouble with,
	// so let's test with it too.
	div = jQuery("<div/>").html("<object height='355' width='425' cl***REMOVED***id='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'>  <param name='movie' value='http://www.youtube.com/v/3KANI2dpXLw&amp;hl=en'>  <param name='wmode' value='transparent'> </object>");
	...
	jQuery.each( [ "height", "width", "cl***REMOVED***id" ], function( i, attr ) {
...
var testHtml = function( valueObj ) {
	...
	equal(
		...
		"&nbsp;&amp;",
		"Entities are p***REMOVED***ed through correctly"
	);
...
test( "html(Function) with incoming value", function() {
	...
	var els, actualhtml, p***REMOVED***, j, $div, $div2, insert;
...
test( "clone()/html() don't expose jQuery/Sizzle expan***REMOVED*** (#12858)", function() {
...
test( "jQuery.cleanData", function() {
	...
	function getDiv() {
		var div = jQuery("<div cl***REMOVED***='outer'><div cl***REMOVED***='inner'></div></div>").on( "click", function() {
...
test( "Cloned, detached HTML5 elems (#10667,10670)", function() {
	...
	equal( $clone.attr("cl***REMOVED***"), $section.attr("cl***REMOVED***"), "clone and element have same cl***REMOVED*** attribute" );
...
test( "Ensure oldIE creates a new set on appendTo (#8894)", function() {
	...
	strictEqual( jQuery("<div/>").clone().addCl***REMOVED***("test").appendTo("<div/>").end().end().hasCl***REMOVED***("test"), false, "Check jQuery.fn.appendTo after jQuery.clone" );
	strictEqual( jQuery("<div/>").find("p").end().addCl***REMOVED***("test").appendTo("<div/>").end().end().hasCl***REMOVED***("test"), false, "Check jQuery.fn.appendTo after jQuery.fn.find" );
	strictEqual( jQuery("<div/>").text("test").addCl***REMOVED***("test").appendTo("<div/>").end().end().hasCl***REMOVED***("test"), false, "Check jQuery.fn.appendTo after jQuery.fn.text" );
	strictEqual( jQuery("<bdi/>").clone().addCl***REMOVED***("test").appendTo("<div/>").end().end().hasCl***REMOVED***("test"), false, "Check jQuery.fn.appendTo after clone html5 element" );
...
test( "script evaluation (#11795)", function() {
	...
	scriptsIn.appendTo( jQuery("<div cl***REMOVED***='detached'/>") );
	objGlobal.ok = isOk;
...
test( "insertAfter, insertBefore, etc do not work when destination is original element. Element is removed (#4087)", function() {
	...
	jQuery.each([
		...
		elems = jQuery( [
			"<ul id='test4087-complex'><li cl***REMOVED***='test4087'><div>c1</div>h1</li><li><div>c2</div>h2</li></ul>",
			"<div id='test4087-simple'><div cl***REMOVED***='test4087-1'>1<div cl***REMOVED***='test4087-2'>2</div><div cl***REMOVED***='test4087-3'>3</div></div></div>",
			"<div id='test4087-multiple'><div cl***REMOVED***='test4087-multiple'>1</div><div cl***REMOVED***='test4087-multiple'>2</div></div>"
