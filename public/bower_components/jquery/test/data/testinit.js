		...
		<soap:Body> \
			<jsconf xmlns="http://www.example.com/ns1"> \
				<response xmlns:ab="http://www.example.com/ns2"> \
					<meta> \
						<component id="seite1" cl***REMOVED***="component"> \
...
(function () {
	// Store the old counts so that we only ***REMOVED***ert on tests that have actually leaked,
	// instead of ***REMOVED***erting every time a test has leaked sometime in the past
	...
	/**
	 * Ensures that tests have cleaned up properly after themselves. Should be p***REMOVED***ed as the
	...
	this.moduleTeardown = function () {
		...
		// Because QUnit doesn't have a mechanism for retrieving the number of expected ***REMOVED***ertions for a test,
		// if we unconditionally ***REMOVED***ert any of these, the test will fail with too many ***REMOVED***ertions :|
			...
			var iframe = loadFixture(),
				...
				interval = setInterval( function() {
					if ( win && win.jQuery && win.jQuery.isReady ) {
						...
						// continue
						start();
						// call actual tests p***REMOVED***ing the correct jQuery instance to use
