<!DOCTYPE html>
<!--[if lt IE 7 ]><html cl***REMOVED***="ie ie6" lang="en"> <![endif]-->
<!--[if IE 7 ]><html cl***REMOVED***="ie ie7" lang="en"> <![endif]-->
<!--[if IE 8 ]><html cl***REMOVED***="ie ie8" lang="en"> <![endif]-->
...
<body>
	...
	<header cl***REMOVED***="hogan-hero">
		<div cl***REMOVED***="stripes"></div>
		<div cl***REMOVED***="noise"></div>
		<div cl***REMOVED***="container">
			<h1>Hogan.js</h1>
			<h3>JavaScript templating from Twitter.</h3>
			<a href="https://github.com/twitter/hogan.js" cl***REMOVED***="download button">View on Github</a>
		</div>
	</header>
		<div cl***REMOVED***="primary container">

		<!--  Layout 1  -->
		<div cl***REMOVED***="five columns">
			<h4>Getting started</h4>
			<p>
				Hogan.js is a 2.5k JS templating engine developed at Twitter. Use it as a part of your ***REMOVED***et packager to compile templates ahead of time or include it in your browser to handle dynamic templates.
			</p>
			<p>
		...
		<div cl***REMOVED***="ten columns offset-by-one">
			<script src="https://gist.github.com/1484613.js"> </script>
		</div>
		<div cl***REMOVED***="hogan-divider">
			<div cl***REMOVED***="hogan-icon"></div>
		</div>
		...
		<div cl***REMOVED***="five columns">
			...
			<p>
				If supplying partials, you can compile them ahead of time, or p***REMOVED*** string templates.</p>
			<p>
			</p>
		</div>
		<div cl***REMOVED***="ten columns offset-by-one">
		...
		<div cl***REMOVED***="sixteen columns hogan-footer">
			<span cl***REMOVED***="copyright">
