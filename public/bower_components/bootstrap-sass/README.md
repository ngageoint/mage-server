<a href="http://getbootstrap.com">
  <img src="http://twitter.github.com/bootstrap/***REMOVED***ets/img/bootstrap-docs-readme.png" width="100px">
</a>
...
* [Download the latest release](https://github.com/jlong/s***REMOVED***-twitter-bootstrap/zipball/master).
* Clone the repo: `git clone git://github.com/jlong/s***REMOVED***-twitter-bootstrap.git`.
* Install with [Bower](http://bower.io): `bower install --save s***REMOVED***-bootstrap`.
...
[s***REMOVED***-lang.com](http://s***REMOVED***-lang.com)

SASS runs as a local GEM on your system. You can run `s***REMOVED*** --watch lib/bootstrap.scss:bootstrap-2.3.2.css`
...
+ **watch** - `rake watch`
This is a convenience method for watching your S***REMOVED*** files and automatically building them whenever you save.
...
## SASS: Conversion less to S***REMOVED***

The Twitter Bootstrap was lovingly converted to S***REMOVED*** by:
...
And [others](https://github.com/jlong/s***REMOVED***-twitter-bootstrap/contributors)
...
* p***REMOVED*** grid-* mixin arguments to generators, because otherwise the generator mixins will use the default variables pull transition definition into variable
...
s***REMOVED***-twitter-bootstrap is as simple as typing :
```shell
composer.phar require jlong/s***REMOVED***-twitter-bootstrap:x.y.z
```
...
or like this:
```shell
composer.phar require jlong/s***REMOVED***-twitter-bootstrap:x.y.*
```
