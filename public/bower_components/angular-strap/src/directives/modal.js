  ...
  var ModalFactory = function ModalFactory(config) {
    ...
    function Modal(config) {
      ...
      .then(function onSuccess(template) {
        ...
        if(options.modalCl***REMOVED***) $modal.addCl***REMOVED***(options.modalCl***REMOVED***);
        ...
        // Auto-remove $modal created via ***REMOVED***
...
.directive('bsModal', function($q, $modal) {
  ...
  return {
    ...
    link: function postLink(scope, iElement, iAttrs, controller) {
      ...
      angular.forEach(['modalCl***REMOVED***', 'backdrop', 'keyboard'], function(key) {
