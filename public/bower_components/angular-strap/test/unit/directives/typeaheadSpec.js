...
describe('typeahead', function () {
  ...
  var templates = {
    'default': {
      scope: {typeahead: ["Alabama","Alaska","Arizona","Arka***REMOVED***s","California","Colorado","Connecticut","Delaware","Florida","Georgia","Hawaii","Idaho","Illinois","Indiana","Iowa","Ka***REMOVED***s","Kentucky","Louisiana","Maine","Maryland","M***REMOVED***achusetts","Michigan","Minnesota","Mississippi","Missouri","Montana","Nebraska","Nevada","New Hampshire","New Jersey","New Mexico","New York","North Dakota","North Carolina","Ohio","Oklahoma","Oregon","Pennsylvania","Rhode Island","South Carolina","South Dakota","Tennessee","Texas","Utah","Vermont","Virginia","Washington","West Virginia","Wisconsin","Wyoming"]},
      element: '<input type="text" cl***REMOVED***="span3" data-items="4" ng-model="typeaheadValue" bs-typeahead="typeahead">'
    },
    'minLength': {
      element: '<input type="text" cl***REMOVED***="span3" data-items="4" data-min-length="4" ng-model="typeaheadValue" bs-typeahead="typeahead">'
    },
    'minLength-0': {
      element: '<input type="text" cl***REMOVED***="span3" data-items="4" data-min-length="0" ng-model="typeaheadValue" bs-typeahead="typeahead">'
    }
  };
