...
describe('button', function () {
  ...
  var templates = {
    'default': {
      ...
      element: '<div cl***REMOVED***="btn" ng-model="buttonValue" data-toggle="button" bs-button>'
    },
    'promise': {
      scope: {},
      element: '<div cl***REMOVED***="btn" ng-model="buttonValue" data-toggle="button" bs-button>'
    ...
    'checkbox': {
      ...
      element: '<div cl***REMOVED***="btn-group" bs-buttons-checkbox>'
      +   '<button type="button" cl***REMOVED***="btn" ng-model="checkbox.left">Left</button>'
      +   '<button type="button" cl***REMOVED***="btn" ng-model="checkbox.middle">Middle</button>'
      +   '<button type="button" cl***REMOVED***="btn" ng-model="checkbox.right">Right</button>'
      + '</div>'
    },
    'radio': {
      scope: {radio: {left: false, middle: true, right: false}},
      element: '<div cl***REMOVED***="btn-group" bs-buttons-radio>'
      +   '<button type="button" cl***REMOVED***="btn" ng-model="radio.left">Left</button>'
      +   '<button type="button" cl***REMOVED***="btn" ng-model="radio.middle">Middle</button>'
      +   '<button type="button" cl***REMOVED***="btn" ng-model="radio.right">Right</button>'
      + '</div>'
    },
    'radio-single-model': {
      scope: {radio: 'middle'},
      element: '<div cl***REMOVED***="btn-group" ng-model="radio" bs-buttons-radio>'
      +   '<button type="button" cl***REMOVED***="btn" value="left">Left</button>'
      +   '<button type="button" cl***REMOVED***="btn" value="middle">Middle</button>'
      +   '<button type="button" cl***REMOVED***="btn" value="right">Right</button>'
      + '</div>'
    }
  };
  ...
  describe('model change to view', function () {
    ...
    it('should add cl***REMOVED***', function () {
      var elm = compileDirective();
      scope.$apply(function () {
        scope.buttonValue = true;
      });
      expect(elm.hasCl***REMOVED***('active')).toBe(true);
    });

    it('should remove cl***REMOVED***', function () {
      var elm = compileDirective();
      scope.$apply(function () {
        scope.buttonValue = false;
      });
      expect(elm.hasCl***REMOVED***('active')).toBe(false);
    });
  ...
  describe('buttons checkbox', function () {
    ...
    it('should handle model to view changes', function () {
      ...
      expect(elm.find('[ng-model="checkbox.left"]').hasCl***REMOVED***('active')).toBe(true);
      expect(elm.find('[ng-model="checkbox.middle"]').hasCl***REMOVED***('active')).toBe(false);
      expect(elm.find('[ng-model="checkbox.right"]').hasCl***REMOVED***('active')).toBe(true);
    });
  });
  ...
  describe('buttons radio', function () {
    ...
    it('should handle model to view changes', function () {
      ...
      expect(elm.find('[ng-model="radio.left"]').hasCl***REMOVED***('active')).toBe(false);
      expect(elm.find('[ng-model="radio.middle"]').hasCl***REMOVED***('active')).toBe(false);
      expect(elm.find('[ng-model="radio.right"]').hasCl***REMOVED***('active')).toBe(true);
    });
  });
  ...
  describe('buttons radio single model', function () {
    ...
    it('should handle model to view changes', function () {
      ...
      expect(elm.find('[value="left"]').hasCl***REMOVED***('active')).toBe(false);
      expect(elm.find('[value="middle"]').hasCl***REMOVED***('active')).toBe(false);
      expect(elm.find('[value="right"]').hasCl***REMOVED***('active')).toBe(true);
    });
  });
