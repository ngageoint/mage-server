...
describe('dropdown', function () {
  ...
  var templates = {
    'default': {
      element: '<button type="button" href="#" cl***REMOVED***="dropdown btn" bs-dropdown="items">Dropdown <b cl***REMOVED***="caret"></b></button>',
  ...
  it('should add "data-toggle" attr & "dropdown-toggle" cl***REMOVED*** for you', function () {
    var elm = compileDirective();
    expect(elm.attr('data-toggle')).toBe('dropdown');
    expect(elm.hasCl***REMOVED***('dropdown-toggle')).toBe(true);
  });
  ...
  it('should correctly build the dropdown ul element', function() {
    ...
    expect(ul.attr('cl***REMOVED***')).toBe('dropdown-menu ng-scope');
