...
describe('tooltip', function () {
  ...
  var templates = {
    'default': {
      ...
      element: '<a cl***REMOVED***="btn" bs-tooltip="content" data-unique="true" data-placement="left"></a>'
    },
    'click': {
      element: '<a cl***REMOVED***="btn" bs-tooltip="content" data-trigger="click" data-placement="left"></a>'
    }
  };
  ...
  it('should show/hide the tooltip on hover', function() {
    ...
    expect(elm.data('tooltip').tip().hasCl***REMOVED***('in')).toBe(true);
    elm.trigger('mouseleave');
    expect(elm.data('tooltip').tip().hasCl***REMOVED***('in')).toBe(false);
  });
  ...
  it('should support data-unique attribute', function() {
    ...
    elm2.trigger('click');
    expect(elm2.data('tooltip').tip().hasCl***REMOVED***('in')).toBe(true);
    elm.trigger('mouseenter');
    expect(elm2.data('tooltip').tip().hasCl***REMOVED***('in')).toBe(false);
  });
