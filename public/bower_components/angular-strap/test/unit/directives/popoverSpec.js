...
describe('popover', function () {
  ...
  var templates = {
    'default': {
      ...
      popover: 'Hello <span ng-bind-html-u***REMOVED***fe="content"></span>',
      element: '<a cl***REMOVED***="btn" bs-popover="\'partials/popover.html\'" data-title="aTitle" data-placement="left"></a>'
    },
    'unique': {
      scope: {content: "World<br />Multiline Content<br />"},
      popover: 'Hello <span ng-bind-html-u***REMOVED***fe="content"></span>',
      element: '<a cl***REMOVED***="btn" bs-popover="\'partials/popover.html\'" data-title="aTitle" data-unique="1"></a>'
    },
    'hide': {
      scope: {content: "World<br />Multiline Content<br />", foo: {hide: false}},
      popover: 'Hello <span ng-bind-html-u***REMOVED***fe="content"></span>',
      element: '<a cl***REMOVED***="btn" bs-popover="\'partials/popover.html\'" data-title="aTitle" data-hide="foo.hide"></a>'
    },
    'show': {
      scope: {content: "World<br />Multiline Content<br />", foo: {show: false}},
      popover: 'Hello <span ng-bind-html-u***REMOVED***fe="content"></span>',
      element: '<a cl***REMOVED***="btn" bs-popover="\'partials/popover.html\'" data-title="aTitle" data-show="foo.show"></a>'
    },
    'object': {
      scope: {popover: {title: "aTitle", content: "World<br />Multiline Content<br />"}},
      element: '<a cl***REMOVED***="btn" bs-popover="popover"></a>'
    },
    'cached': {
      scope: {content: "World<br />Multiline Content<br />"},
      element: '<script type="text/ng-template" id="cached-popover">' + 'Hello <span ng-bind-html-u***REMOVED***fe="content"></span>' + '</script>' + '<a cl***REMOVED***="btn" bs-popover="\'cached-popover\'" data-title="aTitle"></a>'
    },
    'ngRepeatWithoutTitle': {
      scope: {things: [{name: "A"}, {name: "B"}, {name: "C"}]},
      popover: '<ul><li ng-repeat="thing in things">{{thing.name}}</li></ul>',
      element: '<a cl***REMOVED***="btn" bs-popover="\'partials/popover.html\'"></a>'
    }
  };
  ...
  it('should show/hide the popover on click', function() {
    var elm = compileDirective();
    elm.trigger('click');
    expect(elm.data('popover').tip().hasCl***REMOVED***('in')).toBe(true);
    elm.trigger('click');
    expect(elm.data('popover').tip().hasCl***REMOVED***('in')).toBe(false);
  });
