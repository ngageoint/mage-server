...
describe('timepicker', function () {
  ...
  var templates = {
    ...
    'addon': '<input type="text" name="time" ng-model="model.time" data-default-time="false" data-show-meridian="false" bs-timepicker><span cl***REMOVED***="add-on" data-toggle="timepicker"><i cl***REMOVED***="icon-time"></i></span>'
  };
  ...
  it('should show the timepicker on click', function() {
    var elm = compileDirective();
    elm.trigger('click');
    expect(elm.data('timepicker').$widget.hasCl***REMOVED***('open')).toBe(true);
  });
