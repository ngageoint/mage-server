    ...
    this.$get = ["$window", "debounce", "dimensions", function($window, debounce, dimensions) {
      ...
      function AffixFactory(element, config) {
        ...
        $affix.checkPosition = function() {
          ...
          // Get required affix cl***REMOVED*** according to position
          var affix = getRequiredAffixCl***REMOVED***(unpin, position, elementHeight);

          // Did affix status changed this last check?
          if(affixed === affix) return;
          affixed = affix;

          // Add proper affix cl***REMOVED***
          element.removeCl***REMOVED***(reset).addCl***REMOVED***('affix' + ((affix !== 'middle') ? '-' + affix : ''));
        ...
        function getRequiredAffixCl***REMOVED***(unpin, position, elementHeight) {
      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        controller.$render = function () {
          ...
          $$rAF(function() {
            ...
            activeElement.toggleCl***REMOVED***(options.activeCl***REMOVED***, isActive);
          });
        };
        ...
        element.bind(options.toggleEvent, function() {
          scope.$apply(function () {
            ...
            if(!isInput) {
              controller.$setViewValue(!activeElement.hasCl***REMOVED***('active'));
            }
            if(!hasExoticValues) {
              controller.$render();
            }
...
angular.module('mgcrea.ngStrap.collapse', [])
  ...
  .provider('$collapse', function() {
    ...
    var controller = this.controller = function($scope, $element, $attrs) {
      ...
      angular.forEach(['animation', 'disallowToggle', 'activeCl***REMOVED***', 'startCollapsed', 'allowMultiple'], function (key) {
    ...
    return {
      ...
      link: function postLink(scope, element, attrs, controllers) {
        ...
        if(bsCollapseCtrl.$options.animation) {
          element.addCl***REMOVED***(bsCollapseCtrl.$options.animation);
        }
        ...
        function render() {
          ...
          var action = 'removeCl***REMOVED***';
          if (angular.isArray(active)) {
            if (active.indexOf(index) !== -1) {
              action = 'addCl***REMOVED***';
            }
          }
          ...
          $animate[action](element, bsCollapseCtrl.$options.activeCl***REMOVED***);
        }
    ...
    this.$get = ["$window", "$document", "$rootScope", "$sce", "$dateFormatter", "datepickerViews", "$tooltip", "$timeout", function($window, $document, $rootScope, $sce, $dateFormatter, datepickerViews, $tooltip, $timeout) {
      ...
      function DatepickerFactory(element, controller, config) {
        ...
        $datepicker.$selectPane = function(value) {
          ...
          // date values rollover. This ***REMOVED***umes the viewDate does not
  ...
  .provider('datepickerViews', function() {
    ...
    this.$get = ["$dateFormatter", "$dateParser", "$sce", function($dateFormatter, $dateParser, $sce) {
      ...
      return function(picker) {
        ...
        var weekDaysLabelsHtml = $sce.trustAsHtml('<th cl***REMOVED***="dow text-center">' + weekDaysLabels.join('</th><th cl***REMOVED***="dow text-center">') + '</th>');
    ...
    this.$get = ["$window", "$rootScope", "$tooltip", "$timeout", function($window, $rootScope, $tooltip, $timeout) {
      ...
      function DropdownFactory(element, config) {
        ...
        $dropdown.show = function() {
          ...
          parentEl.hasCl***REMOVED***('dropdown') && parentEl.addCl***REMOVED***('open');
        };
        ...
        $dropdown.hide = function() {
          ...
          parentEl.hasCl***REMOVED***('dropdown') && parentEl.removeCl***REMOVED***('open');
          hide();
        };
...
angular.module('mgcrea.ngStrap.helpers.dateFormatter', [])
  ...
  .***REMOVED***('$dateFormatter', ["$locale", "dateFilter", function($locale, dateFilter) {

    // The unused `lang` arguments are on purpose. The default implementation does not
    // use them and it always uses the locale loaded into the `$locale` ***REMOVED***.
  ...
  .provider('$modal', function() {
    ...
    this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$timeout", "$sce", "dimensions", function($window, $rootScope, $compile, $q, $templateCache, $http, $animate, $timeout, $sce, dimensions) {
      ...
      function ModalFactory(config) {
        ...
        var backdropElement = angular.element('<div cl***REMOVED***="' + options.prefixCl***REMOVED*** + '-backdrop"/>');
        ...
        $modal.show = function() {
          ...
          modalElement.css({display: 'block'}).addCl***REMOVED***(options.placement);

          // Options: animation
          if(options.animation) {
            if(options.backdrop) {
              backdropElement.addCl***REMOVED***(options.backdropAnimation);
            }
            modalElement.addCl***REMOVED***(options.animation);
          }
          ...
          bodyElement.addCl***REMOVED***(options.prefixCl***REMOVED*** + '-open');
          if(options.animation) {
            bodyElement.addCl***REMOVED***(options.prefixCl***REMOVED*** + '-with-' + options.animation);
          }
        ...
        function leaveAnimateCallback() {
          ...
          bodyElement.removeCl***REMOVED***(options.prefixCl***REMOVED*** + '-open');
          if(options.animation) {
            bodyElement.removeCl***REMOVED***(options.prefixCl***REMOVED*** + '-with-' + options.animation);
          }
        }
        ...
        scope.$watch(function() {
          ...
          angular.forEach(liElements, function(li) {
            ...
            if(regexp.test(newValue)) {
              liElement.addCl***REMOVED***(options.activeCl***REMOVED***);
            } else {
              liElement.removeCl***REMOVED***(options.activeCl***REMOVED***);
            }
  ...
  .directive('bsPopover', ["$window", "$sce", "$popover", function($window, $sce, $popover) {
    ...
    return {
      ...
      link: function postLink(scope, element, attr) {
        ...
        // Directive options
        var options = {scope: scope};
        angular.forEach(['template', 'contentTemplate', 'placement', 'container', 'target', 'delay', 'trigger', 'keyboard', 'html', 'animation', 'customCl***REMOVED***', 'autoClose', 'id'], function(key) {
          if(angular.isDefined(attr[key])) options[key] = attr[key];
        });
      ...
      function ScrollSpyFactory(config) {
        ...
        $scrollspy.$activateElement = function(element) {
          if(activeTarget) {
            ...
            if(activeElement) {
              activeElement.source.removeCl***REMOVED***('active');
              if(nodeName(activeElement.source, 'li') && nodeName(activeElement.source.parent().parent(), 'li')) {
                activeElement.source.parent().parent().removeCl***REMOVED***('active');
              }
            }
          }
          activeTarget = element.target;
          element.source.addCl***REMOVED***('active');
          if(nodeName(element.source, 'li') && nodeName(element.source.parent().parent(), 'li')) {
            element.source.parent().parent().addCl***REMOVED***('active');
          }
        };
        ...
        $scrollspy.activate = function(i) {
          trackedElements[i].addCl***REMOVED***('active');
        };
...
angular.module('mgcrea.ngStrap.select', ['mgcrea.ngStrap.tooltip', 'mgcrea.ngStrap.helpers.parseOptions'])
  ...
  .provider('$select', function() {
    ...
    var defaults = this.defaults = {
      ...
      sort: true,
      caretHtml: '&nbsp;<span cl***REMOVED***="caret"></span>',
    ...
    this.$get = ["$window", "$document", "$rootScope", "$tooltip", "$timeout", function($window, $document, $rootScope, $tooltip, $timeout) {
      ...
      function SelectFactory(element, controller, config) {
        ...
        $select.show = function() {
          _show();
          if(options.multiple) {
            $select.$element.addCl***REMOVED***('select-multiple');
          }
          // use timeout to hookup the events to prevent
          // event bubbling from being processed imediately.
          $timeout(function() {
    ...
    return {
      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        if(element[0].nodeName.toLowerCase() === 'select') {
          ...
          element = angular.element('<button type="button" cl***REMOVED***="btn btn-default"></button>');
    ...
    this.$get = ["$window", "$rootScope", "$tooltip", "$timeout", function($window, $rootScope, $tooltip, $timeout) {
      ...
      function TypeaheadFactory(element, controller, config) {
        ...
        $typeahead.$onKeyDown = function(evt) {
          ...
          // Let ngSubmit p***REMOVED*** if the typeahead tip is hidden
    ...
    this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$sce", "dimensions", "$$rAF", "$timeout", function($window, $rootScope, $compile, $q, $templateCache, $http, $animate, $sce, dimensions, $$rAF, $timeout) {
      ...
      function TooltipFactory(element, config) {
        ...
        $tooltip.show = function() {
          ...
          // Options: animation
          if(options.animation) tipElement.addCl***REMOVED***(options.animation);
          // Options: type
          if(options.type) tipElement.addCl***REMOVED***(options.prefixCl***REMOVED*** + '-' + options.type);
          // Options: custom cl***REMOVED***es
          if(options.customCl***REMOVED***) tipElement.addCl***REMOVED***(options.customCl***REMOVED***);
        ...
        $tooltip.$applyPlacement = function() {
          ...
          // Need to add the position cl***REMOVED*** before we get
          // the offsets
          tipElement.addCl***REMOVED***(options.placement);
          ...
          if (autoPlace) {
            ...
            tipElement.removeCl***REMOVED***(originalPlacement).addCl***REMOVED***(placement);
          }
  ...
  .directive('bsTooltip', ["$window", "$location", "$sce", "$tooltip", "$$rAF", function($window, $location, $sce, $tooltip, $$rAF) {
    ...
    return {
      ...
      link: function postLink(scope, element, attr, transclusion) {
        ...
        // Directive options
        var options = {scope: scope};
        angular.forEach(['template', 'contentTemplate', 'placement', 'container', 'delay', 'trigger', 'keyboard', 'html', 'animation', 'backdropAnimation', 'type', 'customCl***REMOVED***', 'id'], function(key) {
          if(angular.isDefined(attr[key])) options[key] = attr[key];
        });
