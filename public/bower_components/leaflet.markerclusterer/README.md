...
You are p***REMOVED***ed a MarkerCluster object, you'll probably want to use getChildCount() or getAllChildMarkers() to work out the icon to show
...
* **polygonOptions**: Options to p***REMOVED*** when creating the L.Polygon(points, options) to show the bounds of a cluster
