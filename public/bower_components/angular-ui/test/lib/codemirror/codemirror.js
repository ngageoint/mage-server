...
window.CodeMirror = (function() {
  ...
  function CodeMirror(place, options) {
    ...
    if (options.lineWrapping)
      this.display.wrapper.cl***REMOVED***Name += " CodeMirror-wrap";
  ...
  function wrappingChanged(cm) {
    ...
    if (cm.options.lineWrapping) {
      cm.display.wrapper.cl***REMOVED***Name += " CodeMirror-wrap";
      ...
      cm.display.wrapper.cl***REMOVED***Name = cm.display.wrapper.cl***REMOVED***Name.replace(" CodeMirror-wrap", "");
  ...
  function keyMapChanged(cm) {
    ...
    cm.display.wrapper.cl***REMOVED***Name = cm.display.wrapper.cl***REMOVED***Name.replace(/\s*cm-keymap-\S+/g, "") +
      (style ? " cm-keymap-" + style : "");
  }

  function themeChanged(cm) {
    cm.display.wrapper.cl***REMOVED***Name = cm.display.wrapper.cl***REMOVED***Name.replace(/\s*cm-s-\S+/g, "") +
  ...
  function updateGutters(cm) {
    ...
    for (var i = 0; i < specs.length; ++i) {
      var gutterCl***REMOVED*** = specs[i];
      var gElt = gutters.appendChild(elt("div", null, "CodeMirror-gutter " + gutterCl***REMOVED***));
      if (gutterCl***REMOVED*** == "CodeMirror-linenumbers") {
  ...
  function alignHorizontally(cm) {
    ...
    var comp = compe***REMOVED***teForHScroll(display) - display.scroller.scrollLeft + cm.view.scrollLeft;
  ...
  function compe***REMOVED***teForHScroll(display) {
  ...
  function getDimensions(cm) {
    ...
    return {fixedPos: compe***REMOVED***teForHScroll(d),
  ...
  function buildLineElement(cm, line, lineNo, dims) {
    ...
    if (!cm.options.lineNumbers && !markers && !line.bgCl***REMOVED*** && !line.wrapCl***REMOVED*** &&
        (!line.widgets || !line.widgets.length)) return lineElement;

    // Lines with gutter elements or a background cl***REMOVED*** need
    // to be wrapped again, and have the extra elements added
    // to the wrapper div

    var wrap = elt("div", null, line.wrapCl***REMOVED***, "position: relative");
    ...
    if (line.bgCl***REMOVED***)
      wrap.appendChild(elt("div", "\u00a0", line.bgCl***REMOVED*** + " CodeMirror-linebackground"));
  ...
  function eventInWidget(display, e) {
    for (var n = e_target(e); n != display.wrapper; n = n.parentNode) {
      if (!n) return true;
      if (/\bCodeMirror-(?:line)?widget\b/.test(n.cl***REMOVED***Name) ||
  ...
  function onFocus(cm) {
    ...
    if (!cm.view.focused) {
      ...
      if (cm.display.scroller.cl***REMOVED***Name.search(/\bCodeMirror-focused\b/) == -1)
        cm.display.scroller.cl***REMOVED***Name += " CodeMirror-focused";
      resetInput(cm, true);
    }
    slowPoll(cm);
    restartBlink(cm);
  ...
  function onBlur(cm) {
    if (cm.view.focused) {
      ...
      cm.display.scroller.cl***REMOVED***Name = cm.display.scroller.cl***REMOVED***Name.replace(" CodeMirror-focused", "");
    }
  ...
  CodeMirror.prototype = {
    ...
    getTokenAt: function(pos) {
      ...
      return {start: stream.start,
              ...
              cl***REMOVED***Name: style || null, // Deprecated, use 'type' instead
              type: style || null,
              state: state};
    },
    ...
    addLineCl***REMOVED***: operation(null, function(handle, where, cls) {
      return changeLine(this, handle, function(line) {
        var prop = where == "text" ? "textCl***REMOVED***" : where == "background" ? "bgCl***REMOVED***" : "wrapCl***REMOVED***";
    ...
    removeLineCl***REMOVED***: operation(null, function(handle, where, cls) {
      return changeLine(this, handle, function(line) {
        var prop = where == "text" ? "textCl***REMOVED***" : where == "background" ? "bgCl***REMOVED***" : "wrapCl***REMOVED***";
        var cur = line[prop];
        if (!cur) return false;
    ...
    lineInfo: function(line) {
      ...
      return {line: n, handle: line, text: line.text, gutterMarkers: line.gutterMarkers,
              textCl***REMOVED***: line.textCl***REMOVED***, bgCl***REMOVED***: line.bgCl***REMOVED***, wrapCl***REMOVED***: line.wrapCl***REMOVED***,
    ...
    toggleOverwrite: function() {
      if (this.view.overwrite = !this.view.overwrite)
        this.display.cursor.cl***REMOVED***Name += " CodeMirror-overwrite";
      else
        this.display.cursor.cl***REMOVED***Name = this.display.cursor.cl***REMOVED***Name.replace(" CodeMirror-overwrite", "");
    },
  ...
  option("fixedGutter", true, function(cm, val) {
    cm.display.gutters.style.left = val ? compe***REMOVED***teForHScroll(cm.display) + "px" : "0";
    cm.refresh();
  }, true);
  ...
  TextMarker.prototype.getOptions = function(copyWidget) {
    ...
    return {cl***REMOVED***Name: this.cl***REMOVED***Name,
  ...
  function markText(cm, from, to, options, type) {
    ...
    if (marker.cl***REMOVED***Name || marker.startStyle || marker.endStyle || marker.collapsed)
  ...
  var styleToCl***REMOVED***Cache = {};
  function styleToCl***REMOVED***(style) {
    if (!style) return null;
    return styleToCl***REMOVED***Cache[style] ||
      (styleToCl***REMOVED***Cache[style] = "cm-" + style.replace(/ +/g, " cm-"));
  }
  ...
  function lineContent(cm, realLine, measure) {
    ...
    if (line.textCl***REMOVED***) builder.pre.cl***REMOVED***Name = line.textCl***REMOVED***;
  ...
  function insertLineContent(line, builder, styles) {
    ...
    if (!spans) {
      for (var i = 1; i < styles.length; i+=2)
        builder.addToken(builder, styles[i], styleToCl***REMOVED***(styles[i+1]));
      return;
    }
    ...
    for (;;) {
      if (nextChange == pos) { // Update current marker set
        ...
        for (var j = 0; j < spans.length; ++j) {
          ...
          if (sp.from <= pos && (sp.to == null || sp.to > pos)) {
            ...
            if (m.cl***REMOVED***Name) spanStyle += " " + m.cl***REMOVED***Name;
      ...
      while (true) {
        ...
        text = styles[i++]; style = styleToCl***REMOVED***(styles[i++]);
      }
    }
  }
  ...
  function elt(tag, content, cl***REMOVED***Name, style) {
    var e = document.createElement(tag);
    if (cl***REMOVED***Name) e.cl***REMOVED***Name = cl***REMOVED***Name;
