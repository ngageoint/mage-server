...
All the jQueryUI DatePicker options can be p***REMOVED***ed through the directive.
...
If you want to p***REMOVED*** date strings to and from the date directive via ng-model then you must use the ui-date-format directive.
