describe('uiEvent', function () {
  ...
  describe('test', function () {
    it('should work with dblclick event and ***REMOVED***ignment', function () {
      $scope = $rootScope.$new();
    ...
    it('should allow p***REMOVED***ing of $event object', function () {
      $scope = $rootScope.$new();
    ...
    it('should allow p***REMOVED***ing of $params object', function () {
      $scope = $rootScope.$new();
