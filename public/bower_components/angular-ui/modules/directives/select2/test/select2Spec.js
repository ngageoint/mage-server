...
describe('uiSelect2', function () {
  ...
  describe('with a <select> element', function () {
    ...
    it('should observe the disabled attribute', function () {
      ...
      expect(element.siblings().hasCl***REMOVED***('select2-container-disabled')).toBe(false);
      scope.$apply('disabled = true');
      expect(element.siblings().hasCl***REMOVED***('select2-container-disabled')).toBe(true);
    ...
    it('should observe the multiple attribute', function () {
      ...
      expect(element.siblings().hasCl***REMOVED***('select2-container-multi')).toBe(false);
      scope.$apply('multiple = true');
      expect(element.siblings().hasCl***REMOVED***('select2-container-multi')).toBe(true);
