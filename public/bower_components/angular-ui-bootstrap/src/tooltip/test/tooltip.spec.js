...
describe( 'tooltipHtmlU***REMOVED***fe', function() {
  ...
  // load the template
  beforeEach(module('template/tooltip/tooltip-html-u***REMOVED***fe-popup.html'));

  beforeEach(inject(function($rootScope, $compile) {
    scope = $rootScope;
    scope.html = 'I say: <strong cl***REMOVED***="hello">Hello!</strong>';

    elmBody = $compile( angular.element(
      '<div><span tooltip-html-u***REMOVED***fe="{{html}}">Selector Text</span></div>'
    ))( scope );
    scope.$digest();
    elm = elmBody.find('span');
    elmScope = elm.scope();
