describe('timepicker directive', function () {
  ...
  describe('user input validation', function () {
    ...
    it('clears model when input hours is invalid & alerts the UI', function() {
      ...
      expect($rootScope.time).toBe(null);
      expect(el.parent().hasCl***REMOVED***('error')).toBe(true);
      expect(element.hasCl***REMOVED***('ng-invalid-time')).toBe(true);
      ...
      expect(el.parent().hasCl***REMOVED***('error')).toBe(false);
      expect(element.hasCl***REMOVED***('ng-invalid-time')).toBe(false);
    });
  ...
  describe('use with `ng-required` directive', function() {
    ...
    it('should be invalid initially', function() {
      expect(element.hasCl***REMOVED***('ng-invalid')).toBe(true);
    });

    it('should be valid if model has been specified', function() {
      $rootScope.time = new Date();
      $rootScope.$digest();
      expect(element.hasCl***REMOVED***('ng-invalid')).toBe(false);
    });
  });
