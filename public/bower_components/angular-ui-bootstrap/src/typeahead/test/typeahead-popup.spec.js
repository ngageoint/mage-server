describe('typeaheadPopup - result rendering', function () {
  ...
  it('should render initial results', function () {
    ...
    expect(liElems.eq(0)).not.toHaveCl***REMOVED***('active');
    expect(liElems.eq(1)).toHaveCl***REMOVED***('active');
    expect(liElems.eq(2)).not.toHaveCl***REMOVED***('active');
  });
  ...
  it('should change active item on mouseenter', function () {
    ...
    expect(liElems.eq(1)).not.toHaveCl***REMOVED***('active');
    expect(liElems.eq(2)).toHaveCl***REMOVED***('active');
  });
