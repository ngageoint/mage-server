describe('typeahead tests', function () {
  ...
  beforeEach(function () {
    this.addMatchers({
      toBeClosed: function () {
        ...
        return typeaheadEl.css('display') === 'block' && liEls.length === noOfMatches && $(liEls[activeIdx]).hasCl***REMOVED***('active');
      }
    });
  });
  ...
  describe('basic functionality', function () {
    ...
    it('should allow timeouts when something is typed after waitTime has p***REMOVED***ed', inject(function ($timeout) {
      var values = [];
