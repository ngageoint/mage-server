describe('buttons', function () {
  ...
  describe('checkbox', function () {
    ...
    it('should work correctly with default model values', function () {
      ...
      expect(btn).not.toHaveCl***REMOVED***('active');

      $scope.model = true;
      $scope.$digest();
      expect(btn).toHaveCl***REMOVED***('active');
    });
  ...
  describe('radio', function () {
    ...
    //model -> UI
    it('should work correctly set active cl***REMOVED*** based on model', function () {
      ...
      expect(btns.eq(0)).not.toHaveCl***REMOVED***('active');
      expect(btns.eq(1)).not.toHaveCl***REMOVED***('active');

      $scope.model = 2;
      $scope.$digest();
      expect(btns.eq(0)).not.toHaveCl***REMOVED***('active');
      expect(btns.eq(1)).toHaveCl***REMOVED***('active');
    });
    ...
    it('should work correctly set active cl***REMOVED*** based on model', function () {
      ...
      btns.eq(0).click();
      expect($scope.model).toEqual(1);
      expect(btns.eq(0)).toHaveCl***REMOVED***('active');
      expect(btns.eq(1)).not.toHaveCl***REMOVED***('active');
