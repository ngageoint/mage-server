describe('pager directive', function () {
  ...
  it('has a "pager" css cl***REMOVED***', function() {
    expect(element.hasCl***REMOVED***('pager')).toBe(true);
  });
  ...
  it('aligns previous & next page', function() {
    expect(getPaginationEl(0)).toHaveCl***REMOVED***('previous');
    expect(getPaginationEl(0)).not.toHaveCl***REMOVED***('next');

    expect(getPaginationEl(-1)).not.toHaveCl***REMOVED***('previous');
    expect(getPaginationEl(-1)).toHaveCl***REMOVED***('next');
  });
  ...
  describe('setting `pagerConfig`', function() {
    ...
    it('should not align previous & next page link', function () {
      expect(getPaginationEl(0)).not.toHaveCl***REMOVED***('previous');
      expect(getPaginationEl(-1)).not.toHaveCl***REMOVED***('next');
    });
  });
