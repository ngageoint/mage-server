...
describe('$transition', function() {
  ...
  it('changes the css if p***REMOVED***ed a string', function() {
    var element = angular.element('<div></div>');
    spyOn(element, 'addCl***REMOVED***');
    $transition(element, 'triggerCl***REMOVED***');
    $timeout.flush();

    expect(element.addCl***REMOVED***).toHaveBeenCalledWith('triggerCl***REMOVED***');
  });

  it('changes the style if p***REMOVED***ed an object', function() {
    var element = angular.element('<div></div>');
  ...
  it('calls the function if p***REMOVED***ed', function() {
    var element = angular.element('<div></div>');
