describe('$modal', function () {
  ...
  describe('option by option', function () {
    ...
    describe('custom window cl***REMOVED***es', function () {

      it('should support additional window cl***REMOVED*** as string', function () {
        open({
          template: '<div>With custom window cl***REMOVED***</div>',
          windowCl***REMOVED***: 'additional'
        });

        expect($document.find('div.modal')).toHaveCl***REMOVED***('additional');
      });
    });
  });
