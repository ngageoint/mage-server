...
- **typeahead:** 
  ...
  - remove dependency on ng-bind-html-u***REMOVED***fe ([75893393](http://github.com/angular-ui/bootstrap/commit/75893393))   

## Breaking Changes

- **modal:**

* `$dialog` ***REMOVED*** was refactored into `$modal`
* `modal` directive was removed - use the `$modal` ***REMOVED*** instead

Check the documentation for the `$modal` ***REMOVED*** to migrate from `$dialog`
...
- **dialog:** 
  - remove dialogOpenCl***REMOVED*** to get in line with v2.3 ([f009b23f](http://github.com/angular-ui/bootstrap/commit/f009b23f))  
- **pagination:** 
...
- **tooltip:**
  ...
  - added tooltip-html-u***REMOVED***fe directive ([45ed2805](https://github.com/angular-ui/bootstrap/commit/45ed2805))
