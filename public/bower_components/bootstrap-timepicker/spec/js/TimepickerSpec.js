describe('Timepicker feature', function() {
  ...
  it('should be configurable with data attributes', function() {
    $('body').append('<div id="hi" cl***REMOVED***="bootstrap-timepicker"><input id="customTimepicker" data-template="modal" data-minute-step="30" data-modal-backdrop="true" data-show-meridian="true" type="text"/></div');
