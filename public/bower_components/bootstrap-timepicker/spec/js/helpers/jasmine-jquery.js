...
jasmine.Fixtures.prototype.proxyCallTo_ = function(methodName, p***REMOVED***edArguments) {
  return this[methodName].apply(this, p***REMOVED***edArguments)
}
...
jasmine.JSONFixtures.prototype.proxyCallTo_ = function(methodName, p***REMOVED***edArguments) {
  return this[methodName].apply(this, p***REMOVED***edArguments)
}
...
jasmine.JQuery.matchersCl***REMOVED*** = {}
...
!function(){
  var jQueryMatchers = {
    toHaveCl***REMOVED***: function(cl***REMOVED***Name) {
      return this.actual.hasCl***REMOVED***(cl***REMOVED***Name)
    },
  ...
  var bindMatcher = function(methodName) {
    ...
    jasmine.JQuery.matchersCl***REMOVED***[methodName] = function() {
      if (this.actual
...
beforeEach(function() {
  this.addMatchers(jasmine.JQuery.matchersCl***REMOVED***)
  this.addMatchers({
