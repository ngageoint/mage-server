...
# the PEM path to the file containing the private key for 2-way SSL/x509 certificate authentication from the server to mongodb
...
# (https://docs.mongodb.com/v3.6/core/security-x.509/), rather than user/password authentication.  if the key is
