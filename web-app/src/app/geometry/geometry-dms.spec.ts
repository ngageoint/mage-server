...
fdescribe('DMS', () => {
  ...
  it('should parse the coordinate string', () => {
    ...
    expect(DMS.parseOne(`12454N`, DimensionKey.Latitude)).toEqual(1.415)
    expect(DMS.parseOne(`02230N`, DimensionKey.Latitude)).toEqual(0.375)
    expect(DMS.parseOne(`2230N`, DimensionKey.Latitude)).toEqual(22.5)
    expect(DMS.parseOne(`215N`, DimensionKey.Latitude)).toEqual(2.25)
    expect(DMS.parseOne(`21N`, DimensionKey.Latitude)).toEqual(21)
    expect(DMS.parseOne(`2N`, DimensionKey.Latitude)).toEqual(2)
    expect(DMS.parseOne(`N 11 ° 22'30.36 `, DimensionKey.Latitude)).toEqual(11.375)
    expect(DMS.parseOne(`N 11 ° 22'30.remove `, DimensionKey.Latitude)).toEqual(11.375)
    ...
    expect(DMS.parseOne(`-11.4584`, DimensionKey.Latitude)).toEqual(-11.4584)
    expect(DMS.parseOne(`- 1 1 . 4 5 8 4`, DimensionKey.Latitude)).toEqual(-11.4584)
