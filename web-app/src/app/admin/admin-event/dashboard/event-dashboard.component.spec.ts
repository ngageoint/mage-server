...
describe('EventDashboardComponent', () => {
  ...
  beforeEach(async () => {
    ...
    sessionServiceSpy = { hasPermission: jasmine.createSpy('hasPermission').and.returnValue(false) };
  ...
  it('should initialize permissions properly (has CREATE_EVENT)', () => {
    sessionServiceSpy.hasPermission.and.returnValue(true);

    expect(component.hasEventCreatePermission).toBeTrue();
  });

  it('should set hasEventCreatePermission false when there is no permission', () => {
