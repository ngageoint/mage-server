...
describe('AdminFeedEditItemPropertiesComponent', () => {
  ...
  describe('changing topic and feed schemas', () => {
    ...
    describe('updating the schema form', () => {
      ...
      afterEach(fakeAsync(() => {
        ...
        fixture.detectChanges()
        tick(target.changeDebounceInterval + 50);
    ...
    describe('emitting schema changes', () => {
      ...
      it('emits debounced changes when form values change ', fakeAsync(() => {
      ...
      it('retains extra properties from topic schema in emitted schema changes', fakeAsync(() => {
      ...
      it('does not emit a change when populating the form from the topic schema', fakeAsync(() => {
      ...
      it('does not emit a change when populating the form from the feed schema', fakeAsync(() => {
      ...
      it('does not emit a change when topic and feed schemas change', fakeAsync(() => {
      ...
      it('does not emit a change when populating from feed schema after feed schema changes', fakeAsync(() => {
      ...
      it('does not emit a change when populating from topic schema after feed schema changes to null', fakeAsync(() => {
  ...
  describe('accepting the schema', () => {
    ...
    it('emits a null schema if the user never changed the form from the topic schema', fakeAsync(() => {
    ...
    it('emits a null schema if the user never changed the form from the feed schema', fakeAsync(() => {
    ...
    it('emits the schema with changed form values applied', fakeAsync(() => {
      ...
      const allTitleInputs = fixture.debugElement.queryAll(By.css('.item-property-list input'))
    ...
    it('emits the correct schema if accepted before the debounce interval', fakeAsync(() => {
      ...
      timestampInput.dispatchEvent(new Event('input'))
      fixture.detectChanges()
      tick(target.changeDebounceInterval / 2);
    ...
    it('emits the correct schema when accepted before debounce interval and feed schema is null', fakeAsync(() => {
