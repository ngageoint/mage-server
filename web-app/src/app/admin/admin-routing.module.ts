...
import { SecurityBannerComponent } from './admin-settings/security-banner/security-banner.component';
import { SecurityDisclaimerComponent } from './admin-settings/security-disclaimer/security-disclaimer.component';
import { ContactInfoComponent } from './admin-settings/contact-info/contact-info.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'events/:eventId/forms/new', component: FormDetailsComponent },
      ...
      { path: 'banner', component: SecurityBannerComponent, canDeactivate: [AdminUnsavedChangesGuard] },
      { path: 'disclaimer', component: SecurityDisclaimerComponent, canDeactivate: [AdminUnsavedChangesGuard] },
      { path: 'contact', component: ContactInfoComponent, canDeactivate: [AdminUnsavedChangesGuard] },
