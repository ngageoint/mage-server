...
import {
  MatChipsModule as MatChipsModule,
  MatChipInputEvent as MatChipInputEvent,
  MatChipInput as MatChipInput
...
@Component({
  standalone: true,
  imports: [ObservationEditMultiselectComponent],
  template: `
...
class TestHostComponent {
  ...
  @ViewChild(ObservationEditMultiselectComponent)
