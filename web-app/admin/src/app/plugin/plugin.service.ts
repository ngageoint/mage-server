...
import * as ngMatAutocomplete from '@angular/material/legacy-autocomplete';
import * as ngMatBadge from '@angular/material/badge';
import * as ngMatBottomSheet from '@angular/material/bottom-sheet';
import * as ngMatButton from '@angular/material/legacy-button';
import * as ngMatButtonToggle from '@angular/material/button-toggle';
import * as ngMatCard from '@angular/material/legacy-card';
import * as ngMatCheckbox from '@angular/material/legacy-checkbox';
import * as ngMatChips from '@angular/material/legacy-chips';
import * as ngMatCore from '@angular/material/legacy-core';
import * as ngMatDatepicker from '@angular/material/datepicker';
import * as ngMatDialog from '@angular/material/legacy-dialog';
import * as ngMatDivider from '@angular/material/divider';
import * as ngMatExpansion from '@angular/material/expansion';
import * as ngMatFormField from '@angular/material/legacy-form-field';
import * as ngMatGridList from '@angular/material/grid-list';
import * as ngMatIcon from '@angular/material/icon';
import * as ngMatInput from '@angular/material/legacy-input';
import * as ngMatList from '@angular/material/legacy-list';
import * as ngMatMenu from '@angular/material/legacy-menu';
import * as ngMatPaginator from '@angular/material/legacy-paginator';
import * as ngMatProgressBar from '@angular/material/legacy-progress-bar';
import * as ngMatProgressSpinner from '@angular/material/legacy-progress-spinner';
import * as ngMatRadio from '@angular/material/legacy-radio';
import * as ngMatSelect from '@angular/material/legacy-select';
import * as ngMatSidenav from '@angular/material/sidenav';
import * as ngMatSlideToggle from '@angular/material/legacy-slide-toggle';
import * as ngMatSlider from '@angular/material/legacy-slider';
import * as ngMatSnackBar from '@angular/material/legacy-snack-bar';
import * as ngMatSort from '@angular/material/sort';
import * as ngMatStepper from '@angular/material/stepper';
import * as ngMatTable from '@angular/material/legacy-table';
import * as ngMatTabs from '@angular/material/legacy-tabs';
import * as ngMatToolbar from '@angular/material/toolbar';
import * as ngMatTooltip from '@angular/material/legacy-tooltip';
