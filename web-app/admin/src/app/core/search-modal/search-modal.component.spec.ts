...
describe('SearchModalComponent', () => {
  ...
  beforeEach(async () => {
    ...
    mockSearchFunction = jasmine
      .createSpy('searchFunction')
      .and.returnValue(of(mockSearchResults));
  ...
  describe('Template Integration', () => {
    ...
    it('should display title in card navbar', () => {
      const cardNavbar = fixture.debugElement.query(
        (directive) => directive.name === 'mage-card-navbar'
      );
    ...
    it('should show no results message when no data', () => {
      ...
      const noResults = fixture.debugElement.nativeElement.querySelector(
    ...
    it('should show paginator when totalCount > 0', () => {
      ...
      const paginator = fixture.debugElement.nativeElement.querySelector(
