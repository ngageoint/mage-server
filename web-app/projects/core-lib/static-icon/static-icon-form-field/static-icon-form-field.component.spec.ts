...
describe('StaticIconFormFieldComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    iconService = jasmine.createSpyObj<StaticIconService>(
      'MockStaticIconService',
  ...
  beforeEach(() => {
    ...
    target = fixture.debugElement.query(
      By.directive(StaticIconFormFieldComponent)
    ).componentInstance;
  ...
  it('fetches the icon by reference when ref changes', () => {
    ...
    iconService.fetchIconByReference
      .withArgs(iconRef)
      .and.returnValue(of(icon));
