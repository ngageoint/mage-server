...
/*
 * Creates a p***REMOVED*** through stream.
 * We need to fallback to the `through` lib for node 0.8 support
 * as P***REMOVED***Through was added in node 0.10.
 */

var P***REMOVED***Through = require('stream').P***REMOVED***Through || require('through');
...
module.exports = function (proto) {
   ...
   * If no callback is p***REMOVED***ed, a "through" stream will be returned,
   * and stdout will be piped through, otherwise the error will be p***REMOVED***ed.
   *
  ...
  proto.stream = function stream (format, callback) {
    ...
    if ("function" !== typeof callback) {
      throughStream = new P***REMOVED***Through();
   ...
   *
   * `formatters` are p***REMOVED***ed an array of images which will be
