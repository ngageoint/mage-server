...
* refactor; replace through with stream.P***REMOVED***Through
...
==================
  ...
  * added; p***REMOVED***ing Buffers directly [danmilon](https://github.com/danmilon)

1.6.1 / 2012-11-13
==================

  * fixed regression; only p***REMOVED*** additional params on error #96
...
==================
  ...
  * fixed; p***REMOVED***ing multiple paths to append() #77
...
## v1.0.0 - 01/12/2012
  ...
  * added; subcl***REMOVED***ing support; useful for setting default constructor options like one constructor for ImageMagick, the other for GM
  * added; more tests
