 ...
 *
 * Other options are p***REMOVED***ed along to `send`.
 *
 * Examples:
 *
 ...
 *    });
 *
 * By default Express p***REMOVED***es an `Error`
...
/**
 * Set header `field` to `val`, or p***REMOVED***
...
res.cookie = function(name, val, options){
  ...
  var ***REMOVED*** = this.req.***REMOVED***;
  var signed = options.signed;
  if (signed && !***REMOVED***) throw new Error('cookieParser("***REMOVED***") required for signed cookies');
  if ('number' == typeof val) val = val.toString();
  if ('object' == typeof val) val = 'j:' + JSON.stringify(val);
  if (signed) val = 's:' + sign(val, ***REMOVED***);
