 ...
 * `-1` when u***REMOVED***tisfiable, `-2` when syntactically invalid.
 *
 ...
 *    req.auth
 *    // => { username: 'tobi', p***REMOVED***word: 'hello' }
 *
...
req.__defineGetter__('auth', function(){
  ...
  if (!auth) return;
  return { username: auth[1], p***REMOVED***word: auth[2] };
});
 ...
 * the app. By default, the domain of the app is ***REMOVED***umed to be the last two
