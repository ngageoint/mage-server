...
exports.sign = (function (val, ***REMOVED***) {
  ...
  return val + "." + crypto.createHmac("sha256", ***REMOVED***).update(val).digest("base64").replace(/=+$/, "");
});
...
exports.parseSignedCookies = (function (obj, ***REMOVED***) {
  ...
  if (0 == val.indexOf("s:")) {
    ...
    val = signature.unsign(val.slice(2), ***REMOVED***);
...
exports.parseSignedCookie = (function (str, ***REMOVED***) {
  _$jscoverage['utils.js'][209]++;
  return 0 == str.indexOf("s:")? signature.unsign(str.slice(2), ***REMOVED***): str;
});
