...
function session(options) {
  ...
  var ***REMOVED*** = options.***REMOVED*** || req.***REMOVED***;
  _$jscoverage['middleware/session.js'][228]++;
  if (! ***REMOVED***) {
    _$jscoverage['middleware/session.js'][228]++;
    throw new Error("`***REMOVED***` option required for sessions");
  }
  ...
  if (! unsignedCookie && rawCookie) {
    ...
    unsignedCookie = utils.parseSignedCookie(rawCookie, ***REMOVED***);
  }
  ...
  var val = "s:" + signature.sign(req.sessionID, ***REMOVED***);
