...
module.exports = (function cookieSession(options) {
  ...
  if (! ***REMOVED***) {
    _$jscoverage['middleware/cookieSession.js'][56]++;
    throw new Error("`***REMOVED***` option required for cookie sessions");
  }
  ...
  if (! options.***REMOVED*** && req.***REMOVED***) {
    ...
    if (rawCookie) {
      ...
      var unsigned = utils.parseSignedCookie(rawCookie, ***REMOVED***);
  ...
  val = "s:" + signature.sign(val, ***REMOVED***);
