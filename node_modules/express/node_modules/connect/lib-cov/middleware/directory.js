...
function html(files, dir, useIcons) {
  ...
  if (useIcons && ".." != file) {
    ...
    cl***REMOVED***es.push("icon");
  }
  _$jscoverage['middleware/directory.js'][176]++;
  return "<li><a href=\"" + join(dir, file) + "\" cl***REMOVED***=\"" + cl***REMOVED***es.join(" ") + "\"" + " title=\"" + file + "\">" + icon + file + "</a></li>";
})).join("\n") + "</ul>";
}
