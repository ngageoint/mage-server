 ...
 *      app.use(connect.cookieSession({ ***REMOVED***: 'tobo!', cookie: { maxAge: 60 * 60 * 1000 }}));
 *
 * Options:
 *
 *   - `key` cookie name defaulting to `connect.sess`
 *   - `***REMOVED***` prevents cookie tampering
...
module.exports = function cookieSession(options){
  ...
  return function cookieSession(req, res, next) {
    ...
    // req.***REMOVED*** is for backwards compatibility
    var ***REMOVED*** = options.***REMOVED*** || req.***REMOVED***;
    if (!***REMOVED***) throw new Error('`***REMOVED***` option required for cookie sessions');
