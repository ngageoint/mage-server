...
files are collected and p***REMOVED***ed to the callback:
...
(***REMOVED***uming no other fields expected besides the file) and use `filesList[0]`.
 ...
 * `byteCount` - ***REMOVED***uming that this is the last part in the request,
