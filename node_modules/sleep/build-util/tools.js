...
function download(from,options,callback) {
    ...
    req.on('response', function(res){
        ...
        function returnBuffer() {
            // todo - use http://nodejs.org/api/buffer.html#buffer_cl***REMOVED***_method_buffer_concat_list_totallength
...
function parse_args(_args, opts) {
    ...
    // respect flags p***REMOVED***ed to npm install
    ...
    if (opts.stage) {
        ...
        if ( from_source > -1) {
            // no specific module name p***REMOVED***ed
