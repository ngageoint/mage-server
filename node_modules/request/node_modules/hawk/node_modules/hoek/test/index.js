...
describe('Hoek', function () {
    ...
    describe('#clone', function () {
        ...
        it('should perform actual copy for shallow keys (no p***REMOVED*** by reference)', function (done) {
        ...
        it('should perform actual copy for deep keys (no p***REMOVED*** by reference)', function (done) {
    ...
    describe('#***REMOVED***ert', function () {

        it('should throw an Error when using ***REMOVED***ert in a test', function (done) {

            var fn = function () {

                Hoek.***REMOVED***ert(false, 'my error message');
            };
        ...
        it('should throw an Error when using ***REMOVED***ert in a test with no message', function (done) {

            var fn = function () {

                Hoek.***REMOVED***ert(false);
            };
        ...
        it('should throw an Error when using ***REMOVED***ert in a test with multipart message', function (done) {

            var fn = function () {

                Hoek.***REMOVED***ert(false, 'This', 'is', 'my message');
            };
        ...
        it('should throw an Error when using ***REMOVED***ert in a test with object message', function (done) {

            var fn = function () {

                Hoek.***REMOVED***ert(false, 'This', 'is', { spinal: 'tap' });
            };
        ...
        it('should throw an Error when using ***REMOVED***ert in a test with error object message', function (done) {

            var fn = function () {

                Hoek.***REMOVED***ert(false, new Error('This is spinal tap'));
            };
    ...
    describe('#toss', function () {
        ...
        it('should call callback with new error using p***REMOVED***ed error with error condition', function (done) {
