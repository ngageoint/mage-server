...
exports.merge = function (target, source, isNullOverride /* = true */, isMergeArrays /* = true */) {
    ...
    exports.***REMOVED***ert(target && typeof target == 'object', 'Invalid target value: must be an object');
    exports.***REMOVED***ert(source === null || source === undefined || typeof source === 'object', 'Invalid source value: must be null, undefined, or an object');
    ...
    if (source instanceof Array) {
        exports.***REMOVED***ert(target instanceof Array, 'Cannot merge array onto an object');
        if (isMergeArrays === false) {                                                  // isMergeArrays defaults to true
            target.length = 0;                                                          // Must not change target ***REMOVED***ignment
        }
...
exports.applyToDefaults = function (defaults, options) {
    ...
    exports.***REMOVED***ert(defaults && typeof defaults == 'object', 'Invalid defaults value: must be an object');
    exports.***REMOVED***ert(!options || options === true || typeof options === 'object', 'Invalid options value: must be true, falsy or an object');
...
exports.***REMOVED***ert = function (condition /*, msg1, msg2, msg3 */) {
...
exports.escapeHeaderAttribute = function (attribute) {
    ...
    exports.***REMOVED***ert(attribute.match(/^[ \w\!#\$%&'\(\)\*\+,\-\.\/\:;<\=>\?@\[\]\^`\{\|\}~\"\\]*$/), 'Bad attribute value (' + attribute + ')');
