...
describe('Boom', function () {
    ...
    describe('#badRequest', function () {
        ...
        it('sets the message with the p***REMOVED***ed in message', function (done) {
    ...
    describe('#unauthorized', function () {
        ...
        it('returns a WWW-Authenticate header when p***REMOVED***ed a scheme', function (done) {
        ...
        it('returns a WWW-Authenticate header when p***REMOVED***ed a scheme and attributes', function (done) {
        ...
        it('sets a WWW-Authenticate when p***REMOVED***ed as an array', function (done) {
    ...
    describe('#internal', function () {
        ...
        it('p***REMOVED***es data on the callback if its p***REMOVED***ed in', function (done) {

            expect(Boom.internal('my message', { my: 'data' }).data.my).to.equal('data');
            done();
        });

        it('uses p***REMOVED***ed in stack if its available', function (done) {
    ...
    describe('#p***REMOVED***Through', function () {

        it('returns a p***REMOVED***-through error', function (done) {

            var err = Boom.p***REMOVED***Through(499, { a: 1 }, 'application/text', { 'X-Test': 'Boom' });
            expect(err.response.code).to.equal(499);
            expect(err.message).to.equal('P***REMOVED***-through');
            expect(err.response).to.deep.equal({
                code: 499,
                payload: { a: 1 },
                headers: { 'X-Test': 'Boom' },
