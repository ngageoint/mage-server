...
module.exports = {
   ...
   * true or false.  You are expected to p***REMOVED*** in an object that was
   * returned from `parse()`.
   *
   * @param {Object} parsedSignature the object you got from `parse`.
   * @param {String} key either an RSA private key PEM or HMAC ***REMOVED***.
   * @return {Boolean} true if valid, false otherwise.
   * @throws {TypeError} if you p***REMOVED*** in bad arguments.
   */
  verifySignature: function verifySignature(parsedSignature, key) {
    ***REMOVED***ert.object(parsedSignature, 'parsedSignature');
    ***REMOVED***ert.string(key, 'key');
