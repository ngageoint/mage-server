...
When this is p***REMOVED***ed into the read routine, it would read the first two bytes
...
example, let's ***REMOVED***ume that's 0. After reading x, the next offset to read from
