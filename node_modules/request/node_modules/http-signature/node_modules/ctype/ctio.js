 ...
 * If you find that it does in fact work, that's pretty cool. Try and p***REMOVED*** word
...
/*
 * Numbers in Javascript have a ***REMOVED***: all numbers must be represented with an
 ...
 * maybe a size? You mean we byp***REMOVED***ed the 4 GB limit on file sizes, when did
 * that happen?
 *
 ...
 * aren't floats ***REMOVED***ly under the hood for that, we /should/ be okay.
 */
...
function rsint64(buffer, endian, offset)
{
	 ...
	 */
	mod_***REMOVED***ert.ok(val[1] <= 0x100000000);
 ...
 * and what is ***REMOVED***ly hiding at the heart of everything in this. I really hope
...
/*
 * 8-bit version, cl***REMOVED***y. We can ignore endianness which is good.
 */
 ...
 *   -  P***REMOVED*** it off to the appropriate unsigned version, potentially modifying
 ...
 *			mantissa & 0xff
 *
 * Once we have this we have to ***REMOVED***ign them into the buffer in proper endian
 * order.
 */
...
function wdouble(value, endian, buffer, offset)
{
	...
	if (isNaN(value)) {
		...
		if (value <= 2.225073858507201e-308 || ebits <= -1023) {
			...
			/*
			 * We might have gotten ***REMOVED***ed by our floating point
			 * logarithm magic. This is rather ***REMOVED***py, but that's
			 * our luck. If we just had a log base 2 or access to
			 * the ***REMOVED*** underlying representation this would have
			 * been much easier and we wouldn't have such ***REMOVED***
			 * kludges or hacks.
			 */
			if (ebits > 1023)
				ebits = 1023;
