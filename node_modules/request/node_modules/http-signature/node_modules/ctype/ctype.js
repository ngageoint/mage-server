 ...
 * If it resolves to a struct, we just p***REMOVED*** it off to read struct. If not, we
 * can just p***REMOVED*** it off to read entry.
 */
    ...
    offset, value)
{
	...
	mod_***REMOVED***ert.ok(type in this.types);
...
CTypeParser.prototype.readEntry = function (type, buffer, offset)
{
	 ...
	 * first cl***REMOVED*** type where as all other arrays just call into a
...
function getValues(def)
{
	...
	for (ii = 0; ii < def.length; ii++) {
		key = Object.keys(def[ii])[0];
		mod_***REMOVED***ert.ok('value' in def[ii][key]);
