...
/**
 * A cl***REMOVED*** to represent a JSDoc entry alias.
 */
cl***REMOVED*** Alias {
  ...
  /**
   * Checks if the owner entry *is* ***REMOVED***igned to a prototype.
   *
   * @memberOf Alias
   * @returns {Boolean} Returns `true` if ***REMOVED***igned to a prototype, else `false`.
   */
  ...
  /**
   * Checks if the owner entry is *not* ***REMOVED***igned to a prototype.
   *
   * @memberOf Alias
   * @returns {Boolean} Returns `true` if not ***REMOVED***igned to a prototype, else `false`.
   */
