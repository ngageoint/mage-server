...
cl***REMOVED*** Generator {
  ...
  /**
   * Modify a string by replacing named tokens with matching ***REMOVED***oc. array values.
   *
   * @private
   * @static
   * @memberOf Generator
    ...
    foreach ($this->entries as $entry) {
      ...
      foreach ($members as $member) {
        ...
        if (!$member || $entry->isCtor() || ($entry->getType() == 'Object' &&
          ...
          // ***REMOVED***ign the real entry, replacing the temporary entry if it exist
