...
/**
 * A cl***REMOVED*** to simplify parsing a single JSDoc entry.
 */
cl***REMOVED*** Entry {
  ...
  /**
   * Checks if the entry *is* ***REMOVED***igned to a prototype.
   *
   * @memberOf Entry
  ...
  /**
   * Checks if the entry is *not* ***REMOVED***igned to a prototype.
   *
   * @memberOf Entry
