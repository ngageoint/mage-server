...
Request.prototype.init = function (options) {
  ...
  if (!self.uri.host) {
    ...
    if (Object.keys(options).length === 0) {
      ...
      message += '. This can be caused by a ***REMOVED***py redirection.'
    }
  ...
  if (options.auth) {
    ...
    if (Object.prototype.hasOwnProperty.call(options.auth, 'p***REMOVED***word')) options.auth.p***REMOVED*** = options.auth.p***REMOVED***word

    self.auth(
      options.auth.user,
      options.auth.p***REMOVED***,
  ...
  if (!self.agent) {
    ...
    if (options.agentCl***REMOVED***) {
      self.agentCl***REMOVED*** = options.agentCl***REMOVED***
    } else if (options.forever) {
      self.agentCl***REMOVED*** = protocol === 'http:' ? ForeverAgent : ForeverAgent.SSL
    } else {
      self.agentCl***REMOVED*** = self.httpModule.Agent
    }
  }
  ...
  process.nextTick(function () {
    ...
    if (self.body) {
      ...
      console.warn("options.requestBodyStream is deprecated, please p***REMOVED*** the request object to stream.pipe.")
...
Request.prototype._updateProtocol = function () {
  ...
  if (protocol === 'https:') {
    ...
    switch (self.agentCl***REMOVED***) {
      case ForeverAgent:
        self.agentCl***REMOVED*** = ForeverAgent.SSL
        break
      case http.Agent:
        self.agentCl***REMOVED*** = https.Agent
        break
      default:
    ...
    switch (self.agentCl***REMOVED***) {
      case ForeverAgent.SSL:
        self.agentCl***REMOVED*** = ForeverAgent
        break
      case https.Agent:
        self.agentCl***REMOVED*** = http.Agent
        break
      default:
        // nothing we can do.  just hope for the best
        return
...
Request.prototype.getAgent = function () {
  var Agent = this.agentCl***REMOVED***
  var options = {}
...
Request.prototype.onResponse = function (response) {
  ...
  if (response.statusCode >= 300 && response.statusCode < 400 && hasHeader('location', response.headers)) {
    ...
    switch (authVerb) {
      case 'basic':
        self.auth(self._user, self._p***REMOVED***, true)
        redirectTo = self.uri
        break
      ...
      case 'digest':
        ...
        var ha1 = md5(self._user + ':' + challenge.realm + ':' + self._p***REMOVED***)
...
Request.prototype.auth = function (user, p***REMOVED***, sendImmediately) {
  if (typeof user !== 'string' || (p***REMOVED*** !== undefined && typeof p***REMOVED*** !== 'string')) {
    throw new Error('auth() received invalid user or p***REMOVED***word')
  }
  this._user = user
  this._p***REMOVED*** = p***REMOVED***
  this._hasAuth = true
  var header = typeof p***REMOVED*** !== 'undefined' ? user + ':' + p***REMOVED*** : user
...
Request.prototype.oauth = function (_oauth) {
  ...
  var consumer_***REMOVED*** = oa.oauth_consumer_***REMOVED***
  delete oa.oauth_consumer_***REMOVED***
  var token_***REMOVED*** = oa.oauth_token_***REMOVED***
  delete oa.oauth_token_***REMOVED***
  var timestamp = oa.oauth_timestamp

  var baseurl = this.uri.protocol + '//' + this.uri.host + this.uri.pathname
  var signature = oauth.hmacsign(this.method, baseurl, oa, consumer_***REMOVED***, token_***REMOVED***)
