...
if (!fs.lutimes) {
  ...
  } else if (fs.utime***REMOVED***t && constants.hasOwnProperty("AT_SYMLINK_NOFOLLOW")) {
    // maybe utime***REMOVED***t will be bound soonish?
    fs.lutimes = function (path, at, mt, cb) {
      fs.utime***REMOVED***t(path, at, mt, constants.AT_SYMLINK_NOFOLLOW, cb)
    }

    fs.lutimesSync = function (path, at, mt) {
      return fs.utime***REMOVED***tSync(path, at, mt, constants.AT_SYMLINK_NOFOLLOW)
    }
