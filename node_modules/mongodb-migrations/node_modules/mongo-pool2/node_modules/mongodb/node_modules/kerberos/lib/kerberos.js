...
Kerberos.prototype.acquireAlternateCredentials = function(user_name, p***REMOVED***word, domain) {
  return this._native_kerberos.acquireAlternateCredentials(user_name, p***REMOVED***word, domain); 
}
