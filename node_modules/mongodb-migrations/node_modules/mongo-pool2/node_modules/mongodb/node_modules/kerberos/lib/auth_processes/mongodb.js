...
var MongoAuthProcess = function(host, port, ***REMOVED***_name) {  
  // Check what system we are on
  if(process.platform == 'win32') {
    this._processor = new Win32MongoProcessor(host, port, ***REMOVED***_name);
  } else {
    this._processor = new UnixMongoProcessor(host, port, ***REMOVED***_name);
  }
}

MongoAuthProcess.prototype.init = function(username, p***REMOVED***word, callback) {
  this._processor.init(username, p***REMOVED***word, callback);
}
 ...
 *
 *******************************************************************/
var Win32MongoProcessor = function(host, port, ***REMOVED***_name) {
  this.host = host;
  this.port = port  
  // SSIP cl***REMOVED***es
  ...
  // Set up ***REMOVED*** name
  ***REMOVED***_name = ***REMOVED***_name || "mongodb";
  // Set up target
  this.target = format("%s/%s", ***REMOVED***_name, host);
  // Number of retries
  this.retries = 10;
}

Win32MongoProcessor.prototype.init = function(username, p***REMOVED***word, callback) {
  var self = this;
  // Save the values used later
  this.username = username;
  this.p***REMOVED***word = p***REMOVED***word;
  // Aquire credentials
  this.ssip.SecurityCredentials.aquire_kerberos(username, p***REMOVED***word, function(err, security_credentials) {
 ...
 *
 *******************************************************************/
var UnixMongoProcessor = function(host, port, ***REMOVED***_name) {
  this.host = host;
  this.port = port  
  // SSIP cl***REMOVED***es
...
UnixMongoProcessor.prototype.init = function(username, p***REMOVED***word, callback) {
  var self = this;
  this.username = username;
  this.p***REMOVED***word = p***REMOVED***word;
