...
template<typename T> cl***REMOVED*** BSONSerializer;

cl***REMOVED*** BSON : public ObjectWrap {
public:
	BSON();
	~BSON() {}
...
private:
	...
	template<typename T> friend cl***REMOVED*** BSONSerializer;
	friend cl***REMOVED*** BSONDeserializer;
};

//===========================================================================

cl***REMOVED*** CountStream
{
public:
	CountStream() : count(0) { }
...
template<typename T> cl***REMOVED*** BSONSerializer : public T
{
private:
	typedef T Inherited;
