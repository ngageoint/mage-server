...
void BSON::Initialize(v8::Handle<v8::Object> target)
{
	...
	t->SetCl***REMOVED***Name(String::NewSymbol("BSON"));
...
NAN_METHOD(BSON::New)
{
	...
	if(args.Length() == 1 && args[0]->IsArray())
	{
		...
		{
			return NanThrowError("No types p***REMOVED***ed in");
		}
	}
	else
	{
		return NanThrowTypeError("Argument p***REMOVED***ed in must be an array of types");
	}
}
