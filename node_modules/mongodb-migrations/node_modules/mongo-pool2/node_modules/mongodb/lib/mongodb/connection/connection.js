...
Connection.prototype.start = function() {
  ...
  if(this.socketOptions.ssl) {
    ...
    // If the driver has been provided a private key p***REMOVED***word
    if(this.socketOptions.sslP***REMOVED***) {
      tls_options.p***REMOVED***phrase = this.socketOptions.sslP***REMOVED***;
    }
  ...
  try {
    ...
    if(Array.isArray(command)) {
      for(var i = 0; i < command.length; i++) {
        try {
          // P***REMOVED*** in the bson validation settings (validate early)
