 ...
 *
 * @cl***REMOVED*** Represents a Mongos connection with failover to backup proxies
        ...
        connectFunction(self.db, newServer, options, function(err, _server) {
          ...
          var connectionFunction = function(_auth, _connection, _callback) {
            ...
            for(var j = 0; j < pending; j++) {
              ...
              var p***REMOVED***word = _auth.p***REMOVED***word;
              var options = { 
              ...
              // If we have changed the ***REMOVED*** name
              ...
              self.db.authenticate(username, p***REMOVED***word, options, function(err, result) {
