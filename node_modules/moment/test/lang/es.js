...
exports["lang:es"] = {
    ...
    "from" : function(test) {
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({s:44}), true),  "unos segun***REMOVED***", "44 seconds = a few seconds");
    ...
    "suffix" : function(test) {
        test.expect(2);
        test.equal(moment(30000).from(0), "en unos segun***REMOVED***",  "prefix");
        test.equal(moment(0).from(30000), "hace unos segun***REMOVED***", "suffix");
        test.done();
    },

    "now from now" : function(test) {
        test.expect(1);
        test.equal(moment().fromNow(), "hace unos segun***REMOVED***",  "now from now should display as in the past");
        test.done();
    },

    "fromNow" : function(test) {
        test.expect(2);
        test.equal(moment().add({s:30}).fromNow(), "en unos segun***REMOVED***", "en unos segun***REMOVED***");
