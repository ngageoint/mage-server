...
exports["lang:pt-br"] = {
    ...
    "from" : function(test) {
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({s:44}), true),  "segun***REMOVED***",    "44 seconds = seconds");
    ...
    "suffix" : function(test) {
        ...
        test.equal(moment(30000).from(0), "em segun***REMOVED***", "prefix");
        test.equal(moment(0).from(30000), "segun***REMOVED*** atrás", "suffix");
        test.done();
    },
    ...
    "fromNow" : function(test) {
        ...
        test.equal(moment().add({s:30}).fromNow(), "em segun***REMOVED***", "in seconds");
