...
exports["lang:gl"] = {
    ...
    "from" : function(test) {
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({s:44}), true),  "uns segun***REMOVED***", "44 seconds = a few seconds");
    ...
    "suffix" : function(test) {
        ...
        test.equal(moment(30000).from(0), "nuns segun***REMOVED***",  "prefix");
        test.equal(moment(0).from(30000), "hai uns segun***REMOVED***", "suffix");
        test.done();
    },

    "now from now" : function(test) {
        test.expect(1);
        test.equal(moment().fromNow(), "hai uns segun***REMOVED***",  "now from now should display as in the past");
        test.done();
    },

    "fromNow" : function(test) {
        test.expect(2);
        test.equal(moment().add({s:30}).fromNow(), "nuns segun***REMOVED***", "en unos segun***REMOVED***");
