...
exports["lang:tzm-la"] = {
    ...
    "from" : function(test) {
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({m:90}), true),  "2 t***REMOVED***aɛin",       "90 minutes = 2 hours");
        test.equal(start.from(moment([2007, 1, 28]).add({h:5}), true),   "5 t***REMOVED***aɛin",       "5 hours = 5 hours");
        test.equal(start.from(moment([2007, 1, 28]).add({h:21}), true),  "21 t***REMOVED***aɛin",      "21 hours = 21 hours");
        test.equal(start.from(moment([2007, 1, 28]).add({h:22}), true),  "***REMOVED***",         "22 hours = a day");
        test.equal(start.from(moment([2007, 1, 28]).add({h:35}), true),  "***REMOVED***",         "35 hours = a day");
        test.equal(start.from(moment([2007, 1, 28]).add({h:36}), true),  "2 ossan",        "36 hours = 2 days");
        test.equal(start.from(moment([2007, 1, 28]).add({d:1}), true),   "***REMOVED***",         "1 day = a day");
    ...
    "calendar day" : function(test) {
        ...
        test.equal(moment(a).subtract({ d: 1 }).calendar(),  "***REMOVED***ant g 02:00", "yesterday at the same time");
        test.done();
    },
