...
exports.lang = {
    ...
    "library langData" : function (test) {
        ...
        test.equal(moment.langData(moment().lang('es')).months(jan), 'enero', "if you p***REMOVED*** in a moment it uses the moment's language");
    ...
    "duration lang method" : function (test) {
        ...
        test.equal(moment.duration({seconds:  44}).lang('es').humanize(), 'unos segun***REMOVED***', 'Use the instance specific language');
    ...
    "duration lang persists with cloning" : function (test) {
        ...
        test.equal(b.humanize(), 'unos segun***REMOVED***', 'using moment.duration()');
        test.done();
    },
