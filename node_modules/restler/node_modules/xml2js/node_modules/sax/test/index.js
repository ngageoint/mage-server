...
// otherwise, it's ***REMOVED***umed that the test will write and close.
exports.test = function test (options) {
  ...
  sax.EVENTS.forEach(function (ev) {
    parser["on" + ev] = function (n) {
      ...
      ***REMOVED***ert.ok( e < expect.length,
      ...
      ***REMOVED***ert.equal(ev, expect[e][0],
        "expectation #"+e+"\n"+
        "Didn't get expected event\n"+
        "expect: "+expect[e][0] + " " +util.inspect(expect[e][1])+"\n"+
        "actual: "+ev+" "+inspected+"\n")
      if (ev === "error") ***REMOVED***ert.equal(n.message, expect[e][1])
      else ***REMOVED***ert.deepEqual(n, expect[e][1],
        "expectation #"+e+"\n"+
...
if (module === require.main) {
  ...
  fs.readdir(__dirname, function (error, files) {
    ...
    if (!failures) return console.log("#all p***REMOVED***")
