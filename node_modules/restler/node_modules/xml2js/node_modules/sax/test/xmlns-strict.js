...
require(__dirname).test
  ( { xml :
    ...
    , expect :
      ...
      , [ "opennamespace", { prefix: "a", uri: "uri:***REMOVED***" } ]

      , [ "attribute", { name: "xmlns:a", value: "uri:***REMOVED***", prefix: "xmlns", local: "a", uri: "http://www.w3.org/2000/xmlns/" } ]

      , [ "opentag", { name: "ns2", prefix: "", local: "ns2", uri: "",
            attributes: { "xmlns:a": { name: "xmlns:a", value: "uri:***REMOVED***", prefix: "xmlns", local: "a", uri: "http://www.w3.org/2000/xmlns/" } },
            ns: { a: "uri:***REMOVED***" }, isSelfClosing: false } ]
      ...
      , [ "attribute", { name: "a:attr", value: "namespaced", prefix: "a", local: "attr", uri: "uri:***REMOVED***" } ]
      , [ "opentag", { name: "a:ns", prefix: "a", local: "ns", uri: "uri:***REMOVED***",
            attributes: { "a:attr": { name: "a:attr", value: "namespaced", prefix: "a", local: "attr", uri: "uri:***REMOVED***" } },
            ns: { a: 'uri:***REMOVED***' },
            isSelfClosing: true } ]
      , [ "closetag", "a:ns" ]
      ...
      , [ "closenamespace", { prefix: "a", uri: "uri:***REMOVED***" } ]
