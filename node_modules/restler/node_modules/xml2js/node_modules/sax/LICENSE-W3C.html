     ...
     @import url("/2008/site/css/advanced");
         ...
         <div id="w3c_mast">
            <h1 cl***REMOVED***="logo">
               ...
               <span cl***REMOVED***="alt-logo">W3C</span>
            </h1>
            ...
            <div id="w3c_nav">
               ...
               <form action="/Help/search" method="get" enctype="application/x-www-form-urlencoded"><div cl***REMOVED***="w3c_sec_nav"><!-- --></div><ul cl***REMOVED***="main_nav"><li cl***REMOVED***="first-item">
                        <a href="/standards/">Standards</a>
                     </li><li>
                        <a href="/participate/">Participate</a>
                     </li><li>
                        <a href="/Consortium/membership">Membership</a>
                     </li><li cl***REMOVED***="last-item">
                        <a href="/Consortium/">About W3C</a>
                     </li><li cl***REMOVED***="search-item">
                        <div id="search-form">
                           <input tabindex="3" cl***REMOVED***="text" name="q" value="" title="Search" type="text" />
                           <button id="search-submit" name="search-submit" type="submit"><img cl***REMOVED***="submit" src="/2008/site/images/search-button" alt="Search" width="21" height="17" /></button>
                        </div>
                     </li></ul></form>
            </div>
         ...
         <div id="w3c_main">
            <div id="w3c_logo_shadow" cl***REMOVED***="w3c_leftCol">
               <img height="32" alt="" src="/2008/site/images/logo-shadow" />
            </div>
            
            <div cl***REMOVED***="w3c_leftCol"><h2 cl***REMOVED***="offscreen">Site Navigation</h2>
    <h3 cl***REMOVED***="category"><span cl***REMOVED***="ribbon"><a href="/Consortium/Legal/ipr-notice.html" title="Up to Policies and Legal Information">Policies and Legal Information <img src="/2008/site/images/header-link" alt="Header link" width="13" height="13" cl***REMOVED***="header-link" /></a></span></h3>
       <ul cl***REMOVED***="theme">
        ...
        <li><a cl***REMOVED***="current">W3C Software Notice and License</a></li>
       ...
       <br /></div>
            <div cl***REMOVED***="w3c_mainCol">
               <div id="w3c_crumbs">
       <div id="w3c_crumbs_frame">
        <ul cl***REMOVED***="bct"> <!-- .bct / Breadcrumbs -->
          <li cl***REMOVED***="skip"><a tabindex="1" accesskey="2" title="Skip to content (e.g., when browsing via audio)" href="#w3c_content_body">Skip</a></li>
          <li><a href="/">W3C</a>&#xA0;<span cl***REMOVED***="cr">&#xBB;</span>&#xA0;</li>
          <li><a href="/Consortium/">About&#xA0;W3C</a>&#xA0;<span cl***REMOVED***="cr">&#xBB;</span>&#xA0;</li>
          <li><a href="/Consortium/facts.html">Facts&#xA0;About&#xA0;W3C</a>&#xA0;<span cl***REMOVED***="cr">&#xBB;</span>&#xA0;</li>
          <li><a href="/Consortium/Legal/ipr-notice.html">Policies&#xA0;and&#xA0;Legal&#xA0;Information</a>&#xA0;<span cl***REMOVED***="cr">&#xBB;</span>&#xA0;</li>
          <li cl***REMOVED***="current">W3C Software Notice and License</li>
        </ul>            
     </div>
    </div>
               <h1 cl***REMOVED***="title">W3C Software Notice and License</h1>
               <div id="w3c_content_body">
                  <div cl***REMOVED***="line">
                     <p cl***REMOVED***="intro tPadding">This work (and included software, documentation such as READMEs, or other
related items) is being provided by the copyright holders under the following
license.</p>
<h2>License</h2>
                     
                     <p cl***REMOVED***="tPadding">
...
modifications:</p>
                     ...
                     <ul cl***REMOVED***="show_items"><li>The full text of this NOTICE in a location viewable to users of the
...
prior permission. Title to copyright in this software and any ***REMOVED***ociated
...
Software Foundation's ***REMOVED***essment of GPL compatibility</a> and <a href="http://www.opensource.org/licenses/W3C.php">OSI's certification</a>
...
Definition</a>.</p>
         ...
         <div id="w3c_footer-inner">
            <h2 cl***REMOVED***="offscreen">Footer Navigation</h2>
            <div cl***REMOVED***="w3c_footer-nav">
               <h3>Navigation</h3>
               <ul cl***REMOVED***="footer_top_nav"><li>
                     <a href="/">Home</a>
                  </li><li>
                     <a href="/standards/">Standards</a>
                  </li><li>
            ...
            <div cl***REMOVED***="w3c_footer-nav">
               <h3>Contact W3C</h3>
               <ul cl***REMOVED***="footer_bottom_nav"><li>
            ...
            <div cl***REMOVED***="w3c_footer-nav">
               <h3>W3C Updates</h3>
               <ul cl***REMOVED***="footer_follow_nav"><li>
                     <a href="http://twitter.com/W3C" title="Follow W3C on Twitter">
                        <img src="/2008/site/images/twitter-bird" alt="Twitter" width="78" height="83" cl***REMOVED***="social-icon" />
                     </a>
                     <a href="http://identi.ca/w3c" title="See W3C on Identica">
                        <img src="/2008/site/images/identica-logo" alt="Identica" width="91" height="83" cl***REMOVED***="social-icon" />
                     </a>
                  </li></ul>
            </div>
            <p cl***REMOVED***="copyright">Copyright &#xA9; 2012 W3C <sup>&#xAE;</sup> (<a href="http://www.csail.mit.edu/">
                  <acronym title="M***REMOVED***achusetts Institute of Technology">MIT</acronym>
