...
(function() {
  ...
  exports.Parser = (function(_super) {
    ...
    function Parser(opts) {
      ...
      this.***REMOVED***ignOrPush = __bind(this.***REMOVED***ignOrPush, this);
      var key, value, _ref;
    ...
    Parser.prototype.***REMOVED***ignOrPush = function(obj, key, newValue) {
      if (!(key in obj)) {
    ...
    Parser.prototype.reset = function() {
        ...
        if (!_this.options.ignoreAttrs) {
          ...
          for (key in _ref) {
            ...
            if (_this.options.mergeAttrs) {
              _this.***REMOVED***ignOrPush(obj, key, newValue);
            } else {
      ...
      this.saxParser.onclosetag = function() {
        ...
        if (stack.length > 0) {
          return _this.***REMOVED***ignOrPush(s, nodeName, obj);
        } else {
