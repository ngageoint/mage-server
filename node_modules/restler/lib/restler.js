...
mixin(Request.prototype, {
  ...
  _applyBasicAuth: function() {
    ...
    if (this.url.auth) {
      ...
      this.options.p***REMOVED***word = authParts[1];
    }

    if (this.options.username && this.options.p***REMOVED***word !== undefined) {
      var b = new Buffer([this.options.username, this.options.p***REMOVED***word].join(':'));
...
function ***REMOVED***(constructor, defaults, methods) {
