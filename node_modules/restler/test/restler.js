...
nodeunit.***REMOVED***ert.re = function(actual, expected, message) {
  if (!new RegExp(expected).test(actual)) {
    nodeunit.***REMOVED***ert.fail(actual, expected, message, '~=', nodeunit.***REMOVED***ert.re);
  }
};
...
module.exports['Basic'] = {
  ...
  'Should send basic auth': function(test) {
    rest.post(host, { username: 'danwrong', p***REMOVED***word: 'flange' }).on('complete', function(data) {
      test.re(data, /authorization\: Basic ZGFud3Jvbmc6Zmxhbmdl/, 'should have "authorization "header');
      test.done();
    });
  },

  'Should send basic auth with blank p***REMOVED***word': function(test) {
    rest.post(host, { username: 'danwrong', p***REMOVED***word: '' }).on('complete', function(data) {
...
module.exports['Deserialization'] = {
  ...
  'Should post and parse JSON': function(test) {
    var obj = { ***REMOVED*** : 'very ***REMOVED*** string' };
    rest.post(host + '/push-json', {
      ...
      test.equal(obj.***REMOVED***, data.***REMOVED***, 'returned: ' + util.inspect(data));
      test.done();
    });
  },
