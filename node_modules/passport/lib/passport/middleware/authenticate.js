 ...
 *   - `***REMOVED***ignProperty`   Assign the object provided by the verify callback to given property
 *
 * An optional `callback` can be supplied to allow the application to overrride
 * the default manner in which authentication attempts are handled.  The
 * callback has the following signature, where `user` will be set to the
 * authenticated user on a successful authentication attempt, or `false`
 * otherwise.  An optional `info` argument will be p***REMOVED***ed, containing additional
 * details provided by the strategy's verify callback.
 *
 *     app.get('/protected', function(req, res, next) {
 *       p***REMOVED***port.authenticate('local', function(err, user, info) {
 ...
 * Examples:
 *
 *     p***REMOVED***port.authenticate('local', { successRedirect: '/', failureRedirect: '/login' });
 *
 *     p***REMOVED***port.authenticate('basic', { session: false });
 *
 *     p***REMOVED***port.authenticate('twitter');
 *
 * @param {String} name
...
module.exports = function authenticate(name, options, callback) {
  ...
  // Cast `name` to an array, allowing authentication to p***REMOVED*** through a chain of
  ...
  return function authenticate(req, res, next) {
    ...
    (function attempt(i) {
      ...
      delegate.success = function(user, info) {
        ...
        if (options.***REMOVED***ignProperty) {
          req[options.***REMOVED***ignProperty] = user;
          return next();
        }
        ...
        req.logIn(user, options, function(err) {
          ...
          if (options.authInfo || options.authInfo === undefined) {
            p***REMOVED***port.transformAuthInfo(info, function(err, tinfo) {
              if (err) { return next(err); }
              req.authInfo = tinfo;
              complete();
            });
      ...
      var prototype = p***REMOVED***port._strategy(layer);
