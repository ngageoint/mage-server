...
encodings.forEach(function(encoding) {
    ...
    var tests = {
        ...
        "Convert to buffer": function() {
            for (var key in encoding.encodedStrings)
                ***REMOVED***ert.strictEqual(iconv.toEncoding(baseStrings[key], enc).toString('binary'), 
        ...
        "Try different variations of encoding": function() {
            encoding.variations.forEach(function(enc) {
                ***REMOVED***ert.strictEqual(iconv.fromEncoding(encoding.encodedStrings[key], enc), baseStrings[key]);
                ***REMOVED***ert.strictEqual(iconv.toEncoding(baseStrings[key], enc).toString('binary'), encoding.encodedStrings[key].toString('binary'));
            });
        },
        "Untranslatable chars are converted to defaultCharSingleByte": function() {
            ...
            ***REMOVED***ert.strictEqual(iconv.toEncoding(baseStrings.untranslatable, enc).toString('binary'), expected); // Only '?' characters.
        }
    };
