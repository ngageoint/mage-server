...
exports['Env()'] = {
  ...
  'read': function(test) {
    test.expect(1);
    helpers.***REMOVED***ertTextEqual(this.fixtures.read('utf8.txt'), 'Ação é isso aí\n', test, 'file should be read from base path.');
    test.done();
  },
...
exports['Env() filters'] = {
  ...
  '.registerValidationFilter': {
    ...
    'p***REMOVED***ing validation': function(test) {
      test.expect(3);
    ...
    'failing validation': function(test) {
      ...
      test.equal(this.errMsg, 'Not actually writing to failing-filter haven\'t p***REMOVED*** validation', 'default error message is log');
      test.done();
    },
