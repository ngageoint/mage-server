...
crc32-stream is a streaming CRC32 checksumer. It uses [buffer-crc32](https://www.npmjs.org/package/buffer-crc32) behind the scenes to reliably handle binary data and fancy character sets. Data is p***REMOVED***ed through untouched.
...
Returns the raw size/length of p***REMOVED***ed-through data.

### Instance Options

Inherits [Transform Stream](http://nodejs.org/api/stream.html#stream_cl***REMOVED***_stream_transform) options.
