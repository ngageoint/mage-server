...
var tests = [
  ...
  { source: ['foo&bar=baz'],
    expected: [['foo', '', false, false],
               ['bar', 'baz', false, false]],
    what: 'Un***REMOVED***igned and ***REMOVED***igned value'
  },
  { source: ['foo=bar&baz'],
    expected: [['foo', 'bar', false, false],
               ['baz', '', false, false]],
    what: 'Assigned and un***REMOVED***igned value'
  },
  { source: ['foo=bar&baz=bla'],
    expected: [['foo', 'bar', false, false],
               ['baz', 'bla', false, false]],
    what: 'Two ***REMOVED***igned values'
  },
  { source: ['foo&bar'],
    expected: [['foo', '', false, false],
               ['bar', '', false, false]],
    what: 'Two un***REMOVED***igned values'
  },
  { source: ['foo&bar&'],
    expected: [['foo', '', false, false],
               ['bar', '', false, false]],
    what: 'Two un***REMOVED***igned values and ampersand'
  },
  ...
  { source: ['foo=bar%20baz%21&num=1000'],
    ...
    what: 'Two ***REMOVED***igned values, one with encoded bytes'
  },
  { source: ['foo=bar&baz=bla'],
    expected: [],
...
function next() {
  ...
  busboy.on('finish', function() {
    ***REMOVED***ert(finishes++ === 0, makeMsg(v.what, 'finish emitted multiple times'));
    ***REMOVED***ert.deepEqual(results.length,
                     v.expected.length,
...
process.on('exit', function() {
  ***REMOVED***ert(t === tests.length, makeMsg('_exit', 'Only finished ' + t + '/' + tests.length + ' tests'));
});
