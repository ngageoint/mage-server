...
[
  ...
  parser.on('header', function(header) {
    ***REMOVED***ert(!fired, errPrefix + 'Header event fired more than once');
    fired = true;
    ***REMOVED***ert.deepEqual(header, v.expected, errPrefix + 'Parsed result mismatch');
  });
  ...
  ***REMOVED***ert(fired, errPrefix + 'Did not receive header from parser');
});