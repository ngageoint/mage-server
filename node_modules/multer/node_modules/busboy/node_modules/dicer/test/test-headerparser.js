...
[
  ...
  parser.on('header', function(header) {
    ***REMOVED***ert(!fired, makeMsg(v.what, 'Header event fired more than once'));
    fired = true;
    ***REMOVED***ert.deepEqual(header,
                     v.expected,
  ...
  ***REMOVED***ert(fired, makeMsg(v.what, 'Did not receive header from parser'));
});
