...
wows.describe('XML attrs').addBatch({
    "set attribute":function(){
    	...
    	console.***REMOVED***ert(root.attributes[0].localName == 'a');
    	root.setAttribute('b',2);
    	root.setAttribute('a',1);
    	root.setAttribute('a',1);
    	root.setAttribute('a',1);
    	console.***REMOVED***ert(root.attributes.length == 2);
    	try {
    		var c = root.ownerDocument.createElement('c');
    		c.setAttributeNode(root.attributes.item(0));
    	} catch (e) {
    		console.***REMOVED***ert(e.code == 10);
    		return;
    	}
    	console.***REMOVED***ert(false);
    },
    "set ns attribute":function(){
    	...
    	console.***REMOVED***ert(child.attributes.length == 3,child.attributes.length,child+'');
    	child.setAttribute('a',1);
    	child.setAttributeNS('b','b:b','2');
    	console.***REMOVED***ert(child.attributes.length == 4,child.attributes.length);
    	try {
    		var c = root.ownerDocument.createElement('c');
    ...
    "override attribute":function(){
    	...
    	console.***REMOVED***ert(root.attributes.length == 4,root.attributes.length);
//not standart
//    	root.firstChild.setAttributeNode(root.attributes[0]);
//    	console.***REMOVED***ert(root.attributes.length == 0);
    },
    "attribute namespace":function(){
    	...
    	console.***REMOVED***ert(root.getAttributeNS("a", "b"), "e");
    },
