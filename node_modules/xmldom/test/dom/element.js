...
wows.describe('XML Namespace Parse').addBatch({
    ...
    "Document_getElementsByTagName":function () {
    	...
    	console.***REMOVED***ert(doc.getElementsByTagName('*').length == 2);
    	console.***REMOVED***ert(doc.documentElement.getElementsByTagName('*').length == 1);
    },
    'getElementsByTagName': function () { 
       ...
       console.***REMOVED***ert(childs.item(0).getAttribute('attr')=="1",childs.item(0)+'');
       console.***REMOVED***ert(childs.item(1).getAttribute('attr')=="2",childs.item(1)+'');
       console.***REMOVED***ert(childs.item(2).getAttribute('attr')=="3",childs.item(2)+'');
       console.***REMOVED***ert(childs.length==3,3,childs.length);
       ...
       console.***REMOVED***ert(childs.length==7,childs.length,buf);
    ...
    'getElementsByTagNameNS': function () { 
       ...
       console.***REMOVED***ert(childs.length==6,childs.length);
       
        var childs = doc.getElementsByTagNameNS("http://test.com",'*');
       console.***REMOVED***ert(childs.length==7,childs.length);
       
       
       var childs = doc.documentElement.getElementsByTagNameNS("http://test.com",'test');
       console.***REMOVED***ert(childs.length==3,childs.length);
    ...
    'getElementById': function () { 
       ...
       console.***REMOVED***ert(doc.getElementById('root'))
       console.***REMOVED***ert(doc.getElementById('a1').getAttribute('title')=="1",doc.getElementById('a1'));
       console.***REMOVED***ert(doc.getElementById('a2').getAttribute('title')=="2",doc.getElementById('a2'));
       console.***REMOVED***ert(doc.getElementById('a2').getAttribute('title2')=="",doc.getElementById('a2'));
    },
    "append exist child":function(){
       var doc = new DOMParser().parseFromString('<xml xmlns="http://test.com" id="root">' +
       	...
       	console.***REMOVED***ert(str1 == str2 && str2 == str3,str3,str1);
       	console.***REMOVED***ert(str3 != str4 && str3.length == str4.length,str3);
    ...
    "append exist other child":function(){
    	var doc = new DOMParser().parseFromString('<xml xmlns="http://test.com" id="root">' +
       	...
       	console.***REMOVED***ert(doc2.documentElement.lastChild.childNodes.length == 0);
       	doc2.documentElement.appendChild(doc2.documentElement.firstChild.firstChild);
       	
       	var str2=new XMLSerializer().serializeToString(doc2);
       	
       	console.***REMOVED***ert(doc2.documentElement.lastChild.childNodes.length == 1);
       	console.***REMOVED***ert(str1 != str2 && str1.length != str2.length,str3);
    ...
    "set textContent":function() {
        ...
        var b = a.nextSibling;
        a.textContent = 'hello';
        console.***REMOVED***ert(doc.documentElement.toString() == '<test><a>hello</a><b><c/></b></test>');
        b.textContent = 'there';
        console.***REMOVED***ert(doc.documentElement.toString() == '<test><a>hello</a><b>there</b></test>');
        b.textContent = '';
        console.***REMOVED***ert(doc.documentElement.toString() == '<test><a>hello</a><b/></test>');
        doc.documentElement.textContent = 'bye';
        console.***REMOVED***ert(doc.documentElement.toString() == '<test>bye</test>');
    },
