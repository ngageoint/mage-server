  ...
  "An instance of the File Transport": {
    "when p***REMOVED***ed a valid filename": {
      ...
      "should be a valid transporter": function (transportTest) {
        helpers.***REMOVED***ertFile(transportTest);
      },
      "should set the maxFiles option correctly": function (transportTest) {
        ***REMOVED***ert.isNumber(transportTest.maxFiles);
      }
    },
    "when delete old test files": {
      ...
      "and when p***REMOVED***ed more files than the maxFiles": {
        topic: function () {
          var that = this,
              created = 0;
        ...
        "should be only 3 files called 5.log, 4.log and 3.log": function () {
          for (var num = 0; num < 6; num++) {
            ...
            if (num >= 0 && num < 3) {
              return ***REMOVED***ert.throws(function () {
                fs.statSync(file);
              }, Error);
            } 
        ...
        "should have the correct content": function () {
          ['D', 'E', 'F'].forEach(function (name, inx) {
            ...
            ***REMOVED***ert.lengthOf(content.match(new RegExp(name, 'g')), 4068);
          });
        }
      }
    }
