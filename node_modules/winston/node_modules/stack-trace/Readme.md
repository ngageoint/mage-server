...
require('***REMOVED***ert').strictEqual(trace[0].getFileName(), __filename);
```
...
When p***REMOVED***ing a function on the current stack as the `belowFn` parameter, the
...
> * **getTypeName**: returns the type of this as a string. This is the name of the function stored in the constructor field of this, if available, otherwise the object's [[Cl***REMOVED***]] internal property.
