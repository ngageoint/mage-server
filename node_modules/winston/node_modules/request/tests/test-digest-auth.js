...
request({
  ...
  ***REMOVED***ert.equal(response.statusCode, 200);
  ***REMOVED***ert.equal(numDigestRequests, 2);
  ...
  request({
    ...
    ***REMOVED***ert.equal(response.statusCode, 401);
    ***REMOVED***ert.equal(numDigestRequests, 3);
