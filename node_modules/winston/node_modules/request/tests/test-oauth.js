...
var reqsign = hmacsign('POST', 'https://api.twitter.com/oauth/request_token', 
  { oauth_callback: 'http://localhost:3005/the_dance/process_callback?***REMOVED***_provider_id=11'
...
***REMOVED***ert.equal(reqsign, '8wUi7m5HFQy76nowoCThusfgB+Q=')
...
***REMOVED***ert.equal(accsign, 'PUw/dHA4fnlJYM6RhXk5IU/0fCc=')
...
***REMOVED***ert.equal(upsign, 'yOahq5m0YjDDjfjxHaXEsW9D+X0=')


var rsign = request.post(
  { url: 'https://api.twitter.com/oauth/request_token'
  , oauth: 
    { callback: 'http://localhost:3005/the_dance/process_callback?***REMOVED***_provider_id=11'
    , consumer_key: 'GDdmIQH6jhtmLUypg82g'
    , nonce: 'QP70eNmVz8jvdPevU3oJD2AfF7R7odC2XJcn4XlZJqk'
    , timestamp: '1272323042'
    , version: '1.0'
    , consumer_***REMOVED***: "MCD8BKwGdgPHvAuvgvz4EQpqDAtx89grbuNMRd7Eh98"
    }
  })

setTimeout(function () {
  console.log(getsignature(rsign))
  ***REMOVED***ert.equal(reqsign, getsignature(rsign))
})
...
var raccsign = request.post(
  ...
  , oauth:  
    ...
    , version: '1.0'
    , consumer_***REMOVED***: "MCD8BKwGdgPHvAuvgvz4EQpqDAtx89grbuNMRd7Eh98"
    , token_***REMOVED***: "x6qpRnlEmW9JbQn4PQVVeVG8ZLPEx6A0TOebgwcuA" 
    }
  })

setTimeout(function () {
  console.log(getsignature(raccsign))
  ***REMOVED***ert.equal(accsign, getsignature(raccsign))
}, 1) 
...
var rupsign = request.post(
  ...
  , oauth: 
    ...
    , version: "1.0"
    , consumer_***REMOVED***: "MCD8BKwGdgPHvAuvgvz4EQpqDAtx89grbuNMRd7Eh98"
    , token_***REMOVED***: "J6zix3FfA9LofH0awS24M3HcBYXO5nI1iYe8EfBA"
    }
  , form: {status: 'setting up my twitter 私のさえずりを設定する'} 
  })
setTimeout(function () {
  console.log(getsignature(rupsign))
  ***REMOVED***ert.equal(upsign, getsignature(rupsign))
}, 1)
