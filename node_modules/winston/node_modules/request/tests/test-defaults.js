...
s.listen(s.port, function () {
  ...
  s.on('/get', function (req, resp) {
    ***REMOVED***ert.equal(req.headers.foo, 'bar');
    ***REMOVED***ert.equal(req.method, 'GET')
  ...
  request.defaults({headers:{foo:"bar"}})(s.url + '/get', function (e, r, b){
    if (e) throw e;
    ***REMOVED***ert.deepEqual("TESTING!", b);
    counter += 1;
  });

  s.on('/post', function (req, resp) {
    ***REMOVED***ert.equal(req.headers.foo, 'bar');
    ***REMOVED***ert.equal(req.headers['content-type'], null);
    ***REMOVED***ert.equal(req.method, 'POST')
  ...
  request.defaults({headers:{foo:"bar"}}).post(s.url + '/post', {json: true}, function (e, r, b){
    if (e) throw e;
    ***REMOVED***ert.deepEqual('bar', b.foo);
    counter += 1;
  });
  ...
  s.on('/patch', function (req, resp) {
    ***REMOVED***ert.equal(req.headers.foo, 'bar');
    ***REMOVED***ert.equal(req.headers['content-type'], null);
    ***REMOVED***ert.equal(req.method, 'PATCH')
    resp.writeHead(200, {'Content-Type': 'application/json'});
    resp.end(JSON.stringify({foo:'bar'}));
  });
  ...
  s.on('/post-body', function (req, resp) {
    ***REMOVED***ert.equal(req.headers.foo, 'bar');
    ***REMOVED***ert.equal(req.headers['content-type'], 'application/json');
    ***REMOVED***ert.equal(req.method, 'POST')
    resp.writeHead(200, {'Content-Type': 'application/json'});
    resp.end(JSON.stringify({foo:'bar'}));
  });
  ...
  s.on('/del', function (req, resp) {
    ***REMOVED***ert.equal(req.headers.foo, 'bar');
    ***REMOVED***ert.equal(req.method, 'DELETE')
    resp.writeHead(200, {'Content-Type': 'application/json'});
    resp.end(JSON.stringify({foo:'bar'}));
  });
  ...
  s.on('/head', function (req, resp) {
    ***REMOVED***ert.equal(req.headers.foo, 'bar');
    ***REMOVED***ert.equal(req.method, 'HEAD')
    resp.writeHead(200, {'Content-Type': 'text/plain'});
    resp.end();
  });
  ...
  s.on('/get_custom', function(req, resp) {
    ***REMOVED***ert.equal(req.headers.foo, 'bar');
    ***REMOVED***ert.equal(req.headers.x, 'y');
    resp.writeHead(200, {'Content-Type': 'text/plain'});
    resp.end();
  });
  ...
  ***REMOVED***ert.throws(function() {
  ...
  defaultRequest.get(s.url + '/get_custom', function(e, r, b) {
    if(e) throw e;
    counter += 1;
    console.log(counter.toString() + " tests p***REMOVED***ed.");
    s.close();
  });
})
