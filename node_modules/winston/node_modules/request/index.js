...
Request.prototype.init = function (options) {
  ...
  if (options.auth) {
    self.auth(
      ...
      options.auth.p***REMOVED*** || options.auth.p***REMOVED***word,
...
Request.prototype.auth = function (user, p***REMOVED***, sendImmediately) {
  if (typeof user !== 'string' || typeof p***REMOVED*** !== 'string') {
  ...
  if (sendImmediately || typeof sendImmediately == 'undefined') {
    this.setHeader('authorization', 'Basic ' + toBase64(user + ':' + p***REMOVED***))
    this._sentAuth = true
  }
  return this
}
