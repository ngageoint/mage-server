...
exports = module.exports = internals.Boom = function (/* (new Error) or (code, message) */) {
    ...
    Hoek.***REMOVED***ert(this.constructor === internals.Boom, 'Error must be instantiated using new');
    ...
    if (arguments[0] instanceof Error) {
        ...
        Hoek.***REMOVED***ert(!isNaN(parseFloat(code)) && isFinite(code) && code >= 400, 'First argument must be a number (400+)');
...
internals.Boom.p***REMOVED***Through = function (code, payload, contentType, headers) {

    var err = new internals.Boom(500, 'P***REMOVED***-through');                                      // 500 code is only used to initialize
