...
-----
    ...
    inspect(something); // inspect with the settings p***REMOVED***ed to `inspector`
...
you can p***REMOVED*** a _label_ to `inspect()`, to keep track of your inspections:
...
You can overwrite them with your own, by p***REMOVED***ing a similar object to `inspector()` or `inspect()`.
