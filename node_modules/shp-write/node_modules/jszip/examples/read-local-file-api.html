    ...
    $("#file").on("change", function(evt) {
      ...
      for (var i = 0, f; f = files[i]; i++) {
        ...
        if (f.type !== "application/zip") {
          $result.append("<div cl***REMOVED***='warning'>" + f.name + " isn't a 'application/zip', opening it as a zip file may not work :-)</div>");
        }
        ...
        reader.onload = (function(theFile) {
          return function(e) {
            ...
            try {
              ...
              $ul.append("<li cl***REMOVED***='error'>Error reading " + theFile.name + " : " + e.message + "</li>");
            }
            $result.append($ul);
          }
        })(f);
...
<p cl***REMOVED***="note">Note : your browser will process the zip file, don't choose a file too big !</p>
