...
<title>JSZip: JavaScript zip cl***REMOVED***</title>
...
<div cl***REMOVED***="container_12">
   <div id="header" cl***REMOVED***="grid_12">
   <div cl***REMOVED***="alpha grid_5">
    <h1>JS<span style="font-weight:100">Zip</span></h1>
    Create, read and edit .zip files with Javascript
   </div>
   </div>

   <div id="how" cl***REMOVED***="grid_5 border">
      <h2>How?</h2>
      <textarea id="demo-code" rows="7" cl***REMOVED***="grid_5 alpha omega" spellcheck="false">
var zip = new JSZip();
...
location.href="data:application/zip;base64,"+content;
   ...
   <div id="why" cl***REMOVED***="grid_4 border">
      <h2>Why?</h2>
      <ol>
   ...
   <div id="where" cl***REMOVED***="grid_3">
      <h2>Where?</h2>
      <p>
      <a href="http://github.com/Stuk/jszip/zipball/master" cl***REMOVED***="download grid_3 alpha omega">Download</a>
   ...
   <hr/>
   <div cl***REMOVED***="grid_9 border">
      <h2>Tell me more!</h2>

      <h3>Browser support</h3>
      <table cellspacing="0" cl***REMOVED***="browser_support">
         <tr><th cl***REMOVED***="op">Opera</th> <th cl***REMOVED***="ff">Firefox</th> <th cl***REMOVED***="sf">Safari</th> <th cl***REMOVED***="cr">Chrome</th> <th cl***REMOVED***="ie">Internet Explorer</th> </tr>
      ...
      <p>Downloadify uses a small Flash SWF to download files to a user's computer with a filename that you can choose. Doug Neiner has added the <code>dataType</code> option to allow you to p***REMOVED*** a zip for downloading. Follow the <a href="http://downloadify.info/downloadify/test.html">Downloadify demo</a> with the following changes:</p>
      <pre cl***REMOVED***="example">
zip = new JSZip();
...
myLink.download = "myFile.zip";</pre>
      ...
      <dl>
        ...
        <dd><code>options</code> (Object) options to p***REMOVED*** to the <a href="#doc_load_data_options"><code>load()</code></a> method..</dd>
        <dt>Returns : </dt>
        <dd>A new JSZip.</dd>
      </dl>
      <pre cl***REMOVED***="example">
...
zip.load(zipDataFromXHR);</pre>
      ...
      <ul>
         <li>p***REMOVED***word protected zip</li>
...
zip.filter(function (relativePath, file){
  ...
  return true/false;
      ...
      Cl***REMOVED***ic zip files will work but encrypted zip, multi-volume, etc are not supported
