...
describe('promise', function(){
  ...
  describe('onResolve()', function(){
    ...
    it('after fulfill()', function(done){
      ...
      promise.onResolve(function (err, data){
        ***REMOVED***ert.equal(data,'woot');
        called++;
      });

      promise.onResolve(function (err, data){
        ***REMOVED***ert.strictEqual(err, null);
        called++;
      });
  ...
  describe('onFulfill shortcut', function(){
    it('works', function(done){
      ...
      promise.onFulfill(function (woot) {
        ***REMOVED***ert.strictEqual(woot, undefined);
        called++;
      });
  ...
  describe('return values', function(){
    it('on()', function(done){
      var promise = new Promise()
      ***REMOVED***ert.ok(promise.on('jump', function(){}) instanceof Promise);
      done()
    });

    it('onFulfill()', function(done){
      var promise = new Promise()
      ***REMOVED***ert.ok(promise.onFulfill(function(){}) instanceof Promise);
      done();
    })
    it('onReject()', function(done){
      var promise = new Promise()
      ***REMOVED***ert.ok(promise.onReject(function(){}) instanceof Promise);
      done();
    })
    it('onResolve()', function(done){
      var promise = new Promise()
      ***REMOVED***ert.ok(promise.onResolve(function(){}) instanceof Promise);
      done();
    })
  })
  ...
  describe('then', function(){
    describe('catching', function(){
      ...
      it('can be handled using .end() so no throwing', function (done) {
        ...
        domain.run(function () {
          ...
          p2.end(function (err) {
            ***REMOVED***ert.equal(err, errorSentinal);
            clearTimeout(overTimeout);
            done()
          });
    ...
    it('accepts multiple completion values', function(done){
      ...
      p.then(function (a, b) {
        ***REMOVED***ert.equal(2, arguments.length);
        ***REMOVED***ert.equal('hi', a);
        ***REMOVED***ert.equal(4, b);
        done();
      }, done).end();
