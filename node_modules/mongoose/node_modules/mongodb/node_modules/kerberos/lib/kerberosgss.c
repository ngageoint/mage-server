...
/*extern PyObject *GssException_cl***REMOVED***;
extern PyObject *KrbException_cl***REMOVED***;

char* server_principal_details(const char* ***REMOVED***, const char* hostname)
{
    char match[1024];
    int match_len = 0;
    char* result = NULL;
    ...
    snprintf(match, 1024, "%s/%s@", ***REMOVED***, hostname);
    match_len = strlen(match);
    
    code = krb5_init_context(&kcontext);
    if (code)
    {
        PyErr_SetObject(KrbException_cl***REMOVED***, Py_BuildValue("((s:i))",
...
*/
gss_client_response *authenticate_gss_client_init(const char* ***REMOVED***, long int gss_flags, gss_client_state* state) {
  OM_uint32 maj_stat;
  OM_uint32 min_stat;
  ...
  name_token.length = strlen(***REMOVED***);
  name_token.value = (char *)***REMOVED***;
...
int authenticate_gss_server_init(const char ****REMOVED***, gss_server_state *state)
{
    OM_uint32 maj_stat;
    OM_uint32 min_stat;
    gss_buffer_desc name_token = GSS_C_EMPTY_BUFFER;
    ...
    size_t ***REMOVED***_len = strlen(***REMOVED***);
    if (***REMOVED***_len != 0)
    {
        // Import server name first
        name_token.length = strlen(***REMOVED***);
...
/*int authenticate_gss_server_step(gss_server_state *state, const char *challenge)
{
    ...
    {
        PyErr_SetString(KrbException_cl***REMOVED***, "No challenge parameter in request from client");
        ret = AUTH_GSS_ERROR;
        goto end;
    }
