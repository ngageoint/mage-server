...
exports['exercise all the binary object constructor methods'] = function (test) {
  ...
  test.ok(utils.***REMOVED***ertArrayEqual(array, binary.buffer));
...
exports['exercise the put binary object method for an instance when using Uint8Array'] = function (test) {
  ...
  test.ok(utils.***REMOVED***ertArrayEqual(array, binary.value(true)));
  ...
  test.ok(utils.***REMOVED***ertArrayEqual(['a'.charCodeAt(0)], binary.value(true)));
...
exports['exercise the read binary object method for an instance when using Uint8Array'] = function (test) {      
  ...
  test.ok(utils.***REMOVED***ertArrayEqual(utils.stringToArrayBuffer('he'), data));

  // Read the entire field
  var data = binary.read(0);
  test.ok(utils.***REMOVED***ertArrayEqual(utils.stringToArrayBuffer(string), data));

  // Read 3 bytes
  var data = binary.read(6, 5);
  test.ok(utils.***REMOVED***ertArrayEqual(utils.stringToArrayBuffer('world'), data));
  test.done();
}
