...
exports['Should Correctly Deserialize object'] = function(test) {
  ...
  ***REMOVED***ert.equal("a_1", object.name);
  ***REMOVED***ert.equal(false, object.unique);
  ***REMOVED***ert.equal(1, object.key.a);
  test.done();
}
...
exports['Should Correctly Deserialize object with all types'] = function(test) {
  ...
  ***REMOVED***ert.equal("hello", object.string);
  ***REMOVED***ert.deepEqual([1, 2, 3], object.array);
  ***REMOVED***ert.equal(1, object.hash.a);
  ***REMOVED***ert.equal(2, object.hash.b);
  ***REMOVED***ert.ok(object.date != null);
  ***REMOVED***ert.ok(object.oid != null);
  ***REMOVED***ert.ok(object.binary != null);
  ***REMOVED***ert.equal(42, object.int);
  ***REMOVED***ert.equal(33.3333, object.float);
  ***REMOVED***ert.ok(object.regexp != null);
  ***REMOVED***ert.equal(true, object.boolean);
  ***REMOVED***ert.ok(object.where != null);
  ***REMOVED***ert.ok(object.dbref != null);
  ***REMOVED***ert.ok(object['null'] == null);
  test.done();
}
...
exports['Should Serialize and Deserialize String'] = function(test) {
  ...
  ***REMOVED***ert.deepEqual(test_string, bsonC.deserialize(serialized_data));
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize Integer'] = function(test) {
  ...
  ***REMOVED***ert.deepEqual(test_number, bsonC.deserialize(serialized_data));
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize null value'] = function(test) {
  ...
  var object = bsonC.deserialize(serialized_data);
  ***REMOVED***ert.deepEqual(test_null, object);
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize undefined value'] = function(test) {
  ...
  var object = bsonJS.deserialize(new Buffer(serialized_data, 'binary'));
  ***REMOVED***ert.equal(null, object.doc)
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize Integer'] = function(test) {
  ...
  ***REMOVED***ert.deepEqual(test_int, bsonC.deserialize(serialized_data));
...
exports['Should Correctly Serialize and Deserialize Object'] = function(test) {
  ...
  ***REMOVED***ert.deepEqual(doc, bsonC.deserialize(serialized_data));
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize Oid'] = function(test) {
  ...
  var serialized_data = bsonC.serialize(doc)
  ***REMOVED***ert.deepEqual(doc.doc.toHexString(), bsonC.deserialize(serialized_data).doc.toHexString())
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize Buffer'] = function(test) {
  ...
  ***REMOVED***ert.equal("123451234512345", bsonC.deserialize(serialized_data).doc.buffer.toString('ascii'));
  test.done();
}
...
exports['Should Correctly encode Empty Hash'] = function(test) {
  ...
  ***REMOVED***ert.deepEqual(test_code, bsonC.deserialize(serialized_data));
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize Ordered Hash'] = function(test) {
  ...
  ***REMOVED***ert.deepEqual(['b', 'a', 'c', 'd'], keys)
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize Regular Expression'] = function(test) {
  ...
  ***REMOVED***ert.equal(doc.doc.toString(), doc2.doc.toString())
  test.done();
}
...
exports['Should Correctly Serialize and Deserialize a Binary object'] = function(test) {
  ...
  ***REMOVED***ert.equal(doc.doc.value(), deserialized_data.doc.value())
  test.done();
}
