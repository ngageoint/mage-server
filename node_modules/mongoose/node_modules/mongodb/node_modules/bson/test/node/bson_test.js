...
var ***REMOVED***ertBuffersEqual = function(test, buffer1, buffer2) {  
...
exports['Should Serialize and Deserialize String'] = function(test) {
  ...
  ***REMOVED***ertBuffersEqual(test, serialized_data, serialized_data2, 0);
  test.deepEqual(test_string, new BSONDE.BSON([Long, ObjectID, Binary, Code, DBRef, Symbol, Double, Timestamp, MaxKey, MinKey]).deserialize(serialized_data));
  test.done();
}
...
exports['Should handle complicated all typed object'] = function(test) {
  ...
  ***REMOVED***ertBuffersEqual(test, serialized_data, serialized_data2, 0);
  ...
  for(var i = 0; i < serialized_data2.length; i++) {
    require('***REMOVED***ert').equal(serialized_data2[i], serialized_data[i])      
  }
 ...
 * @ignore
 */
exports['Should correctly m***REMOVED***ive doc'] = function(test) {
...
exports['Should deserialize correctly'] = function(test) {
  var doc = {
   ...
   "links" : [
     "http://www.reddit.com/r/worldnews/comments/kybm0/uk_home_***REMOVED***ary_calls_for_the_s***REMOVED***ping_of_the/"
   ]
  }    
 ...
 * @ignore
 */
 exports['Should correctly deserialize a buffer using the BSON cl***REMOVED*** level parser'] = function(test) {  
  // Create a simple object
