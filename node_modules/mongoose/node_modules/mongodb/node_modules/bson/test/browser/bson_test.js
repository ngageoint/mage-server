this.bson_test = {
    'Full document serialization and deserialization': function (test) {
      ...
      test.ok(***REMOVED***ertArrayEqual(motherOfAllDocuments.binary.value(true), object.binary.value(true)));
    ...
    'exercise all the binary object constructor methods': function (test) {
      ...
      test.ok(***REMOVED***ertArrayEqual(array, binary.buffer));
    ...
    'exercise the put binary object method for an instance when using Uint8Array': function (test) {
      ...
      test.ok(***REMOVED***ertArrayEqual(array, binary.value(true)));
      ...
      test.ok(***REMOVED***ertArrayEqual(['a'.charCodeAt(0)], binary.value(true)));
    ...
    'exercise the read binary object method for an instance when using Uint8Array': function (test) {      
      ...
      test.ok(***REMOVED***ertArrayEqual(stringToArrayBuffer('he'), data));
    
      // Read the entire field
      var data = binary.read(0);
      test.ok(***REMOVED***ertArrayEqual(stringToArrayBuffer(string), data));
    
      // Read 3 bytes
      var data = binary.read(6, 5);
      test.ok(***REMOVED***ertArrayEqual(stringToArrayBuffer('world'), data));
      test.done();
    },
...
var ***REMOVED***ertArrayEqual = function(array1, array2) {
