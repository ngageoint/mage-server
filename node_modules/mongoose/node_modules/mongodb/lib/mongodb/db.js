...
Db.prototype.authenticate = function(username, p***REMOVED***word, options, callback) {
  ...
  if(options.authMechanism == 'MONGODB-CR') {
    mongodb_cr_authenticate(self, username, p***REMOVED***word, authdb, options, callback);
    ...
    if(process.platform == 'win32') {
      mongodb_sspi_authenticate(self, username, p***REMOVED***word, authdb, options, callback);
    } else {
      // We have the kerberos library, execute auth process
      mongodb_gssapi_authenticate(self, username, p***REMOVED***word, authdb, options, callback);      
    }
  }
};
...
var __executeQueryCommand = function(self, db_command, options, callback) {
  ...
  if(typeof callback === 'function' && !onAll) {
    ...
    /*if(connection == null && self.serverConfig.isAutoReconnect()) {
      return self.serverConfig._commandsStore.read_from_writer(
        {   type: 'query'
