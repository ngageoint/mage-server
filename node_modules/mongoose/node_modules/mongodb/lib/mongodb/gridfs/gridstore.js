 ...
 * cl***REMOVED*** offers a simplified api to interact with files while managing the
...
/**
 * A cl***REMOVED*** representation of a file stored in GridFS.
 *
 * Modes
 ...
 *
 * @cl***REMOVED*** Represents the GridStore.
...
var _open = function(self, callback) {
  ...
  // only p***REMOVED*** error to callback once
  function error (err) {
    if(error.err) return;
 ...
 *     method. The object will be p***REMOVED***ed to the first parameter and will have
 *     the structure:
 *
 *        <pre><code>
 *        {
 ...
 * "w" or "w+".
 *
 * @param {Function} callback this will be called after executing this method. P***REMOVED***es an **{Error}** object to the first parameter and null to the second if an error occured. Otherwise, p***REMOVED***es null to the first and a reference to this object to the second.
 * @return {null}
 * @api public
 */
 ...
 *     executing this method. null will be p***REMOVED***ed to the first parameter while
 *     a new {@link Chunk} instance will be p***REMOVED***ed to the second parameter if
 ...
 *
 * @param {Function} callback this will be called after executing this method. An exception object will be p***REMOVED***ed to the first parameter when an error occured or null otherwise. A new **{Collection}** object will be p***REMOVED***ed to the second parameter if no error occured.
 * @return {null}
 * @api public
 */
 ...
 *     executes. P***REMOVED***es null to the first and true to the second argument.
 *
 * @ignore
 * @api private
 */
 ...
 * Deletes all the chunks of this file in the database.
 *
 * @param {Function} callback this will be called after this method executes. P***REMOVED***es null to the first and true to the second argument.
 * @return {null}
 * @api public
 */
...
/**
 * Retrieves the file collection ***REMOVED***ociated with this object.
 *
 * @param {Function} callback this will be called after executing this method. An exception object will be p***REMOVED***ed to the first parameter when an error occured or null otherwise. A new **{Collection}** object will be p***REMOVED***ed to the second parameter if no error occured.
 * @return {null}
 * @api public
 ...
 * @param {Function} callback this will be called after this method is executed. null will be p***REMOVED***ed to the first parameter and a string containing the contents of the buffer concatenated with the contents read from this file will be p***REMOVED***ed to the second.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Function} callback This gets called after this method terminates. null is p***REMOVED***ed to the first parameter and the position is p***REMOVED***ed to the second.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Function} callback this gets called after this method is executed. P***REMOVED***es null to the first parameter and the character read to the second or null to the second if the read/write head is at the end of the file.
 * @return {null}
 * @api public
 */
...
*
* @cl***REMOVED***constant DEFAULT_ROOT_COLLECTION
**/
...
*
* @cl***REMOVED***constant DEFAULT_CONTENT_TYPE
**/
...
*
* @cl***REMOVED***constant IO_SEEK_SET
**/
...
*
* @cl***REMOVED***constant IO_SEEK_CUR
**/
...
*
* @cl***REMOVED***constant IO_SEEK_END
**/
 ...
 * @param {Function} callback this will be called after this method executes. P***REMOVED***es null to the first and p***REMOVED***es true to the second if the file exists and false otherwise.
 * @return {null}
 * @api public
 */
 ...
 * @param {Db} db the database to query.
 * @param {String} [rootCollection] the root collection that holds the files and chunks collection. Defaults to **{GridStore.DEFAULT_ROOT_COLLECTION}**.
 * @param {Function} callback this will be called after this method executes. P***REMOVED***es null to the first and p***REMOVED***es an array of strings containing the names of the files.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after this method executes. A string with an error message will be p***REMOVED***ed to the first parameter when the length and offset combination exceeds the length of the file while an Error object will be p***REMOVED***ed if other forms of error occured, otherwise, a string is p***REMOVED***ed. The second parameter will contain the data read if successful or null if an error occured.
 * @return {null}
 * @api public
 */
...
var _read = function _read(self) {
  ...
  self.pause = function () {
    ...
    // byp***REMOVED*** its pause() method to hack it
