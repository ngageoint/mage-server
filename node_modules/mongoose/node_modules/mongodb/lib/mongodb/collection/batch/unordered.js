 ...
 *
 * @cl***REMOVED*** Represents a UnorderedBulkOperation
...
var UnorderedBulkOperation = function(collection, options) {
  ...
  // Specify a full cl***REMOVED*** so we can generate documentation correctly
    ...
    if(Array.isArray(document)) {
    	throw util.toError("operation p***REMOVED***ed in cannot be an Array");
    } else {
