 ...
 *
 * @cl***REMOVED*** Represents a BatchWriteResult
...
var BatchWriteResult = function(bulkResult) {
   ...
   *
   * @param {Number} index the number of the upserted id to return, returns undefined if no result for p***REMOVED***ed in index
   * @return {Array}
   * @api public
   */
