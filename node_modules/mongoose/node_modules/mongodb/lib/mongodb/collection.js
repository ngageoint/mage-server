 ...
 *
 * @cl***REMOVED*** Represents a Collection
 ...
 *  - **scope** {Object}, can p***REMOVED*** in variables that can be access from map/reduce/finalize.
...
Collection.prototype.mapReduce = function mapReduce (map, reduce, options, callback) {
  ...
  // Add any other options p***REMOVED***ed in
...
/**
 * Functions that are p***REMOVED***ed as scope args must
...
Collection.prototype.group = function group(keys, condition, initial, reduce, finalize, command, options, callback) {
  ...
  if(command) {
    ...
    // P***REMOVED*** in the function text to execute within mongodb.
