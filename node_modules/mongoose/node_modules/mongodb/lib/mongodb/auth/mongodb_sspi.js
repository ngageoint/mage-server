...
var authenticate = function(db, username, p***REMOVED***word, authdb, options, callback) {
  ...
  for(var i = 0; i < numberOfConnections; i++) {
    ...
    SSIPAuthenticate(db, username, p***REMOVED***word, authdb, connections[i], function(err, result) {
...
var SSIPAuthenticate = function(db, username, p***REMOVED***word, authdb, connection, callback) {
  // --------------------------------------------------------------
  // Async Version
  // --------------------------------------------------------------
  var command = {
