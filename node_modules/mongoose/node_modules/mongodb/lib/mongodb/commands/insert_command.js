...
InsertCommand.prototype.toBinary = function(bsonSettings) {
  // Validate that we are not p***REMOVED***ing 0x00 in the colletion name
  ...
  // Let's build the single p***REMOVED*** buffer command
  var _index = 0;
  ...
  for(var i = 0; i < this.documents.length; i++) {
    ...
    // If we are p***REMOVED***ing a raw buffer, do minimal validation
