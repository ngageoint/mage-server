...
exports.parse = function(url, options) {
  ...
  if(url.indexOf("mongodb://") != 0)
    throw Error("URL must be in the format mongodb://user:p***REMOVED***@host:port/dbname");
  ...
  if(auth.length == 2) object.auth = {user: auth[0], p***REMOVED***word: auth[1]};
  ...
  if(url.match(/\.sock/)) {
    ...
    servers = hostPart.split(',').map(function(h) {
      ...
      if ((ipv6match = /\[([^\]]+)\](?:\:(.+))?/.exec(h))) {
        ...
        //otherwise ***REMOVED***ume it's IPv4, or plain hostname
  ...
  urlOptions.forEach(function(opt) {
    ...
    switch(name) {
      ...
      case 'authMechanism':
        if(value == 'GSSAPI') {
          // If no p***REMOVED***word provided decode only the principal
          if(object.auth == null) {
            ...
            object.auth = {user: urlDecodeAuthPart, p***REMOVED***word: null};
          } else {
