...
/**
 * Cl***REMOVED*** representing a single MongoDB Server connection
 *
 * Options
 ...
 *
 * @cl***REMOVED*** Represents a Server connection.
...
function Server(host, port, options) {
  ...
  if(this.ssl) {
    ...
    // P***REMOVED***word to unlock private key
    this.socketOptions.sslP***REMOVED*** = this.sslP***REMOVED***;
  }
...
//
//  Deprecated, USE ReadPreferences cl***REMOVED***
//
 ...
 * @ignore
 */
Server.prototype.***REMOVED***ignReplicaSet = function (replset) {
...
Server.prototype.inheritReplSetOptionsFrom = function (replset) {
  ...
  if(replset.options.ssl) {
    ...
    // P***REMOVED***word to unlock private key
    this.socketOptions.sslP***REMOVED*** = replset.options.sslP***REMOVED***;
  }
...
Server.prototype.connect = function(dbInstance, options, callback) {
  ...
  // Set basic parameters p***REMOVED***ed in
  ...
  // Boot up connection poole, p***REMOVED*** in a locator of callbacks
