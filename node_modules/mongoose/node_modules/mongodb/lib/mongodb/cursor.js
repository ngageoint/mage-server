 ...
 *  - **snapshot** {Boolean}, snapshot Snapshot mode ***REMOVED***ures no duplicates are returned.
 ...
 *
 * @cl***REMOVED*** Represents a Cursor.
 ...
 *
 * @param {String|Array|Object} keyOrList This can be a string or an array. If p***REMOVED***ed as a string, the string will be the field to sort. If p***REMOVED***ed an array, each element will represent a field to be sorted and should be an array that contains the format [string, direction].
