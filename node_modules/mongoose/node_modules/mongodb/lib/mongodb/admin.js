...
function Admin(db) {
   ...
   * @api public
   */
  this.authenticate = function(username, p***REMOVED***word, callback) {
    db.authenticate(username, p***REMOVED***word, {authdb: 'admin'}, function(err, doc) {
   ...
   * @api public
   */
  this.addUser = function(username, p***REMOVED***word, options, callback) {
    ...
    // Add user
    db.addUser(username, p***REMOVED***word, options, function(err, doc) {
      return callback(err, doc);
    })
  }
  /**
