 ...
 *
 * @cl***REMOVED*** Represents the Admin methods of MongoDB.
 ...
 * @param {String} p***REMOVED***word The p***REMOVED***word for the authentication.
 ...
 * @api public
 */
Admin.prototype.authenticate = function(username, p***REMOVED***word, callback) {
  this.db.authenticate(username, p***REMOVED***word, {authdb: 'admin'}, function(err, doc) {
 ...
 * overwrite the current p***REMOVED***word
 *
 * Options
 ...
 * @api public
 */
Admin.prototype.addUser = function(username, p***REMOVED***word, options, callback) {
  ...
  // Add user
  this.db.addUser(username, p***REMOVED***word, options, function(err, doc) {
    return callback(err, doc);
  })
}
