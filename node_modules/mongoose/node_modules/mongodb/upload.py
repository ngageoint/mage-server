...
Diff options are p***REMOVED***ed to the diff command of the underlying system.
...
cl***REMOVED*** ClientLoginError(urllib2.HTTPError):
...
cl***REMOVED*** AbstractRpcServer(object):
  ...
  def __init__(self, host, auth_function, host_override=None, extra_headers={},
    ...
    Args:
      ...
      auth_function: A function that takes no arguments and returns an
        (email, p***REMOVED***word) tuple when called. Will be called if authentication
        is required.
      host_override: The host header to send to the server (defaults to host).
      extra_headers: A dict of extra headers to append to every request.
      save_cookies: If True, save the authentication cookies to local disk.
        If False, use an in-memory cookiejar instead.  Subcl***REMOVED***es must
  ...
  def _GetAuthToken(self, email, p***REMOVED***word):
    """Uses ClientLogin to authenticate the user, returning an auth token.

    Args:
      email:    The user's email address
      p***REMOVED***word: The user's p***REMOVED***word
  ...
  def _Authenticate(self):
    ...
    The authentication process works as follows:
     1) We get a username and p***REMOVED***word from the user
     2) We use ClientLogin to obtain an AUTH token for the user
        (see http://code.google.com/apis/accounts/AuthForInstalledApps.html).
     3) We p***REMOVED*** the auth token to /_ah/login on the server to obtain an
      ...
      try:
        ...
        if e.reason == "BadAuthentication":
          if e.info == "InvalidSecondFactor":
            print >>sys.stderr, (
                "Use an application-specific p***REMOVED***word instead "
                "of your regular account p***REMOVED***word.\n"
                "See http://www.google.com/"
                "support/accounts/bin/answer.py?answer=185833")
          else:
            print >>sys.stderr, "Invalid username or p***REMOVED***word."
          ...
          print >>sys.stderr, ("The user's access to the ***REMOVED*** has been "
                               "disabled.")
        elif e.reason == "ServiceUnavailable":
          print >>sys.stderr, "The ***REMOVED*** is not available; try again later."
        else:
          # Unknown error.
          raise
        print >>sys.stderr, ''
...
cl***REMOVED*** HttpRpcServer(AbstractRpcServer):
...
cl***REMOVED*** CondensedHelpFormatter(optparse.IndentedHelpFormatter):
...
parser.add_option("-y", "--***REMOVED***ume_yes", action="store_true",
                  dest="***REMOVED***ume_yes", default=False,
...
def GetRpcServer(server, email=None, host_override=None, save_cookies=True,
  ...
  rpc_server_cl***REMOVED*** = HttpRpcServer
  ...
  if re.match(r'(http://)?localhost([:/]|$)', host):
    ...
    server = rpc_server_cl***REMOVED***(
        server,
        lambda: (email, "p***REMOVED***word"),
  ...
  def GetUserCredentials():
    """Prompts the user for a username and p***REMOVED***word."""
    ...
    if keyring:
      try:
        p***REMOVED***word = keyring.get_p***REMOVED***word(host, local_email)
      except:
        # Sadly, we have to trap all errors here as
        # gnomekeyring.IOError inherits from object. :/
        print "Failed to get p***REMOVED***word from keyring"
        keyring = None
    if p***REMOVED***word is not None:
      print "Using p***REMOVED***word from system keyring."
    else:
      p***REMOVED***word = getp***REMOVED***.getp***REMOVED***("P***REMOVED***word for %s: " % local_email)
      if keyring:
        answer = raw_input("Store p***REMOVED***word in system keyring?(y/N) ").strip()
        if answer == "y":
          keyring.set_p***REMOVED***word(host, local_email, p***REMOVED***word)
    return (local_email, p***REMOVED***word)

  return rpc_server_cl***REMOVED***(server,
                          GetUserCredentials,
                          host_override=host_override,
                          save_cookies=save_cookies)
...
cl***REMOVED*** VersionControlSystem(object):
  """Abstract base cl***REMOVED*** providing an interface to the VCS."""
  ...
  def GetGUID(self):
    ...
    raise NotImplementedError(
        "abstract method -- subcl***REMOVED*** %s must override" % self.__cl***REMOVED***__)
  ...
  def GenerateDiff(self, args):
    ...
    Args:
      args: Extra arguments to p***REMOVED*** to the diff command.
    """
    raise NotImplementedError(
        "abstract method -- subcl***REMOVED*** %s must override" % self.__cl***REMOVED***__)
...
cl***REMOVED*** SubversionVCS(VersionControlSystem):
...
cl***REMOVED*** GitVCS(VersionControlSystem):
  ...
  def PostProcessDiff(self, gitdiff):
    ...
    ***REMOVED***ert filename is not None
    AddSubversionPropertyChange(filename)
    return "".join(svndiff)
...
cl***REMOVED*** CVSVCS(VersionControlSystem):
...
cl***REMOVED*** MercurialVCS(VersionControlSystem):
  ...
  def __init__(self, options, repo_dir):
    ...
    ***REMOVED***ert cwd.startswith(self.repo_dir)
...
cl***REMOVED*** PerforceVCS(VersionControlSystem):
    ...
    def ConfirmLogin():
      ...
      while True:
        ...
        if not retcode and (not "code" in data or data["code"] != "error"):
          break
        print "Enter perforce p***REMOVED***word: "
...
def GuessVCS(options):
  ...
  and returns an instance of the appropriate cl***REMOVED***.  Exit with an error
...
def RealMain(argv, data=None):
  ...
  if not options.***REMOVED***ume_yes:
