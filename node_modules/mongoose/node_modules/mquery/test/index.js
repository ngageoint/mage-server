...
describe('mquery', function(){
  ...
  describe('mquery', function(){
    it('is a function', function(){
      ***REMOVED***ert.equal('function', typeof mquery);
    })
    it('creates instances with the `new` keyword', function(){
      ***REMOVED***ert.ok(mquery() instanceof mquery);
    })
    describe('defaults', function(){
      it('are set', function(){
        var m = mquery();
        ***REMOVED***ert.strictEqual(undefined, m.op);
        ***REMOVED***ert.deepEqual({}, m.options);
      })
    })
    describe('criteria', function(){
      it('if collection-like is used as collection', function(){
        var m = mquery(col);
        ***REMOVED***ert.equal(col, m._collection.collection);
      })
      it('non-collection-like is used as criteria', function(){
        var m = mquery({ works: true });
        ***REMOVED***ert.ok(!m._collection);
        ***REMOVED***ert.deepEqual({ works: true }, m._conditions);
      })
    })
    describe('options', function(){
      it('are merged when p***REMOVED***ed', function(){
        var m = mquery(col, { safe: true });
        ***REMOVED***ert.deepEqual({ safe: true }, m.options);
  ...
  describe('toConstructor', function(){
    it('creates subcl***REMOVED***es of mquery', function(){
      ...
      ***REMOVED***ert.ok(m instanceof mquery);
      ***REMOVED***ert.deepEqual(opts, m.options);
      ***REMOVED***ert.deepEqual(match, m._conditions);
      ***REMOVED***ert.deepEqual(select, m._fields);
      ***REMOVED***ert.deepEqual(update, m._update);
      ***REMOVED***ert.equal(path, m._path);
      ***REMOVED***ert.equal('find', m.op);
    })
  })

  describe('setOptions', function(){
    it('calls ***REMOVED***ociated methods', function(){
      var m = mquery();
      ***REMOVED***ert.equal(m._collection, null);
      m.setOptions({ collection: col });
      ***REMOVED***ert.equal(m._collection.collection, col);
    })
    it('directly sets option when no method exists', function(){
      var m = mquery();
      ***REMOVED***ert.equal(m.options.woot, null);
      m.setOptions({ woot: 'yay' });
      ***REMOVED***ert.equal(m.options.woot, 'yay');
    })
    it('is chainable', function(){
      var m = mquery();
      var n = m.setOptions();
      ***REMOVED***ert.equal(m, n);
  ...
  describe('$where', function(){
    it('sets the $where condition', function(){
      ...
      function go () {}
      m.$where(go);
      ***REMOVED***ert.ok(go === m._conditions.$where);
    })
    it('is chainable', function(){
      var m = mquery();
      var n = m.$where('x');
  ...
  describe('where', function(){
    it('without arguments', function(){
      var m = mquery();
      m.where();
      ***REMOVED***ert.deepEqual({}, m._conditions);
    })
    ...
    describe('with one argument', function(){
      it('that is an object', function(){
        var m = mquery();
        m.where({ name: 'flawed' });
        ***REMOVED***ert.strictEqual(m._conditions.name, 'flawed');
      })
      it('that is a query', function(){
        var m = mquery({ name: 'first' });
        var n = mquery({ name: 'changed' });
        m.where(n);
        ***REMOVED***ert.strictEqual(m._conditions.name, 'changed');
      })
      it('that is a string', function(){
        var m = mquery();
        m.where('name');
        ***REMOVED***ert.equal('name', m._path);
        ***REMOVED***ert.strictEqual(m._conditions.name, undefined);
      })
    })
    it('with two arguments', function(){
      ...
      ***REMOVED***ert.equal('name', m._path);
      ***REMOVED***ert.strictEqual(m._conditions.name, 'The Great Pumpkin');
    })
    it('is chainable', function(){
      var m = mquery();
      var n = m.where('x', 'y');
  ...
  describe('equals', function(){
    ...
    it('sets value of path set with where()', function(){
      ...
      ***REMOVED***ert.deepEqual({ age: 1000 }, m._conditions);
    })
    it('is chainable', function(){
      var m = mquery();
  ...
  describe('or', function(){
    it('pushes onto the internal $or condition', function(){
      ...
      ***REMOVED***ert.deepEqual([{'Nightmare Before Christmas': true }], m._conditions.$or)
    })
    it('allows p***REMOVED***ing arrays', function(){
      var m = mquery();
      var arg = [{ 'Nightmare Before Christmas': true }, { x: 1 }];
      m.or(arg);
      ***REMOVED***ert.deepEqual(arg, m._conditions.$or)
    })
    it('allows calling multiple times', function(){
      ...
      m.or({ y: 1 })
      m.or([{ w: 'oo' }, { z: 'oo'} ])
      ***REMOVED***ert.deepEqual([{looper:true},{x:1},{y:1},{w:'oo'},{z:'oo'}], m._conditions.$or)
    })
    it('is chainable', function(){
      var m = mquery();
      m.or({ o: "k"}).where('name', 'table');
      ***REMOVED***ert.deepEqual({ name: 'table', $or: [{ o: 'k' }] }, m._conditions)
    })
  })
  ...
  describe('nor', function(){
    it('pushes onto the internal $nor condition', function(){
      ...
      ***REMOVED***ert.deepEqual([{'Nightmare Before Christmas': true }], m._conditions.$nor)
    })
    it('allows p***REMOVED***ing arrays', function(){
      var m = mquery();
      var arg = [{ 'Nightmare Before Christmas': true }, { x: 1 }];
      m.nor(arg);
      ***REMOVED***ert.deepEqual(arg, m._conditions.$nor)
    })
    it('allows calling multiple times', function(){
      var m = mquery();
      var arg = [{ looper: true }, { x: 1 }];
      ...
      m.nor({ y: 1 })
      m.nor([{ w: 'oo' }, { z: 'oo'} ])
      ***REMOVED***ert.deepEqual([{looper:true},{x:1},{y:1},{w:'oo'},{z:'oo'}], m._conditions.$nor)
    })
    it('is chainable', function(){
      var m = mquery();
      m.nor({ o: "k"}).where('name', 'table');
      ***REMOVED***ert.deepEqual({ name: 'table', $nor: [{ o: 'k' }] }, m._conditions)
    })
  })
  ...
  describe('and', function(){
    it('pushes onto the internal $and condition', function(){
      ...
      ***REMOVED***ert.deepEqual([{'Nightmare Before Christmas': true }], m._conditions.$and)
    })
    it('allows p***REMOVED***ing arrays', function(){
      var m = mquery();
      var arg = [{ 'Nightmare Before Christmas': true }, { x: 1 }];
      m.and(arg);
      ***REMOVED***ert.deepEqual(arg, m._conditions.$and)
    })
    it('allows calling multiple times', function(){
      var m = mquery();
      var arg = [{ looper: true }, { x: 1 }];
      ...
      m.and({ y: 1 })
      m.and([{ w: 'oo' }, { z: 'oo'} ])
      ***REMOVED***ert.deepEqual([{looper:true},{x:1},{y:1},{w:'oo'},{z:'oo'}], m._conditions.$and)
    })
    it('is chainable', function(){
      var m = mquery();
      m.and({ o: "k"}).where('name', 'table');
      ***REMOVED***ert.deepEqual({ name: 'table', $and: [{ o: 'k' }] }, m._conditions)
    })
  })
  ...
  function generalCondition (type) {
    return function () {
      it('accepts 2 args', function(){
        ...
        var check = {};
        check['$' + type] = 3;
        ***REMOVED***ert.deepEqual(m._conditions.count, check);
      })
      it('uses previously set `where` path if 1 arg p***REMOVED***ed', function(){
        var m = mquery().where('count')[type](3);
        var check = {};
        check['$' + type] = 3;
        ***REMOVED***ert.deepEqual(m._conditions.count, check);
      })
      it('throws if 1 arg was p***REMOVED***ed but no previous `where` was used', function(){
        ***REMOVED***ert.throws(function(){
          mquery()[type](3);
        }, /must be used after where/);
      })
      it('is chainable', function(){
        ...
        var check = {x: 8, count: {}};
        check.count['$' + type] = 3;
        ***REMOVED***ert.deepEqual(m._conditions, check);
      })
  ...
  describe('mod', function () {
    describe('with 1 argument', function(){
      ...
      it('works', function(){
        ...
        ***REMOVED***ert.deepEqual(m._conditions, { madmen: { $mod: [10,20] }})
      })
    })
    ...
    describe('with 1 argument', function(){
      ...
      describe('that is an object', function(){
        ...
        it('works', function(){
          ...
          ***REMOVED***ert.deepEqual({ comment: { $elemMatch: { author: 'joe', votes: {$gte: 3}}}}, m._conditions);
        })
      })
  ...
  describe('within', function(){
    it('is chainable', function(){
      var m = mquery();
      ***REMOVED***ert.equal(m.where('a').within(), m);
    })
    describe('when called with arguments', function(){
      ...
      describe('of length 1', function(){
        ...
        it('delegates to circle when center exists', function(){
          ...
          ***REMOVED***ert.deepEqual({ $geoWithin: {$center:[[10,10], 3]}}, m._conditions.loc);
        })
        it('delegates to box when exists', function(){
          var m = mquery().where('loc').within({ box: [[10,10], [11,14]] });
          ***REMOVED***ert.deepEqual({ $geoWithin: {$box:[[10,10], [11,14]]}}, m._conditions.loc);
        })
        it('delegates to polygon when exists', function(){
          var m = mquery().where('loc').within({ polygon: [[10,10], [11,14],[10,9]] });
          ***REMOVED***ert.deepEqual({ $geoWithin: {$polygon:[[10,10], [11,14],[10,9]]}}, m._conditions.loc);
        })
        it('delegates to geometry when exists', function(){
          var m = mquery().where('loc').within({ type: 'Polygon', coordinates: [[10,10], [11,14],[10,9]] });
          ***REMOVED***ert.deepEqual({ $geoWithin: {$geometry: {type:'Polygon', coordinates: [[10,10], [11,14],[10,9]]}}}, m._conditions.loc);
        })
      })
      ...
      describe('of length 2', function(){
        it('delegates to box()', function(){
          ...
          ***REMOVED***ert.deepEqual(m._conditions.loc, { $geoWithin: { $box: [[1,2],[2,5]]}});
        })
      })
      ...
      describe('of length > 2', function(){
        it('delegates to polygon()', function(){
          ...
          ***REMOVED***ert.deepEqual(m._conditions.loc, { $geoWithin: { $polygon: [[1,2],[2,5],[2,4],[1,3]]}});
        })
      })
    })
  })
  ...
  describe('geoWithin', function(){
    ...
    describe('when called with arguments', function(){
      describe('of length 1', function(){
        it('delegates to circle when center exists', function(){
          var m = mquery().where('loc').within({ center: [10,10], radius: 3 });
          ***REMOVED***ert.deepEqual({ $within: {$center:[[10,10], 3]}}, m._conditions.loc);
        })
        it('delegates to box when exists', function(){
          var m = mquery().where('loc').within({ box: [[10,10], [11,14]] });
          ***REMOVED***ert.deepEqual({ $within: {$box:[[10,10], [11,14]]}}, m._conditions.loc);
        })
        it('delegates to polygon when exists', function(){
          var m = mquery().where('loc').within({ polygon: [[10,10], [11,14],[10,9]] });
          ***REMOVED***ert.deepEqual({ $within: {$polygon:[[10,10], [11,14],[10,9]]}}, m._conditions.loc);
        })
        it('delegates to geometry when exists', function(){
          var m = mquery().where('loc').within({ type: 'Polygon', coordinates: [[10,10], [11,14],[10,9]] });
          ***REMOVED***ert.deepEqual({ $within: {$geometry: {type:'Polygon', coordinates: [[10,10], [11,14],[10,9]]}}}, m._conditions.loc);
        })
      })
      ...
      describe('of length 2', function(){
        it('delegates to box()', function(){
          var m = mquery().where('loc').within([1,2],[2,5]);
          ***REMOVED***ert.deepEqual(m._conditions.loc, { $within: { $box: [[1,2],[2,5]]}});
        })
      })
      ...
      describe('of length > 2', function(){
        it('delegates to polygon()', function(){
          var m = mquery().where('loc').within([1,2],[2,5],[2,4],[1,3]);
          ***REMOVED***ert.deepEqual(m._conditions.loc, { $within: { $polygon: [[1,2],[2,5],[2,4],[1,3]]}});
        })
      })
    })
  })
  ...
  describe('box', function(){
    ...
    describe('with 2 arguments', function(){
      ...
      it('works', function(){
        ...
        ***REMOVED***ert.deepEqual(m._conditions.loc, { $geoWithin: { $box: [[1,2],[3,4]] }});
      })
    })
  ...
  describe('polygon', function(){
    describe('when first argument is not a string', function(){
      ...
      it('***REMOVED***igns arguments to within polygon condition', function(){
        var m = mquery().where('loc').polygon([1,2], [2,3], [3,6]);
        ***REMOVED***ert.deepEqual(m._conditions, { loc: {$geoWithin: {$polygon: [[1,2],[2,3],[3,6]]}} });
      })
    })

    describe('when first arg is a string', function(){
      it('***REMOVED***igns remaining arguments to within polygon condition', function(){
  ...
  describe('circle', function(){
    describe('with one arg', function(){
      ...
      it('works', function(){
        ...
        ***REMOVED***ert.deepEqual(m._conditions, { loc: { $geoWithin: {$center: [[0,0],3] }}});
      })
    })
    ...
    describe('when called with one argument', function(){
      describe('after within()', function(){
        it('and arg quacks like geoJSON', function(done){
          ...
          ***REMOVED***ert.deepEqual({ a: { $geoWithin: { $geometry: point }}}, m._conditions);
          done();
        })
      })
      ...
      describe('after intersects()', function(){
        it('and arg quacks like geoJSON', function(done){
          ...
          ***REMOVED***ert.deepEqual({ a: { $geoIntersects: { $geometry: point }}}, m._conditions);
          done();
        })
      })
  ...
  describe('intersects', function(){
    ...
    it('sets geo comparison to "$intersects"', function(done){
      ...
      ***REMOVED***ert.equal('$geoIntersects', n._geoComparison);
      done();
    })

    it('is chainable', function(){
      var m = mquery();
      ***REMOVED***ert.equal(m.where('a').intersects(), m);
    })
  ...
  describe('near', function(){
    ...
    describe('with 0 args', function(){
      it('is compatible with geometry()', function(done){
        ...
        ***REMOVED***ert.deepEqual({ $near: {$geometry: {type:'Point', coordinates: [180,11]}}}, q._conditions.x);
        done();
      })
    })
    ...
    it('creates $geometry args for GeoJSON', function(){
      ...
      ***REMOVED***ert.deepEqual({ $near: {$geometry: {type:'Point', coordinates: [10,10]}}}, m._conditions.loc);
    })
    ...
    it('accepts spherical conditions', function(){
      ...
      ***REMOVED***ert.deepEqual(m._conditions, { loc: { $nearSphere: [1,2]}});
    })

    it('is non-spherical by default', function(){
      var m = mquery().where('loc').near({ center: [1,2] });
      ***REMOVED***ert.deepEqual(m._conditions, { loc: { $near: [1,2]}});
    })

    it('supports maxDistance', function(){
      var m = mquery().where('loc').near({ center: [1,2], maxDistance:4 });
      ***REMOVED***ert.deepEqual(m._conditions, { loc: { $near: [1,2], $maxDistance: 4}});
    })

    it('is chainable', function(){
      var m = mquery().where('loc').near({ center: [1,2], maxDistance:4 }).find({ x: 1 });
      ***REMOVED***ert.deepEqual(m._conditions, { loc: { $near: [1,2], $maxDistance: 4}, x: 1});
    })

    describe('supports p***REMOVED***ing GeoJSON, gh-13', function(){
      it('with center', function(){
        ...
        ***REMOVED***ert.deepEqual(m._conditions, expect);
      })
    })
  })
  ...
  describe('select', function(){
    ...
    it('accepts an object', function(){
      ...
      ***REMOVED***ert.deepEqual(m._fields, o);
    })

    it('accepts a string', function(){
      var o = 'x -y';
      var m = mquery().select(o);
      ***REMOVED***ert.deepEqual(m._fields, { x: 1, y: 0 });
    })
    ...
    it('merges previous arguments', function(){
      ...
      ***REMOVED***ert.deepEqual(m._fields, {
          x: 0
        , y: 0
        , z: 1
        , u: 0
  ...
  describe('selected', function() {
    ...
    it('returns false when no fields have been selected', function(done) {
      var m = mquery();
      ***REMOVED***ert.strictEqual(false, m.selected());
      done();
    });
  });
  ...
  describe('selectedInclusively', function() {
    describe('returns false', function(){
      it('when no fields have been selected', function(done) {
        ***REMOVED***ert.strictEqual(false, mquery().selectedInclusively());
        ***REMOVED***ert.equal(false, mquery().select({}).selectedInclusively());
        done();
      });
      it('when any fields have been excluded', function(done) {
        ***REMOVED***ert.strictEqual(false, mquery().select('-name').selectedInclusively());
        ***REMOVED***ert.strictEqual(false, mquery().select({ name: 0 }).selectedInclusively());
        ***REMOVED***ert.strictEqual(false, mquery().select('name bio -_id').selectedInclusively());
        ***REMOVED***ert.strictEqual(false, mquery().select({ name: 1, _id: 0 }).selectedInclusively());
        done();
      });
    });
    ...
    describe('returns true', function() {
      it('when fields have been included', function(done) {
        ***REMOVED***ert.equal(true, mquery().select('name').selectedInclusively());
        ***REMOVED***ert.equal(true, mquery().select({ name:1 }).selectedInclusively());
        done();
      });
    });
  });
  ...
  describe('selectedExclusively', function() {
    describe('returns false', function(){
      it('when no fields have been selected', function(done) {
        ***REMOVED***ert.equal(false, mquery().selectedExclusively());
        ***REMOVED***ert.equal(false, mquery().select({}).selectedExclusively());
        done();
      });
      it('when fields have only been included', function(done) {
        ***REMOVED***ert.equal(false, mquery().select('name').selectedExclusively());
        ***REMOVED***ert.equal(false, mquery().select({ name: 1 }).selectedExclusively());
        done();
      });
    });
    ...
    describe('returns true', function() {
      it('when any field has been excluded', function(done) {
        ***REMOVED***ert.equal(true, mquery().select('-name').selectedExclusively());
        ***REMOVED***ert.equal(true, mquery().select({ name:0 }).selectedExclusively());
        ***REMOVED***ert.equal(true, mquery().select('-_id').selectedExclusively());
        ***REMOVED***ert.strictEqual(true, mquery().select('name bio -_id').selectedExclusively());
        ***REMOVED***ert.strictEqual(true, mquery().select({ name: 1, _id: 0 }).selectedExclusively());
        done();
      });
    });
  });
  ...
  describe('slice', function(){
    describe('with 0 args', function(){
      it('is chainable', function(){
        var m = mquery()
        ***REMOVED***ert.equal(m, m.slice());
      })
      it('is a noop', function(){
        var m = mquery().slice();
        ***REMOVED***ert.deepEqual(m._fields, undefined);
      })
    })
    ...
    describe('with 1 arg', function(){
      ...
      it('that is a number', function(){
        ...
        ***REMOVED***ert.deepEqual(query._fields, {collection: {$slice: 5}});
      })
      it('that is an array', function(){
        var query = mquery();
        query.where('collection').slice([5,10]);
        ***REMOVED***ert.deepEqual(query._fields, {collection: {$slice: [5,10]}});
      })
    })
    ...
    describe('with 2 args', function(){
      describe('and first is a number', function(){
        ...
        it('does not throw if used after where', function(){
          ...
          ***REMOVED***ert.deepEqual(query._fields, {collection: {$slice: [2,3]}});
        })
      })
      it('and first is not a number', function(){
        var query = mquery().slice('collection', [-5, 2]);
        ***REMOVED***ert.deepEqual(query._fields, {collection: {$slice: [-5,2]}});
      })
    })
    ...
    describe('with 3 args', function(){
      it('works', function(){
        ...
        ***REMOVED***ert.deepEqual(query._fields, {collection: {$slice: [14, 10]}});
      })
    })
  ...
  describe('sort', function(){
    describe('with 0 args', function(){
      it('chains', function(){
        var m = mquery();
        ***REMOVED***ert.equal(m, m.sort());
      })
      it('has no affect', function(){
        var m = mquery();
        ***REMOVED***ert.equal(m.options.sort, undefined);
      })
    })
    ...
    it('works', function(){
      var query = mquery();
      query.sort('a -c b');
      ***REMOVED***ert.deepEqual(query.options.sort, { a : 1, b: 1, c : -1});

      query = mquery();
      query.sort({'a': 1, 'c': -1, 'b': 'asc', e: 'descending', f: 'ascending'});
      ***REMOVED***ert.deepEqual(query.options.sort, {'a': 1, 'c': -1, 'b': 1, 'e': -1, 'f': 1});
      ...
      ***REMOVED***ert.ok(e, 'uh oh. no error was thrown');
      ***REMOVED***ert.equal(e.message, 'Invalid sort() argument. Must be a string or object.');
    ...
    it('handles $meta sort options', function(){
      ...
      ***REMOVED***ert.deepEqual(query.options.sort, { score : { $meta : "textScore" } });
    })
  ...
  function simpleOption (type) {
    describe(type, function(){
      it('sets the ' + type + ' option', function(){
        var m = mquery()[type](2);
        ***REMOVED***ert.equal(2, m.options[type]);
      })
      it('is chainable', function(){
        var m = mquery();
        ***REMOVED***ert.equal(m[type](3), m);
      })
  ...
  describe('snapshot', function(){
    it('works', function(){
      var query = mquery();
      query.snapshot();
      ***REMOVED***ert.equal(true, query.options.snapshot);
      ...
      ***REMOVED***ert.equal(false, query.options.snapshot);
    })
    noDistinct('snapshot');
    no('count', 'snapshot');
  })
  ...
  describe('hint', function(){
    it('accepts an object', function(){
      var query2 = mquery();
      query2.hint({'a': 1, 'b': -1});
      ***REMOVED***ert.deepEqual(query2.options.hint, {'a': 1, 'b': -1});
    })
    ...
    describe('does not have side affects', function(){
      it('on invalid arg', function(){
        ...
        ***REMOVED***ert.equal(undefined, m.options.hint);
      })
  ...
  describe('slaveOk', function(){
    it('works', function(){
      var query = mquery();
      query.slaveOk();
      ***REMOVED***ert.equal(true, query.options.slaveOk);
      ...
      ***REMOVED***ert.equal(true, query.options.slaveOk);
      ...
      var query = mquery()
      query.slaveOk(false);
      ***REMOVED***ert.equal(false, query.options.slaveOk);
    })
  })

  describe('read', function(){
    it('sets ***REMOVED***ociated readPreference option', function(){
      var m = mquery();
      m.read('p');
      ***REMOVED***ert.equal('primary', m.options.readPreference);
    })
    it('is chainable', function(){
      var m = mquery();
      ***REMOVED***ert.equal(m, m.read('sp'));
    })
  })
  ...
  describe('tailable', function(){
    it('works', function(){
      var query = mquery();
      query.tailable();
      ***REMOVED***ert.equal(true, query.options.tailable);
      ...
      ***REMOVED***ert.equal(false, query.options.tailable);
    })
    it('is chainable', function(){
      var m = mquery();
      ***REMOVED***ert.equal(m, m.tailable());
    })
    noDistinct('tailable');
    no('count', 'tailable');
  })
  ...
  describe('merge', function(){
    describe('with falsy arg', function(){
      it('returns itself', function(){
        var m = mquery();
        ***REMOVED***ert.equal(m, m.merge());
        ***REMOVED***ert.equal(m, m.merge(null));
        ***REMOVED***ert.equal(m, m.merge(0));
      })
    })
    describe('with an argument', function(){
      ...
      describe('that is a query', function(){
        it('merges conditions, field selection, and options', function(){
          ...
          ***REMOVED***ert.deepEqual(n._conditions, m._conditions);
          ***REMOVED***ert.deepEqual(n._fields, m._fields);
          ***REMOVED***ert.deepEqual(n.options, m.options);
        })
        it('clones update arguments', function(done){
          ...
          var n = mquery().merge(m);
          m.update({ $set: { x: 2 }})
          ***REMOVED***ert.notDeepEqual(m._update, n._update);
          done();
        })
        it('is chainable', function(){
          var m = mquery({ x: 'hi' });
          var n = mquery();
          ***REMOVED***ert.equal(n, n.merge(m));
        })
      })
      ...
      describe('that is an object', function(){
        it('merges', function(){
          var m = { x: 'hi' };
          var n = mquery().merge(m);
          ***REMOVED***ert.deepEqual(n._conditions, { x: 'hi' });
        })
        it('clones update arguments', function(done){
          var original = { $set: { iTerm: true }}
          var m = mquery().update(original);
  ...
  describe('find', function(){
    ...
    it('is chainable', function(){
      ...
      ***REMOVED***ert.deepEqual(m._conditions, {x:1,y:2});
    })
    ...
    it('merges other queries', function(){
      ...
      m.select('_id');
      var a = mquery().find(m);
      ***REMOVED***ert.deepEqual(a._conditions, m._conditions);
      ***REMOVED***ert.deepEqual(a.options, m.options);
      ***REMOVED***ert.deepEqual(a._fields, m._fields);
    })
    ...
    describe('executes', function(){
      ...
      it('when criteria is p***REMOVED***ed with a callback', function(done){
        mquery(col).find({ name: 'mquery' }, function (err, docs) {
          ***REMOVED***ert.ifError(err);
          ***REMOVED***ert.equal(1, docs.length);
          done();
        })
      })
      it('when Query is p***REMOVED***ed with a callback', function(done){
        var m = mquery({ name: 'mquery' });
      ...
      it('when just a callback is p***REMOVED***ed', function(done){
  ...
  describe('findOne', function(){
    ...
    it('is chainable', function(){
      ...
      ***REMOVED***ert.equal(m, n);
      ***REMOVED***ert.deepEqual(m._conditions, {x:1,y:2});
      ***REMOVED***ert.equal('findOne', m.op);
    })
    ...
    describe('executes', function(){
      ...
      it('when criteria is p***REMOVED***ed with a callback', function(done){
        mquery(col).findOne({ name: 'mquery findone' }, function (err, doc) {
          ***REMOVED***ert.ifError(err);
          ***REMOVED***ert.ok(doc);
          ***REMOVED***ert.equal('mquery findone', doc.name);
          done();
        })
      })
      it('when Query is p***REMOVED***ed with a callback', function(done){
    ...
    describe('executes', function(){
      ...
      it('when criteria is p***REMOVED***ed with a callback', function(done){
        mquery(col).count({ name: 'mquery count' }, function (err, count) {
          ***REMOVED***ert.ifError(err);
          ***REMOVED***ert.ok(count);
          ***REMOVED***ert.ok(1 === count);
          done();
        })
      })
      it('when Query is p***REMOVED***ed with a callback', function(done){
  ...
  describe('distinct', function(){
    ...
    it('is chainable', function(){
      ...
      ***REMOVED***ert.equal(m, n);
      ***REMOVED***ert.deepEqual(n._conditions, {x:1, y:2});
      ***REMOVED***ert.equal('name', n._distinct);
      ***REMOVED***ert.equal('distinct', n.op);
    });

    it('overwrites field', function(){
      var m = mquery({ name: 'mquery' }).distinct('name');
      m.distinct('rename');
      ***REMOVED***ert.equal(m._distinct, 'rename');
      m.distinct({x:1}, 'renamed');
      ***REMOVED***ert.equal(m._distinct, 'renamed');
    })
    ...
    it('merges other queries', function(){
      ...
      ***REMOVED***ert.deepEqual(a.options, m.options);
      ***REMOVED***ert.deepEqual(a._fields, m._fields);
      ***REMOVED***ert.deepEqual(a._distinct, m._distinct);
    })
    ...
    describe('executes', function(){
      ...
      it('when distinct arg is p***REMOVED***ed with a callback', function(done){
      ...
      describe('when criteria is p***REMOVED***ed with a callback', function(){
      ...
      describe('when Query is p***REMOVED***ed with a callback', function(){
      ...
      describe('when just a callback is p***REMOVED***ed', function(done){
        it('if distinct arg was declared', function(done){
          var m = mquery({ name: 'mquery distinct' });
          m.collection(col);
          m.distinct('age');
  ...
  describe('update', function(){
    ...
    it('is chainable', function(){
      ...
      ***REMOVED***ert.equal(m, n);
      ***REMOVED***ert.deepEqual(n._conditions, {x:1, y:2});
      ***REMOVED***ert.deepEqual({ y: 2 }, n._update);
      ***REMOVED***ert.equal('update', n.op);
    });
    ...
    it('merges update doc arg', function(){
      ...
      m.update({ z: 'stuff' });
      ***REMOVED***ert.deepEqual(m._update, { z: 'stuff', x: 'stuff', a: a });
      ***REMOVED***ert.deepEqual(m._conditions, { name: 'mquery' });
      ***REMOVED***ert.ok(!m.options.overwrite);
      m.update({}, { z: 'renamed' }, { overwrite: true });
      ***REMOVED***ert.ok(m.options.overwrite === true);
      ***REMOVED***ert.deepEqual(m._conditions, { name: 'mquery' });
      ***REMOVED***ert.deepEqual(m._update, { z: 'renamed', x: 'stuff', a: a });
      a.push(3);
      ***REMOVED***ert.notDeepEqual(m._update, { z: 'renamed', x: 'stuff', a: a });
    })
    ...
    it('merges other options', function(){
      ...
      ***REMOVED***ert.deepEqual({ age: 77 }, m._conditions);
      ***REMOVED***ert.deepEqual({ name: 'pagemill' }, m._update);
      ***REMOVED***ert.deepEqual({ overwrite: true, multi: true }, m.options);
    })
    ...
    describe('executes', function(){
      ...
      describe('when conds + doc + opts + callback p***REMOVED***ed', function(){
        it('works', function(done){
          var m = mquery(col).where({ _id: id })
          m.update({}, { name: 'Sparky' }, { safe: true }, function (err, num) {
            ***REMOVED***ert.ifError(err);
            ***REMOVED***ert.ok(1 === num);
            m.findOne(function (err, doc) {
              ***REMOVED***ert.ifError(err);
              ***REMOVED***ert.equal(doc.name, 'Sparky');
              done();
            })
          })
        })
      ...
      describe('when conds + doc + callback p***REMOVED***ed', function(){
        it('works', function (done) {
          var m = mquery(col).update({ _id: id }, { name: 'fairgrounds' }, function (err, num, doc) {
            ...
            ***REMOVED***ert.ok(1, num);
            m.findOne(function (err, doc) {
              ***REMOVED***ert.ifError(err);
              ***REMOVED***ert.equal(doc.name, 'fairgrounds');
              done();
            })
          })
        })
      ...
      describe('when doc + callback p***REMOVED***ed', function(){
        it('works', function (done) {
          var m = mquery(col).where({ _id: id }).update({ name: 'changed' }, function (err, num, doc) {
            ...
            ***REMOVED***ert.ok(1, num);
            m.findOne(function (err, doc) {
              ***REMOVED***ert.ifError(err);
              ***REMOVED***ert.equal(doc.name, 'changed');
              done();
            })
          })
        })
      ...
      describe('when just callback p***REMOVED***ed', function(){
        it('works', function (done) {
          var m = mquery(col).where({ _id: id });
          ...
          m.update(function (err, num) {
            ...
            ***REMOVED***ert.ok(1 === num);
            m.findOne(function (err, doc) {
              ***REMOVED***ert.ifError(err);
              ***REMOVED***ert.equal(doc.name, 'Frankenweenie');
              done();
            })
          })
        })
      ...
      describe('without a callback', function(){
        it('when forced by exec()', function(done){
          ...
          m._collection.update = function (conds, doc, opts, cb) {
            ...
            ***REMOVED***ert.ok(!opts.safe);
            ***REMOVED***ert.ok(true === opts.multi);
            ***REMOVED***ert.equal('forced', doc.$set.name);
            done();
          }
      ...
      describe('except when update doc is empty and missing overwrite flag', function(){
        it('works', function (done) {
          ...
          m.update({ }, function (err, num) {
            ***REMOVED***ert.ifError(err);
            ***REMOVED***ert.ok(0 === num);
            setTimeout(function(){
              m.findOne(function (err, doc) {
                ***REMOVED***ert.ifError(err);
                ***REMOVED***ert.equal(3, mquery.utils.keys(doc).length);
                ***REMOVED***ert.equal(id, doc._id.toString());
                ***REMOVED***ert.equal('Frankenweenie', doc.name);
                done();
              })
            }, 300);
          })
          ...
          m.update({ all: 'yep', two: 2 }, function (err, num) {
            ...
            ***REMOVED***ert.ok(1 === num);
            m.findOne(function (err, doc) {
              ***REMOVED***ert.ifError(err);
              ***REMOVED***ert.equal(3, mquery.utils.keys(doc).length);
              ***REMOVED***ert.equal('yep', doc.all);
              ***REMOVED***ert.equal(2, doc.two);
              ***REMOVED***ert.equal(id, doc._id.toString());
              done();
            })
          })
        ...
        it('works', function (done) {
          ...
          m.update({ }, function (err, num) {
            ...
            ***REMOVED***ert.ok(1 === num);
            m.findOne(function (err, doc) {
              ***REMOVED***ert.ifError(err);
              ***REMOVED***ert.equal(1, mquery.utils.keys(doc).length);
              ***REMOVED***ert.equal(id, doc._id.toString());
              done();
            })
          })
        ...
        it('works', function(done){
          ...
          setTimeout(function () {
            m.findOne(function (err, doc) {
              ***REMOVED***ert.ifError(err);
              ***REMOVED***ert.ok(doc);
              ***REMOVED***ert.equal('bool', doc.name);
              done();
            })
          }, 300)
        })
    ...
    describe('with 1 argument', function(){
      ...
      describe('that is a', function(){
        it('plain object', function(){
          ...
          m.remove({ color: '#fff' })
          ***REMOVED***ert.deepEqual({ name: 'Whiskers', color: '#fff' }, m._conditions);
        })
              ...
              ***REMOVED***ert.ok(doc);
              ...
              setTimeout(function () {
                mquery(col).find(function (err, docs) {
                  ***REMOVED***ert.ifError(err);
                  ***REMOVED***ert.ok(docs);
                  ***REMOVED***ert.equal(0, docs.length);
                  done();
                })
              }, 300)
            })
          ...
          mquery(col).remove({ name: name }, function (err) {
            ***REMOVED***ert.ifError(err);
            mquery(col).find(function (err, docs) {
              ...
              ***REMOVED***ert.ok(docs);
              ***REMOVED***ert.equal(1, docs.length);
              ***REMOVED***ert.equal('shelly', docs[0].name);
              done();
            })
          });
        })
  ...
  describe('findOneAndUpdate', function(){
    ...
    describe('with 1 arg', function(){
      describe('that is an object', function(){
        it('updates the doc', function(){
          ...
          ***REMOVED***ert.deepEqual(n._update, { $set: { name: '1 arg' }});
        })
      })
      describe('that is a query', function(){
        it('updates the doc', function(){
          ...
          ***REMOVED***ert.deepEqual(n._update, { x: 1 });
        })
      })
        ...
        col.insert({ name: name }, { safe: true }, function (err) {
          ***REMOVED***ert.ifError(err);
          ...
          n.findOneAndUpdate(function (err, doc) {
            ***REMOVED***ert.ifError(err);
            ***REMOVED***ert.ok(doc);
            ***REMOVED***ert.equal(name, doc.name);
            done();
          });
        })
      })
    ...
    describe('with 2 args', function(){
      it('conditions + update', function(){
        ...
        ***REMOVED***ert.deepEqual({ name: name }, m._conditions);
        ***REMOVED***ert.deepEqual({ age: 100 }, m._update);
      })
    ...
    describe('with 3 args', function(){
      it('conditions + update + options', function(){
        ...
        ***REMOVED***ert.deepEqual({ name: name}, n._conditions);
        ***REMOVED***ert.deepEqual({ works: true }, n._update);
        ***REMOVED***ert.deepEqual({ new: false }, n.options);
      })
  ...
  describe('findOneAndRemove', function(){
    ...
    describe('with 1 arg', function(){
      describe('that is an object', function(){
        it('updates the doc', function(){
          ...
          ***REMOVED***ert.deepEqual(n._conditions, { name: '1 arg' });
        })
      })
      describe('that is a query', function(){
        it('updates the doc', function(){
          ...
          ***REMOVED***ert.deepEqual(n._conditions, { name: name });
        })
      })
      it('that is a function', function(done){
        col.insert({ name: name }, { safe: true }, function (err) {
    ...
    describe('with 2 args', function(){
      it('conditions + options', function(){
        ...
        ***REMOVED***ert.deepEqual({ name: name }, m._conditions);
        ***REMOVED***ert.deepEqual({ new: false }, m.options);
      })
      it('query + options', function(){
        ...
        ***REMOVED***ert.deepEqual({ name: name }, m._conditions);
        ***REMOVED***ert.deepEqual({ sort: { 'x': 1 }}, m.options);
      })
  ...
  describe('exec', function(){
    ...
    it('distinct', function(done){
      ...
      m.exec(function (err, array) {
        ***REMOVED***ert.ifError(err);
        ***REMOVED***ert.ok(Array.isArray(array));
        ***REMOVED***ert.equal(2, array.length);
        ***REMOVED***ert(~array.indexOf(1));
        ***REMOVED***ert(~array.indexOf(2));
        done();
      });
    })
    ...
    describe('update', function(){
        ...
        m.count(function (err, _num) {
          ***REMOVED***ert.ifError(err);
          ...
          m.exec(function (err, res) {
            ***REMOVED***ert.ifError(err);
            ***REMOVED***ert.equal(num, res);
            mquery(col).find({ name: 'exec + update' }, function (err, docs) {
              ***REMOVED***ert.ifError(err);
              ***REMOVED***ert.equal(num, docs.length);
              done();
            })
          })
        })
      ...
      it('preserves key ordering', function(done) {
        ...
        for (var i in doc) {
          if (count == 0) {
            ***REMOVED***ert.equal('1', i);
          } else if (count == 1) {
            ***REMOVED***ert.equal('2', i);
          } else if (count ==2) {
            ***REMOVED***ert.equal('3', i);
          }
          count++;
        }
        done();
    ...
    describe('findOneAndUpdate', function(){
      it('with a callback', function(done){
        ...
        m.exec(function (err, doc) {
          ***REMOVED***ert.ifError(err);
          ***REMOVED***ert.equal('findOneAndUpdate', doc.name);
          done();
        });
      })
    })
    ...
    describe('findOneAndRemove', function(){
      it('with a callback', function(done){
        ...
        m.exec(function (err, doc) {
          ***REMOVED***ert.ifError(err);
          ***REMOVED***ert.equal('exec', doc.name);
          ***REMOVED***ert.equal(2, doc.age);
