 ...
 *
 *     // Video is now a subcl***REMOVED*** of mquery() and works the same way but with the
 ...
 * - coordinates {Array}
 *
 * The most recent path p***REMOVED***ed to `where()` is used.
 *
 ...
 *
 * Sets these ***REMOVED***ociated options.
 *
 ...
 *
 *     // you can also use mongodb.ReadPreference cl***REMOVED*** to also specify tags
...
Query.prototype.update = function update (criteria, doc, options, callback) {
    ...
    case 1:
      switch (typeof criteria) {
        case 'function':
          ...
          break;
        case 'boolean':
          // execution with no callback (u***REMOVED***fe write)
          force = criteria;
          criteria = undefined;
          break;
        default:
  ...
  // not forcing an u***REMOVED***fe write.
  if (!(force || callback))
    return this;
...
Query.prototype._findAndModify = function (type, callback) {
  ***REMOVED***ert.equal('function', typeof callback);
...
Query.prototype.exec = function exec (op, callback) {
  ...
  ***REMOVED***ert.ok(this.op, "Missing query type: (find, update, etc)");
