...
module.exports = {
  'should be able to ***REMOVED***ign multiple hooks at once': function () {
    var A = function () {};
    _.extend(A, hooks);
    A.hook({
      hook1: function (a) {},
    ...
    var a = new A();
    ***REMOVED***ert.equal(typeof a.hook1, 'function');
    ***REMOVED***ert.equal(typeof a.hook2, 'function');
  },
  ...
  'should not run a hook if a pre fails': function () {
    ...
    ***REMOVED***ert.equal(typeof a.value, 'undefined');
  },
  ...
  'should run multiple pres until a pre fails and not call the hook': function () {
    ...
    a.save();
    a.v1.should.equal(1);
    ***REMOVED***ert.equal(typeof a.v3, 'undefined');
    ***REMOVED***ert.equal(typeof a.value, 'undefined');
  },
  'should be able to run multiple posts': function () {
    ...
    var a = new A();
    a.save();
    ***REMOVED***ert.equal(a.value, 3.14);
    ***REMOVED***ert.equal(a.v3, 3);
  },
  ...
  "can p***REMOVED*** the hook's arguments verbatim to pres": function () {
    var A = function () {};
    _.extend(A, hooks);
...
//  "can p***REMOVED*** the hook's arguments as an array to pres": function () {
...
//    var a = new A();
//    a.set('hello', 'world');
//    ***REMOVED***ert.equal(a.hello, 'world');
//  },
  "can p***REMOVED*** the hook's arguments verbatim to posts": function () {
    var A = function () {};
    _.extend(A, hooks);
    A.hook('set', function (path, val) {
      this[path] = val;
...
//  "can p***REMOVED*** the hook's arguments as an array to posts": function () {
//    var A = function () {};
//    _.extend(A, hooks);
//    A.hook('set', function (path, val) {
//      this[path] = val;
...
//      ***REMOVED***ert.equal(args[0], 'hello');
//      ***REMOVED***ert.equal(args[1], 'world');
//      next();
//    });
//    var a = new A();
//    a.set('hello', 'world');
//    ***REMOVED***ert.equal(a.hello, 'world');
//  },
  "pres should be able to modify and p***REMOVED*** on a modified version of the hook's arguments": function () {
    var A = function () {};
    _.extend(A, hooks);
    A.hook('set', function (path, val) {
      this[path] = val;
      ***REMOVED***ert.equal(arguments[2], 'optional');
    });
    A.pre('set', function (next, path, val) {
      next('foo', 'bar');
    });
    A.pre('set', function (next, path, val) {
      ***REMOVED***ert.equal(path, 'foo');
      ***REMOVED***ert.equal(val, 'bar');
      next('rock', 'says', 'optional');
    });
    A.pre('set', function (next, path, val, opt) {
      ***REMOVED***ert.equal(path, 'rock');
      ***REMOVED***ert.equal(val, 'says');
      ***REMOVED***ert.equal(opt, 'optional');
      next();
    });
    var a = new A();
    a.set('hello', 'world');
    ***REMOVED***ert.equal(typeof a.hello, 'undefined');
  ...
  'should pad missing arguments (relative to expected arguments of the hook) with null': function () {
    ...
    A.pre('set', function (next, path, val, opts) {
      next('foo', 'bar');
      ***REMOVED***ert.equal(typeof opts, 'undefined');
    });
    var a = new A();
    a.set('hello', 'world');
  },
  ...
  'asynchronous middleware should be able to p***REMOVED*** an error via `done`, stopping the middleware chain': function () {
    var counter = 0;
    var A = function () {};
    _.extend(A, hooks);
  ...
  'should be able to remove all pres ***REMOVED***ociated with a hook': function () {
    var A = function () {};
    _.extend(A, hooks);
    A.hook('save', function () {
      this.value = 1;
