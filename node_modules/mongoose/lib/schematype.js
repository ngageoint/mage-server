 ...
 *
 * P***REMOVED***ing a validator function that receives two arguments tells mongoose that the validator is an asynchronous validator. The second argument is an callback function that must be p***REMOVED***ed either `true` or `false` when validation is complete.
 *
