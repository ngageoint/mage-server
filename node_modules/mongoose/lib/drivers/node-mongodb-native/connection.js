...
NativeConnection.prototype.useDb = function (name) {
  ...
  newConn.p***REMOVED*** = this.p***REMOVED***;
 ...
 *
 * See description of [doOpen](#NativeConnection-doOpen) for server options. In this case `options.replset` is also p***REMOVED***ed to ReplSetServers.
 *
 * @param {Function} fn
 * @api private
 * @return {Connection} this
 ...
 *
 * _NOTE: `p***REMOVED***ed` options take precedence over connection string options._
 *
 * @param {Object} p***REMOVED***ed options that were p***REMOVED***ed directly during connection
 * @param {Object} [connStrOptions] options that were p***REMOVED***ed in the connection string
 * @api private
 */

NativeConnection.prototype.parseOptions = function (p***REMOVED***ed, connStrOpts) {
  var o = p***REMOVED***ed || {};
  o.db || (o.db = {});
  o.auth || (o.auth = {});
  o.server || (o.server = {});
