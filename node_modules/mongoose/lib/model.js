...
function ***REMOVED***ignVals (opts) {
  ...
  ***REMOVED***ignRawDocsToIdStructure(rawIds, rawDocs, options);
...
function ***REMOVED***ignRawDocsToIdStructure (rawIds, vals, options, recursed) {
  ...
  for (var i = 0; i < rawIds.length; ++i) {
    ...
    if (Array.isArray(id)) {
      // handle [ [id0, id2], [id3] ]
      ***REMOVED***ignRawDocsToIdStructure(id, vals, options, true);
      newOrder.push(id);
      continue;
    }
