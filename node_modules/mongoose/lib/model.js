 ...
 * @inherits Document
 * @event `error`: If listening to this Model event, it is emitted when a document was saved without p***REMOVED***ing a callback and an `error` occurred. If not listening, the event bubbles to the connection used to create this Model.
...
Model.populate = function (docs, paths, cb) {
  ***REMOVED***ert.equal('function', typeof cb);
