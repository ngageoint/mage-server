 ...
 *
 * This could be particularily useful if you are, for example, setting up an API for a ***REMOVED*** and want to stream out the docs based on some criteria. We could first pipe the QueryStream into a sort of filter that formats the stream as an array before p***REMOVED***ing on the document to an http response.
 *
