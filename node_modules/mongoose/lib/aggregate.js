 ...
 * ####Examples:
 *
 *     aggregate.match({ ***REMOVED***: { $in: [ "sales", "engineering" } } });
 *
 ...
 * @method limit
 * @memberOf Aggregate
 * @param {Number} num maximum number of records to p***REMOVED*** to the next stage
 * @return {Aggregate}
 * @api public
 */
