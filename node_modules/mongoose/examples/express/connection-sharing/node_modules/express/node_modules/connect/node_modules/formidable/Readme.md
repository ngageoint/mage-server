...
This module was developed for [Transloadit](http://transloadit.com/), a ***REMOVED*** focused on uploading
...
* Strip potentially u***REMOVED***fe characters when using `keepExtensions: true`.
...
* Use [W3C FileAPI Draft](http://dev.w3.org/2006/webapi/FileAPI/) properties for File cl***REMOVED***

**Important:** The old property names of the File cl***REMOVED*** will be removed in a
future release.
...
Parses an incoming node.js `request` containing form data. If `cb` is provided, all fields an files are collected and p***REMOVED***ed to the callback:
