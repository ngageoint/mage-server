 ...
 * added; p***REMOVED*** the doc to doc.remove() callback #1419 [JoeWagner](https://github.com/JoeWagner)
...
==================
  ...
  * fixed; properly p***REMOVED*** subtype to Binary in MongooseBuffer
...
==================
  ...
  * updated; driver to 1.2.12
  * fixed; properly p***REMOVED*** Binary subtype
  * fixed; add EventEmitter props to reserved paths #1338
...
==================
  ...
  * fixed; always p***REMOVED*** current document to post hooks
  ...
  * fixed; p***REMOVED***ing model name + collection name now always honors collection name
  * fixed; setting virtual field to an empty object #1154
  * fixed; subcl***REMOVED***ed MongooseErrors exposure, now available in mongoose.Error.xxxx
...
==================
  ...
  * fixed; p***REMOVED***ing options as 2nd arg to connect() #1144
...
==================
  ...
  * added; direct array index ***REMOVED***ignment with casting support `doc.array.set(index, value)`
...
=========================
  ...
  * changed; index errors are now emitted on their model and p***REMOVED***ed to an optional callback (#984)
...
=========================
  ...
  * fixed; no need to p***REMOVED*** updateArg to findOneAndUpdate (#931)
  ...
  * fixed; doc#remove now p***REMOVED***es safe options
  ...
  * fixed; handle p***REMOVED***ing db name with any repl set string
  ...
  * fixed; connection ***REMOVED***ignment in Model#model (#853)
  * fixed; stringifying arrays of docs (#852)
  * fixed; modifying subdoc and parent array works (#842)
  * fixed; p***REMOVED***ing undefined to next hook (#785)
  ...
  * fixed; support for p***REMOVED***ing $options with $regex
...
===================
  ...
  * fixed; p***REMOVED*** option `safe` along to doc#remove() calls
...
===================
  ...
  * fixed; connection ***REMOVED***ignment in mongoose#model (#853, #877)
  * fixed; incorrect reported num of affected docs in update ops (#862)
...
===================
  ...
  * fixed; issue with p***REMOVED***ing undefined to a hook callback. thanks to [chrisleishman] for reporting.
...
===================
  ...
  * added; more flexible user/p***REMOVED***word connection options (#738) [KarneAsada]
...
===================
  ...
  * added; p***REMOVED*** number of affected docs back in model.update/save
...
===================
  ...
  * fixed; regression, objects p***REMOVED***ed to Model.update should not be changed (#605)
...
==================
  ...
  * fixed; calling queries without p***REMOVED***ing a callback works (#569)
...
==================
  ...
  * fixed; correctly p***REMOVED*** $addToSet op instead of $push
...
==================
  ...
  * fixed; p***REMOVED***ing collection name via schema in conn.model() now works (thanks vedmalex for reporting)
...
==================
  ...
  * added; p***REMOVED*** model.options.safe through with .save() so w:2, wtimeout:5000 options work [andrewjstone]
...
===================
  ...
  * Fixed; support for p***REMOVED***ing other context object into Schemas (#234) [Sija]
...
===================
  ...
  * added; support for p***REMOVED***ing options to node-mongo-native db, server, and replsetserver [tomseago]
...
===================
  ...
  * fixed/changed; Mongodb segfault when p***REMOVED***ed invalid ObjectId (#407)
      - This means invalid data p***REMOVED***ed to the ObjectId constructor will now error
...
===================
  ...
  * changed; node-mongodb-native version bumped to 0.9.6.1 - When .remove() doesn't
             return an error, null is no longer p***REMOVED***ed.
  * fixed; two memory leaks (@justmoon)
  * added; sparse index support
  * added; more ObjectId conditionals (gt, lt, gte, lte) (@phillyqueso)
  * added; options are now p***REMOVED***ed in model#remote (@JerryLuke)

1.4.0 / 2011-06-10
===================

  * bumped hooks-js dependency (fixes issue p***REMOVED***ing null as first arg to next())
...
===================
  ...
  * changed; .save() now p***REMOVED***es the instance to the callback (GH-294, GH-264)
