 ...
 * p***REMOVED***ed as a third argument, which will be set by P***REMOVED***port at `req.authInfo`,
 * where it can be used by later middleware for access control.  This is
 * typically used to p***REMOVED*** any scope ***REMOVED***ociated with the token.
 *
 * Options:
