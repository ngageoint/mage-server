...
vows.describe('ArcGIS').addBatch({
  'When Converting a GeoJSON Point to an ArcGIS Point': {
    ...
    'it should convert correctly': function (topic) {
      ...
      ***REMOVED***ert.deepEqual(topic, expect, 'GeoJSON is correct');
    }
  },
  ...
  'When Converting an ArcGIS Point to Primitive': {
    ...
    'it should convert correctly': function (topic) {
      ***REMOVED***ert.deepEqual(topic.coordinates, [-66.796875, 20.0390625]);
    }
  },
  'When Converting an ArcGIS Polyline to Primitive': {
    ...
    'it should convert correctly': function (topic) {
      ***REMOVED***ert.deepEqual(topic.coordinates, [ [6.6796875,47.8125],[-65.390625,52.3828125],[-52.3828125,42.5390625] ]);
    }
  },
  'When Converting an ArcGIS Polygon to Primitive': {
    ...
    'it should convert correctly': function (topic) {
      ***REMOVED***ert.deepEqual(topic.coordinates, [[ [41.8359375,71.015625],[56.953125,33.75],[21.796875,36.5625],[41.8359375,71.015625] ]]);
    }
  },
  'When Converting an ArcGIS MultiPoint to Primitive': {
    ...
    'it should convert correctly': function (topic) {
      ***REMOVED***ert.deepEqual(topic.coordinates, [ [41.8359375,71.015625],[56.953125,33.75],[21.796875,36.5625] ]);
    }
  },
  'When Converting a Different ArcGIS Polygon to Primitive': {
    ...
    'it should convert correctly': function (topic) {
      ***REMOVED***ert.deepEqual(topic.coordinates, [[ [-122.63,45.52],[-122.57,45.53],[-122.52,45.50],[-122.49,45.48],[-122.64,45.49],[-122.63,45.52],[-122.63,45.52] ],[ [-83,35],[-74,35],[-74,41],[-83,41],[-83,35] ]]);
    }
  }
}).export(module);
