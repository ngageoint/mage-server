this.ExtBootstrapData = {
    "nameToAliasesMap":{
        ...
        "Ext.data.***REMOVED***ociation.BelongsTo":["***REMOVED***ociation.belongsto"
        ],
        "Ext.data.***REMOVED***ociation.HasMany":["***REMOVED***ociation.hasmany"
        ],
        "Ext.data.***REMOVED***ociation.HasOne":["***REMOVED***ociation.hasone"
        ],
        ...
        "Ext.direct.Tra***REMOVED***ction":["direct.tra***REMOVED***ction"
        ],
        "Ext.draw.Color":[],
    ...
    "alternateToNameMap":{
        ...
        "Ext.data.Association":"Ext.data.***REMOVED***ociation.Association",
        "Ext.data.BelongsToAssociation":"Ext.data.***REMOVED***ociation.BelongsTo",
        "Ext.data.HasManyAssociation":"Ext.data.***REMOVED***ociation.HasMany",
        "Ext.data.HasOneAssociation":"Ext.data.***REMOVED***ociation.HasOne",
        ...
        "Ext.Direct.Tra***REMOVED***ction":"Ext.direct.Tra***REMOVED***ction",
...
(function() {
    var scripts = document.getElementsByTagName('script'),
        ...
        Loader = Ext.Loader,
        Cl***REMOVED***Manager = Ext.Cl***REMOVED***Manager,
            ...
            if (nameToAliasesMap.hasOwnProperty(name)) {
                ...
                if (aliases.length > 0) {
                    for (i = 0,ln = aliases.length; i < ln; i++) {
                        Cl***REMOVED***Manager.setAlias(name, aliases[i]);
                    }
                }
                else {
                    Cl***REMOVED***Manager.setAlias(name, null);
                }
            }
        }
    }
    ...
    if (alternateToNameMap) {
        Ext.merge(Cl***REMOVED***Manager.maps.alternateToName, alternateToNameMap);
    }
