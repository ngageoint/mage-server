...
Ext.define('Ext.Neptune.panel.Tool', {
    ...
    renderTpl: ['<div id="{id}-toolEl" cl***REMOVED***="{baseCls}-{type}" role="presentation"></div>']
});
...
Ext.define('Ext.Neptune.grid.column.Column', {
    ...
    initComponent: function() {
		...
		Ext.grid.column.Column.supercl***REMOVED***.initComponent.call(this, arguments);
...
Ext.define('Ext.Neptune.layout.container.Accordion', {
    ...
    beforeRenderItems: function (items) {
        ...
        for (i = 0; i < ln; i++) {
            comp = items[i];
            if (!comp.rendered) {
                // Add cl***REMOVED*** to the Panel's header before render
                comp.on({
...
Ext.define('Ext.Neptune.panel.Header', {
    ...
    initComponent: function() {
		...
		Ext.panel.Header.supercl***REMOVED***.initComponent.call(this, arguments);
...
Ext.define('Ext.Neptune.tree.Panel', {
    ...
    initComponent: function() {
        ...
        me.cls = cls.join(' ');
        Ext.tree.Panel.supercl***REMOVED***.initComponent.apply(me, arguments);
