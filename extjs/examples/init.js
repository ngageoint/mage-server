                        ...
                        '<dd ext:url="{url}"><img src="shared/screens/{icon}"/>',
                            '<div><h4>{text}',
                                '<tpl if="this.isNew(values.status)">',
                                    '<span cl***REMOVED***="new-sample"> (New)</span>',
                                '<tpl elseif="this.isUpdated(values.status)">',
                                    '<span cl***REMOVED***="updated-sample"> (Updated)</span>',
                                '<tpl elseif="this.isExperimental(values.status)">',
                                    '<span cl***REMOVED***="new-sample"> (Experimental)</span>',
                                '<tpl elseif="status">',
                                    '<span cl***REMOVED***="status"> ({status})</span>',
                                '</tpl>',
                            '</h4><p>{desc}</p></div>',
                        '</dd>',
                    '</tpl>',
...
Ext.onReady(function() {
    ...
    (Ext.defer(function() {
        ...
        var headerEl  = Ext.get('hd'),
            footerEl  = Ext.get('ft'),
            bodyEl    = Ext.get('bd'),
            sideBoxEl = bodyEl.down('div[cl***REMOVED***=side-box]'),
