/**
 * @cl***REMOVED*** SimpleTasks.ux.DropZone
...
Ext.define('SimpleTasks.ux.DropZone', {
    ...
    onNodeOver: function(node, dragZone, e, data) {
        ...
        // if we're dragging to reorder rows within the List Tree, then call supercl***REMOVED*** onNodeOver.
        // This allows the supercl***REMOVED*** to show the visual position indicator.
