/**
 * @cl***REMOVED*** SimpleTasks.controller.Lists
        ...
        Ext.Msg.show({
            ...
            fn: function(response) {
                if(response === 'yes') {
                    ...
                    // recursively remove any tasks from the store that are ***REMOVED***ociated with the list being deleted or any of its children.
                    ...
                    if(isLocal) {
                        ...
                        // when using an ajax proxy we will allow the server to handle deleting any tasks ***REMOVED***ociated with the deleted list(s)
                        tasksStore.sync();
                    }
