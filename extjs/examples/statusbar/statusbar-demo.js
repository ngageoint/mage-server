 ...
 */
    Ext.create('Ext.Panel', {
        ...
        items:[{
            ...
            id: 'basic-button',
            text: 'Do Loading',
            handler: Ext.Function.p***REMOVED***(loadFn, ['basic-button', 'basic-statusbar'])
        }],
 ...
 */
    Ext.create('Ext.Panel', {
        ...
        items:[{
            ...
            id: 'right-button',
            text: 'Do Loading',
            handler: Ext.Function.p***REMOVED***(loadFn, ['right-button', 'right-statusbar'])
        }],
        bbar: Ext.create('Ext.ux.StatusBar', {
 ...
 */
    var win = Ext.create('Ext.Window', {
        ...
        items:[{
            ...
            id: 'win-button',
            text: 'Do Loading',
            handler: Ext.Function.p***REMOVED***(loadFn, ['win-button', 'win-statusbar'])
        }],
        bbar: Ext.create('Ext.ux.StatusBar', {
            id: 'win-statusbar',
            defaultText: 'Ready',
 ...
 */
    ...
    Ext.create('Ext.Panel', {
        ...
        bbar: Ext.create('Ext.ux.StatusBar', {
            ...
            // custom cl***REMOVED***es below in the render handler which is what gives them their
        ...
        listeners: {
            render: {
                fn: function(){
                    // Add a cl***REMOVED*** to the parent TD of each text item so we can give them some custom inset box
