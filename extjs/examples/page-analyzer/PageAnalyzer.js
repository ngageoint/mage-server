...
Ext.define('PageAnalyzer.MainForm', {
    ...
    layoutTpl: [
        '<tpl if="isBoxParent">',
            '<img cl***REMOVED***="x-tree-icon" src="resources/images/boxParent.gif">',
        '</tpl>',
        '{name:this.encode}',
        {
    ...
    triggerTpl: [
        '<div cl***REMOVED***="pgan-{[values.missing ? "missing" : "available"]}-value">',
    ...
    createLayoutTree: function() {
        var me = this,
            ...
            tree = {
                ...
                region: 'center',
                viewConfig: {
                    getRowCl***REMOVED***: function (record) {
    ...
    getCompNodeForElem: function(el, root, refName) {
        ...
        return new PageAnalyzer.models.ComponentTreeNode({
            ...
            cssCl***REMOVED***: el.dom ? el.dom.cl***REMOVED***Name : undefined,
            refName: refName,
            isContainer: false,
            isComponent: false,
            isElement: true,
