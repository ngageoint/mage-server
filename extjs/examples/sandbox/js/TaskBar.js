    ...
    init : function(){
        ...
        this.startBtn = new Ext.Button({
            ...
            template: new Ext.Template(
                '<table cellspacing="0" cl***REMOVED***="x-btn"><tbody cl***REMOVED***="{1}"><tr>',
                '<td cl***REMOVED***="ux-startbutton-left"><i>&#160;</i></td>',
                '<td cl***REMOVED***="ux-startbutton-center"><em cl***REMOVED***="{2} unselectable="on">',
                    '<button cl***REMOVED***="x-btn-text" type="{0}" style="height:30px;"></button>',
                '</em></td>',
                '<td cl***REMOVED***="ux-startbutton-right"><i>&#160;</i></td>',
                '</tr></tbody></table>')
        });
...
/**
 * @cl***REMOVED*** Ext.ux.TaskBarContainer
 * @extends Ext.Container
 */
Ext.ux.TaskBarContainer = Ext.extend(Ext.Container, {
    initComponent : function() {
        Ext.ux.TaskBarContainer.supercl***REMOVED***.initComponent.call(this);
...
/**
 * @cl***REMOVED*** Ext.ux.TaskButtonsPanel
...
Ext.ux.TaskButtonsPanel = Ext.extend(Ext.BoxComponent, {
    ...
    initComponent : function() {
        Ext.ux.TaskButtonsPanel.supercl***REMOVED***.initComponent.call(this);
    ...
    autoScroll : function(){
        ...
        if(l <= tw){
            ...
            if(this.scrolling){
                ...
                this.el.removeCl***REMOVED***('x-taskbuttons-scrolling');
                this.scrollLeft.hide();
                this.scrollRight.hide();
            }
        }else{
            if(!this.scrolling){
                this.el.addCl***REMOVED***('x-taskbuttons-scrolling');
            }
    ...
    createScrollers : function(){
        ...
        sl.setHeight(h);
        sl.addCl***REMOVED***OnOver('ux-taskbuttons-scroller-left-over');
        ...
        sr.setHeight(h);
        sr.addCl***REMOVED***OnOver('ux-taskbuttons-scroller-right-over');
    ...
    updateScrollButtons : function(){
        var pos = this.getScrollPos();
        this.scrollLeft[pos == 0 ? 'addCl***REMOVED***' : 'removeCl***REMOVED***']('ux-taskbuttons-scroller-left-disabled');
        this.scrollRight[pos >= (this.getScrollWidth()-this.getScrollArea()) ? 'addCl***REMOVED***' : 'removeCl***REMOVED***']('ux-taskbuttons-scroller-right-disabled');
    }
});
...
/**
 * @cl***REMOVED*** Ext.ux.TaskBar.TaskButton
 * @extends Ext.Button
 */
Ext.ux.TaskBar.TaskButton = function(win, el){
    this.win = win;
    Ext.ux.TaskBar.TaskButton.supercl***REMOVED***.constructor.call(this, {
        iconCls: win.iconCls,
        ...
        clickEvent:'mousedown',
        template: new Ext.Template(
            '<table cellspacing="0" cl***REMOVED***="x-btn {3}"><tbody><tr>',
            '<td cl***REMOVED***="ux-taskbutton-left"><i>&#160;</i></td>',
            '<td cl***REMOVED***="ux-taskbutton-center"><em cl***REMOVED***="{5} unselectable="on">',
                '<button cl***REMOVED***="x-btn-text {2}" type="{1}" style="height:28px;">{0}</button>',
            '</em></td>',
            '<td cl***REMOVED***="ux-taskbutton-right"><i>&#160;</i></td>',
            "</tr></tbody></table>")
    });
};
...
Ext.extend(Ext.ux.TaskBar.TaskButton, Ext.Button, {
    onRender : function(){
        Ext.ux.TaskBar.TaskButton.supercl***REMOVED***.onRender.apply(this, arguments);
