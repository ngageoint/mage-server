...
Ext.ux.StartMenu = Ext.extend(Ext.menu.Menu, {
    initComponent: function(config) {
    	Ext.ux.StartMenu.supercl***REMOVED***.initComponent.call(this, config);
    ...
    onRender : function(ct, position){
        Ext.ux.StartMenu.supercl***REMOVED***.onRender.call(this, ct, position);
        var el = this.el.addCl***REMOVED***('ux-start-menu');
        ...
        this.toolItems.each(
        	function(item){
	            ...
	            li.cl***REMOVED***Name = "x-menu-list-item";
