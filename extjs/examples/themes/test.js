...
/**
 * @cl***REMOVED*** Ext.ux.event.Driver
 * This is the base cl***REMOVED*** for {@link Recorder} and {@link Player}.
 */
...
/**
 * @cl***REMOVED*** Ext.ux.event.Player
 * @extends Ext.ux.event.Driver
 *
 * This cl***REMOVED*** manages the playback of an array of "event descriptors". For details on the
 * contents of an "event descriptor", see {@link Recorder}. The events recorded by the
 * {@link Recorder} cl***REMOVED*** are designed to serve as input for this cl***REMOVED***.
 * 
 * The simplest use of this cl***REMOVED*** is to instantiate it with an {@link #eventQueue} and call
 * {@link #start}. Like so:
 *
