/**
 * @cl***REMOVED*** FeedViewer.FeedPost
    ...
    initComponent: function(){
        Ext.apply(this, {
            ...
            tpl: Ext.create('Ext.XTemplate',
                '<div cl***REMOVED***="post-data">',
                    '<span cl***REMOVED***="post-date">{pubDate:this.formatDate}</span>',
                    '<h3 cl***REMOVED***="post-title">{title}</h3>',
                    '<h4 cl***REMOVED***="post-author">by {author:this.defaultValue}</h4>',
                '</div>',
                '<div cl***REMOVED***="post-body">{content:this.getBody}</div>',
                {
