...
Ext.onReady(function() {
    ...
    var formPanel = Ext.widget('form', {
        ...
        items: [{
            ...
            xtype: 'textfield',
            name: 'p***REMOVED***word2',
            fieldLabel: 'Repeat P***REMOVED***word',
            inputType: 'p***REMOVED***word',
            allowBlank: false,
            /**
             * Custom validator implementation - checks that the value matches what was entered into
             * the p***REMOVED***word1 field.
             */
            validator: function(value) {
                var p***REMOVED***word1 = this.previousSibling('[name=p***REMOVED***word1]');
                return (value === p***REMOVED***word1.getValue()) ? true : 'P***REMOVED***words do not match.'
            }
        },
         ...
         */
        {
            ...
            hideLabel: true,
            style: 'margin-top:15px',
            boxLabel: 'I have read and accept the <a href="#" cl***REMOVED***="terms">Terms of Use</a>.',
        ...
        dockedItems: [{
            ...
            items: [{
                ...
                tipTpl: Ext.create('Ext.XTemplate', '<ul><tpl for="."><li><span cl***REMOVED***="field-name">{name}</span>: <span cl***REMOVED***="error">{error}</span></li></tpl></ul>'),
                ...
                setErrors: function(errors) {
                    ...
                    // Update CSS cl***REMOVED*** and tooltip content
                    if (errors.length) {
