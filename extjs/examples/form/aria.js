...
/**
 * @cl***REMOVED*** Ext.aria.AriaController
 * <p>This cl***REMOVED*** supplies support methods for integrating ARIA support into Components.</p>
 * 
 */
Ext.define('Ext.aria.AriaController', {
    ...
    // This function is called as an interceptor of the target cl***REMOVED***'s fireEvent method
    // It invokes the event's ariaHandler if present
    ariaFireEvent: function(evt){
        var me = this,
            evtName = evt.toLowerCase(),
            args = Array.prototype.slice.call(arguments, 1),
            cl***REMOVED***Fn = Ext.aria.AriaController.getCl***REMOVED***AriaHandler(this.self.prototype, evtName),
        ...
        if (result !== false) {
            ...
            // Then cl***REMOVED***'s configured ARIA event handler
            if (typeof cl***REMOVED***Fn === 'function') {
                result = cl***REMOVED***Fn.apply(me, args);
            }
        }
        return result;
    },

    // Examine the p***REMOVED***ed cl***REMOVED*** prototype for an aria_event_handler, and if not found, continue up the prototype chain.
    getCl***REMOVED***AriaHandler: function(clsProto, evtName) {
        ...
        // If there is no generated ariaEventHandler for the cl***REMOVED***/event, we must generate one
        ...
        if (!result) {
            ...
            while (curProto) {
                ...
                curProto = curProto.supercl***REMOVED***;
            }
    ...
    processCl***REMOVED***: function(cls, props) {
        var me = this,
        ...
        for (propName in props) {
            if (props.hasOwnProperty(propName)) {
                ...
                if (k && (typeof value === 'function')) {
                    ...
                    // Hang the ariaHandlers on the cl***REMOVED***'s prototype.
        ...
        // Replace the cl***REMOVED***'s fireEvent method with our code which intercepts relevant events,
...
Ext.onReady(function() {
    Ext.aria.AriaController.processCl***REMOVED***(Ext.AbstractComponent, {
        onDisable: function() {
    ...
    Ext.aria.AriaController.processCl***REMOVED***(Ext.form.FieldSet, {
        onRender: function() {
            this.updateAria({
    ...
    Ext.aria.AriaController.processCl***REMOVED***(Ext.form.field.Base, {
        onRender: function() {
            if (this.labelEl) {
    ...
    Ext.aria.AriaController.processCl***REMOVED***(Ext.form.field.Text, {
        role: 'textbox'
    });

    Ext.aria.AriaController.processCl***REMOVED***(Ext.form.field.Number, {
        role: 'spinbutton',
    ...
    Ext.aria.AriaController.processCl***REMOVED***(Ext.form.field.Picker, function() {
        var listFns = {
    ...
    Ext.aria.AriaController.processCl***REMOVED***(Ext.view.BoundList, {
        role: 'listbox'
    });
...
/**
 * @cl***REMOVED*** Ext.picker.Date
 * @extends Ext.Component
 * <p>A date picker. This cl***REMOVED*** is used by the {@link Ext.form.field.Date} field to allow browsing and
...
Ext.define('Ext.picker.NewDate', {
    ...
    alternateCl***REMOVED***Name: 'Ext.DatePicker',

    renderTpl: [
        '<div cl***REMOVED***="{cls}" id="{id}" role="grid" title="{ariaTitle} {value:this.longDay}">',
            '<div role="presentation" cl***REMOVED***="{baseCls}-header">',
                '<div cl***REMOVED***="{baseCls}-prev"><a id="{id}-prevEl" href="#" role="button" title="{prevText}"></a></div>',
                '<div cl***REMOVED***="{baseCls}-month" id="{id}-middleBtnEl"></div>',
                '<div cl***REMOVED***="{baseCls}-next"><a id="{id}-nextEl" href="#" role="button" title="{nextText}"></a></div>',
            '</div>',
            '<div id="{id}-calendarContainer"></div>',
            '<tpl if="showToday">',
                '<div id="{id}-footerEl" role="presentation" cl***REMOVED***="{baseCls}-footer"></div>',
            '</tpl>',
        '</div>',
        {
    ...
    calendarTpl: [
        '<table cl***REMOVED***="{baseCls}-inner" cellspacing="0" role="presentation">' +
            ...
            '<tbody role="presentation"><tr role="presentation">' +
                '<tpl for="days">' +
                    '{#:this.isEndOfWeek}' +
                    '<td role="gridcell" id="{[Ext.id()]}" cl***REMOVED***="{[this.getCellCl***REMOVED***(values, parent)]}" title="{date:this.titleFormat}">' +
                        '<a role="presentation" href="#" hidefocus="on" cl***REMOVED***="{parent.baseCls}-date" tabIndex="1">' +
        ...
        cellCl***REMOVED***: function(value, data) {
     ...
     * The handler is p***REMOVED***ed the following parameters:<div cl***REMOVED***="mdetail-params"><ul>
     * <li><code>picker</code> : Ext.picker.Date <div cl***REMOVED***="sub-desc">This Date picker.</div></li>
     * <li><code>date</code> : Date <div cl***REMOVED***="sub-desc">The selected date.</div></li>
     * </ul></div>
     */
    /**
     * @cfg {Object} scope
    ...
    /**
     * @cfg {String} baseCls
     * The base CSS cl***REMOVED*** to apply to this components element (defaults to <tt>'x-datepicker'</tt>).
     */
    baseCls: Ext.baseCSSPrefix + 'datepicker',

    /**
     * @cfg {String} selectedCls
     * The cl***REMOVED*** to apply to the selected cell. Defaults to <tt>'x-datepicker-selected'</tt>
     */

    /**
     * @cfg {String} disabledCellCls
     * The cl***REMOVED*** to apply to disabled cells. Defaults to <tt>'x-datepicker-disabled'</tt>
     */
...
// private, inherit docs
    ...
    fullUpdate: function(date, active){
        ...
        setCellCl***REMOVED*** = function(cell){
            value = +eDate.clearTime(current, true);
            cell.title = eDate.format(current, longDayFormat);
            // store dateValue number as an expando
            cell.firstChild.dateValue = value;
            if(value == today){
                cell.cl***REMOVED***Name += ' ' + me.todayCls;
                cell.title = me.todayText;
            }
            if(value == sel){
                cell.cl***REMOVED***Name += ' ' + me.selectedCls;
            ...
            // disabling
            if(value < min) {
                cell.cl***REMOVED***Name = disabledCls;
        ...
        for(; i < me.numDays; ++i) {
            ...
            cells[i].cl***REMOVED***Name = cls;
            current.setDate(current.getDate() + 1);
            setCellCl***REMOVED***(cells[i]);
        }
