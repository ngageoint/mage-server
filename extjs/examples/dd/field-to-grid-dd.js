    ...
    init: function(grid) {
        ...
        if (grid.rendered) {
            ...
            grid.getView().on({
                render: function(v) {
                    me.view = v;
                    Ext.ux.CellFieldDropZone.supercl***REMOVED***.constructor.call(me, me.view.el);
                },
                single: true
            });
        } else {
...
//  Return the cl***REMOVED*** name to add to the drag proxy. This provides a visual indication
...
//  A cl***REMOVED*** which makes Fields within a Panel draggable.
...
//  Call the DRagZone's constructor. The Panel must have been rendered.
    init: function(panel) {
        if (panel.nodeType) {
            Ext.ux.PanelFieldDragZone.supercl***REMOVED***.init.apply(this, arguments);
        } else {
            if (panel.rendered) {
                Ext.ux.PanelFieldDragZone.supercl***REMOVED***.constructor.call(this, panel.getEl());
