...
Ext.onReady(function() {
    ...
    var patientView = Ext.create('Ext.view.View', {
        cls: 'patient-view',
        tpl: '<tpl for=".">' +
                '<div cl***REMOVED***="patient-source"><table><tbody>' +
                    '<tr><td cl***REMOVED***="patient-label">Name</td><td cl***REMOVED***="patient-name">{name}</td></tr>' +
                    '<tr><td cl***REMOVED***="patient-label">Address</td><td cl***REMOVED***="patient-name">{address}</td></tr>' +
                    '<tr><td cl***REMOVED***="patient-label">Telephone</td><td cl***REMOVED***="patient-name">{telephone}</td></tr>' +
                '</tbody></table></div>' +
             '</tpl>',
        itemSelector: 'div.patient-source',
        overItemCls: 'patient-over',
        selectedItemCl***REMOVED***: 'patient-selected',
        singleSelect: true,
        store: patientStore,
        listeners: {
 ...
 * We have decided that each node with the cl***REMOVED*** "patient-source" encapsulates a single draggable
 * object.
 *
 * So we inject code into the DragZone which, when p***REMOVED***ed a mousedown event, interrogates
 * the event to see if it was within an element with the cl***REMOVED*** "patient-source". If so, we
 ...
 * We have decided that the element with cl***REMOVED*** "hospital-target" is the element which can receieve
