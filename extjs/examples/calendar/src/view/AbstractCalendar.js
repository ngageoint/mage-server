/**
 * @cl***REMOVED*** Ext.calendar.view.AbstractCalendar
 * @extends Ext.BoxComponent
 * <p>This is an abstract cl***REMOVED*** that serves as the base for other calendar views. This cl***REMOVED*** is not
 * intended to be directly instantiated.</p>
 * <p>When extending this cl***REMOVED*** to create a custom calendar view, you must provide an implementation
 ...
 * is determined by the underlying UI template (this base cl***REMOVED*** does not have a template).</p>
 * @constructor
...
Ext.define('Ext.calendar.view.AbstractCalendar', {
    ...
    eventOverCl***REMOVED***: 'ext-evt-over',
    ...
    // must be implemented by a subcl***REMOVED***
    /**
     ...
     * @return {String} The selector cl***REMOVED***
     */
     ...
     * earliest and latest dates that match the view requirements and contain the date p***REMOVED***ed to this function.
    ...
    /**
     * Updates the view to contain the p***REMOVED***ed date
    ...
    /**
     * Shifts the view by the p***REMOVED***ed number of months relative to the currently set date
    ...
    /**
     * Shifts the view by the p***REMOVED***ed number of weeks relative to the currently set date
    ...
    /**
     * Shifts the view by the p***REMOVED***ed number of days relative to the currently set date
     ...
     * can handle the click (and so the subcl***REMOVED*** should ignore it) else false.
     */
    ...
    handleEventMouseEvent: function(e, t, type) {
        ...
        if (el) {
            ...
            if (this.eventOverCl***REMOVED*** != '') {
                els = this.getEventEls(evtId);
                els[type == 'over' ? 'addCls': 'removeCls'](this.eventOverCl***REMOVED***);
            }
        ...
        if (t) {
            if (t.id && t.id.indexOf(this.dayElIdDelimiter) > -1) {
                ...
                if (!rel || dt != relDate) {
                    ...
                    if (el && this.dayOverCl***REMOVED*** != '') {
                        el[type == 'over' ? 'addCls': 'removeCls'](this.dayOverCl***REMOVED***);
                    }
    ...
    renderItems: function() {
        throw 'This method must be implemented by a subcl***REMOVED***';
    },
