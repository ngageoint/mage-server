/**
 * @cl***REMOVED*** Ext.calendar.CalendarPanel
 * @extends Ext.Panel
 * <p>This is the default container for Ext calendar views. It supports day, week and month views as well
 * as a built-in event edit form. The only requirement for displaying a calendar is p***REMOVED***ing in a valid
...
Ext.define('Ext.calendar.CalendarPanel', {
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {Ext.calendar.CalendarPanel} this
             * @param {Ext.Ext.calendar.view.AbstractCalendar} view The view being activated (any valid {@link Ext.calendar.view.AbstractCalendar AbstractCalendar} subcl***REMOVED***)
             * @param {Object} info Extra information about the newly activated view. This is a plain object 
             * with following properties:<div cl***REMOVED***="mdetail-params"><ul>
             * <li><b><code>activeDate</code></b> : <div cl***REMOVED***="sub-desc">The currently-selected date</div></li>
             * <li><b><code>viewStart</code></b> : <div cl***REMOVED***="sub-desc">The first date in the new view range</div></li>
             * <li><b><code>viewEnd</code></b> : <div cl***REMOVED***="sub-desc">The last date in the new view range</div></li>
             * </ul></div>
             */
            viewchange: true
    ...
    /**
     * Shows the built-in event edit form for the p***REMOVED***ed in event record.  This method automatically
    ...
    /**
     * Return the calendar view that is currently active, which will be a subcl***REMOVED*** of
