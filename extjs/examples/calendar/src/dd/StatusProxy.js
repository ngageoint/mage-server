/*
 * @cl***REMOVED*** Ext.calendar.dd.StatusProxy
...
Ext.define('Ext.calendar.dd.StatusProxy', {
     ...
     * The CSS cl***REMOVED*** to apply to the status element when an event is being dragged (defaults to 'ext-cal-dd-move').
     */
    moveEventCls : 'ext-cal-dd-move',
    
    /**
     * @cfg {String} addEventCls
     * The CSS cl***REMOVED*** to apply to the status element when drop is not allowed (defaults to 'ext-cal-dd-add').
     */
    ...
    renderTpl: [
        ...
        '<div cl***REMOVED***="ext-dd-ghost-ct">' +
            '<div id="{id}-ghost" cl***REMOVED***="' + Ext.baseCSSPrefix + 'dd-drag-ghost"></div>' +
            '<div id="{id}-message" cl***REMOVED***="' + Ext.baseCSSPrefix + 'dd-msg"></div>' +
        '</div>'
    ],
