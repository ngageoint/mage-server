/**
 * @cl***REMOVED*** Ext.calendar.template.DayHeader
...
Ext.define('Ext.calendar.template.DayHeader', {
    ...
    constructor: function(config){
        ...
        this.callParent([
            '<div cl***REMOVED***="ext-cal-hd-ct">',
                '<table cl***REMOVED***="ext-cal-hd-days-tbl" cellspacing="0" cellpadding="0">',
                    '<tbody>',
                        '<tr>',
                            '<td cl***REMOVED***="ext-cal-gutter"></td>',
                            '<td cl***REMOVED***="ext-cal-hd-days-td"><div cl***REMOVED***="ext-cal-hd-ad-inner">{allDayTpl}</div></td>',
                            '<td cl***REMOVED***="ext-cal-gutter-rt"></td>',
                        '</tr>',
                    '</tobdy>',
                '</table>',
            '</div>'
