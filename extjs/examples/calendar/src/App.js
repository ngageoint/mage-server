...
Ext.define('Ext.calendar.App', {
    ...
    // scrollbar width, we add a special cl***REMOVED*** if needed so that we can apply
...
function() {
    ...
    // to simulate CRUD tra***REMOVED***ctions we have to at the very least allow them to be
