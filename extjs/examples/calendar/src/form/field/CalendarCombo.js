/**
 * @cl***REMOVED*** Ext.calendar.form.field.CalendarCombo
 * @extends Ext.form.ComboBox
 * <p>A custom combo used for choosing from the list of available calendars to ***REMOVED***ign an event to.</p>
...
Ext.define('Ext.calendar.form.field.CalendarCombo', {
    ...
    getListItemTpl: function(displayField) {
        return '<div cl***REMOVED***="x-combo-list-item ext-color-{' + Ext.calendar.data.CalendarMappings.CalendarId.name +
                '}"><div cl***REMOVED***="ext-cal-picker-icon">&#160;</div>{' + displayField + '}</div>';
    },
     ...
     */
    getStyleCl***REMOVED***: function(value){
        var val = value;
    ...
    setValue: function(value) {
        ...
        if (this.wrap && value) {
            var currentCl***REMOVED*** = this.getStyleCl***REMOVED***(this.getValue()),
                newCl***REMOVED*** = this.getStyleCl***REMOVED***(value);
            
            this.wrap.replaceCls(currentCl***REMOVED***, newCl***REMOVED***);
        }
