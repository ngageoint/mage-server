/**
 * @cl***REMOVED*** Ext.form.field.DateRange
...
Ext.define('Ext.calendar.form.field.DateRange', {
    ...
    /**
     * Returns an array containing the following values in order:<div cl***REMOVED***="mdetail-params"><ul>
     * <li><b><code>DateTime</code></b> : <div cl***REMOVED***="sub-desc">The start date/time</div></li>
     * <li><b><code>DateTime</code></b> : <div cl***REMOVED***="sub-desc">The end date/time</div></li>
     * <li><b><code>Boolean</code></b> : <div cl***REMOVED***="sub-desc">True if the dates are all-day, false 
     ...
     * @param {Array/Date/Object} v The value(s) to set into the field. Valid types are as follows:<div cl***REMOVED***="mdetail-params"><ul>
     * <li><b><code>Array</code></b> : <div cl***REMOVED***="sub-desc">An array containing, in order, a start date, end date and all-day flag.
     * This array should exactly match the return type as specified by {@link #getValue}.</div></li>
     * <li><b><code>DateTime</code></b> : <div cl***REMOVED***="sub-desc">A single Date object, which will be used for both the start and
     * end dates in the range.  The all-day flag will be defaulted to false.</div></li>
     * <li><b><code>Object</code></b> : <div cl***REMOVED***="sub-desc">An object containing properties for StartDate, EndDate and IsAllDay
