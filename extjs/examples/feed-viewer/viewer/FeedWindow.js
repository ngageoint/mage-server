/**
 * @cl***REMOVED*** FeedViewer.FeedWindow
...
Ext.define('FeedViewer.FeedWindow', {
        ...
        me.form = Ext.create('widget.form', {
            ...
            items: [{
                ...
                getInnerTpl: function(){
                    return '<div cl***REMOVED***="feed-picker-url">{field1}</div><div cl***REMOVED***="feed-picker-title">{field2}</div>'; 
                }
            }]
        });
        Ext.apply(me, {
    ...
    /**
     * React to the feed validation p***REMOVED***ing
     * @private
