...
Ext.onReady(function(){
    ...
    var menu = Ext.create('Ext.menu.Menu', {
        ...
        items: [
            ...
            {
                text: 'I like Ext',
                checked: true,       // when checked has a boolean value, it is ***REMOVED***umed to be a CheckItem
                ...
                menu: {        // <-- submenu by nested config object
                    items: [
                        ...
                        '<b cl***REMOVED***="menu-title">Choose a Theme</b>',
                        {
                            text: 'Aero Gl***REMOVED***',
                            checked: true,
                            group: 'theme',
                            checkHandler: onItemCheck
                        }, {
    ...
    tb.add({
            text:'Button w/ Menu',
            iconCls: 'bmenu',  // <-- icon
            menu: menu  // ***REMOVED***ign menu by instance
        }, {
            text: 'Users',
            iconCls: 'user',
            menu: {
