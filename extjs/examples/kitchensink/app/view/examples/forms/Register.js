    ...
    items: [{
        ...
        items: [{
            ...
            items: [
                ...
                { allowBlank:false, fieldLabel: 'P***REMOVED***word', name: 'p***REMOVED***', emptyText: 'p***REMOVED***word', inputType: 'p***REMOVED***word' },
                { allowBlank:false, fieldLabel: 'Verify', name: 'p***REMOVED***', emptyText: 'p***REMOVED***word', inputType: 'p***REMOVED***word' }
            ]
        },
        {
            xtype: 'fieldset',
