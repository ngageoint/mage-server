...
Ext.Loader.onReady(function() {
    ...
    Ext.define('App.BookStore', {
        ...
        constructor: function(config) {
            ...
            // call the supercl***REMOVED***'s constructor
     ...
     *
     * It also registers the cl***REMOVED*** with the Component Manager with an xtype of
    ...
    Ext.define('App.BookGrid', {
        ...
        // This will ***REMOVED***ociate an string representation of a cl***REMOVED***
        ...
        initComponent : function() {
            // P***REMOVED*** in a column model definition
            ...
            // finally call the supercl***REMOVED***es implementation
            this.callParent();
        }
    });
     ...
     *
     * The cl***REMOVED*** will be registered with an xtype of 'bookdetail'
     */
    Ext.define('App.BookDetail', {
        extend: 'Ext.Panel',
        // register the App.BookDetail cl***REMOVED*** with an xtype of bookdetail
    ...
    Ext.define('App.BookMasterDetail', {
        ...
        // override initEvents
        initEvents: function() {
            // call the supercl***REMOVED***'s initEvents implementation
            this.callParent();
...
// Finally now that we've defined all of our cl***REMOVED***es we can instantiate
// an instance of the app and renderTo an existing div called 'binding-example'
// Note now that cl***REMOVED***es have encapsulated this behavior we can easily create
