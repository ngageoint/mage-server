        ...
        Ext.apply(this, {
            ...
            dockedItems: [{
                ...
                items: [{
                    ...
                    itemId: 'load',
                    text: 'Parent ***REMOVED***ociation loader',
                    tooltip: 'Demonstrate loading parent relationships - A new record will be created so we ignore any previous ***REMOVED***ociations setup',
                    scope: this,
...
Ext.onReady(function(){
    ...
    var main = Ext.create('Ext.panel.Panel', {
        ...
        items: [{
            ...
            title: 'Loader log',
            tplWriteMode: 'append',
            tpl: '<div cl***REMOVED***="{cls}">[{now:date("H:i:s")}] - {msg}</div>',
            bodyPadding: 5,
            autoScroll: true,
            listeners: {
                render: Logger.init
