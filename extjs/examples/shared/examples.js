...
Ext.example = function(){
    ...
    function createBox(t, s){
       // return ['<div cl***REMOVED***="msg">',
       //         '<div cl***REMOVED***="x-box-tl"><div cl***REMOVED***="x-box-tr"><div cl***REMOVED***="x-box-tc"></div></div></div>',
       //         '<div cl***REMOVED***="x-box-ml"><div cl***REMOVED***="x-box-mr"><div cl***REMOVED***="x-box-mc"><h3>', t, '</h3>', s, '</div></div></div>',
       //         '<div cl***REMOVED***="x-box-bl"><div cl***REMOVED***="x-box-br"><div cl***REMOVED***="x-box-bc"></div></div></div>',
       //         '</div>'].join('');
       return '<div cl***REMOVED***="msg"><h3>' + t + '</h3><p>' + s + '</p></div>';
    }
    return {
...
//            if(theme){
//                t.dom.value = theme;
//                Ext.getBody().addCl***REMOVED***('x-'+theme);
//            }
...
Ext.example.bogusMarkup = '<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Sed metus nibh, sodales a, '+
    ...
    'eget, nonummy non, nisi. Morbi nunc est, dignissim non, ornare sed, luctus eu, m***REMOVED***a. Vivamus eget quam. Vivamus tincidunt '+
