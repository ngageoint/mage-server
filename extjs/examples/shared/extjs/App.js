...
Ext.define('Ext.App', {
    ...
    constructor: function(config) {
        ...
        Ext.App.supercl***REMOVED***.constructor.apply(this, arguments);
    },
    ...
    buildMessageBox : function(title, msg) {
        ...
        return [
            '<div cl***REMOVED***="app-msg">',
            '<div cl***REMOVED***="x-box-tl"><div cl***REMOVED***="x-box-tr"><div cl***REMOVED***="x-box-tc"></div></div></div>',
            '<div cl***REMOVED***="x-box-ml"><div cl***REMOVED***="x-box-mr"><div cl***REMOVED***="x-box-mc"><h3 cl***REMOVED***="x-icon-text icon-status-' + title + '">', title, '</h3>', msg, '</div></div></div>',
