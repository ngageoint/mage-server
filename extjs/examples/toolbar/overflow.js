    ...
    Ext.create('Ext.window.Window', {
        ...
        tbar: Ext.create('Ext.toolbar.Toolbar', {
            ...
            items: [{
                ...
                text: 'Menu Button',
                iconCls: 'add16',
                handler: Ext.Function.p***REMOVED***(handleAction, 'Menu Button'),
                menu: [{text: 'Menu Item 1', handler: Ext.Function.p***REMOVED***(handleAction, 'Menu Item 1')}]
            },'-',{
                xtype:'splitbutton',
                text: 'Cut',
                iconCls: 'add16',
                handler: Ext.Function.p***REMOVED***(handleAction, 'Cut'),
                menu: [{text: 'Cut menu', handler: Ext.Function.p***REMOVED***(handleAction, 'Cut menu')}]
            },{
                text: 'Copy',
                iconCls: 'add16',
                handler: Ext.Function.p***REMOVED***(handleAction, 'Copy')
            },{
                text: 'Paste',
                iconCls: 'add16',
                menu: [{text: 'Paste menu', handler: Ext.Function.p***REMOVED***(handleAction, 'Paste menu')}]
            },'-',{
                text: 'Format',
                iconCls: 'add16',
                handler: Ext.Function.p***REMOVED***(handleAction, 'Format')
            },'->', {
                fieldLabel: 'Action',
                labelAlign: 'right',
                labelWidth: 70,
