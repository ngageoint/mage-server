...
Ext.onReady(function() {
   ...
   /**
    ...
    Ext.define('App.RadarStore', {
        ...
        constructor: function(config) {
            ...
            App.RadarStore.supercl***REMOVED***.constructor.call(this, config);
        },
   ...
   /**
     ...
     * performance reviews.
     *
     * The cl***REMOVED*** will be registered with an xtype of 'performanceradar'
     */      
    Ext.define('App.PerformanceRadar', {
        ...
        constructor: function(config) {
            ...
            App.PerformanceRadar.supercl***REMOVED***.constructor.call(this, config);
        ...
        setAverageSeries: function(config) {
            ...
            if(config.series) {        
                config.series.push(avgSeries);     // if a series is p***REMOVED***ed in then append the average to it
            } else {                    
                config.series = [avgSeries];    // if a series isn't p***REMOVED***ed just create average
            }
        } 
   ...
   /**
     ...
     * startingMarkup) to the cl***REMOVED***. It also overrides the initComponent
     * method and adds a new method called updateDetail.
     *
     * The cl***REMOVED*** will be registered with an xtype of 'employeedetail'
     */
    Ext.define('App.EmployeeDetail', {
        extend: 'Ext.panel.Panel',
        // register the App.EmployeeDetail cl***REMOVED*** with an xtype of employeedetail
        ...
        initComponent: function() {
            ...
            // call the supercl***REMOVED***'s initComponent implementation
            App.EmployeeDetail.supercl***REMOVED***.initComponent.call(this);
        }
    });
    ...
    Ext.define('App.ReviewWindow', {
        ...
        constructor: function(config) {        
            ...
            App.ReviewWindow.supercl***REMOVED***.constructor.call(this, config);
