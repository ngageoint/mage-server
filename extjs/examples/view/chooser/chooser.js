 ...
 * To create the example we create simple subcl***REMOVED***es of Window, DataView and Panel. When the user selects an image
 * we just add it to the page using the insertSelectedImage function below.
 * 
 * Our subcl***REMOVED***es all sit under the Ext.chooser namespace so the first thing we do is tell Ext's cl***REMOVED*** loader that it
 * can find those cl***REMOVED***es in this directory (InfoPanel.js, IconBrowser.js and Window.js). Then we just need to require
 * those files and p***REMOVED*** in an onReady callback that will be called as soon as everything is loaded.
 */
...
Ext.onReady(function() {
     ...
     * This window is a simple subcl***REMOVED*** of Ext.window.Window, and you can see its source code in Window.js.
