/**
 * @cl***REMOVED*** Ext.chooser.Window
 * @extends Ext.window.Window
 * @author Ed Spencer
 * 
 * This is a simple subcl***REMOVED*** of the built-in Ext.window.Window cl***REMOVED***. Although it weighs in at 100+ lines, most of this
 * is just configuration. This Window cl***REMOVED*** uses a border layout and creates a DataView in the central region and an
 * information panel in the east. It also sets up a toolbar to enable sorting and filtering of the items in the 
 * DataView. We add a few simple methods to the cl***REMOVED*** at the bottom, see the comments inline for details.
 */
Ext.define('Ext.chooser.Window', {
     ...
     * at the bottom. Finally we call the supercl***REMOVED*** initComponent.
     */
