/**
 * @cl***REMOVED*** Ext.chooser.IconBrowser
 * @extends Ext.view.View
 * @author Ed Spencer
 * 
 * This is a really basic subcl***REMOVED*** of Ext.view.View. All we're really doing here is providing the template that dataview
...
Ext.define('Ext.chooser.IconBrowser', {
    ...
    tpl: [
        // '<div cl***REMOVED***="details">',
            '<tpl for=".">',
                '<div cl***REMOVED***="thumb-wrap">',
                    '<div cl***REMOVED***="thumb">',
