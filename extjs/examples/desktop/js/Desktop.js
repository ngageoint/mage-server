...
/**
 * @cl***REMOVED*** Ext.ux.desktop.Desktop
 * @extends Ext.panel.Panel
 * <p>This cl***REMOVED*** manages the wallpaper, shortcuts and taskbar.</p>
 */
Ext.define('Ext.ux.desktop.Desktop', {
     ...
     * This property is p***REMOVED***ed to the DataView for the desktop to select shortcut items.
    ...
    shortcutTpl: [
        '<tpl for=".">',
            '<div cl***REMOVED***="ux-desktop-shortcut" id="{name}-shortcut">',
                '<div cl***REMOVED***="ux-desktop-shortcut-icon {iconCls}">',
                    '<img src="',Ext.BLANK_IMAGE_URL,'" title="{name}">',
                '</div>',
                '<span cl***REMOVED***="ux-desktop-shortcut-text">{name}</span>',
            '</div>',
        '</tpl>',
        '<div cl***REMOVED***="x-clear"></div>'
    ],
