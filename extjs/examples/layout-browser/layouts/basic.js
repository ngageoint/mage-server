...
//
// However, by p***REMOVED***ing configs into the main container instead of objects, we can defer
...
// automatically ***REMOVED***umed to be panel configs, and so the xtype of 'panel' is
...
function getBasicLayouts() {
    ...
    // be ***REMOVED***igned next as the handling function for the buttons in the CardLayout example.
    ...
    return {
        ...
        accordion: {
            ...
            items: [{
                ...
                cls: 'custom-accordion', // look in layout-browser.css to see the CSS rules for this cl***REMOVED***
                html: '<p>Here is an example of how easy it is to completely customize the look and feel of an individual panel simply by adding a CSS cl***REMOVED*** in the config.</p>'
            }]
        },
