        ...
        },
        {
            ...
            "items": [
                ...
                },
                {
                    ...
                    "url": "grid/binding-with-cl***REMOVED***es.html",
                    "icon": "grid-data-binding.gif",
                    "desc": "Refactoring the basic data binding example to use a cl***REMOVED***-based application design model."
                },
                {
        ...
        },
        {
            ...
            "items": [
                ...
                },
                {
                    ...
                    "url": "draw/Tiger.html",
                    "icon": "draw-tiger.gif",
                    "desc": "The cl***REMOVED***ic SVG Tiger in a floatable, draggable component. Scalable to any size, fully resolution independent.",
                    "status": "new"
                },
                {
                    "text": "Rotate Text",
        ...
        },
        {
            ...
            "items": [
                ...
                },
                {
                   ...
                   "desc": "Bind the same behavior to multiple buttons, toolbar and menu items using the Ext.Action cl***REMOVED***.",
                   "status": "updated"
                },
                {
        ...
        },
        {
            ...
            "items": [
                ...
                },
                {
                    ...
                    "desc": "A demo of how to give standard file upload fields a bit of Ext style using a custom cl***REMOVED***.",
                    "status": "updated"
                },
                {
                    "text": "Number Field",
        ...
        },
        {
            ...
            "items": [
                ...
                },
                {
                    ...
                    "icon": "gmap-panel.gif",
                    "desc": "A Google Maps wrapper cl***REMOVED*** that enables easy display of dynamic maps in Ext panels and windows."
                },
                {
                    "text": "Editor",
                    "url": "simple-widgets/editor.html",
                    "icon": "editor.gif",
                    "desc": "An example demonstrating the ease of use of the Ext.editor cl***REMOVED*** to modify DOM elements"
                },
                {
                    "text": "Slider",
                ...
                },
                {
                    ...
                    "icon": "keyboard.gif",
                    "desc": "Shows a custom keyboard navigation using the KeyNav cl***REMOVED***",
                    "status": "new"
                },
                {
