 ...
 * notification when the ***REMOVED***ociated form contains validation errors.
 */
Ext.define('Ext.ux.statusbar.ValidationStatus', {
     ...
     * The css cl***REMOVED*** to be used for the error list when there are validation errors.
     */
