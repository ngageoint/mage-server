...
Ext.define('Ext.ux.statusbar.StatusBar', {
    ...
    alternateCl***REMOVED***Name: 'Ext.ux.StatusBar',
    ...
    /**
     * @cfg {String} [iconCls='']
     * A CSS cl***REMOVED*** that will be **initially** set as the status bar icon and is
    ...
    /**
     * @cfg {String} cls
     * The base cl***REMOVED*** applied to the containing element for this component on render.
     */
    cls : 'x-statusbar',
    /**
     * @cfg {String} busyIconCls
     * The default {@link #iconCls} applied when calling {@link #showBusy}.
     * It can be overridden at any time by p***REMOVED***ing the `iconCls` argument into {@link #showBusy}.
     */
    busyIconCls : 'x-status-busy',
    /**
     * @cfg {String} busyText
     * The default {@link #text} applied when calling {@link #showBusy}.
     * It can be overridden at any time by p***REMOVED***ing the `text` argument into {@link #showBusy}.
     */
    busyText : 'Loading...',
    /**
     ...
     * Note that this only applies when p***REMOVED***ing the `clear` argument to {@link #setStatus}
     ...
     *     });
     *
     * @param {Object/String} config A config object specifying what status to set, or a string ***REMOVED***umed
     * to be the status text (and all other options are defaulted as explained below). A config
     * object containing any or all of the following properties can be p***REMOVED***ed:
     *
     * @param {String} config.text The status text to display.  If not specified, any current
     * status text will remain unchanged.
     *
     * @param {String} config.iconCls The CSS cl***REMOVED*** used to customize the status icon (see
     ...
     * automatically clear the status text and iconCls after a specified amount of time has p***REMOVED***ed. If clear is not
     * specified, the new status will not be auto-cleared and will stay until updated again or cleared using
     * {@link #clearStatus}. If `true` is p***REMOVED***ed, the status will be cleared using {@link #autoClear},
     * {@link #defaultText} and {@link #defaultIconCls} via a fade out animation. If a numeric value is p***REMOVED***ed,
     * it will be used as the callback interval (in milliseconds), overriding the {@link #autoClear} value.
     * All other options will be defaulted as with the boolean option.  To customize any other options,
     * you can p***REMOVED*** an object in the format:
     * 
     ...
     * {@link #defaultIconCls} (defaults to false which sets the text to '' and removes any existing icon cl***REMOVED***).
     *
     * @return {Ext.ux.statusbar.StatusBar} this
     */
     ...
     * @param {String} iconCls (optional) The icon cl***REMOVED*** to set (defaults to '', and any current icon cl***REMOVED*** is removed)
     * @return {Ext.ux.statusbar.StatusBar} this
     */
