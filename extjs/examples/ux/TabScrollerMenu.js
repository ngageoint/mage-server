Ext.ns('Ext.ux');
/**
 * @cl***REMOVED*** Ext.ux.TabScrollerMenu
 * @extends Object
...
Ext.define('Ext.ux.TabScrollerMenu', {
    ...
    showButton: function() {
        var me = this,
            result = Ext.getCl***REMOVED***(me.layout.overflowHandler).prototype.handleOverflow.apply(me.layout.overflowHandler, arguments);
