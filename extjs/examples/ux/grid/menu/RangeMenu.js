/**
 * @cl***REMOVED*** Ext.ux.grid.menu.RangeMenu
...
Ext.define('Ext.ux.grid.menu.RangeMenu', {
    ...
    /**
     * @cfg {String} fieldCls
     * The Cl***REMOVED*** to use to construct each field item within this menu
     * Defaults to:<pre>
...
menuItemCfgs : {
     ...
     * @param {Object} data The data to ***REMOVED***ign to this menu
     */	
    ...
    this.prototype.iconTpl = Ext.create('Ext.XTemplate',
        '<img src="{src}" alt="{text}" cl***REMOVED***="' + Ext.baseCSSPrefix + 'menu-item-icon ux-rangemenu-icon {cls}" />'
    );
