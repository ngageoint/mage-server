/**
 * @cl***REMOVED*** Ext.ux.grid.filter.DateFilter
...
Ext.define('Ext.ux.grid.filter.DateFilter', {
     ...
     * Map for ***REMOVED***igning the comparison values used in serialization.
     */
    compareMap : {
        before: 'lt',
        after:  'gt',
    ...
    /**
     * @cfg {Date} maxDate
     * Allowable date as p***REMOVED***ed to the Ext.DatePicker
     ...
     * Configuration options for the date picker ***REMOVED***ociated with each field.
     */
    pickerOpts : {},
    ...
    /**
     * Gets the menu picker ***REMOVED***ociated with the p***REMOVED***ed field
     * @param {String} item The field identifier ('before', 'after', 'on')
