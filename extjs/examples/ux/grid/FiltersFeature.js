 ...
 *
 * Columns that are filtered have {@link #filterCls a configurable css cl***REMOVED***} applied to the column headers.
 *
...
Ext.define('Ext.ux.grid.FiltersFeature', {
    ...
    /**
     * @cfg {Array} filters
     * An Array of filters config objects. Refer to each filter type cl***REMOVED*** for
     ...
     * The css cl***REMOVED*** to be applied to column headers with active filters.
    ...
    initializeFilters: function(filters) {
        var me = this,
            ...
            i, filter, FilterCl***REMOVED***;

        for (i = 0; i < filtersLength; i++) {
            filter = filters[i];
            if (filter) {
                FilterCl***REMOVED*** = me.getFilterCl***REMOVED***(filter.type);
                filter = filter.menu ? filter : new FilterCl***REMOVED***(filter);
     ...
     *
     *   - `false` (Default) :
     *     Flatten into query string of the form (***REMOVED***uming <code>{@link #paramPrefix}='filters'</code>:
     *
     ...
     * Each element will take the form of {field: dataIndex, data: filterConf}. dataIndex is not ***REMOVED***ured
    ...
    /**
     * Function for locating filter cl***REMOVED***es, overwrite this with your favorite
     * loader to provide dynamic filter loading.
     * @param {String} type The type of filter to load ('Filter' is automatically
     * appended to the p***REMOVED***ed type; eg, 'string' becomes 'StringFilter').
     * @return {Function} The Ext.ux.grid.filter.Cl***REMOVED***
     */
    getFilterCl***REMOVED*** : function (type) {
        ...
        return Ext.Cl***REMOVED***Manager.getByAlias('gridfilter.' + type);
    }
});
