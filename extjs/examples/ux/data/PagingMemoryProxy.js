/**
 * @cl***REMOVED*** Ext.ux.data.PagingMemoryProxy
...
Ext.define('Ext.ux.data.PagingMemoryProxy', {
    ...
    alternateCl***REMOVED***Name: 'Ext.data.PagingMemoryProxy',
    ...
    read : function(operation, callback, scope){
        ...
        if (sorters.length > 0) {
            //construct an amalgamated sorter function which combines all of the Sorters p***REMOVED***ed
