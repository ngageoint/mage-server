/**
 * @cl***REMOVED*** Ext.ux.PreviewPlugin
 * @extends Ext.AbstractPlugin
 *
 * The Preview enables you to show a configurable preview of a record.
 *
 * This plugin ***REMOVED***umes that it has control over the features used for this
...
Ext.define('Ext.ux.PreviewPlugin', {
    ...
    // private, css cl***REMOVED*** to use to hide the body
     ...
     * @param {Boolean} expanded P***REMOVED*** true to expand the record and false to not show the preview.
     */
