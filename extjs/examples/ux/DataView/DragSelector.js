/**
 * @cl***REMOVED*** Ext.ux.DataView.DragSelector
 * @extends Object
 * @author Ed Spencer
 * 
 */
Ext.define('Ext.ux.DataView.DragSelector', {
    ...
    onRender: function() {
         ...
         * DragTracker ('this' refers to the DragTracker inside those functions), so we p***REMOVED*** a reference to the 
         * DragSelector so that we can call this cl***REMOVED***'s functions.
         */
