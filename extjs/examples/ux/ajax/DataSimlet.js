/**
 * This base cl***REMOVED*** is used to handle data preparation (e.g., sorting, filtering and
 * group summary).
 */
Ext.define('Ext.ux.ajax.DataSimlet', function () {
    ...
    return {
        ...
        getSummary: function (ctx, data, page) {
            ...
            // data is ordered primarily by the groupField, so one p***REMOVED*** can pick up all
