 ...
 * @author Don Griffin
 *
 * This is a base cl***REMOVED*** for more advanced "simlets" (simulated servers). A simlet is asked
...
Ext.define('Ext.ux.ajax.Simlet', function () {
    ...
    return {
         ...
         * this is delegated to `doMethod` methods on this cl***REMOVED***, such as `doGet`.
         *
