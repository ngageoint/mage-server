/**
 * Base cl***REMOVED*** for all Ext components.
 *
 * The Component base cl***REMOVED*** has built-in support for basic hide/show and enable/disable and size control behavior.
 *
 * ## xtypes
 *
 ...
 * any time via {@link Ext#getCmp Ext.getCmp}, p***REMOVED***ing the {@link #id}.
 *
 ...
 *
 * All subcl***REMOVED***es of Component may participate in the automated Ext component
 * lifecycle of creation, rendering and destruction which is provided by the {@link Ext.container.Container Container}
 * cl***REMOVED***. Components may be added to a Container through the {@link Ext.container.Container#cfg-items items} config option
 ...
 * subcl***REMOVED*** Component.
 *
 * See the Creating new UI controls chapter in [Component Guide][1] for details on how and to either extend
 * or augment Ext JS base cl***REMOVED***es to create custom Components.
 *
 * ## The Ext.Component cl***REMOVED*** by itself
 *
 * Usually one doesn't need to instantiate the Ext.Component cl***REMOVED***. There are subcl***REMOVED***es which implement
 ...
 * m***REMOVED*** data, it is recommended that an ExtJS data-backed Component such as a {@link Ext.view.View View},
...
Ext.define('Ext.Component', {
     ...
     *
     * May also be specified as a config object to be p***REMOVED***ed to the constructor of {@link Ext.resizer.Resizer Resizer}
     * to override any defaults. By default the Component p***REMOVED***es its minimum and maximum size, and uses
     ...
     * a {@link Ext.ZIndexManager ZIndexManager} which provides z-indexing ***REMOVED***s for all its descendant floating
     * Components.
     *
    ...
    //    '<div id="{id}" cl***REMOVED***="{baseCls} {cls} {cmpCls}<tpl if="typeof ui !== \'undefined\'"> {uiBase}-{ui}</tpl>"<tpl if="typeof style !== \'undefined\'"> style="{style}"</tpl>></div>', {
    //        compiled: true,
    //        disableFormats: true
    //    }
    //),
     ...
     * - **a string** : it is ***REMOVED***umed to be the id of an existing element and is used as the component id
     * - **anything else** : it is ***REMOVED***umed to be a standard config object and is applied to the component
     */
     ...
     * implemented by each subcl***REMOVED*** of Ext.Component to provide any needed constructor logic. The
     * initComponent method of the cl***REMOVED*** being created is called first, with each initComponent method
     ...
     * to ensure that the parent cl***REMOVED***' initComponent method is also called.
     *
     * All config options p***REMOVED***ed to the constructor are applied to `this` before initComponent is called,
     * so you can simply access them with `this.someOption`.
     *
     * The following example demonstrates using a dynamic string for the text of a button at the time of
     * instantiation of the cl***REMOVED***.
     *
     ...
     * value is 'hidden'. P***REMOVED***ing null for one of the values will erase the inline style.
     * P***REMOVED***ing `undefined` will preserve the current value.
     *
    ...
    /**
     * Scrolls this Component's {@link #getTargetEl target element} by the p***REMOVED***ed delta values, optionally animating.
     *
     ...
     *
     * @param {Boolean/Object/String} load True to show the default LoadMask, a config object that will be p***REMOVED***ed to the
    ...
    beforeSetPosition: function () {
        var me = this,
            pos = me.callParent(arguments), // p***REMOVED*** all args on for signature decoding
            adj;
     ...
     * @param {Boolean/Object} [animate] True to animate the Component into its new position. You may also p***REMOVED*** an
     ...
     * calling the supercl***REMOVED***'s onShow, the Component will be visible.
     *
     * Override in subcl***REMOVED***es where more complex behaviour is needed.
     *
     * Gets p***REMOVED***ed the same parameters as #show.
     *
    ...
    afterShow: function(animateTarget, cb, scope) {
        ...
        // Default to configured animate target if none p***REMOVED***ed
        ...
        if (animateTarget) {
            ...
            // Shunting it offscreen immediately, *before* the Animation cl***REMOVED*** grabs it ensure no flicker.
     ...
     *
     * Gets p***REMOVED***ed the same `callback` and `scope` parameters that #afterShow received.
     *
     * @param {Function} [callback]
     * @param {Object} [scope]
     *
     ...
     * calling the supercl***REMOVED***’s onHide, the Component will be hidden.
     *
     * Gets p***REMOVED***ed the same parameters as #hide.
     *
     ...
     *
     * Gets p***REMOVED***ed the same `callback` and `scope` parameters that #onHide received.
     *
     * @param {Function} [callback]
     * @param {Object} [scope]
     *
     ...
     * After calling the supercl***REMOVED***’s onDestroy, the Component will be destroyed.
     *
     * @template
     * @protected
     */
    ...
    focus: function(selectText, delay) {
        ...
        if (me.rendered && !me.isDestroyed && me.isVisible(true) && (focusEl = me.getFocusEl())) {
            ...
            // this is performed by its zIndexManager. P***REMOVED*** preventFocus true to avoid recursion.
            if (me.floating) {
                me.toFront(true);
    ...
    // Some Component subcl***REMOVED***es (such as Menu) might implement a different ownership hierarchy.
    ...
    /**
     * Clone the current component using the original config values p***REMOVED***ed into this instance by default.
     * @param {Object} overrides A new config containing any properties to override in the cloned version.
     * An id property can be p***REMOVED***ed on this object, otherwise one will be generated to avoid duplicates.
    ...
    /**
     * Find a container above this component at any level by a custom function. If the p***REMOVED***ed function returns true, the
    ...
    /**
     * Find a container above this component at any level by xtype or cl***REMOVED***
     *
     * See also the {@link Ext.Component#up up} method.
     *
     * @param {String/Ext.Cl***REMOVED***} xtype The xtype string for a component, or the cl***REMOVED*** of the component directly
     * @return {Ext.container.Container} The first Container which matches the given xtype or cl***REMOVED***
     */
     ...
     * @param {Array} [args] The args to call the function with. Defaults to p***REMOVED***ing the current component.
     * @return {Ext.Component} this
     */
