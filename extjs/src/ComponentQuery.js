 ...
 *
 * To match only the exact type, p***REMOVED*** the "shallow" flag (See {@link Ext.AbstractComponent#isXType AbstractComponent's isXType method})
 *
 ...
 *
 * Pseudo cl***REMOVED***es may be used to filter results in the same way as in {@link Ext.DomQuery DomQuery}:
 *
 *     // Function receives array and returns a filtered array.
 *     Ext.ComponentQuery.pseu***REMOVED***.invalid = function(items) {
...
Ext.define('Ext.ComponentQuery', {
    ...
    var cq = this,
        ...
        // as a member on each item in the p***REMOVED***ed array.
        filterFnPattern = [
            'var r = [],',
                'i = 0,',
                'it = items,',
        ...
        // Filters the p***REMOVED***ed candidate array and returns only items which match the p***REMOVED***ed xtype
        ...
        // Filters the p***REMOVED***ed candidate array and returns only items which have the p***REMOVED***ed cl***REMOVED***Name
        filterByCl***REMOVED***Name = function(items, cl***REMOVED***Name) {
            var EA = Ext.Array,
                result = [],
                i = 0,
                length = items.length,
            ...
            for (; i < length; i++) {
                candidate = items[i];
                if (candidate.hasCls(cl***REMOVED***Name)) {
                    result.push(candidate);
                }
            }
            return result;
        ...
        // Filters the p***REMOVED***ed candidate array and returns only items which have the specified property match
        ...
        // Filters the p***REMOVED***ed candidate array and returns only items which have the specified itemId or id
        ...
        // Filters the p***REMOVED***ed candidate array and returns only items which the named pseudo cl***REMOVED*** matcher filters in
        filterByPseudo = function(items, name, value) {
            return cq.pseu***REMOVED***[name](items, value);
        },
        ...
        matchers = [{
            ...
            // checks for :<pseudo_cl***REMOVED***>(<selector>)
            re: /^\:([\w\-]+)(?:\(((?:\{[^\}]+\})|(?:(?!\{)[^\s>\/]*?(?!\})))\))?/,
    ...
    // Internal cl***REMOVED*** Ext.ComponentQuery.Query
    ...
    Ext.apply(this, {
        ...
        // private cache of pseudo cl***REMOVED*** filter functions
        pseu***REMOVED***: {
        ...
        /**
         * Returns an array of matched Components from within the p***REMOVED***ed root object.
         *
         * This method filters returned Components in a similar way to how CSS selector based DOM
         * queries work using a textual selector string.
         *
         * See cl***REMOVED*** summary for details.
         *
        ...
        /**
         * Tests whether the p***REMOVED***ed Component matches the selector string.
        ...
        parse: function(selector) {
            ...
            while (selector && lastSelector !== selector) {
                ...
                if (tokenMatch) {
                    ...
                    // If the token is prefixed with a . we push a filterByCl***REMOVED***Name operation to our stack
                    // FIXME: Not enabled yet. just needs \. adding to the tokenRe prefix
                    else if (matchedChar === '.') {
                        operations.push({
                            method: filterByCl***REMOVED***Name,
                            args: [Ext.String.trim(tokenMatch[2])]
                        });
                    }
                ...
                while (!(modeMatch = selector.match(modeRe))) {
                    ...
                    for (i = 0; selector && i < length; i++) {
                        ...
                        // ***REMOVED***ociated with this matcher, and p***REMOVED*** the regular
