/**
 * This cl***REMOVED*** parses the XTemplate syntax and calls abstract methods to process the parts.
 * @private
 */
Ext.define('Ext.XTemplateParser', {
     ...
     * these are p***REMOVED***ed in the actions object.
     * @param {String} action
        ...
        for (index = 0; index < len; index = end) {
            ...
            if (m[1]) {
                ...
                */
                ...
                // if the length of m[0] is 5, ***REMOVED***ume that we're dealing with an opening tpl tag with no attributes (e.g. <tpl>...</tpl>)
