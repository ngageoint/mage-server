...
Ext.define('Ext.state.Stateful', {
     ...
     * 
     * The Component base cl***REMOVED*** implements {@link #getState} to save its width and height within the state
     * only if they were initially configured, and have changed from the configured value.
     * 
     * The Panel cl***REMOVED*** saves its collapsed state in addition to that.
     * 
     * The Grid cl***REMOVED*** saves its column state in addition to its supercl***REMOVED*** state.
     * 
     * If there is more application state to be save, the developer must provide an implementation which
     * first calls the supercl***REMOVED*** method to inherit the above behaviour, and then injects new properties
     * into the returned object.
     * 
     * The value yielded by getState is p***REMOVED***ed to {@link Ext.state.Manager#set}
     * which uses the configured {@link Ext.state.Provider} to save the object
     * keyed by the {@link #stateId}.
     * 
     * During construction, a stateful object attempts to *restore* its state by calling
     * {@link Ext.state.Manager#get} p***REMOVED***ing the {@link #stateId}
     * 
     * The resulting object is p***REMOVED***ed to {@link #applyState}*. The default implementation of
    ...
    constructor: function(config) {
        ...
        this.addEvents(
             ...
             * event is not vetoed, then the state object is p***REMOVED***ed to <b><tt>applyState</tt></b>. By default,
             ...
             * @param {Ext.state.Stateful} this
             * @param {Object} state The hash of state values returned from the StateProvider. This is p***REMOVED***ed
     ...
     * argument p***REMOVED***ed to this method is the name of a state event.
     *
    ...
    saveState: function() {
        ...
        if (id) {
            state = me.getState() || {};    //p***REMOVED*** along for custom interactions
     ...
     * it should be overridden in subcl***REMOVED***es to implement methods for getting the state.
    ...
    /**
     * Applies the state to the object. This should be overridden in subcl***REMOVED***es to do
     ...
     * to the p***REMOVED***ed state object.
