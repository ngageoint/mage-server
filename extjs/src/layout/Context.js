 ...
 * # Algorithm
 *
 * This cl***REMOVED*** performs the following jobs:
 *
 ...
 * and down a cl***REMOVED*** hierarchy).
 * 
...
Ext.define('Ext.layout.Context', {
     ...
     * the {@link Ext.layout.ContextItem} cl***REMOVED***.
     *
     * @param {Ext.layout.ContextItem} item
     * @private
     */
    ...
    chainFns: function (oldOptions, newOptions, funcName) {
        ...
        // pointer will be p***REMOVED***ed correctly by createSequence with oldFn first.
     ...
     * layout is done, blocked or already in the queue. The only cl***REMOVED***es that should call
     * this method are this cl***REMOVED*** and {@link Ext.layout.ContextItem}.
     *
    ...
    resetLayout: function (layout, ownerContext, firstTime) {
        ...
        if (firstTime) {
            ...
            if (layout.isComponentLayout && (ownerCtContext = ownerContext.ownerCtContext)) {
                // This layout's ownerCt is in this run... The component ***REMOVED***ociated with
    ...
    runLayout: function (layout) {
        ...
        // We start with the ***REMOVED***umption that the layout will finish and if it does not, it
        // must clear this flag. It turns out this is much simpler than knowing when a layout
        // is done (100% correctly) when base cl***REMOVED***es and derived cl***REMOVED***es are collaborating.
