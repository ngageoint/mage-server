/**
 * @cl***REMOVED*** Ext.layout.container.Auto
 *
 ...
 * a `{@link Ext.container.Container Container}.` AutoLayout provides only a p***REMOVED***through of any layout calls
...
Ext.define('Ext.layout.container.Auto', {
    ...
    renderTpl: [
        ...
        '<div id="{ownerId}-clearEl" cl***REMOVED***="', Ext.baseCSSPrefix, 'clear" role="presentation"></div>'
    ],
