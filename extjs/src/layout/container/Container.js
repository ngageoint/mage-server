/**
 * This cl***REMOVED*** is intended to be extended or created via the {@link Ext.container.Container#layout layout}
...
Ext.define('Ext.layout.container.Container', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.ContainerLayout',
    ...
    /**
     * @cfg {String} itemCls
     * An optional extra CSS cl***REMOVED*** that will be added to the container. This can be useful for
    ...
    /**
     * In addition to work done by our base cl***REMOVED***es, containers benefit from some extra
    ...
    calculateContentSize: function (ownerContext, dimensions) {
        ...
        if (needed) {
            ...
            // at least be correctable by an overridden method in that derived cl***REMOVED***.
            for (i = 0; i < length; ++i) {
     ...
     * has determined contentWidth/Height. In addition to the ownerContext p***REMOVED***ed to the
    ...
    calculateOverflow: function (ownerContext, containerSize, dimensions) {
        ...
        if (manageOverflow && !state.secondP***REMOVED*** && !me.reserveScrollbar) {
            ...
            if (xauto || yauto) {
                ...
                if (overflowAdjust.width !== me.lastOverflowAdjust.width || overflowAdjust.height !== me.lastOverflowAdjust.height) {
                    ...
                    // we p***REMOVED*** overflowAdjust and overflowState in as state for the next
    ...
    configureItem: function(item) {
        var me = this,
            ...
            addCl***REMOVED***es = [].concat(me.itemCls || []);

        me.callParent(arguments);

        if (ownerItemCls) {
            addCl***REMOVED***es = Ext.Array.push(addCl***REMOVED***es, ownerItemCls);
        }
        item.addCls(addCl***REMOVED***es);
    },
     ...
     * method of the layout's base cl***REMOVED***), or the layout phase (onLayout).
