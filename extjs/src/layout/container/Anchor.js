 ...
 * `{@link #anchor}` rules.
 *
 * This cl***REMOVED*** is intended to be extended or created via the {@link Ext.container.AbstractContainer#layout layout}: 'anchor' 
...
Ext.define('Ext.layout.container.Anchor', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.AnchorLayout',
     ...
     *       // one value specified
     *       anchor: '-50'      // anchor value is ***REMOVED***umed to be the right offset value
    ...
    beginLayout: function (ownerContext) {
        ...
        if (!Ext.supports.RightMargin && !me.rightMarginCleanerFn) {
            target = ownerContext.targetContext.el; // targetContext is added by supercl***REMOVED***
