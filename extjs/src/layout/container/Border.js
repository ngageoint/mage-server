 ...
 *
 * This cl***REMOVED*** is intended to be extended or created via the `layout:'border'` {@link Ext.container.Container#layout}
 ...
 *     The 'center' region has a flex value of `1`.
 *
 *   - **There is no BorderLayout.Region cl***REMOVED*** in ExtJS 4.0+**
 */
Ext.define('Ext.layout.container.Border', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.BorderLayout',
     ...
     * padding values. The order of the sides ***REMOVED***ociated with each value matches the way
     ...
     * The default weights to ***REMOVED***ign to regions in the border layout. These values are
     ...
     *      }
     *
     * The region with the highest weight is ***REMOVED***igned space from the border before other
     * regions. Regions of equal weight are ***REMOVED***igned space based on their position in the
    ...
    beginLayout: function (ownerContext) {
        ...
        // Now that weights are ***REMOVED***igned to the region's contextItems, we ***REMOVED***ign those
    ...
    /**
     * Finishes the calculations on an axis. This basically just ***REMOVED***igns the remaining
