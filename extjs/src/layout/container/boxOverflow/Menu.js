...
Ext.define('Ext.layout.container.boxOverflow.Menu', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.boxOverflow.Menu',
    
    /* End Definitions */

    /**
     * @cfg {String} triggerButtonCls
     * CSS cl***REMOVED*** added to the Button which shows the overflow menu.
     */
     ...
     */
    noItemsMenuText : '<div cl***REMOVED***="' + Ext.baseCSSPrefix + 'toolbar-no-items">(None)</div>',
     ...
     * @param {Boolean} hideOnClick P***REMOVED***ed through to the menu item
     */
    ...
    addComponentToMenu : function(menu, component) {
        ...
        if (component instanceof Ext.toolbar.Separator) {
            ...
            if (component.isXType('splitbutton')) {
                ...
                menu.add(Ext.create(Ext.getCl***REMOVED***Name(component), me.createMenuConfig(component)));
            }
        }
    },
