/**
 * @private
 * Base cl***REMOVED*** for Box Layout overflow handlers. These specialized cl***REMOVED***es are invoked when a Box Layout
 * (either an HBox or a VBox) has child items that are either too wide (for HBox) or too tall (for VBox)
 * for its container.
 */
Ext.define('Ext.layout.container.boxOverflow.None', {
    alternateCl***REMOVED***Name: 'Ext.layout.boxOverflow.None',
    ...
    completeLayout: function (ownerContext) {
        ...
        if (plan && plan.tooNarrow) {
            ...
            if (overflow) {
                ...
                // TODO: If we need to use the code below then we will need to p***REMOVED*** along
