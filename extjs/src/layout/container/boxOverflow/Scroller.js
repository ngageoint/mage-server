...
Ext.define('Ext.layout.container.boxOverflow.Scroller', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.boxOverflow.Scroller',
    mixins: {
     ...
     * CSS cl***REMOVED*** added to the beforeCt element. This is the element that holds any special items such as scrollers,
     * which must always be present at the leftmost edge of the Container
     */

    /**
     * @cfg {String} afterCtCls
     * CSS cl***REMOVED*** added to the afterCt element. This is the element that holds any special items such as scrollers,
     * which must always be present at the rightmost edge of the Container
     */

    /**
     * @cfg {String} [scrollerCls='x-box-scroller']
     * CSS cl***REMOVED*** added to both scroller elements if enableScroll is used
     */
    scrollerCls: Ext.baseCSSPrefix + 'box-scroller',

    /**
     * @cfg {String} beforeScrollerCls
     * CSS cl***REMOVED*** added to the left scroller element if enableScroll is used
     */

    /**
     * @cfg {String} afterScrollerCls
     * CSS cl***REMOVED*** added to the right scroller element if enableScroll is used
     */
    ...
    /**
     * @private
     * @return {Object} Object p***REMOVED***ed to scrollTo when scrolling
     */
