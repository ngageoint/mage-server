 ...
 *
 * Note: Only Ext Panels and all subcl***REMOVED***es of Ext.panel.Panel may be used in an accordion layout Container.
 *
 *     @example
...
Ext.define('Ext.layout.container.Accordion', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.AccordionLayout',
    ...
    beginLayout: function (ownerContext) {
        this.callParent(arguments);
        this.updatePanelCl***REMOVED***es(ownerContext);
    },

    updatePanelCl***REMOVED***es: function(ownerContext) {
