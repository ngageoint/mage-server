 ...
 * This cl***REMOVED*** is intended to be extended or created via the layout:'card' {@link Ext.container.Container#layout} config,
 * and should generally not need to be created directly via the new keyword.
 *
 * The CardLayout's focal method is {@link #setActiveItem}.  Since only one panel is displayed at a time,
 * the only way to move from one Component to the next is by calling setActiveItem, p***REMOVED***ing the next panel to display
 ...
 *         // done as a subcl***REMOVED*** of CardLayout in a real-world implementation.
...
Ext.define('Ext.layout.container.Card', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.CardLayout',
