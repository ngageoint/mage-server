/**
 * Base Cl***REMOVED*** for HBoxLayout and VBoxLayout Cl***REMOVED***es. Generally it should not need to be used directly.
 */
Ext.define('Ext.layout.container.Box', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.BoxLayout',
     ...
     * the sides ***REMOVED***ociated with each value matches the way CSS processes margin values:
     *
     ...
     * sides ***REMOVED***ociated with each value matches the way CSS processes padding values:
     *
     *   - If there is only one value, it applies to all sides.
     *   - If there are two values, the top and bottom borders are set to the first value and the right and left are
     *     set to the second.
    ...
    renderTpl: [
        ...
        '}%}',
        '<div id="{ownerId}-innerCt" cl***REMOVED***="{[l.innerCls]} {[oh.getOverflowCls()]}" role="presentation">',
    ...
    beginLayoutCycle: function (ownerContext, firstCycle) {
        ...
        // Consider an hbox w/stretch which means "***REMOVED***ign all items the container's height".
    ...
    calculateParallel: function(ownerContext, names, plan) {
        ...
        if (mayNeedScrollbarAdjust &&
            ...
            // IE8 in what p***REMOVED***es for "strict" mode will not create a scrollbar if 
    ...
    calculatePerpendicular: function(ownerContext, names, plan) {
        ...
        if (isStretch) {
            ...
            // If we are ***REMOVED***ociated with another box layout, grab its maxChildHeight
        ...
        for (i = 0; i < length; ++i) {
            ...
            if (childHeight != props[heightName] ||   // if (wrong height ...
                ...
                childContext.invalidate({
                    ...
                    layout: me,
                    // p***REMOVED***ing this data avoids a 'scope' and its Function.bind
    ...
    publishInnerCtSize: function(ownerContext, reservedSpace) {
        ...
        // not ***REMOVED***umed the size of its content, set it to do so.
        //
        // We MUST p***REMOVED*** the dirty flag to get that into the DOM, and because we are a Container
    ...
    // Overridden method from Ext.layout.container.Container.
    // Used by Container cl***REMOVED***es to insert special DOM elements which must exist in addition to the child components
