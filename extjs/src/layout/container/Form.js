...
Ext.define('Ext.layout.container.Form', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.FormLayout',
    ...
    padRow: '<tr><td cl***REMOVED***="' + Ext.baseCSSPrefix + 'form-item-pad" colspan="3"></td></tr>',

    renderTpl: [
        '<table id="{ownerId}-formTable" cl***REMOVED***="{tableCls}" style="width:100%" cellpadding="0">',
