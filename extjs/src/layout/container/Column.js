 ...
 * cl***REMOVED*** is intended to be extended or created via the layout:'column' {@link Ext.container.Container#layout} config,
 ...
 *
 * The basic rules for specifying column widths are pretty simple. The logic makes two p***REMOVED***es through the set of
 * contained panels. During the first layout p***REMOVED***, all panels that either have a fixed width or none specified (auto)
 * are skipped, but their widths are subtracted from the overall container width.
 *
 * During the second p***REMOVED***, all panels with columnWidths are ***REMOVED***igned pixel widths in proportion to their percentages
...
Ext.define('Ext.layout.container.Column', {
    ...
    alias: ['layout.column'],
    alternateCl***REMOVED***Name: 'Ext.layout.ColumnLayout',
    ...
    renderTpl: [
        '<div id="{ownerId}-innerCt" cl***REMOVED***="',Ext.baseCSSPrefix,'column-inner">',
