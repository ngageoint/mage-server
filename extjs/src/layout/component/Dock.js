...
Ext.define('Ext.layout.component.Dock', {
    ...
    alternateCl***REMOVED***Name: 'Ext.layout.component.AbstractDock',
    ...
    beginLayout: function(ownerContext) {
        ...
        if (collapsed !== me.lastCollapsedState && Ext.isDefined(me.lastCollapsedState)) {
            ...
            if (me.owner.collapsed) {
                ...
                // Add the collapsed cl***REMOVED*** now, so that collapsed CSS rules are applied before measurements are taken by the layout.
                owner.addClsWithUI(owner.collapsedCls);
            } else {
                ownerContext.isCollapsingOrExpanding = 2;
                // Remove the collapsed cl***REMOVED*** now, before layout calculations are done.
     ...
     * body at (0,0) so items docked "top" or "left" will simply be ***REMOVED***igned negative x/y. In
    ...
    /**
     * @protected
     * We are overriding the Ext.layout.Layout configureItem method to also add a cl***REMOVED*** that
     * indicates the position of the docked item. We use the itemCls (x-docked) as a prefix.
     * An example of a cl***REMOVED*** added to a dock: right item is x-docked-right
