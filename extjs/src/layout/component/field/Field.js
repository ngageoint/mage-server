/**
 * Layout cl***REMOVED*** for components with {@link Ext.form.Labelable field labeling}, handling the sizing and alignment of
...
Ext.define('Ext.layout.component.field.Field', {
    ...
    beginLayout: function(ownerContext) {
        ...
        // store the input element's border and padding info so that subcl***REMOVED***es can take it into consideration if needed
        ...
        // perform preparation on the label and error (setting css cl***REMOVED***es, qtips, etc.)
