/**
 * This cl***REMOVED*** is intended to be extended or created via the {@link Ext.Component#componentLayout layout}
...
Ext.define('Ext.layout.component.Component', {
    ...
    notifyOwner: function(ownerContext) {
        ...
        // Call afterComponentLayout p***REMOVED***ing new size, and only p***REMOVED***ing old size if there *was* an old size.
