/**
 * The cl***REMOVED*** is the default component layout for {@link Ext.Component} when no explicit
 * `{@link Ext.Component#componentLayout componentLayout}` is configured.
 *
 * This cl***REMOVED*** uses template methods to perform the individual aspects of measurement,
 ...
 * component) as either "width" or "height". This value, if available, is p***REMOVED***ed to the
