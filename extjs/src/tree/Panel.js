...
Ext.define('Ext.tree.Panel', {
    ...
    alternateCl***REMOVED***Name: ['Ext.tree.TreePanel', 'Ext.TreePanel'],
     ...
     * data without having to specify a TreeStore and Model. A store and model will be created and root will be p***REMOVED***ed
