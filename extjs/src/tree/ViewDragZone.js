    ...
    afterRepair: function() {
        ...
        if (Ext.enableFx && me.repairHighlight) {
            ...
            for (r = 0; r < rLen; r++) {
                ...
                // a self-executing function p***REMOVED***ing in item.
                item = view.getNode(records[r]);

                // We must remove the selected row cl***REMOVED*** before animating, because
                // the selected row cl***REMOVED*** declares !important on its background-color.
