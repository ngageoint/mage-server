...
Ext.define('Ext.panel.Table', {
     ...
     * is empty. When specified, and the Store is empty, the text will be rendered inside a DIV with the CSS cl***REMOVED*** "x-grid-empty".
     */
    ...
    initComponent: function() {
        ...
        if (!me.hasView) {
            ...
            // If we were not configured with a ready-made headerCt (either by direct config with a headerCt property, or by p***REMOVED***ing
            ...
            if (me.hideHeaders) {
                ...
                // IE Quirks Mode fix
                // If hidden configuration option was used, several layout calculations will be byp***REMOVED***ed.
                if (Ext.isIEQuirks) {
                    me.headerCt.style = {
                        display: 'none'
                    };
    ...
    applyState: function(state) {
        ...
        // Ensure supercl***REMOVED*** has applied *its* state.
        ...
        if (sorter) {
            if (store.remoteSort) {
                // P***REMOVED*** false to prevent a sort from occurring
                store.sort({
                    property: sorter.property,
                    direction: sorter.direction,
                    root: sorter.root
    ...
    /**
     * Returns the store ***REMOVED***ociated with this Panel.
    ...
    getView: function() {
        ...
        if (!me.view) {
            ...
            me.view = Ext.widget(Ext.apply({}, me.viewConfig, {
                ...
                panel: me,
                emptyText : me.emptyText ? '<div cl***REMOVED***="' + Ext.baseCSSPrefix + 'grid-empty">' + me.emptyText + '</div>' : ''
            }));
    ...
    /**
     * @private
     * autoScroll is never valid for all cl***REMOVED***es which extend TablePanel.
     */
