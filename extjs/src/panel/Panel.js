 ...
 *     });
 *
 * Note that the Panel above is configured to render into the document and ***REMOVED***igned a size. In a real world scenario,
...
Ext.define('Ext.panel.Panel', {
    ...
    alias: 'widget.panel',
    alternateCl***REMOVED***Name: 'Ext.Panel',

    /**
     * @cfg {String} collapsedCls
     * A CSS cl***REMOVED*** to add to the panel's element after it has been collapsed.
     */
     ...
     * if the {@link Ext.fx.Anim} cl***REMOVED*** is available, otherwise `false`). May also be specified as the animation
     ...
     * P***REMOVED*** as `false` to prevent a Header from being created and shown.
     *
     * P***REMOVED*** as a config object (optionally containing an `xtype`) to custom-configure this Panel's header.
     *
     */
    header: undefined,
    ...
    /**
     * @cfg {String} iconCls
     * CSS cl***REMOVED*** for an icon in the header. Used for displaying an icon to the left of a title.
     */
    ...
    initComponent: function() {
        ...
        me.addEvents(
            ...
            /**
             * @event collapse
             * Fires after this Panel h***REMOVED*** collapsed.
     ...
     * @param {String} newIconCls The new CSS cl***REMOVED*** name
     */
    ...
    beforeRender: function() {
        ...
        // Add cl***REMOVED***-specific header tools.
     ...
     * Panel uses initTools. Subcl***REMOVED***es may contribute tools by implementing addTools.
     */
    initTools: function() {
        var me = this;
        ...
        // Add subcl***REMOVED***-specific tools.
        me.addTools();
     ...
     * @private
     * @template
     * Template method to be implemented in subcl***REMOVED***es to add their tools after the collapsible tool.
     */
    ...
    findReExpander: function (direction) {
        ...
        switch (direction) {
            ...
            default:
                throw('Panel#findReExpander must be p***REMOVED***ed a valid collapseDirection');
        }
    },
    ...
    createReExpander: function(direction, defaults) {
        ...
        result.addClsWithUI(me.getHeaderCollapsedCl***REMOVED***es(result));
        return result;
    },

    // private
    // Create the cl***REMOVED*** array to add to the Header when collpsed.
    getHeaderCollapsedCl***REMOVED***es: function(header) {
        var me = this,
            collapsedCls = me.collapsedCls,
            collapsedCl***REMOVED***es;

        collapsedCl***REMOVED***es = [ collapsedCls, collapsedCls + '-' + header.dock];
        if (me.border && (!me.frame || (me.frame && Ext.supports.CSS3BorderRadius))) {
            collapsedCl***REMOVED***es.push(collapsedCls + '-border-' + header.dock);
        }
        return collapsedCl***REMOVED***es;
    },
    ...
    beginCollapse: function() {
        ...
        if (!me.isPlaceHolderCollapse()) {
            if (me.header === (reExpander = me.getReExpander())) {
                me.header.addClsWithUI(me.getHeaderCollapsedCl***REMOVED***es(me.header));
    ...
    beginExpand: function() {
        ...
        if (!me.isPlaceHolderCollapse()) {
            ...
            if (me.header === (reExpander = me.getReExpander())) {
                me.header.removeClsWithUI(me.getHeaderCollapsedCl***REMOVED***es(me.header));
    ...
    getPlaceholder: function(direction) {
        ...
        // User created placeholder was p***REMOVED***ed in
