/**
 * @cl***REMOVED*** Ext.panel.AbstractPanel
 * @private
 *
 * A base cl***REMOVED*** which provides methods common to Panel cl***REMOVED***es across the Sencha product range.
 *
...
Ext.define('Ext.panel.AbstractPanel', {
     ...
     * The base CSS cl***REMOVED*** to apply to this panel's element.
     */
...
bodyStyle: {
     ...
     * A CSS cl***REMOVED***, space-delimited string of cl***REMOVED***es, or array of cl***REMOVED***es to be applied to the panel's body element.
...
bodyCls: ['foo', 'bar']
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Panel, or subcl***REMOVED*** thereof.
     */
    isPanel: true,
    ...
    renderTpl: [
        ...
        '<div id="{id}-body" cl***REMOVED***="{baseCls}-body<tpl if="bodyCls"> {bodyCls}</tpl>',
...
var panel = new Ext.panel.Panel({
     ...
     * items will only be matched by component id or itemId -- if you p***REMOVED*** a numeric index only non-docked child components will be searched.
    ...
    /**
     * Sets the body style according to the p***REMOVED***ed parameters.
    ...
    /**
     * Adds a CSS cl***REMOVED*** to the body element. If not rendered, the cl***REMOVED*** will
     * be added when the panel is rendered. 
     * @param {String} cls The cl***REMOVED*** to add
     * @return {Ext.panel.Panel} this
     */
    ...
    /**
     * Removes a CSS cl***REMOVED*** from the body element.
     * @param {String} cls The cl***REMOVED*** to remove
     * @return {Ext.panel.Panel} this
     */
