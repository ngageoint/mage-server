...
Ext.define('Ext.window.Window', {
    ...
    alternateCl***REMOVED***Name: 'Ext.Window',
    ...
    */
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Window, or subcl***REMOVED*** thereof.
     */
    isWindow: true,
    ...
    initDraggable: function() {
        ...
        if (me.header) {
             ...
             * {@link Ext.util.ComponentDragger} (A subcl***REMOVED*** of {@link Ext.dd.DragTracker DragTracker}) which handles dragging
    ...
    /**
     * @private
     * Contribute cl***REMOVED***-specific tools to the header.
    ...
    /**
     * @private
     * Returns the focus holder element ***REMOVED***ociated with this Window. By default, this is the Window's element.
    ...
    afterHide: function() {
        ...
        // Perform supercl***REMOVED***'s afterHide tasks.
        me.callParent(arguments);
    },
