/**
 * Utility cl***REMOVED*** for generating different styles of message boxes.  The singleton instance, Ext.MessageBox
 ...
 *     Ext.Msg.show({
 *          title:'Save Changes?',
 *          msg: 'You are closing a tab that has u***REMOVED***ved changes. Would you like to save your changes?',
...
Ext.define('Ext.window.MessageBox', {
    ...
    /**
     * @property
     * The CSS cl***REMOVED*** that provides the INFO icon image
     */
    INFO : Ext.baseCSSPrefix + 'message-box-info',
    /**
     * @property
     * The CSS cl***REMOVED*** that provides the WARNING icon image
     */
    WARNING : Ext.baseCSSPrefix + 'message-box-warning',
    /**
     * @property
     * The CSS cl***REMOVED*** that provides the QUESTION icon image
     */
    QUESTION : Ext.baseCSSPrefix + 'message-box-question',
    /**
     * @property
     * The CSS cl***REMOVED*** that provides the ERROR icon image
     */
    ...
    initComponent: function() {
        ...
        // Create the buttons based upon p***REMOVED***ed bitwise config
        me.msgButtons = [];
        for (i = 0; i < 4; i++) {
    ...
    /**
     * Displays a new message box, or reinitializes an existing message box, based on the config options p***REMOVED***ed in. All
     ...
     * A custom CSS cl***REMOVED*** to apply to the message box's container element
     *
     ...
     *  @param {Object} config.fn.opt The config object p***REMOVED***ed to show.
     *
     ...
     * A CSS cl***REMOVED*** that provides a background image to be used as the body icon for the dialog.
     * One can use a predefined icon cl***REMOVED***:
     *
     *  - Ext.MessageBox.INFO
     ...
     *
     * or use just any `'custom-cl***REMOVED***'`. Defaults to empty string.
     *
    ...
    doAutoSize: function() {
        ...
        me.minWidth = me.cfg.minWidth || Ext.getCl***REMOVED***(this).prototype.minWidth;
    ...
    /**
     * Adds the specified icon to the dialog.  By default, the cl***REMOVED*** 'x-messagebox-icon' is applied for default
     * styling, and the cl***REMOVED*** p***REMOVED***ed in is expected to supply the background image url. P***REMOVED*** in empty string ('')
     * to clear any existing icon. This method must be called before the MessageBox is shown.
     * The following built-in icon cl***REMOVED***es are supported, but you can also p***REMOVED*** in a custom cl***REMOVED*** name:
     *
     ...
     *
     * @param {String} icon A CSS cl***REMOVED***name specifying the icon's background image url, or empty string to clear the icon
     * @return {Ext.window.MessageBox} this
     */
     ...
     * so that any existing body text will not get overwritten by default unless a new value is p***REMOVED***ed in)
     * @return {Ext.window.MessageBox} this
     */
     ...
     * If a callback function is p***REMOVED***ed it will be called after the user clicks either button,
     * and the id of the button that was clicked will be p***REMOVED***ed as the only parameter to the callback
     ...
     * The prompt can be a single-line or multi-line textbox.  If a callback function is p***REMOVED***ed it will be called after the user
     * clicks either button, and the id of the button that was clicked (could also be the top-right
     * close button, which will always report as "cancel") and the text that was entered will be p***REMOVED***ed as the two parameters to the callback.
     *
     * @param {String} title The title bar text
     * @param {String} msg The message box body text
     * @param {Function} [fn] The callback function invoked after the message box is closed.
     ...
     * If a callback function is p***REMOVED***ed it will be called after the user clicks the button, and the
     * id of the button that was clicked will be p***REMOVED***ed as the only parameter to the callback
     * (could also be the top-right close button, which will always report as "cancel").
     *
     * @param {String} title The title bar text
     * @param {String} msg The message box body text
    ...
    /**
     * @cl***REMOVED*** Ext.MessageBox
     * @alternateCl***REMOVED***Name Ext.Msg
