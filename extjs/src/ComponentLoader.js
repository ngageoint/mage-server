/**
 * This cl***REMOVED*** is used to load content via Ajax into a {@link Ext.Component}. In general 
 * this cl***REMOVED*** will not be instanced directly, rather a loader configuration will be p***REMOVED***ed to the
 ...
 * the resulting content. Using this renderer has the same effect as p***REMOVED***ing the
 ...
 * The content received from the response is p***REMOVED***ed to the {@link Ext.Component#update} method.
 ...
 * ## Component Renderer
 *
 * This renderer can only be used with a {@link Ext.container.Container} and subcl***REMOVED***es. It allows for
 ...
 * and then p***REMOVED***ed to {@link Ext.container.Container#method-add}. Using this renderer has the same effect as specifying
 * the {@link Ext.container.Container#cfg-items} configuration on a Container.
 *
 * ## Custom Renderer
 *
 * A custom function can be p***REMOVED***ed to handle any other special case, see the {@link #renderer} option.
 *
 * ## Example Usage
 *
...
Ext.define('Ext.ComponentLoader', {
     ...
     * If a string is p***REMOVED***ed it will be looked up via the id.
     */
    target: null,
...
Alternatively, you can p***REMOVED*** a function which is called with the following parameters.
...
The function must return false is loading is not successful. Below is a sample of using a custom renderer:
     ...
     * @param {String/Ext.Component} target The component to be the target of this loader. If a string is p***REMOVED***ed
