...
Ext.define('Ext.LoadMask', {
     ...
     * The CSS cl***REMOVED*** to apply to the loading message element.
     */
    msgCls : Ext.baseCSSPrefix + 'mask-loading',

    /**
     * @cfg {String} [maskCls="x-mask"]
     * The CSS cl***REMOVED*** to apply to the mask element
     */
    maskCls: Ext.baseCSSPrefix + 'mask',

    /**
     * @cfg {Boolean} [useMsg=true]
     * Whether or not to use a loading message cl***REMOVED*** or simply mask the bound element.
     */
    useMsg: true,
    ...
    renderTpl: '<div id="{id}-msgEl" style="position:relative" cl***REMOVED***="{[values.$comp.msgCls]}"></div>',
