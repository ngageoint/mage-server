...
A singleton instance of an {@link Ext.data.Connection}. This cl***REMOVED***
...
Default options for all requests can be set by changing a property on the Ext.Ajax cl***REMOVED***:

    Ext.Ajax.timeout = 60000; // 60 seconds

Any options specified in the request method for the Ajax request will override any
defaults set on the Ext.Ajax cl***REMOVED***. In the code sample below, the timeout for the
...
In general, this cl***REMOVED*** will be used for all Ajax requests in your application.
...
Ext.define('Ext.Ajax', {
     ...
     * to p***REMOVED*** with each request are commonly put here.
     */
    /**
