/**
 * A cl***REMOVED*** used to load remote content to an Element. Sample usage:
 *
 *     Ext.get('el').load({
 *         url: 'myPage.php',
 *         scripts: true,
 ...
 *     });
 *
 * In general this cl***REMOVED*** will not be instanced directly, rather the {@link Ext.Element#method-load} method
 * will be used.
 */
Ext.define('Ext.ElementLoader', {
     ...
     * This argument can also be a set of options that will be p***REMOVED***ed to {@link #method-load} is called.
     */
    autoLoad: false,
     ...
     * Any additional options to be p***REMOVED***ed to the request, for example timeout or headers.
     */
    ajaxOptions: null,
     ...
     * return false if the renderer could not be applied. The p***REMOVED***ed parameters are:
     *
     * - The loader
     * - The response
     * - The active request
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated ElementLoader, or subcl***REMOVED*** thereof.
     */
    isLoader: true,
    ...
    constructor: function(config) {
        ...
        me.addEvents(
             ...
             * @param {Object} options The options p***REMOVED***ed to the request
             */
            'beforeload',
        ...
        // don't p***REMOVED*** config because we have already applied it.
     ...
     * the cl***REMOVED***, with the exception of the target option. Note that any options p***REMOVED***ed to the method will override any
     * cl***REMOVED*** defaults.
     */
     ...
     * @param {Object} options (optional) The options to p***REMOVED*** to the load method. See {@link #method-load}
     */
