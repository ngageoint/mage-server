/**
 * This cl***REMOVED*** compiles the XTemplate syntax into a function object. The function is used
 * like so:
 * 
...
Ext.define('Ext.XTemplateCompiler', {
    ...
    compile: function (tpl) {
        ...
        // When using "new Function", we have to p***REMOVED*** our "Ext" variable to it in order to
    ...
    evalTpl: function ($) {
        ...
        // with eval containing a return statement, so instead we ***REMOVED***ign to "$" and return
