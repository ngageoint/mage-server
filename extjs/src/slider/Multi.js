 ...
 *
 * Sliders can be created with more than one thumb handle by p***REMOVED***ing an array of values instead of a single one:
 *
 *     @example
 ...
 *         maxValue: 100,
 *
 *         // this defaults to true, setting to false allows the thumbs to p***REMOVED*** each other
...
Ext.define('Ext.slider.Multi', {
    ...
    alternateCl***REMOVED***Name: 'Ext.slider.MultiSlider',
    ...
    fieldSubTpl: [
        '<div id="{id}" cl***REMOVED***="' + Ext.baseCSSPrefix + 'slider {fieldCls} {vertical}" aria-valuemin="{minValue}" aria-valuemax="{maxValue}" aria-valuenow="{value}" aria-valuetext="{value}">',
            '<div id="{cmpId}-endEl" cl***REMOVED***="' + Ext.baseCSSPrefix + 'slider-end" role="presentation">',
                '<div id="{cmpId}-innerEl" cl***REMOVED***="' + Ext.baseCSSPrefix + 'slider-inner" role="presentation">',
