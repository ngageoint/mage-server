/**
 * Simple plugin for using an Ext.tip.Tip with a slider to show the slider value. In general this cl***REMOVED*** is not created
 * directly, instead p***REMOVED*** the {@link Ext.slider.Multi#useTips} and {@link Ext.slider.Multi#tipText} configuration
 ...
 *     });
 *
 * Optionally provide your own tip text by p***REMOVED***ing tipText:
 *
 *     @example
 *     Ext.create('Ext.slider.Single', {
 *         width: 214,
...
Ext.define('Ext.slider.Tip', {
    ...
    /**
     * @private
     * Called whenever a dragstart or drag event is received on the ***REMOVED***ociated Thumb.
