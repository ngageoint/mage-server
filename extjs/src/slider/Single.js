 ...
 *     });
 *
 * The cl***REMOVED*** Ext.slider.Single is aliased to Ext.Slider for backwards compatibility.
 */
Ext.define('Ext.slider.Single', {
    extend: 'Ext.slider.Multi',
    alias: ['widget.slider', 'widget.sliderfield'],
    alternateCl***REMOVED***Name: ['Ext.Slider', 'Ext.form.SliderField', 'Ext.slider.SingleSlider', 'Ext.slider.Slider'],
    ...
    setValue: function(value, animate) {
        ...
        // this is to maintain backwards compatiblity for sliders with only one thunb. Usually you must p***REMOVED*** the thumb
