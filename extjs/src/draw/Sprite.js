...
Ext.define('Ext.draw.Sprite', {
     ...
     *
     * See {@link Ext.draw.Sprite} cl***REMOVED*** documentation for examples of all types.
     */
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Sprite, or subcl***REMOVED*** thereof.
     */
    isSprite: true,
    zIndex: 0,
    fontProperties: [
     ...
     * @param {String} value (optional) The value to apply to the given property, or null if an object was p***REMOVED***ed.
     * @return {Ext.draw.Sprite} this
     */
    setStyle: function() {
    ...
    /**
     * Adds one or more CSS cl***REMOVED***es to the element. Duplicate cl***REMOVED***es are automatically filtered out.  Note this method
     ...
     * @param {String/String[]} cl***REMOVED***Name The CSS cl***REMOVED*** to remove, or an array of cl***REMOVED***es.  Note this method
     * is severly limited in VML.
     * @return {Ext.draw.Sprite} this
     */
