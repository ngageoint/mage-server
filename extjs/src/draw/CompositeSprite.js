...
Ext.define('Ext.draw.CompositeSprite', {
    ...
    /**
     * Hides all sprites. If `true` is p***REMOVED***ed then a redraw will be forced for each sprite.
     * @param {Boolean} redraw Flag to immediately draw the change.
     * @return {Ext.draw.CompositeSprite} this
     */
    ...
    /**
     * Shows all sprites. If `true` is p***REMOVED***ed then a redraw will be forced for each sprite.
     * @param {Boolean} redraw Flag to immediately draw the change.
     * @return {Ext.draw.CompositeSprite} this
     */
    ...
    /**
     * Adds cl***REMOVED*** to all sprites.
     * @param {String} cls CSS cl***REMOVED*** name
     */
    addCls: function(obj) {
        var i = 0,
            items = this.items,
    ...
    /**
     * Removes cl***REMOVED*** from all sprites.
     * @param {String} cls CSS cl***REMOVED*** name
     */
