 ...
 *
 * One of the most used methods for this cl***REMOVED*** is the {@link #add} method, to add Sprites to
 ...
 *     });
 *
 * The configuration object p***REMOVED***ed in the `add` method is the same as described in the
 * {@link Ext.draw.Sprite} cl***REMOVED*** documentation.
 *
...
Ext.define('Ext.draw.Surface', {
    ...
    statics: {
         ...
         * @param {Object} [config] The configuration to be p***REMOVED***ed to the exporter.
     ...
     *
     * @param {Object} sprite The sprite to add the cl***REMOVED*** to.
     ...
     *
     * @param {Object} sprite The sprite to remove the cl***REMOVED*** from.
     * @param {String/String[]} cl***REMOVED***Name The CSS cl***REMOVED*** to remove, or an array of cl***REMOVED***es
     * @method
     */
     ...
     *     });
     *
     * @param {Object} sprite The sprite to add, or an array of cl***REMOVED***es to
     ...
     * Therefore, it is preferred to p***REMOVED*** the gradients as an item to the surface config, rather
     ...
     *
     * The gradient object to be p***REMOVED***ed into this method is composed by:
     *
     ...
     * lower zIndex. By ensuring sprites are always ordered, this allows surface subcl***REMOVED***es to render
    ...
    /**
     * Returns a new group or an existent group ***REMOVED***ociated with the current surface.
