...
Ext.define('Ext.draw.engine.Vml', {
        ...
        if (!me.createNode) {
            try {
                ...
                me.createNode = function (tagName) {
                    return doc.createElement("<rvml:" + tagName + ' cl***REMOVED***="rvml">');
                };
            } catch (e) {
                me.createNode = function (tagName) {
                    return doc.createElement("<" + tagName + ' xmlns="urn:schemas-microsoft.com:vml" cl***REMOVED***="rvml">');
                };
            }
        }
    ...
    rotationCompe***REMOVED***tion: function (deg, dx, dy) {
    ...
    transform: function (sprite, matrixOnly) {
        var me = this,
            ...
            deltaX, deltaY, transform, type, compe***REMOVED***te, y, fill, newAngle, zoomScaleX, zoomScaleY, newOrigin, offset;
    ...
    addCls: function (sprite, cl***REMOVED***Name) {
        if (sprite && sprite.el) {
            sprite.el.addCls(cl***REMOVED***Name);
        }
    },

    removeCls: function (sprite, cl***REMOVED***Name) {
        if (sprite && sprite.el) {
            sprite.el.removeCls(cl***REMOVED***Name);
        }
    },
