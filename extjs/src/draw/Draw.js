/**
 * @cl***REMOVED*** Ext.draw.Draw
 * Base Drawing cl***REMOVED***.  Provides base drawing functions.
 * @private
 */
Ext.define('Ext.draw.Draw', {
    ...
    // Convert the p***REMOVED***ed arrayPath to a proper SVG path string (d attribute)
    ...
    parsePathString: function (pathString) {
        ...
        var paramCounts = {a: 7, c: 6, h: 1, l: 2, m: 2, q: 4, s: 4, t: 2, v: 1, z: 0},
            data = [],
            me = this;
        if (me.is(pathString, "array") && me.is(pathString[0], "array")) { // rough ***REMOVED***umption
    ...
    pathClone: function(pathArray) {
        var res = [],
            j, jj, i, ii;
        if (!this.is(pathArray, "array") || !this.is(pathArray && pathArray[0], "array")) { // rough ***REMOVED***umption
    ...
    //Returns any path command as a curveto command based on the attrs p***REMOVED***ed
     ...
     * Note that this algorithm ***REMOVED***umes that the line being smoothed is normalized going from left
     * to right; it makes special adjustments ***REMOVED***uming this orientation.
     *
