 ...
 * {@link Ext.tip.QuickTip QuickTip} cl***REMOVED***
 *
 ...
 *  - `qcl***REMOVED***`: A CSS cl***REMOVED*** to be applied to the quick tip
...
Ext.define('Ext.tip.QuickTipManager', (function() {
    ...
    return {
        ...
        singleton: true,
        alternateCl***REMOVED***Name: 'Ext.QuickTips',
         ...
         * default, the {@link Ext.tip.QuickTip QuickTip} cl***REMOVED*** is instantiated, but this can
         * be changed by supplying an xtype property or a cl***REMOVED***Name property in this object.
        ...
        init : function (autoRender, config) {
            if (!tip) {
                ...
                var tipConfig = Ext.apply({ disabled: disabled, id: 'ext-quicktips-tip' }, config),
                    cl***REMOVED***Name = tipConfig.cl***REMOVED***Name,
                    xtype = tipConfig.xtype;

                if (cl***REMOVED***Name) {
                    delete tipConfig.cl***REMOVED***Name;
                } else if (xtype) {
                    cl***REMOVED***Name = 'widget.' + xtype;
                ...
                if (autoRender !== false) {
                    ...
                    if (tipConfig.renderTo.tagName.toUpperCase() != 'BODY') { // e.g., == 'FRAMESET'
                        Ext.Error.raise({
                            sourceCl***REMOVED***: 'Ext.tip.QuickTipManager',
                            sourceMethod: 'init',
                ...
                tip = Ext.create(cl***REMOVED***Name || 'Ext.tip.QuickTip', tipConfig);
            }
        },
        ...
        // Protected method called by the dd cl***REMOVED***es
        ddDisable : function(){
        ...
        /**
         * Configures a new quick tip instance and ***REMOVED***igns it to a target element.  See
