/**
 * A specialized tooltip cl***REMOVED*** for tooltips that can be specified in markup and automatically managed
...
Ext.define('Ext.tip.QuickTip', {
    ...
    alternateCl***REMOVED***Name: 'Ext.QuickTip',

    /**
     * @cfg {String/HTMLElement/Ext.Element} target
     * The target HTMLElement, Ext.Element or id to ***REMOVED***ociate with this Quicktip.
     * 
    ...
    /**
     * Configures a new quick tip instance and ***REMOVED***igns it to a target element.
     *
     * For example usage, see the {@link Ext.tip.QuickTipManager} cl***REMOVED*** header.
     *
