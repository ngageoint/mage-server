...
Ext.define('Ext.grid.header.Container', {
    ...
    initComponent: function() {
        ...
        // TODO: P***REMOVED*** in configurations to turn on/off dynamic
    ...
    onAdd: function(c) {
        ...
        if (!c.stateId) {
            ...
            // ***REMOVED***ign a default stateId in that same manner. The stateId's of a column are
        ...
        if (Ext.global.console && Ext.global.console.warn) {
            ...
            if (me._usedIDs[c.headerId]) {
                Ext.global.console.warn(this.$cl***REMOVED***Name, 'attempted to reuse an existing id', c.headerId);
            }
    ...
    applyDefaults: function(config) {
         ...
         * wanting to use the defaults specified on the cl***REMOVED*** as opposed to 
    ...
    onHeaderShow: function(header) {
        // P***REMOVED*** up to the GridSection
        var me = this,
    ...
    // remove the trigger open cl***REMOVED*** when the menu is hidden
     ...
     * of the p***REMOVED***ed Container which have been configured as hideable.
     */
    getColumnMenu: function(headerContainer) {
        ...
        for (; i < itemsLn; i++) {
            ...
            // then the ***REMOVED***ociated menu item must also be destroyed.
            item.on({
     ...
     *  - width
     *  - id
     *  - columnId - used to create an identifying CSS cl***REMOVED***
     ...
     * @param {Boolean} refreshCache If omitted, the cached set of columns will be returned. P***REMOVED*** true to refresh the cache.
     * @returns {Array}
     */
     ...
     * structure is.
     *
     * If a group header is p***REMOVED***ed, the index of the first leaf level heder within it is returned.
     *
    ...
    /**
     * When p***REMOVED***ed a column index, returns the closet *visible* column to that. If the column at the p***REMOVED***ed index is visible,
        ...
        for (; colIdx < headersLn; colIdx++) {
            ...
            if (typeof renderer == "function") {
                value = renderer.call(
                    ...
                    value,
                    // metadata per cell p***REMOVED***ing an obj by reference so that
