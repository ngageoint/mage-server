 ...
 * TablePanel subcl***REMOVED*** such as GridPanel or TreePanel. TablePanel will
 ...
 *
 * Each TablePanel subcl***REMOVED*** must register an alias. It should have an array
 ...
 * flex width.
 *
 * Configurations which are specified in this cl***REMOVED*** will be available on any grid or
...
Ext.define('Ext.grid.Lockable', {
     ...
     * following rule. Use the supercl***REMOVED***es xtype if the supercl***REMOVED*** is NOT
    ...
    // injectLockable will be invoked before initComponent's parent cl***REMOVED*** implementation
    ...
    injectLockable: function() {
        ...
        var me = this,
            ...
            // xtype of this cl***REMOVED***, 'treepanel' or 'gridpanel'
            // (Note: this makes it a requirement that any subcl***REMOVED*** that wants to use lockable functionality needs to register an
            // alias.)
    ...
    processColumns: function(columns){
        ...
        for (; i < len; ++i) {
            column = columns[i];
            // MUST clone the column config because we mutate it, and we must not mutate p***REMOVED***ed in config objects in case they are re-used
