 ...
 * @private
 *
 * This cl***REMOVED*** is used only by the grid's HeaderContainer docked child.
 *
...
Ext.define('Ext.grid.ColumnLayout', {
    ...
    beginLayout: function (ownerContext) {
        ...
        // Add special first/last cl***REMOVED***es
        if (len > 0) {
    ...
    calculate: function(ownerContext) {
        ...
        //     we are not already in the second p***REMOVED***, and we are not shrinkWrapping...
        //     Then we have to see if we know enough to determine whether there is vertical opverflow so that we can
        //     invalidate and loop back for the second p***REMOVED*** with a narrower target width.
    ...
    publishInnerCtSize: function(ownerContext) {
        ...
        if ((cw != null) && !me.owner.isHeader) {
            ...
            // innerCt must also encomp***REMOVED*** any vertical scrollbar width if there may be one
