/**
 * A Column definition cl***REMOVED*** which renders boolean data fields.  See the {@link Ext.grid.column.Column#xtype xtype}
...
Ext.define('Ext.grid.column.Boolean', {
    ...
    alternateCl***REMOVED***Name: 'Ext.grid.BooleanColumn',
