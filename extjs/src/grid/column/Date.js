/**
 * A Column definition cl***REMOVED*** which renders a p***REMOVED***ed date according to the default locale, or a configured
 * {@link #format}.
 *
 *     @example
...
Ext.define('Ext.grid.column.Date', {
    ...
    requires: ['Ext.Date'],
    alternateCl***REMOVED***Name: 'Ext.grid.DateColumn',
