 ...
 *     });
 *
 * This requires a little explanation. We're p***REMOVED***ing in `store` and `columns` as normal, but
 ...
 * For the Email column we customized the editor slightly by p***REMOVED***ing allowBlank: false, which
...
Ext.define('Ext.grid.plugin.CellEditing', {
    ...
    // private
    // Template method called from base cl***REMOVED***'s initEvents
