/**
 * This cl***REMOVED*** provides an abstract grid editing plugin on selected {@link Ext.grid.column.Column columns}.
 ...
 *
 * **Note:** This cl***REMOVED*** should not be used directly. See {@link Ext.grid.plugin.CellEditing} and
...
Ext.define('Ext.grid.plugin.Editing', {
    ...
    beforeViewCellFocus: function(position) {
        // P***REMOVED*** call on to view if the navigation is from the keyboard, or we are not going to edit this cell.
    ...
    // TODO: Have this use a new cl***REMOVED*** Ext.grid.CellContext for use here, and in CellSelectionModel
    /**
     * @private
     * Collects all information necessary for any subcl***REMOVED***es to perform their editing functions.
     * @param record
     * @param columnHeader
     * @returns {Object/undefined} The editing context based upon the p***REMOVED***ed record and column
     */
    getEditingContext: function(record, columnHeader) {
        ...
        if (Ext.isNumber(record)) {
            // look up record if numeric row index was p***REMOVED***ed
            rowIdx = record;
