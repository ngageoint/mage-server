...
/**
 * Internal utility cl***REMOVED*** used to provide row editing functionality. For developers, they should use
...
Ext.define('Ext.grid.RowEditor', {
    ...
    getFloatingButtons: function() {
        ...
        if (!me.floatingButtons) {
            btns = me.floatingButtons = new Ext.Container({
                renderTpl: [
                    '<div cl***REMOVED***="{baseCls}-ml"></div>',
                    '<div cl***REMOVED***="{baseCls}-mr"></div>',
                    '<div cl***REMOVED***="{baseCls}-bl"></div>',
                    '<div cl***REMOVED***="{baseCls}-br"></div>',
                    '<div cl***REMOVED***="{baseCls}-bc"></div>',
    ...
    removeField: function(field) {
        ...
        // Incase we p***REMOVED*** a column instead, which is fine
