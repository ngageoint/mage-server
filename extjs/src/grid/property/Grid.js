...
Ext.define('Ext.grid.property.Grid', {
    ...
    alternateCl***REMOVED***Name: 'Ext.grid.PropertyGrid',
    ...
    */
     ...
     * ***REMOVED***ociated with a custom input control by specifying a custom editor.  The name of the editor
     ...
     * of strings, dates, numbers and booleans using built-in form editors, but any custom type can be supported and
     * ***REMOVED***ociated with the type of the value.  The name of the renderer type should correspond with the name of the property
    ...
    initComponent : function(){
        ...
        me.addEvents(
             ...
             * @param {Object} source The source data object for the grid (corresponds to the same object p***REMOVED***ed in
     ...
     * otherwise string type will be ***REMOVED***umed.  If the grid already contains data, this method will replace any
