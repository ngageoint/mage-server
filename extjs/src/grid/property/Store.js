/**
 * A custom {@link Ext.data.Store} for the {@link Ext.grid.property.Grid}. This cl***REMOVED*** handles the mapping
 * between the custom data source objects supported by the grid and the {@link Ext.grid.property.Property} format
 * used by the {@link Ext.data.Store} base cl***REMOVED***.
 */
Ext.define('Ext.grid.property.Store', {

    extend: 'Ext.data.Store',

    alternateCl***REMOVED***Name: 'Ext.grid.PropertyStore',
