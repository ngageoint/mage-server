 ...
 *
 * This is useful to to ***REMOVED***ociate additional information with a particular
 * record in a grid.
 *
 ...
 *                 // Usually you would style the my-body-cl***REMOVED*** in CSS file
 *                 return {
 *                     rowBody: '<div style="padding: 1em">'+record.get("desc")+'</div>',
 *                     rowBodyCls: "my-body-cl***REMOVED***",
...
Ext.define('Ext.grid.feature.RowBody', {
    ...
    getRowBody: function(values) {
        return [
            '<tr cl***REMOVED***="' + this.rowBodyTrCls + ' {rowBodyCls}">',
                '<td cl***REMOVED***="' + this.rowBodyTdCls + '" colspan="{rowBodyColspan}">',
                    '<div cl***REMOVED***="' + this.rowBodyDivCls + '">{rowBody}</div>',
                '</td>',
            '</tr>'
        ].join('');
    },
