...
Ext.define('Ext.grid.feature.RowWrap', {
    ...
    mutateMetaRowTpl: function(metaRowTpl) {  
        ...
        // 2
        metaRowTpl.unshift('<table cl***REMOVED***="' + prefix + 'grid-table ' + prefix + 'grid-table-resizer" style="width: {[this.embedFullWidth()]}px;">');
        // 1
        metaRowTpl.unshift('<tr cl***REMOVED***="' + prefix + 'grid-row {[this.embedRowCls()]}"><td colspan="{[this.embedColSpan()]}"><div cl***REMOVED***="' + prefix + 'grid-rowwrap-div">');
    ...
    getAdditionalData: function(data, idx, record, orig) {
        ...
        for (; i < itemsLn; i++) {
            ...
            // give the inner td's the resizer cl***REMOVED***
