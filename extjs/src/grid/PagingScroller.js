 ...
 *
 * This cl***REMOVED*** monitors scrolling of the {@link Ext.view.Table
 ...
 * this cl***REMOVED*** should never be instantiated by user code.  Always use the
...
Ext.define('Ext.grid.PagingScroller', {
    ...
    bindView: function(view) {
         ...
         * Current pixel scroll position of the ***REMOVED***ociated {@link Ext.view.Table View}.
         */
        me.position = 0;
