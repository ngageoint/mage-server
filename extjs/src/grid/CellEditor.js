/**
 * Internal utility cl***REMOVED*** that provides default configuration for cell editing.
 * @private
 */
Ext.define('Ext.grid.CellEditor', {
    ...
    /**
     * @private
     * Because when checkbox is clicked it loses focus  completeEdit is byp***REMOVED***ed.
     */
    ...
    realign: function(autoSize) {
        ...
        // let's ***REMOVED***ume this cell contains additional elements before the text node.
        ...
        if(me.isForTree && (childCount > 1 || (childCount === 1 && children[0].nodeType !== 3))) {
            ...
            // calculate the right bound of the text node (this is ***REMOVED***umed to be the right edge of
            // the inner cell, since we are ***REMOVED***uming the text node is always the last node in the
            // inner cell)
