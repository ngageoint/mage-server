 ...
 * tied to a particular column and is p***REMOVED***ed the value that would be rendered into each cell in that column. For example,
...
Ext.define('Ext.grid.Panel', {
    ...
    alternateCl***REMOVED***Name: ['Ext.list.ListView', 'Ext.ListView', 'Ext.grid.GridPanel'],
    viewType: 'gridview',
     ...
     * @param {Ext.data.Store} store The store that was p***REMOVED***ed to the {@link #method-reconfigure} method
     * @param {Object[]} columns The column configs that were p***REMOVED***ed to the {@link #method-reconfigure} method
     */
