/**
 * A base cl***REMOVED*** for all menu items that require menu-related functionality such as click handling,
 * sub-menus, icons, etc.
 *
 *     @example
...
Ext.define('Ext.menu.Item', {
    ...
    alternateCl***REMOVED***Name: 'Ext.menu.TextItem',
     ...
     * The CSS cl***REMOVED*** added to the menu item when the item is activated (focused/mouseover).
     */
     ...
     * Whether or not to destroy any ***REMOVED***ociated sub-menu when this item is destroyed.
     */
    destroyMenu: true,

    /**
     * @cfg {String} disabledCls
     * The CSS cl***REMOVED*** added to the menu item when the item is disabled.
     */
    ...
    /**
     * @cfg {String} iconCls
     * A CSS cl***REMOVED*** that specifies a `background-image` to use as the icon for this item.
     */
    ...
    /**
     * @property {Ext.menu.Menu} menu The sub-menu ***REMOVED***ociated with this item, if one was configured.
     */
    ...
    renderTpl: [
        '<tpl if="plain">',
            '{text}',
        '<tpl else>',
            '<a id="{id}-itemEl" cl***REMOVED***="' + Ext.baseCSSPrefix + 'menu-item-link" href="{href}" <tpl if="hrefTarget">target="{hrefTarget}"</tpl> hidefocus="true" unselectable="on">',
                '<img id="{id}-iconEl" src="{icon}" cl***REMOVED***="' + Ext.baseCSSPrefix + 'menu-item-icon {iconCls}" />',
                '<span id="{id}-textEl" cl***REMOVED***="' + Ext.baseCSSPrefix + 'menu-item-text" <tpl if="arrowCls">style="margin-right: 17px;"</tpl> >{text}</span>',
                '<img id="{id}-arrowEl" src="{blank}" cl***REMOVED***="{arrowCls}" />',
            '</a>',
        '</tpl>'
    ],
     ...
     * p***REMOVED***ed to remove the menu.
     ...
     * @param {String} iconCls The CSS cl***REMOVED*** to set to {@link #iconCls}
     */
