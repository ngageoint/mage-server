 ...
 * is more likely you will want to use one of the component cl***REMOVED***es that import this mixin, such as
 ...
 * two.)
 *
 * Component cl***REMOVED***es which use this mixin should use the Field layout
...
Ext.define("Ext.form.Labelable", {
    ...
    childEls: [
         ...
         * be present in the DOM for use by ***REMOVED***istive technologies.
         */
        'errorEl',
     ...
     * The rendering template for the field decorations. Component cl***REMOVED***es using this mixin
        ...
        '<tr id="{id}-inputRow" <tpl if="inFormLayout">id="{id}"</tpl>>',
            ...
            '<tpl if="labelOnLeft">',
                '<td id="{id}-labelCell" style="{labelCellStyle}" {labelCellAttrs}>',
                    '{beforeLabelTpl}',
                    '<label id="{id}-labelEl" {labelAttrTpl}<tpl if="inputId"> for="{inputId}"</tpl> cl***REMOVED***="{labelCls}"',
            ...
            '<td cl***REMOVED***="{baseBodyCls} {fieldBodyCls}" id="{id}-bodyEl" colspan="{bodyColspan}" role="presentation">',
                '{beforeBodyEl}',
            ...
            '<tpl if="msgTarget===\'side\'">',
                ...
                '<td id="{id}-sideErrorCell" vAlign="{[values.labelAlign===\'top\' && !values.hideLabel ? \'bottom\' : \'middle\']}" style="{[values.autoFitErrors ? \'display:none\' : \'\']}" width="{errorIconWidth}">',
                    '<div id="{id}-errorEl" cl***REMOVED***="{errorMsgCls}" style="display:none;width:{errorIconWidth}px"></div>',
                '</td>',
            '<tpl elseif="msgTarget==\'under\'">',
                '<div id="{id}-errorEl" cl***REMOVED***="{errorMsgCl***REMOVED***}" colspan="2" style="display:none"></div>',
                '{afterBodyEl}',
                '</td>',
            '</tpl>',
     ...
     * The template used to format the Array of error messages p***REMOVED***ed to {@link #setActiveErrors} into a single HTML
     ...
     * A CSS cl***REMOVED*** to be applied to the outermost element to denote that it is participating in the form field layout.
     */
    formItemCls: Ext.baseCSSPrefix + 'form-item',

    /**
     * @cfg {String} labelCls
     * The CSS cl***REMOVED*** to be applied to the label element. This (single) CSS cl***REMOVED*** is used to formulate the renderSelector
     * and drives the field layout where it is concatenated with a hyphen ('-') and {@link #labelAlign}. To add
     * additional cl***REMOVED***es, use {@link #labelClsExtra}.
     */
    labelCls: Ext.baseCSSPrefix + 'form-item-label',

    /**
     * @cfg {String} labelClsExtra
     * An optional string of one or more additional CSS cl***REMOVED***es to add to the label element. Defaults to empty.
     */

    /**
     * @cfg {String} errorMsgCls
     * The CSS cl***REMOVED*** to be applied to the error message element.
     */
    errorMsgCls: Ext.baseCSSPrefix + 'form-error-msg',

    /**
     * @cfg {String} baseBodyCls
     * The CSS cl***REMOVED*** to be applied to the body content element.
     */
    baseBodyCls: Ext.baseCSSPrefix + 'form-item-body',

    /**
     * @cfg {String} fieldBodyCls
     * An extra CSS cl***REMOVED*** to be applied to the body content element in addition to {@link #baseBodyCls}.
     */
    fieldBodyCls: '',

    /**
     * @cfg {String} clearCls
     * The CSS cl***REMOVED*** to be applied to the special clearing div rendered directly after the field contents wrapper to
     ...
     * The CSS cl***REMOVED*** to use when marking the component invalid.
     */
    ...
    /**
     * Performs initialization of this mixin. Component cl***REMOVED***es using this mixin should call this method during their
     * own initialization.
     */
    ...
    getLabelCellAttrs: function() {
        ...
        return result + ' cl***REMOVED***="' + Ext.baseCSSPrefix + 'field-label-cell"';
    },
     ...
     * by cl***REMOVED***es including this mixin as needed.
     ...
     * Implementing subcl***REMOVED***es may also use this as e.g. the id for their own input element.
