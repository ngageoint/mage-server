/**
 * A cl***REMOVED*** which handles submission of data from {@link Ext.form.Basic Form}s and processes the returned response.
 *
 * Instances of this cl***REMOVED*** are only created by a {@link Ext.form.Basic Form} when
 ...
 * # JSON Packets
 *
 * By default, response packets are ***REMOVED***umed to be JSON, so a typical response packet may look like this:
 *
 *     {
 *         success: false,
 *         errors: {
...
Ext.define('Ext.form.action.Submit', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.Action.Submit',
     ...
     * to submission. P***REMOVED*** false in the Form's submit options to prevent this.
     */
    ...
    doSubmit: function() {
        ...
        // and p***REMOVED*** that to the ajax call so it can do its iframe-based submit method.
