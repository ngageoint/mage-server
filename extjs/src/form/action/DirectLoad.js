 ...
 *         },
 *         // specify the order for the p***REMOVED***ed params
 *         paramOrder: ['uid', 'foo']
 *     });
 *
 *     // load the form
 *     myFormPanel.getForm().load({
 *         // p***REMOVED*** 2 arguments to server side getBasicInfo method (len=2)
 *         params: {
 *             foo: 'bar',
 *             uid: 34
 *         }
...
Ext.define('Ext.form.action.DirectLoad', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.Action.DirectLoad',
