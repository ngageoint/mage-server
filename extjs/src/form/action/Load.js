/**
 * A cl***REMOVED*** which handles loading of data from a server into the Fields of an {@link Ext.form.Basic}.
 *
 * Instances of this cl***REMOVED*** are only created by a {@link Ext.form.Basic Form} when {@link Ext.form.Basic#load load}ing.
 *
 ...
 *
 * The `data` property contains the values of Fields to load. The individual value object for each Field is p***REMOVED***ed to
 * the Field's {@link Ext.form.field.Field#setValue setValue} method.
 *
 * ## JSON Packets
 *
 * By default, response packets are ***REMOVED***umed to be JSON, so for the following form load call:
 *
...
Ext.define('Ext.form.action.Load', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.Action.Load',
