/**
 * The subcl***REMOVED***es of this cl***REMOVED*** provide actions to perform upon {@link Ext.form.Basic Form}s.
 *
 * Instances of this cl***REMOVED*** are only created by a {@link Ext.form.Basic Form} when the Form needs to perform an action
 * such as submit or load. The Configuration options listed for this cl***REMOVED*** are set through the Form's action methods:
 * {@link Ext.form.Basic#submit submit}, {@link Ext.form.Basic#load load} and {@link Ext.form.Basic#doAction doAction}
 *
 * The instance of Action which performed the action is p***REMOVED***ed to the success and failure callbacks of the Form's action
...
Ext.define('Ext.form.action.Action', {
    alternateCl***REMOVED***Name: 'Ext.form.Action',
     ...
     * Extra parameter values to p***REMOVED***. These are added to the Form's {@link Ext.form.Basic#baseParams} and p***REMOVED***ed to the
     ...
     * @cfg {Ext.form.action.Action} success.action The Action cl***REMOVED***. The {@link #result} property of this object may
     ...
     * @cfg {Ext.form.action.Action} failure.action The Action cl***REMOVED***. If an Ajax error ocurred, the failure type will
     ...
     * @private
     * @method onSuccess
     * Callback method that gets invoked when the action completes successfully. Must be implemented by subcl***REMOVED***es.
     ...
     * Handles the raw response and builds a result object from it. Must be implemented by subcl***REMOVED***es.
     * @param {Object} response
     */
