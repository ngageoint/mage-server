...
Ext.define('Ext.form.FieldSet', {
     ...
     * The name to ***REMOVED***ign to the fieldset's checkbox if {@link #checkboxToggle} = true
     ...
     * The base CSS cl***REMOVED*** applied to the fieldset.
     */
    ...
    renderTpl: [
        ...
        '<div id="{id}-body" cl***REMOVED***="{baseCls}-body">',
    ...
    /**
     * Creates the legend title component. This is only called internally, but could be overridden in subcl***REMOVED***es to
    ...
    /**
     * Creates the checkbox component. This is only called internally, but could be overridden in subcl***REMOVED***es to
    ...
    /**
     * Creates the toggle button component. This is only called internally, but could be overridden in subcl***REMOVED***es to
