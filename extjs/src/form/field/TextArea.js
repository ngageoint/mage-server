 ...
 *
 * This cl***REMOVED*** creates a multiline text field, which can be used as a direct replacement for traditional
...
Ext.define('Ext.form.field.TextArea', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.TextArea',
    requires: [
        'Ext.XTemplate', 
     ...
     * True if you want the ENTER key to be cl***REMOVED***ed as a special key and the {@link #specialkey} event to be fired
