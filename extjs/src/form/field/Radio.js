...
Ext.define('Ext.form.field.Radio', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.Radio',
    requires: ['Ext.form.RadioManager'],

    /**
     * @property {Boolean} isRadio
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Radio, or subcl***REMOVED*** thereof.
     */
    isRadio: true,
    ...
    /**
     * Sets either the checked/unchecked status of this Radio, or, if a string value is p***REMOVED***ed, checks a sibling Radio
