 ...
 * or as the base cl***REMOVED*** for more sophisticated input controls (like {@link Ext.form.field.TextArea}
 ...
 * {@link Ext.form.Panel} cl***REMOVED*** documentation.
 *
...
Ext.define('Ext.form.field.Text', {
    ...
    alternateCl***REMOVED***Name: ['Ext.form.TextField', 'Ext.form.Text'],
     ...
     * process.
     *
     * This function will be p***REMOVED***ed the following parameters:
     *
     ...
     * p***REMOVED***word input fields.
     */

    /**
     * @cfg {String} [emptyCls='x-form-empty-field']
     * The CSS cl***REMOVED*** to apply to an empty field to style the **{@link #emptyText}**.
     * This cl***REMOVED*** is automatically added and removed as needed depending on the current field value.
     */
    emptyCls : Ext.baseCSSPrefix + 'form-empty-field',

    /**
     * @cfg {String} [requiredCls='x-form-required-field']
     * The CSS cl***REMOVED*** to apply to a required field, i.e. a field where **{@link #allowBlank}** is false.
     */
     ...
     *     function, it will be p***REMOVED***ed the current field value.  The `{@link #validator}`
     ...
     *
     *         If the p***REMOVED***ed value does not satisfy the `{@link #minLength}`
     *         specified, validation halts.
     *
     *     -  `{@link #maxLength}` : (Invalid message = `{@link #maxLengthText}`)
     *
     *         If the p***REMOVED***ed value does not satisfy the `{@link #maxLength}`
     *         specified, validation halts.
     *
     ...
     *
     * @param {Object} value The value to validate. The processed raw value will be used if nothing is p***REMOVED***ed.
