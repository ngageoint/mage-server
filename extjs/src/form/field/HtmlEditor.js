 ...
 *     });
 *
 * P***REMOVED***ed via xtype into a container and with custom options:
 *
 *     @example
 *     Ext.tip.QuickTipManager.init();  // enable tooltips
 *     new Ext.panel.Panel({
...
Ext.define('Ext.form.field.HtmlEditor', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.HtmlEditor',
    requires: [
    ...
    fieldSubTpl: [
        ...
        '<textarea id="{cmpId}-textareaEl" name="{name}" tabIndex="-1" {inputAttrTpl}',
                 ' cl***REMOVED***="{textareaCls}" style="{size}" autocomplete="off">',
    ...
    /**
     * @private
     * Must define this function to allow the Layout base cl***REMOVED*** to collect all descendant layouts to be run.
     */
    ...
    createToolbar : function(editor){
        ...
        if (me.enableFont && !Ext.isSafari2) {
            fontSelectItem = Ext.widget('component', {
                renderTpl: [
                    '<select id="{id}-selectEl" cl***REMOVED***="{cls}">',
                        '<tpl for="fonts">',
    ...
    initRenderData: function() {
        this.beforeSubTpl = '<div cl***REMOVED***="' + this.editorWrapCls + '">' + Ext.DomHelper.markup(this.toolbar.getRenderTree());
    ...
    cleanHtml: function(html) {
        ...
        if (Ext.isWebKit) { // strip safari nonsense
            html = html.replace(/\scl***REMOVED***="(?:Apple-style-span|khtml-block-placeholder)"/gi, '');
        }
     ...
     * @param {String/Boolean} [value=null] The value to p***REMOVED*** to the command
     */
    ...
    /**
     * Inserts the p***REMOVED***ed text at the current cursor position.
     ...
     * Object collection of toolbar tooltips for the buttons in the editor. The key is the command id ***REMOVED***ociated with
