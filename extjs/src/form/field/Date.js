...
Ext.define('Ext.form.field.Date', {
    ...
    alternateCl***REMOVED***Name: ['Ext.form.DateField', 'Ext.form.Date'],
     ...
     * An additional CSS cl***REMOVED*** used to style the trigger button. The trigger will always get the cl***REMOVED*** 'x-form-trigger'
     * and triggerCls will be **appended** if specified (default cl***REMOVED*** displays a calendar icon).
     */
    ...
    /**
     * @method setValue
     * Sets the value of the date field. You can p***REMOVED*** a date object or any string that can be parsed into a valid date,
     ...
     *
     *     //P***REMOVED*** a date object:
     *     var dt = new Date('5/4/2006');
     *     dateField.setValue(dt);
     *
     *     //P***REMOVED*** a date string (default format):
     *     dateField.setValue('05/04/2006');
     *
     *     //P***REMOVED*** a date string (custom format):
