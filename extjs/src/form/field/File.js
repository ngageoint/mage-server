...
Ext.define("Ext.form.field.File", {
    ...
    alternateCl***REMOVED***Name: ['Ext.form.FileUploadField', 'Ext.ux.form.FileUploadField', 'Ext.form.File'],
    ...
    onFileChange: function() {
        ...
        Ext.form.field.File.supercl***REMOVED***.setValue.call(this, this.fileInputEl.dom.value);
    },
