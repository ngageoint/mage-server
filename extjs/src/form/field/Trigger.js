 ...
 * The trigger has no default action, so you must ***REMOVED***ign a function to implement the trigger click handler by overriding
 ...
 *     });
 *
 * However, in general you will most likely want to use Trigger as the base cl***REMOVED*** for a reusable component.
...
Ext.define('Ext.form.field.Trigger', {
    ...
    alternateCl***REMOVED***Name: ['Ext.form.TriggerField', 'Ext.form.TwinTriggerField', 'Ext.form.Trigger'],
    ...
    /**
     * @cfg
     * The base CSS cl***REMOVED*** that is always added to the trigger button. The {@link #triggerCls} will be appended in
     * addition to this cl***REMOVED***.
     */
    triggerBaseCls: Ext.baseCSSPrefix + 'form-trigger',

    /**
     * @cfg
     * The CSS cl***REMOVED*** that is added to the div wrapping the trigger button(s).
     */
    triggerWrapCls: Ext.baseCSSPrefix + 'form-trigger-wrap',

    /**
     * @cfg
     * The CSS cl***REMOVED*** that is added to the text field when component is read-only or not editable.
     */
    ...
    getSubTplMarkup: function() {
        ...
        return '<table id="' + me.id + '-triggerWrap" cl***REMOVED***="' + Ext.baseCSSPrefix + 'form-trigger-wrap" cellpadding="0" cellspacing="0"><tbody><tr>' +
            '<td id="' + me.id + '-inputCell" cl***REMOVED***="' + Ext.baseCSSPrefix + 'form-trigger-input-cell">' + field + '</td>' +
            me.getTriggerMarkup() +
            '</tr></tbody></table>';
    },
     ...
     * @param {Boolean} editable True to allow the user to directly edit the field text. If false is p***REMOVED***ed, the user
     ...
     * Instead the tab key is monitored, and the supercl***REMOVED***'s onBlur is called when tab is detected
     */
    onBlur: Ext.emptyFn,
    ...
    triggerBlur: function(e) {
        ...
        Ext.form.field.Trigger.supercl***REMOVED***.onBlur.call(me, e);
        if (me.bodyEl) {
    ...
    // private
    // This should be overridden by any subcl***REMOVED*** that needs to check whether or not the field can be blurred.
    ...
    onTriggerWrapClick: function() {
        ...
        if (event && !me.readOnly && !me.disabled) {
                ...
                match = targetEl && targetEl.cl***REMOVED***Name.match(me.triggerIndexRe);
    ...
    // private
    // Handle trigger mouse up gesture. To be implemented in subcl***REMOVED***es.
    // Currently the Spinner subcl***REMOVED*** refocuses the input element upon end of spin.
