 ...
 * component cl***REMOVED*** rather than using this mixin directly, as BaseField contains additional logic for generating an
...
Ext.define('Ext.form.field.Field', {
     ...
     *
     * Each subcl***REMOVED*** should override or augment the return value to provide their own errors.
     *
    ...
    /**
     * A utility for grouping a set of modifications which may trigger value changes into a single tra***REMOVED***ction, to
     ...
     * change.
     * @param {Object} fn A function containing the tra***REMOVED***ction code
     */
