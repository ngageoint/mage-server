/**
 * An abstract cl***REMOVED*** for fields that have a single trigger which opens a "picker" popup below the field, e.g. a combobox
 ...
 * respectively.
 *
 * You would not normally use this cl***REMOVED*** directly, but instead use it as the parent cl***REMOVED*** for a specific picker field
 * implementation. Subcl***REMOVED***es must implement the {@link #createPicker} method to create a picker component appropriate
 * for the field.
 */
Ext.define('Ext.form.field.Picker', {
    extend: 'Ext.form.field.Trigger',
    alias: 'widget.pickerfield',
    alternateCl***REMOVED***Name: 'Ext.form.Picker',
     ...
     * A cl***REMOVED*** to be added to the field's {@link #bodyEl} element when the picker is opened.
     */
    ...
    /**
     * Performs the alignment on the picker using the cl***REMOVED*** defaults
     * @private
     */
    doAlign: function(){
        var me = this,
        ...
        // add the {openCls}-above cl***REMOVED*** if the picker was aligned above
    ...
    /**
     * @method
     * Creates and returns the component to be used as this field's picker. Must be implemented by subcl***REMOVED***es of Picker.
     * The current field should also be p***REMOVED***ed as a configuration option to the picker component as the pickerField
     * property.
     */
    ...
    /**
     * returns true if the picker has a load mask and the p***REMOVED***ed event is within the load mask
     * @private
