 ...
 * parent cl***REMOVED*** for {@link Ext.form.field.Radio radio buttons}.
 *
 * # Labeling
 *
...
Ext.define('Ext.form.field.Checkbox', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.Checkbox',
    ...
    fieldSubTpl: [
        '<tpl if="boxLabel && boxLabelAlign == \'before\'">',
            '{beforeBoxLabelTpl}',
            '<label id="{cmpId}-boxLabelEl" {boxLabelAttrTpl} cl***REMOVED***="{boxLabelCls} {boxLabelCls}-{boxLabelAlign}" for="{id}">',
        ...
        '<input type="button" id="{id}" {inputAttrTpl}',
            ...
            ' cl***REMOVED***="{fieldCls} {typeCls}" autocomplete="off" hidefocus="true" />',
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Checkbox, or subcl***REMOVED*** thereof.
     */
    isCheckbox: true,

    /**
     * @cfg {String} [focusCls='x-form-cb-focus']
     * The CSS cl***REMOVED*** to use when the checkbox receives focus
     */
    focusCls: 'form-cb-focus',

    /**
     * @cfg {String} [fieldCls='x-form-field']
     * The default CSS cl***REMOVED*** for the checkbox
     */

    /**
     * @cfg {String} [fieldBodyCls='x-form-cb-wrap']
     * An extra CSS cl***REMOVED*** to be applied to the body content element in addition to {@link #fieldBodyCls}.
     * .
     */
     ...
     * The CSS cl***REMOVED*** added to the component's main element when it is in the checked state.
     */
     ...
     * The CSS cl***REMOVED*** to be applied to the {@link #boxLabel} element
     */
    ...
    getElConfig: function() {
        ...
        // Add the checked cl***REMOVED*** if this begins checked
    ...
    setValue: function(checked) {
        ...
        // If an array of strings is p***REMOVED***ed, find all checkboxes in the group with the same name as this
