/**
 * @singleton
 * @alternateCl***REMOVED***Name Ext.form.VTypes
 *
...
Ext.define('Ext.form.field.VTypes', (function(){
    ...
    return {
         ...
         * validation per the email RFC specifications is very complex and beyond the scope of this cl***REMOVED***, although this
         ...
         * @return {Boolean} true if the RegExp test p***REMOVED***ed, and false if not.
         */
        'email' : function(v){
            return email.test(v);
        },
