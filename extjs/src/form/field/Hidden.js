/**
 * A basic hidden field for storing hidden values in forms that need to be p***REMOVED***ed in the form submit.
 *
 ...
 * {@link Ext.form.action.Action#params p***REMOVED*** hidden parameters} directly when
...
Ext.define('Ext.form.field.Hidden', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.Hidden',
