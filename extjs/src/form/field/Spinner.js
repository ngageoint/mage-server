/**
 * A field with a pair of up/down spinner buttons. This cl***REMOVED*** is not normally instantiated directly,
 * instead it is subcl***REMOVED***ed and the {@link #onSpinUp} and {@link #onSpinDown} methods are implemented
...
Ext.define('Ext.form.field.Spinner', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.Spinner',
     ...
     * {@link #keyNavEnabled} is true. Must be implemented by subcl***REMOVED***es.
     */
    ...
    triggerTpl: '<td style="{triggerStyle}">' +
                    '<div cl***REMOVED***="' + Ext.baseCSSPrefix + 'trigger-index-0 ' + Ext.baseCSSPrefix + 'form-trigger ' + Ext.baseCSSPrefix + 'form-spinner-up" role="button"></div>' +
                    '<div cl***REMOVED***="' + Ext.baseCSSPrefix + 'trigger-index-1 ' + Ext.baseCSSPrefix + 'form-trigger ' + Ext.baseCSSPrefix + 'form-spinner-down" role="button"></div>' +
                '</td>' +
            '</tr>',
    ...
    getSubTplMarkup: function() {
        ...
        return '<table id="' + me.id + '-triggerWrap" cl***REMOVED***="' + Ext.baseCSSPrefix + 'form-trigger-wrap" cellpadding="0" cellspacing="0">' +
            '<tbody>' +
                '<tr><td id="' + me.id + '-inputCell" cl***REMOVED***="' + Ext.baseCSSPrefix + 'form-trigger-input-cell">' + field + '</td>' +
                me.getTriggerMarkup() +
            '</tbody></table>';
    },
