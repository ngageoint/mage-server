 ...
 *
 * Base cl***REMOVED*** for form fields that provides default event handling, rendering, and other common functionality
 ...
 *
 * In most cases you will want to use a subcl***REMOVED***, such as {@link Ext.form.field.Text} or {@link Ext.form.field.Checkbox},
 * rather than creating instances of this cl***REMOVED*** directly. However if you are implementing a custom form field,
 * using this as the parent cl***REMOVED*** is recommended.
 *
 ...
 * {@link #rawToValue} methods. If you are implementing a subcl***REMOVED*** that uses a non-String value data type, you
 ...
 *
 *     @example
 *     // A simple subcl***REMOVED*** of Base that creates a HTML5 search field. Redirects to the
...
Ext.define('Ext.form.field.Base', {
    ...
    alias: 'widget.field',
    alternateCl***REMOVED***Name: ['Ext.form.Field', 'Ext.form.BaseField'],
    ...
    fieldSubTpl: [ // note: {id} here is really {inputId}, but {cmpId} is available
        ...
        ' cl***REMOVED***="{fieldCls} {typeCls} {editableCls}" autocomplete="off"/>',
        {
            disableFormats: true
        }
    ],
     ...
     * The type attribute for input fields -- e.g. radio, text, p***REMOVED***word, file. The extended types
     * supported by HTML5 inputs (url, email, etc.) may also be used, though using them will cause older browsers to
     * fall back to 'text'.
     *
     * The type 'p***REMOVED***word' must be used to render that field type currently -- there is no separate Ext component for
     ...
     * The default CSS cl***REMOVED*** for the field input
     */
     ...
     * The CSS cl***REMOVED*** to use when the field receives focus
     */
    focusCls : 'form-focus',

    /**
     * @cfg {String} dirtyCls
     * The CSS cl***REMOVED*** to use when the field value {@link #isDirty is dirty}.
     */
     ...
     * The CSS cl***REMOVED*** applied to the component's main element when it is {@link #readOnly}.
     */
    ...
    getSubTplData: function() {
        ...
        data = Ext.apply({
            ...
            tabIdx     : me.tabIndex,
            typeCls    : Ext.baseCSSPrefix + 'form-' + (type === 'p***REMOVED***word' ? 'text' : type)
        }, me.subTplData);
    ...
    /**
     * Sets the field's raw value directly, byp***REMOVED***ing {@link #valueToRaw value conversion}, change detection, and
    ...
    setRawValue: function(value) {
        ...
        // Some Field subcl***REMOVED***es may not render an inputEl
        if (me.inputEl) {
     ...
     * how value objects p***REMOVED***ed to {@link #setValue} are shown to the user, including localization. For instance, for a
     * {@link Ext.form.field.Date}, this would control how a Date object p***REMOVED***ed to {@link #setValue} would be converted
     ...
     * nothing; individual subcl***REMOVED***es may override this as needed.
     *
    ...
    /**
     * Uses {@link #getErrors} to build an array of validation errors. If any errors are found, they are p***REMOVED***ed to
     * {@link #markInvalid} and false is returned, otherwise true is returned.
     *
     * Previously, subcl***REMOVED***es were invited to provide an implementation of this to process validations - from 3.2
     * onwards {@link #getErrors} should be overridden instead.
     *
     * @param {Object} value The value to validate
     * @return {Boolean} True if all validations p***REMOVED***ed, false if one or more failed
     */
    ...
    /**
     * Display one or more error messages ***REMOVED***ociated with this field, using {@link #msgTarget} to determine how to
     ...
     * if the value does _p***REMOVED***_ validation. So simply marking a Field as invalid will not prevent submission of forms
     ...
     * if the value does not _p***REMOVED***_ validation. So simply clearing a field's errors will not necessarily allow
