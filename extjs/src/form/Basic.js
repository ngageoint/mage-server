/**
 * Provides input field management, validation, submission, and form loading ***REMOVED***s for the collection
 ...
 * ## Form Actions
 *
 * The Basic cl***REMOVED*** delegates the handling of form loads and submits to instances of {@link Ext.form.action.Action}.
 ...
 *         width: 350,
 *
 *         // Any configuration items here will be automatically p***REMOVED***ed along to
...
Ext.define('Ext.form.Basic', {
    ...
    alternateCl***REMOVED***Name: 'Ext.form.BasicForm',
     ...
     * {@link Ext.form.Panel} constructor, which p***REMOVED***es them along to the BasicForm automatically.
     */
     ...
     * Parameters to p***REMOVED*** with all requests. e.g. baseParams: `{id: '123', foo: 'bar'}`.
     *
     ...
     * (see Ext.direct.RemotingProvider#action) must be set on the ***REMOVED***ociated server-side method which has
     ...
     * element by p***REMOVED***ing it or its id or mask the form itself by p***REMOVED***ing in true.
     */
     ...
     *
     * @param {Object} [options] The options to p***REMOVED*** to the {@link Ext.form.action.Action} that will get created,
     ...
     * The params to p***REMOVED*** (defaults to the form's baseParams, or none if not defined)
     *
     ...
     * The callback that will be invoked after a failed tra***REMOVED***ction attempt.
    ...
    doAction: function(action, options) {
        if (Ext.isString(action)) {
            action = Ext.Cl***REMOVED***Manager.instantiateByAlias('formaction.' + action, Ext.apply({}, options, {form: this}));
        }
     ...
     *     }
     *
     * @param {Object} options The options to p***REMOVED*** to the action (see {@link #doAction} for details).
     * @return {Ext.form.Basic} this
     */
    ...
    /**
     * Persists the values in this form into the p***REMOVED***ed {@link Ext.data.Model} object in a beginEdit/endEdit block.
    ...
    /**
     * Calls {@link Ext#apply Ext.apply} for all fields in this form with the p***REMOVED***ed object.
    ...
    /**
     * Calls {@link Ext#applyIf Ext.applyIf} for all field in this form with the p***REMOVED***ed object.
     * @param {Object} obj The object to be applied
     * @return {Ext.form.Basic} this
     */
