 ...
 *
 * Produces a standalone `<label />` element which can be inserted into a form and be ***REMOVED***ociated with a field
 ...
 * and ***REMOVED***ociated config properties ({@link Ext.form.Labelable#labelAlign}, {@link Ext.form.Labelable#labelWidth},
 ...
 * 
 * You will likely be ***REMOVED***ociating the label with a field component that extends {@link Ext.form.field.Base}, so
 ...
 * # Example
 * 
 * This example creates a Label after its ***REMOVED***ociated Text field, an arrangement that cannot currently
...
Ext.define('Ext.form.Label', {
     ...
     * ***REMOVED***ociating the label with a {@link Ext.form.field.Base} component, so you should make sure this matches
