...
Ext.define('Ext.form.CheckboxGroup', {
     ...
     *
     *   - A single Boolean or String value will be p***REMOVED***ed to the `setValue` method of the checkbox with that name.
     ...
     *
     * The object format returned from this method can also be p***REMOVED***ed directly to the {@link #setValue} method.
     *
