 ...
 * # BasicForm
 * 
 * Although **not listed** as configuration options of FormPanel, the FormPanel cl***REMOVED*** accepts all
 * of the config options supported by the {@link Ext.form.Basic} cl***REMOVED***, and will p***REMOVED*** them along to
...
Ext.define('Ext.form.Panel', {
    ...
    alias: 'widget.form',
    alternateCl***REMOVED***Name: ['Ext.FormPanel', 'Ext.form.FormPanel'],
     ...
     * @param {Object} options The options to p***REMOVED*** to the action (see {@link Ext.form.Basic#load} and
     ...
     * @param {Object} options The options to p***REMOVED*** to the action (see {@link Ext.form.Basic#submit} and
     * {@link Ext.form.Basic#doAction} for details)
     */
