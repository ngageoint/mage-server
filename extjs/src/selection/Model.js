 ...
 *
 * This is an abstract cl***REMOVED*** and is not meant to be directly used. Databound UI widgets such as
 * {@link Ext.grid.Panel Grid} and {@link Ext.tree.Panel Tree} should subcl***REMOVED*** Ext.selection.Model
 ...
 * subcl***REMOVED***es to update the UI widget.
 */
Ext.define('Ext.selection.Model', {
    extend: 'Ext.util.Observable',
    alternateCl***REMOVED***Name: 'Ext.AbstractSelectionModel',
    ...
    // selection modes. Requires that an event be p***REMOVED***ed so that we can know
    ...
    select: function(records, keepExisting, suppressEvent) {
        // Automatically selecting eg store.first() or store.last() will p***REMOVED*** undefined, so that must just return;
    ...
    // fire selection change as long as true is not p***REMOVED***ed
