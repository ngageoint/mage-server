/**
 * Provides a registry of available Plugin cl***REMOVED***es indexed by a mnemonic code known as the Plugin's ptype.
 *
...
Ext.define('Ext.PluginManager', {
    ...
    alternateCl***REMOVED***Name: 'Ext.PluginMgr',
    singleton: true,
    typeName: 'ptype',

    /**
     * Creates a new Plugin from the specified config object using the config object's ptype to determine the cl***REMOVED*** to
     * instantiate.
     ...
     * @param {String} ptype The ptype mnemonic string by which the Plugin cl***REMOVED***
     * may be looked up.
     * @param {Function} cls The new Plugin cl***REMOVED***.
     * @member Ext
     * @method preg
     */
    Ext.preg = function() {
