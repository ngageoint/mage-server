 ...
 *     });
 *
 * You can ***REMOVED***ign a menu to a button by using the {@link #cfg-menu} configuration. This standard configuration
 * can either be a reference to a {@link Ext.menu.Menu menu} object, a {@link Ext.menu.Menu menu} id or a
 * {@link Ext.menu.Menu menu} config blob. When ***REMOVED***igning a menu to a button, an arrow is automatically
...
Ext.define('Ext.button.Button', {
    ...
    alternateCl***REMOVED***Name: 'Ext.Button',
    /* End Definitions */

    /*
     * @property {Boolean} isAction
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Button, or subcl***REMOVED*** thereof.
     */
    isButton: true,
    ...
    /**
     * @cfg {String} iconCls
     * A css cl***REMOVED*** which sets a background image to be used as the icon for this button.
     */
     ...
     * The base CSS cl***REMOVED*** to add to all buttons.
     */
    baseCls: Ext.baseCSSPrefix + 'btn',

    /**
     * @cfg {String} pressedCls
     * The CSS cl***REMOVED*** to add to a button when it is in the pressed state.
     */
    pressedCls: 'pressed',

    /**
     * @cfg {String} overCls
     * The CSS cl***REMOVED*** to add to a button when it is in the over (hovered) state.
     */
    overCls: 'over',

    /**
     * @cfg {String} focusCls
     * The CSS cl***REMOVED*** to add to a button when it is in the focussed state.
     */
    focusCls: 'focus',

    /**
     * @cfg {String} menuActiveCls
     * The CSS cl***REMOVED*** to add to a button when it's menu is active.
     */
     ...
     * An object literal of parameters to p***REMOVED*** to the url when the {@link #href} property is specified.
     */

    /**
     * @cfg {Object} params
     * An object literal of parameters to p***REMOVED*** to the url when the {@link #href} property is specified. Any params
    ...
    renderTpl: [
        '<em id="{id}-btnWrap"<tpl if="splitCls"> cl***REMOVED***="{splitCls}"</tpl>>',
            '<tpl if="href">',
                '<a id="{id}-btnEl" href="{href}" cl***REMOVED***="{btnCls}" target="{hrefTarget}"',
                    '<tpl if="tabIndex"> tabIndex="{tabIndex}"</tpl>',
                    '<tpl if="disabled"> disabled="disabled"</tpl>',
                    ' role="link">',
                    '<span id="{id}-btnInnerEl" cl***REMOVED***="{baseCls}-inner">',
                        '{text}',
                    '</span>',
                    '<span id="{id}-btnIconEl" cl***REMOVED***="{baseCls}-icon {iconCls}"<tpl if="iconUrl"> style="background-image:url({iconUrl})"</tpl>></span>',
                '</a>',
            '<tpl else>',
                '<button id="{id}-btnEl" type="{type}" cl***REMOVED***="{btnCls}" hidefocus="true"',
                    ...
                    '<span id="{id}-btnInnerEl" cl***REMOVED***="{baseCls}-inner" style="{innerSpanStyle}">',
                        '{text}',
                    '</span>',
                    '<span id="{id}-btnIconEl" cl***REMOVED***="{baseCls}-icon {iconCls}"<tpl if="iconUrl"> style="background-image:url({iconUrl})"</tpl>></span>',
                '</button>',
        ...
        '</em>',
        '<tpl if="closable">',
            '<a id="{id}-closeEl" href="#" cl***REMOVED***="{baseCls}-close-btn" title="{closeText}"></a>',
        '</tpl>'
    ],
     ...
     * The side of the Button box to render the arrow if the button has an ***REMOVED***ociated {@link #cfg-menu}. Two
     * values are allowed:
     *
     * - 'right'
     * - 'bottom'
    ...
    /**
     * @cfg {String} arrowCls
     * The cl***REMOVED***Name used for the inner arrow element if the button has a menu.
     */
    arrowCls: 'arrow',
     ...
     *
     * Instances, or subcl***REMOVED***es which need a different DOM structure may provide a different template layout in
     * conjunction with an implementation of {@link #getTemplateArgs}.
     */

    /**
     * @cfg {String} cls
     * A CSS cl***REMOVED*** string to apply to the button's main element.
     */

    /**
     * @property {Ext.menu.Menu} menu
     * The {@link Ext.menu.Menu Menu} object ***REMOVED***ociated with this Button when configured with the {@link #cfg-menu} config
     * option.
     */
    ...
    // Buttons add the focus cl***REMOVED*** to the *outermost element*, not the focusEl!
    onFocus: function(e) {
        var me = this;
    ...
    beforeRender: function () {
        ...
        // Add all needed cl***REMOVED***es to the protoElement.
     ...
     *
     * Instances or subcl***REMOVED***es which use a different Template to create a different DOM structure may need to provide
     ...
     * @return {String} return.splitCls A CSS cl***REMOVED*** to determine the presence and position of an arrow icon.
     * (`'x-btn-arrow'` or `'x-btn-arrow-bottom'` or `''`)
     * @return {String} return.cls A CSS cl***REMOVED*** name applied to the Button's main `<tbody>` element which determines the
    ...
    /**
     * Sets the href of the link dynamically according to the params p***REMOVED***ed, and any {@link #baseParams} configured.
     *
    ...
    /**
     * Sets the CSS cl***REMOVED*** that provides a background image to use as the button's icon. This method also changes the
     * value of the {@link #iconCls} config internally.
     * @param {String} cls The CSS cl***REMOVED*** providing the icon image
    ...
    /**
     * If a state it p***REMOVED***ed, it becomes the pressed state otherwise the current state is toggled.
    ...
    setUI: function(ui) {
        ...
        // Set all the state cl***REMOVED***Names, as they need to include the UI
    ...
    // Private utility cl***REMOVED*** used by Button
    Ext.ButtonToggleManager = {
        ...
        // Gets the pressed button in the p***REMOVED***ed group or null
        // @param {String} group
