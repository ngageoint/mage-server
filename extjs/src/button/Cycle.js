...
Ext.define('Ext.button.Cycle', {
    ...
    alternateCl***REMOVED***Name: 'Ext.CycleButton',
     ...
     * A css cl***REMOVED*** which sets an image to be used as the static icon for this button. This icon will always be displayed
