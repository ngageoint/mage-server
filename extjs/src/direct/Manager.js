 ...
 *
 * The Ext.direct namespace includes several cl***REMOVED***es for a closer integration with the server-side. The Ext.data
 * namespace also includes cl***REMOVED***es for working with Ext.data.Stores which are backed by data from an Ext.Direct method.
 *
 * # Specification
 *
 ...
 *
 * @singleton
 * @alternateCl***REMOVED***Name Ext.Direct
 */
Ext.define('Ext.direct.Manager', {
     ...
     *         "actions":{              // each property within the actions object represents a Cl***REMOVED***
     *             "TestAction":[       // array of methods within each server side Cl***REMOVED***
     *             {
     ...
     *             },{
     *                 "name":"doForm",
     *                 "formHandler":true, // handle form on server with Ext.Direct.Tra***REMOVED***ction
     *                 "len":1
     *             }]
     *         },
    ...
    /**
     * Adds a tra***REMOVED***ction to the manager.
     * @private
     * @param {Ext.direct.Tra***REMOVED***ction} tra***REMOVED***ction The tra***REMOVED***ction to add
     * @return {Ext.direct.Tra***REMOVED***ction} tra***REMOVED***ction
     */
    addTra***REMOVED***ction: function(tra***REMOVED***ction){
        this.tra***REMOVED***ctions.add(tra***REMOVED***ction);
        return tra***REMOVED***ction;
    },

    /**
     * Removes a tra***REMOVED***ction from the manager.
     * @private
     * @param {String/Ext.direct.Tra***REMOVED***ction} tra***REMOVED***ction The tra***REMOVED***ction/id of tra***REMOVED***ction to remove
     * @return {Ext.direct.Tra***REMOVED***ction} tra***REMOVED***ction
     */
    removeTra***REMOVED***ction: function(tra***REMOVED***ction){
        tra***REMOVED***ction = this.getTra***REMOVED***ction(tra***REMOVED***ction);
        this.tra***REMOVED***ctions.remove(tra***REMOVED***ction);
        return tra***REMOVED***ction;
    },

    /**
     * Gets a tra***REMOVED***ction
     * @private
     * @param {String/Ext.direct.Tra***REMOVED***ction} tra***REMOVED***ction The tra***REMOVED***ction/id of tra***REMOVED***ction to get
     * @return {Ext.direct.Tra***REMOVED***ction}
     */
    getTra***REMOVED***ction: function(tra***REMOVED***ction){
        return Ext.isObject(tra***REMOVED***ction) ? tra***REMOVED***ction : this.tra***REMOVED***ctions.get(tra***REMOVED***ction);
    },
    ...
    /**
     * Parses a direct function. It may be p***REMOVED***ed in a string format, for example:
     * "MyApp.Person.read".
     * @protected
