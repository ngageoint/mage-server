/**
 * @cl***REMOVED*** Ext.fx.target.ElementCSS
 * 
 * This cl***REMOVED*** represents a animation target for an {@link Ext.Element} that supports CSS
 * based animation. In general this cl***REMOVED*** will not be created directly, the {@link Ext.Element} 
 * will be p***REMOVED***ed to the animation and the appropriate target will be created.
 */
