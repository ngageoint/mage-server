/**
 * @cl***REMOVED*** Ext.fx.target.Sprite

 This cl***REMOVED*** represents an animation target for a {@link Ext.draw.Sprite}. In general this cl***REMOVED*** will not be
 created directly, the {@link Ext.draw.Sprite} will be p***REMOVED***ed to the animation and
