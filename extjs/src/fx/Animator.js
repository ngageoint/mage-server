/**
 * @cl***REMOVED*** Ext.fx.Animator
 *
 * This cl***REMOVED*** is used to run keyframe based animations, which follows the CSS3 based animation structure.
 ...
 * cl***REMOVED***. A key frame is a point in a particular animation. We represent this as a percentage of the
...
Ext.define('Ext.fx.Animator', {
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Animator, or subcl***REMOVED*** thereof.
     */
    isAnimator: true,
    ...
    /**
     * @cfg {Boolean} dynamic
     * Currently only for Component Animation: Only set a component's outer element size byp***REMOVED***ing layouts.  Set to true to do full layouts for every frame of the animation.  Defaults to false.
     */
    dynamic: false,
     ...
     * The Ext.fx.target to apply the animation to.  If not specified during initialization, this can be p***REMOVED***ed to the applyAnimator
...
keyframes : {
    ...
    /**
     * @private
     * Takes the given keyframe configuration object and converts it into an ordered array with the p***REMOVED***ed attributes per keyframe
        ...
        if (delay) {
            if (!delayStart) {
                ...
                if (delayDelta < delay) {
                    ...
                    // Compe***REMOVED***te for frame delay;
