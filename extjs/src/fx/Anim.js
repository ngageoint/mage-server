/**
 * This cl***REMOVED*** manages animation for a specific {@link #target}. The animation allows
...
Ext.define('Ext.fx.Anim', {
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Anim, or subcl***REMOVED*** thereof.
     */
    isAnimation: true,
    ...
    /**
     * @cfg {Boolean} dynamic
     * Currently only for Component Animation: Only set a component's outer element size byp***REMOVED***ing layouts.
     ...
     * p***REMOVED*** a Component, Element or Sprite as the target and the Anim will create the appropriate {@link Ext.fx.target.Target} object
     * automatically.
     */
    ...
    constructor: function(config) {
        ...
        config = config || {};
        // If keyframes are p***REMOVED***ed, they really want an Animator instead.
        if (config.keyframes) {
    ...
    /**
     * @private
     * Calculate attribute value at the p***REMOVED***ed timestamp.
...
// Set flag to indicate that Fx is available. Cl***REMOVED*** might not be available immediately.
Ext.enableFx = true;
