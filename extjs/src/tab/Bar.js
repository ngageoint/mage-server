...
Ext.define('Ext.tab.Bar', {
     ...
     * `true` in this cl***REMOVED*** to identify an objact as an instantiated Tab Bar, or subcl***REMOVED*** thereof.
     */
    isTabBar: true,
    ...
    // @private
    renderTpl: [
        '<div id="{id}-body" cl***REMOVED***="{baseCls}-body {bodyCls}<tpl if="ui"> {baseCls}-body-{ui}<tpl for="uiCls"> {parent.baseCls}-body-{parent.ui}-{.}</tpl></tpl>"<tpl if="bodyStyle"> style="{bodyStyle}"</tpl>>',
            '{%this.renderContainer(out,values)%}',
        '</div>',
        '<div id="{id}-strip" cl***REMOVED***="{baseCls}-strip<tpl if="ui"> {baseCls}-strip-{ui}<tpl for="uiCls"> {parent.baseCls}-strip-{parent.ui}-{.}</tpl></tpl>"></div>'
    ],
    ...
    initComponent: function() {
        ...
        // Element onClick listener added by Header base cl***REMOVED***
    ...
    closeTab: function(toClose) {
        ...
        // We are going to remove the ***REMOVED***ociated card, and then, if that was sucessful, remove the Tab,
