 ...
 * ## Controlling tabs
 *
 * Configuration options for the {@link Ext.tab.Tab} that represents the component can be p***REMOVED***ed in
...
Ext.define('Ext.tab.Panel', {
    ...
    alternateCl***REMOVED***Name: ['Ext.TabPanel'],
     ...
     * If present, this is p***REMOVED***ed straight through to the TabBar's constructor
     */

    /**
     * @cfg {Object} layout
     * Optional configuration object for the internal {@link Ext.layout.container.Card card layout}.
     * If present, this is p***REMOVED***ed straight through to the layout's constructor
     */
     ...
     * The cl***REMOVED*** added to each child item of this TabPanel.
     */
     ...
     * performance.
     *
     * The deferredRender property is internally p***REMOVED***ed to the layout manager for TabPanels ({@link
    ...
    setActiveTab: function(card) {
        ...
        if (card) {
            ...
            // We may be p***REMOVED***ed a config object, so add it.
