...
Ext.define('Ext.tab.Tab', {
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Tab, or subcl***REMOVED*** thereof.
     */
    isTab: true,
     ...
     * The CSS cl***REMOVED*** to be applied to a Tab when it is active.
     * Providing your own CSS for this cl***REMOVED*** enables you to customize the active state.
     */
    activeCls: 'active',

    /**
     * @cfg {String} [disabledCls='x-tab-disabled']
     * The CSS cl***REMOVED*** to be applied to a Tab when it is disabled.
     */

    /**
     * @cfg {String} closableCls
     * The CSS cl***REMOVED*** which is added to the tab when it is closable
     */
     ...
     * @param {Boolean} closable P***REMOVED*** false to make the tab not closable. Otherwise the tab will be made closable (eg a
    ...
    /**
     * This method ensures that the UI cl***REMOVED***es are added or removed based on 'closable'.
     * @private
     */
    syncClosableUI: function () {
        var me = this,
            cl***REMOVED***es = [me.closableCls, me.closableCls + '-' + me.position];

        if (me.closable) {
            me.addClsWithUI(cl***REMOVED***es);
        } else {
            me.removeClsWithUI(cl***REMOVED***es);
        }
    },
