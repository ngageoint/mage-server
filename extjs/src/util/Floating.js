...
Ext.define('Ext.util.Floating', {
     ...
     * rendered to.
     *
     * An alternative constraint may be p***REMOVED***ed.
     ...
     * The element or {@link Ext.Component} to align to. If p***REMOVED***ing a component, it must be a
     * component instance. If a string id is p***REMOVED***ed, it will be used as an element id.
