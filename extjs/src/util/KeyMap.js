 ...
 *
 * The KeyMap's event handling requires that the first parameter p***REMOVED***ed is a key event. So if the Component's event
...
Ext.define('Ext.util.KeyMap', {
    alternateCl***REMOVED***Name: 'Ext.KeyMap',
