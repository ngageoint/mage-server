...
Ext.define('Ext.util.History', {
    singleton: true,
    alternateCl***REMOVED***Name: 'Ext.History',
    mixins: {
    ...
    init: function (onReady, scope) {
        ...
        */
        ...
        me.addEvents(
             ...
             * @param {String} token An identifier ***REMOVED***ociated with the page state at that point in its history.
             */
            'change'
        );
     ...
     * @param {Boolean} [preventDuplicates=true] When true, if the p***REMOVED***ed token matches the current token
