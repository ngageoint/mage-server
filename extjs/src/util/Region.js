/**
 * This cl***REMOVED*** represents a rectangular region in X,Y space, and performs geometric
 * transformations or tests upon the region.
 *
 * This cl***REMOVED*** may be used to compare the document regions occupied by elements.
 */
Ext.define('Ext.util.Region', {
    ...
    statics: {
         ...
         * @return {Ext.util.Region} region The Region constructed based on the p***REMOVED***ed object
         */
        from: function(o) {
    ...
    /**
     * Checks if this region completely contains the region that is p***REMOVED***ed in.
    ...
    /**
     * Checks if this region intersects the region p***REMOVED***ed in.
     * @param {Ext.util.Region} region
