/**
 * This cl***REMOVED*** is used as a mixin.
 *
 * This cl***REMOVED*** is to be used to provide basic methods for binding/unbinding stores to other
 * cl***REMOVED***es. In general it will not be used directly.
 */
Ext.define('Ext.util.Bindable', {
     ...
     * When no store given (or when `null` or `undefined` p***REMOVED***ed), unbinds the existing store.
     ...
     * in a subcl***REMOVED*** to provide any more complicated handling.
     * @protected 
     * @param {Ext.data.AbstractStore} store The store to unbind from
     */
    unbindStoreListeners: function(store) {
        // Can be overridden in the subcl***REMOVED*** for more complex removal
    ...
    bindStoreListeners: function(store) {
        // Can be overridden in the subcl***REMOVED*** for more complex binding
        var me = this,
     ...
     * may be omitted, it is ***REMOVED***umed to be the current instance.
     */
