/**
 * @cl***REMOVED*** Ext.util.MixedCollection
 * <p>
 * Represents a collection of a set of key and value pairs. Each key in the MixedCollection
 * must be unique, the same key cannot exist twice. This collection is ordered, items in the
 * collection can be accessed by index  or via the key. Newly added items are added to
 * the end of the collection. This cl***REMOVED*** is similar to {@link Ext.util.HashMap} however it
...
Ext.define('Ext.util.MixedCollection', {
     ...
     * were p***REMOVED***ed without an explicit key parameter to a MixedCollection method.  P***REMOVED***ing this parameter is
    ...
    /**
     * Calculates the insertion index of the new item based upon the comparison function p***REMOVED***ed, or the current sort order.
     ...
     * p***REMOVED***ed to {@link #sortBy}. It accepts 2 items from this MixedCollection, and returns -1 0, or 1
