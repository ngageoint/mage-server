 ...
 * filter on a property/value pair or p***REMOVED*** in a filter function with custom logic. Filters are always used in the
...
Ext.define('Ext.util.Filter', {
    ...
    /**
     * @cfg {String} property
     * The property to filter on. Required unless a {@link #filterFn} is p***REMOVED***ed
     */
    
    /**
     * @cfg {Function} filterFn
     * A custom filter function which is p***REMOVED***ed each item in the {@link Ext.util.MixedCollection} in turn. Should return
