...
Ext.define("Ext.util.Sortable", {
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Sortable, or subcl***REMOVED*** thereof.
     */
    isSortable: true,
     ...
     *     ]);
     *
     * Internally, Store converts the p***REMOVED***ed arguments into an array of {@link Ext.util.Sorter} instances, and delegates
     * the actual sorting to its internal {@link Ext.util.MixedCollection}.
     *
     * When p***REMOVED***ing a single string argument to sort, Store maintains a ASC/DESC toggler per field, so this code:
     *
     *     store.sort('myField');
     *     store.sort('myField');
     *
    ...
    sort: function(sorters, direction, where, doSort) {
        ...
        if (doSort !== false) {
            ...
            if (sorters.length) {
                // Sort using a generated sorter function which combines all of the Sorters p***REMOVED***ed
