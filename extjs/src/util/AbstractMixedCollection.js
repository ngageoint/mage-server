/**
 * @cl***REMOVED*** Ext.util.AbstractMixedCollection
 * @private
 */
Ext.define('Ext.util.AbstractMixedCollection', {
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated MixedCollection, or subcl***REMOVED*** thereof.
     */
    ...
    constructor: function(allowFunctions, keyFn) {
        ...
        me.length = 0;
             ...
             * @param {String} key The key ***REMOVED***ociated with the added item.
             */

            /**
             * @event replace
             * Fires when an item is replaced in the collection.
             * @param {String} key he key ***REMOVED***ociated with the new added.
             ...
             * @param {String} key (optional) The key ***REMOVED***ociated with the removed item.
             */
     ...
     *
     * @param {String/Object} key The key to ***REMOVED***ociate with the item, or the new item.
     *
     ...
     * In this case just p***REMOVED*** the new item in this parameter.
     *
...
mc.add(otherEl);
     ...
     * @return {Object} The key for the p***REMOVED***ed item.
     */
    getKey : function(o){
         return o.id;
    },
     ...
     * @param {String} key <p>The key ***REMOVED***ociated with the item to replace, or the replacement item.</p>
     * <p>If you supplied a {@link #getKey} implementation for this MixedCollection, or if the key
     * of your stored items is in a property called <code><b>id</b></code>, then the MixedCollection
     * will be able to <i>derive</i> the key of the replacement item. If you want to replace an item
     * with one having the same key value, then just p***REMOVED*** the replacement item in this parameter.</p>
     * @param o {Object} o (optional) If the first parameter p***REMOVED***ed was a key, the item to ***REMOVED***ociate
     * with that key.
    ...
    /**
     * Executes the specified function once for every key in the collection, p***REMOVED***ing each
     * key, and its ***REMOVED***ociated item as the first two parameters.
     * @param {Function} fn The function to execute for each item.
     ...
     * p***REMOVED***ed selection function.
     ...
     * @param {String} key The key to ***REMOVED***ociate with the new item, or the item itself.
    ...
    /**
     * Remove all items in the p***REMOVED***ed array from the collection.
    ...
    /**
     * Removed an item ***REMOVED***ociated with the p***REMOVED***ed key fom the collection.
    ...
    /**
     * Returns index within the collection of the p***REMOVED***ed Object.
    ...
    /**
     * Returns index within the collection of the p***REMOVED***ed key.
    ...
    /**
     * Returns the item ***REMOVED***ociated with the p***REMOVED***ed key OR index.
     ...
     * If an item was found, but is a Cl***REMOVED***, returns <code>null</code>.
     */
    get : function(key) {
        var me = this,
            mk = me.map[key],
    ...
    /**
     * Returns the item ***REMOVED***ociated with the p***REMOVED***ed key.
     * @param {String/Number} key The key of the item.
     * @return {Object} The item ***REMOVED***ociated with the p***REMOVED***ed key.
     */
    ...
    /**
     * Returns true if the collection contains the p***REMOVED***ed Object as an item.
    ...
    /**
     * Returns true if the collection contains the p***REMOVED***ed Object as a key.
     ...
     * summing fields in records, where the fields are all stored inside the 'data' object
     * @param {Boolean} allowBlank (optional) P***REMOVED*** true to allow null, undefined or empty string values
...
var middleAged = people.filter('age', 24);
     ...
     * The p***REMOVED***ed function will be called with each object in the collection.
