 ...
 * </p>
 *
 * <p>The HashMap is an unordered cl***REMOVED***,
...
Ext.define('Ext.util.HashMap', {
    ...
    /**
     * @cfg {Function} keyFn A function that is used to retrieve a default key for a p***REMOVED***ed object.
     ...
     * a single argument is p***REMOVED***ed.
     * @private
     ...
     *
     * The paramaters p***REMOVED***ed to the function are:
     * <div cl***REMOVED***="mdetail-params"><ul>
     * <li><b>key</b> : String<p cl***REMOVED***="sub-desc">The key of the item</p></li>
     * <li><b>value</b> : Number<p cl***REMOVED***="sub-desc">The value of the item</p></li>
     * <li><b>length</b> : Number<p cl***REMOVED***="sub-desc">The total number of items in the hash</p></li>
     * </ul></div>
