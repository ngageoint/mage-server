/**
 * @cl***REMOVED*** Ext.util.Memento
 * This cl***REMOVED*** manages a set of captured properties from an object. These captured properties
...
Ext.define('Ext.util.Memento', (function () {
    ...
    return {
        ...
        /**
         * @property target
         * The default target object for capture/restore (p***REMOVED***ed to the constructor).
         */
        target: null,
