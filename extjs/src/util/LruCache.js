...
Ext.define('Ext.util.LruCache', {
     ...
     * @param {Boolean} [reverse=false] P***REMOVED*** <code>true</code> to iterate the list in reverse (most recent first) order.
