 ...
 * paging control. This Component {@link Ext.data.Store#method-load load}s blocks of data into the {@link #store} by p***REMOVED***ing
 ...
 *     });
 *
 * To use paging, you need to set a pageSize configuration on the Store, and p***REMOVED*** the paging requirements to
...
Ext.define('Ext.toolbar.Paging', {
    ...
    alternateCl***REMOVED***Name: 'Ext.PagingToolbar',
