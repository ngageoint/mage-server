/**
 * Basic Toolbar cl***REMOVED***. Although the {@link Ext.container.Container#defaultType defaultType} for
 ...
 *
 * | Shortcut | xtype         | Cl***REMOVED***                         | Description
 * |:---------|:--------------|:------------------------------|:---------------------------------------------------
...
Ext.define('Ext.toolbar.Toolbar', {
    ...
    alternateCl***REMOVED***Name: 'Ext.Toolbar',

    /**
     * @property {Boolean} isToolbar
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Toolbar, or subcl***REMOVED*** thereof.
     */
    isToolbar: true,
     ...
     * This cl***REMOVED*** ***REMOVED***igns a default layout (`layout: 'hbox'`).
     * Developers _may_ override this configuration option if another layout
     * is required (the constructor must be p***REMOVED***ed a configuration object in this
     ...
     * Configure the icon cl***REMOVED*** of the overflow button.
     */
     ...
     *  - `Item`: Any subcl***REMOVED*** of {@link Ext.toolbar.Item}
