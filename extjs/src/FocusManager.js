 ...
 *
 * To enable the optional focus frame, p***REMOVED*** `true` or `{focusFrame: true}` to {@link #method-enable}.
 *
...
Ext.define('Ext.FocusManager', {
    singleton: true,
    alternateCl***REMOVED***Name: ['Ext.FocusMgr' ],
    ...
    constructor: function(config) {
        ...
        // Setup some ComponentQuery pseu***REMOVED***
        Ext.apply(CQ.pseu***REMOVED***, {
    ...
    shouldShowFocusFrame: function(cmp) {
        ...
        // 2. No Component was p***REMOVED***ed
