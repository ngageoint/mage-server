 ...
 * Ext.data.proxy.Proxy Proxy} that we want a XML Reader. The Store automatically p***REMOVED***es the configured model to the
...
Ext.define('Ext.data.reader.Xml', {
    ...
    alternateCl***REMOVED***Name: 'Ext.data.XmlReader',
    alias : 'reader.xml',
    ...
    /**
     * @private
     * We're just preparing the data for the supercl***REMOVED*** by pulling out the record nodes we want.
    ...
    getAssociatedDataRoot: function(data, ***REMOVED***ociationName) {
        return Ext.DomQuery.select(***REMOVED***ociationName, data)[0];
    },
    ...
    readRecords: function(doc) {
        // it's possible that we get p***REMOVED***ed an array here by ***REMOVED***ociations.
    ...
    /**
     * @private
     * Returns an accessor expression for the p***REMOVED***ed Field from an XML element using either the Field's mapping, or
