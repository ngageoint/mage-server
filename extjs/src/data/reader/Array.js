/**
 * @author Ed Spencer
 * @cl***REMOVED*** Ext.data.reader.Array
 * 
 * <p>Data reader cl***REMOVED*** to create an Array of {@link Ext.data.Model} objects from an Array.
...
Ext.define('Ext.data.reader.Array', {
    ...
    alternateCl***REMOVED***Name: 'Ext.data.ArrayReader',
    alias : 'reader.array',
    ...
    /**
     * @private
     * Returns an accessor expression for the p***REMOVED***ed Field from an Array using either the Field's mapping, or
