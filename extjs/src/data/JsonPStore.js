/**
 * @cl***REMOVED*** Ext.data.JsonPStore
 * @extends Ext.data.Store
 * <p>Small helper cl***REMOVED*** to make creating {@link Ext.data.Store}s from different domain JSON data easier.
 ...
 * </code></pre>
 * <p>Where stcCallback is the callback name p***REMOVED***ed in the request to the remote domain. See {@link Ext.data.proxy.JsonP JsonPProxy}
