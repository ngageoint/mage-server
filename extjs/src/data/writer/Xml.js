/**
 * @author Ed Spencer
 * @cl***REMOVED*** Ext.data.writer.Xml

This cl***REMOVED*** is used to write {@link Ext.data.Model} data to the server in an XML format.
...
Ext.define('Ext.data.writer.Xml', {
    ...
    alternateCl***REMOVED***Name: 'Ext.data.XmlWriter',
