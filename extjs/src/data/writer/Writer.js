 ...
 * @author Ed Spencer
 *
 * Base Writer cl***REMOVED*** used by most subcl***REMOVED***es of {@link Ext.data.proxy.Server}. This cl***REMOVED*** is responsible for taking a
 ...
 * the config options p***REMOVED***ed to the JsonWriter's constructor.
 *
...
Ext.define('Ext.data.writer.Writer', {
    alias: 'writer.base',
    alternateCl***REMOVED***Name: ['Ext.data.DataWriter', 'Ext.data.Writer'],
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Writer, or subcl***REMOVED*** thereof.
     */
    isWriter: true,
