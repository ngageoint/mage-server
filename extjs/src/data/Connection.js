/**
 * The Connection cl***REMOVED*** encapsulates a connection to the page's originating domain, allowing requests to be made either
 * to a configured URL, or to a URL specified at request time.
 *
 * Requests made by this cl***REMOVED*** are asynchronous, and will return immediately. No data from the server will be available
...
Ext.define('Ext.data.Connection', {
    ...
    constructor : function(config) {
         ...
         * @param {Object} options The options config object p***REMOVED***ed to the {@link #request} method.
         */
        /**
     ...
     * postprocessing in a callback because it is p***REMOVED***ed to callback functions.)
     *
     ...
     * The callback is p***REMOVED***ed the following parameters:
    ...
    request : function(options) {
        ...
        var me = this,
            ...
            p***REMOVED***word = options.p***REMOVED***word || me.p***REMOVED***word || '',
            async,
            requestOptions,
            request,
            headers,
        ...
        if (me.fireEvent('beforerequest', me, options) !== false) {
            ...
            // if autoabort is set, cancel the current tra***REMOVED***ctions
            ...
            xhr = me.openRequest(options, requestOptions, async, username, p***REMOVED***word);

            headers = me.setupHeaders(xhr, options, requestOptions.data, requestOptions.params);

            // create the tra***REMOVED***ction object
            request = {
     ...
     * @param {String} params Any extra parameters to p***REMOVED***
        ...
        try {
            ...
            if (doc) {
                if (doc.body) {
                    ...
                    // Note: The statement below tests the result of an ***REMOVED***ignment.
                    ...
                    // Response sent as Content-Type: text/html with no wrapping. S***REMOVED***e JSON response out of text
                    else {
     ...
     * @return {HTMLElement} The form, null if not p***REMOVED***ed
     */
     ...
     * @private
     */
    openRequest: function (options, requestOptions, async, username, p***REMOVED***word) {
        var xhr = this.newRequest(options);

        if (username) {
            xhr.open(requestOptions.method, requestOptions.url, async, username, p***REMOVED***word);
        } else {
     ...
     * @param {Object} [request] Defaults to the last tra***REMOVED***ction
    ...
    createException : function(request) {
        return {
            ...
            statusText : request.aborted ? 'tra***REMOVED***ction aborted' : 'communication failure',
