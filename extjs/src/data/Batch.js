 ...
 *
 * <p>Usually these are only used internally by {@link Ext.data.proxy.Proxy} cl***REMOVED***es</p>
 *
 */
Ext.define('Ext.data.Batch', {
     ...
     * not be automatically reversible. Any tra***REMOVED***ctional / rollback behavior that might be desired would have
     ...
     * 
     * If you have not implemented tra***REMOVED***ctional operation handling then this option should typically be left 
