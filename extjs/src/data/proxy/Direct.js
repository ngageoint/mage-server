/**
 * This cl***REMOVED*** is used to send requests to the server using {@link Ext.direct.Manager Ext.Direct}. When a
 ...
 *
 * This proxy expects a Direct remoting method to be p***REMOVED***ed in order to be able to complete requests.
 ...
 * of the p***REMOVED***ed parameters. The {@link #paramOrder} option can be used to specify the order in which
 * the remoting method parameters are p***REMOVED***ed.
 *
 * # Example Usage
 *
 *     Ext.define('User', {
 ...
 *             paramOrder: 'id' // Tells the proxy to p***REMOVED*** the id as the first parameter to the remoting method.
 *         }
 *     });
 *     User.load(1);
 */
Ext.define('Ext.data.proxy.Direct', {
    ...
    alternateCl***REMOVED***Name: 'Ext.data.DirectProxy',
