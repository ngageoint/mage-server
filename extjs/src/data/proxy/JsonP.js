 ...
 * other type of JavaScript include. By p***REMOVED***ing a callback in the url above, we're telling domainB's server that we want
 ...
 *     });
 *
 * As soon as the script finishes loading, the 'someCallback' function that we p***REMOVED***ed in the url is called with the JSON
 * object that the server returned.
 *
 * JsonP proxy takes care of all of this automatically. It formats the url you p***REMOVED***, adding the callback parameter
...
Ext.define('Ext.data.proxy.JsonP', {
    ...
    alternateCl***REMOVED***Name: 'Ext.data.ScriptTagProxy',
     ...
     * The param name to use when p***REMOVED***ing records to the server (e.g. 'records=someEncodedRecordString'). Defaults to
     * 'records'
     */
    recordParam: 'records',
     ...
     * the response. This callback will typically be the callback p***REMOVED***ed by a store, e.g. in proxy.read(operation, theCallback, scope)
     * theCallback refers to the callback argument received by this function.
     * See {@link #doRequest} for details.
     * @param {Ext.data.Request} request The Request object
     * @param {Ext.data.Operation} operation The Operation being executed
     * @param {Function} callback The callback function to be called when the request completes. This is usually the callback
     * p***REMOVED***ed to doRequest
