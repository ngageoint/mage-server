 ...
 * @author Ed Spencer
 *
 * ServerProxy is a supercl***REMOVED*** of {@link Ext.data.proxy.JsonP JsonPProxy} and {@link Ext.data.proxy.Ajax AjaxProxy}, and
 * would not usually be used directly.
 *
 * ServerProxy should ideally be named HttpProxy as it is a supercl***REMOVED*** for all HTTP proxies - for Ext JS 4.x it has been
...
Ext.define('Ext.data.proxy.Server', {
    ...
    alias : 'proxy.server',
    alternateCl***REMOVED***Name: 'Ext.data.ServerProxy',
     ...
     *
     * This gets called from doRequest methods in subcl***REMOVED***es of Server proxy.
     * 
    ...
    buildRequest: function(operation) {
         ...
         * ServerProxy and any of its subcl***REMOVED***es we add both request and response as they may be useful for further processing
         */
    ...
    processResponse: function(success, operation, request, response, callback, scope) {
        ...
        //this callback is the one that was p***REMOVED***ed to the 'read' or 'write' function above
    ...
    /**
     * Template method to allow subcl***REMOVED***es to specify how to get the response for the reader.
     * @template
     * @private
    ...
    /**
     * Encode any values being sent to the server. Can be overridden in subcl***REMOVED***es.
     * @private
    ...
    getParams: function(operation) {
        ...
        if (groupParam && groupers && groupers.length > 0) {
            // Grouper is a subcl***REMOVED*** of sorter, so we can just use the sorter method
            if (simpleGroupMode) {
     ...
     * cache-buster param to the end of the url. Subcl***REMOVED***es may need to perform additional modifications to the url.
    ...
    /**
     * In ServerProxy subcl***REMOVED***es, the {@link #create}, {@link #read}, {@link #update} and {@link #destroy} methods all
     * p***REMOVED*** through to doRequest. Each ServerProxy subcl***REMOVED*** must implement the doRequest method - see {@link
    ...
    doRequest: function(operation, callback, scope) {
        //<debug>
        Ext.Error.raise("The doRequest function has not been implemented on your Ext.data.proxy.Server subcl***REMOVED***. See src/data/ServerProxy.js for details");
        //</debug>
    },
