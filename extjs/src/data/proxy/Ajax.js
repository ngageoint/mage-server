 ...
 * Ext.data.proxy.Ajax instance, with the url we specified being p***REMOVED***ed into AjaxProxy's constructor.
 ...
 * configuration can be p***REMOVED***ed in as a simple object, which the Proxy automatically turns into a {@link
 ...
 * If an options parameter is p***REMOVED***ed, the singleton {@link Ext.Ajax} object will be used to make the request.
 */
Ext.define('Ext.data.proxy.Ajax', {
    requires: ['Ext.util.MixedCollection', 'Ext.Ajax'],
    extend: 'Ext.data.proxy.Server',
    alias: 'proxy.ajax',
    alternateCl***REMOVED***Name: ['Ext.data.HttpProxy', 'Ext.data.AjaxProxy'],
