 ...
 * p***REMOVED*** to the LocalStorage proxy is an {@link #id}. This is important as it separates the Model data in this Proxy from
 ...
 * and places it into localStorage. We can also save directly to localStorage, byp***REMOVED***ing the Store altogether:
 *
...
Ext.define('Ext.data.proxy.LocalStorage', {
    ...
    alternateCl***REMOVED***Name: 'Ext.data.LocalStorageProxy',
