 ...
 * The Client proxies save their data locally and include the following subcl***REMOVED***es:
 *
 ...
 * respectively. Each Proxy subcl***REMOVED*** implements these functions.
 *
...
Ext.define('Ext.data.proxy.Proxy', {
    alias: 'proxy.proxy',
    alternateCl***REMOVED***Name: ['Ext.data.DataProxy', 'Ext.data.Proxy'],
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Proxy, or subcl***REMOVED*** thereof.
     */
    isProxy: true,
    ...
    /**
     * Sets the model ***REMOVED***ociated with this proxy. This will only usually be called by a Store
     *
     ...
     * @param {Boolean} setOnStore Sets the new model on the ***REMOVED***ociated Store, if one is present
     */
     ...
     * 
     * @param {Object} [options.listeners] Event listeners object p***REMOVED***ed straight through to the Batch -
     ...
     * @param {Object} options.callback.options The options argument that was originally p***REMOVED***ed into batch
     * 
     ...
     * containing all operations in their current state after processing
     * @param {Object} options.success.options The options argument that was originally p***REMOVED***ed into batch
     * 
     ...
     * containing all operations in their current state after processing
     * @param {Object} options.failure.options The options argument that was originally p***REMOVED***ed into batch
     * 
