 ...
 * it has been created. We'll ***REMOVED***ume the creation went successfully and that the server gave this user an ID of 123:
 *
 *     user.save({
 ...
 * onto the {@link Ext.data.Request Request} object that is p***REMOVED***ed to buildUrl. See [Rest proxy's implementation][1] for
...
Ext.define('Ext.data.proxy.Rest', {
    ...
    alternateCl***REMOVED***Name: 'Ext.data.RestProxy',
    alias : 'proxy.rest',
     ...
     * generated url. Override this to provide further customizations, but remember to call the supercl***REMOVED*** buildUrl so
