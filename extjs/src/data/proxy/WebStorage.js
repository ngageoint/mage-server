 ...
 * @author Ed Spencer
 *
 * WebStorageProxy is simply a supercl***REMOVED*** for the {@link Ext.data.proxy.LocalStorage LocalStorage} and {@link
...
Ext.define('Ext.data.proxy.WebStorage', {
    ...
    alternateCl***REMOVED***Name: 'Ext.data.WebStorageProxy',
    requires: [
     ...
     * in each subcl***REMOVED***.
     * @return {Object} The storage object
     */
    getStorageObject: function() {
        //<debug>
        Ext.Error.raise("The getStorageObject function has not been defined in your Ext.data.proxy.WebStorage subcl***REMOVED***");
        //</debug>
    }
});