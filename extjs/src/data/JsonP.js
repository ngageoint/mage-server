/**
 * @cl***REMOVED*** Ext.data.JsonP
 * @singleton
 * This cl***REMOVED*** is used to create JSONP requests. JSONP is a mechanism that allows for making
...
Ext.define('Ext.data.JsonP', {
     ...
     * take priority over any defaults that are specified in the cl***REMOVED***.
     * <ul>
     * <li><b>url</b> : String <div cl***REMOVED***="sub-desc">The URL to request.</div></li>
     * <li><b>params</b> : Object (Optional)<div cl***REMOVED***="sub-desc">An object containing a series of
     * key value pairs that will be sent along with the request.</div></li>
     * <li><b>timeout</b> : Number (Optional) <div cl***REMOVED***="sub-desc">See {@link #timeout}</div></li>
     * <li><b>callbackKey</b> : String (Optional) <div cl***REMOVED***="sub-desc">See {@link #callbackKey}</div></li>
     * <li><b>callbackName</b> : String (Optional) <div cl***REMOVED***="sub-desc">The function name to use for this request.
     ...
     * <li><b>disableCaching</b> : Boolean (Optional) <div cl***REMOVED***="sub-desc">See {@link #disableCaching}</div></li>
     * <li><b>disableCachingParam</b> : String (Optional) <div cl***REMOVED***="sub-desc">See {@link #disableCachingParam}</div></li>
     * <li><b>success</b> : Function (Optional) <div cl***REMOVED***="sub-desc">A function to execute if the request succeeds.</div></li>
     * <li><b>failure</b> : Function (Optional) <div cl***REMOVED***="sub-desc">A function to execute if the request fails.</div></li>
     * <li><b>callback</b> : Function (Optional) <div cl***REMOVED***="sub-desc">A function to execute when the request
     * completes, whether it is a success or failure.</div></li>
     * <li><b>scope</b> : Object (Optional)<div cl***REMOVED***="sub-desc">The scope in
     ...
     * parameter is p***REMOVED***ed to allow an override to access it.
     * @private
     * @param {String} url The url of the request
     * @param {Object} params Any extra params to be sent
     * @param {Object} options The object p***REMOVED***ed to {@link #request}.
     */
