 ...
 * @author Don Griffin
 *
 * This cl***REMOVED*** is a base for all id generators. It also provides lookup of id generators by
 * their id.
 * 
 ...
 * up using the {@link #get} method. To configure two {@link Ext.data.Model Model} cl***REMOVED***es
 * to share one {@link Ext.data.SequentialIdGenerator sequential} id generator, you simply
 * ***REMOVED***ign them the same id:
 *
 ...
 * 
 * An id generator should derive from this cl***REMOVED*** and implement the {@link #generate} method.
 * The constructor will apply config properties on new instances, so a constructor is often
 * not necessary.
 *
 * To register an id generator type, a derived cl***REMOVED*** should provide an `alias` like so:
 *
...
Ext.define('Ext.data.IdGenerator', {
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated IdGenerator, or subcl***REMOVED*** thereof.
     */
    isGenerator: true,
