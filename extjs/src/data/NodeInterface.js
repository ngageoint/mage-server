/**
 * This cl***REMOVED*** is used as a set of methods that are applied to the prototype of a
 * Model to decorate it with a Node API. This means that models used in conjunction with a tree
 * will have all of the tree related methods available on the model. In general this cl***REMOVED*** will
 * not be used directly by the developer. This cl***REMOVED*** also creates extra fields on the model if
...
Ext.define('Ext.data.NodeInterface', {
    ...
    /**
     * @cfg {String} cls
     * CSS cl***REMOVED*** to apply for this node.
     */

    /**
     * @cfg {String} iconCls
     * CSS cl***REMOVED*** to apply for this node's icon.
     */
    ...
    statics: {
        /**
         * This method allows you to decorate a Model's cl***REMOVED*** to implement the NodeInterface.
         * This adds a set of methods, new events, new properties and new fields on every Record.
         * @param {Ext.Cl***REMOVED***/Ext.data.Model} modelCl***REMOVED*** The Model cl***REMOVED*** or an instance of the Model cl***REMOVED*** you want to
         * decorate the prototype of.
         * @static
         */
        decorate: function(modelCl***REMOVED***) {
            var idName, idType;
            
            // get the reference to the model cl***REMOVED***, in case the argument was a string or a record
            if (typeof modelCl***REMOVED*** == 'string') {
                modelCl***REMOVED*** = Ext.ModelManager.getModel(modelCl***REMOVED***);
            } else if (modelCl***REMOVED***.isModel) {
                modelCl***REMOVED*** = Ext.ModelManager.getModel(modelCl***REMOVED***.modelName);
            }
            
            // avoid unnecessary work in case the model was already decorated
            if (modelCl***REMOVED***.prototype.isNode) {
                return;
            }

            idName = modelCl***REMOVED***.prototype.idProperty;
            idField = modelCl***REMOVED***.prototype.fields.get(idName);
            idType = modelCl***REMOVED***.prototype.fields.get(idName).type.type;
            modelCl***REMOVED***.override(this.getPrototypeBody());
            this.applyFields(modelCl***REMOVED***, [
        ...
        applyFields: function(modelCl***REMOVED***, addFields) {
            var modelPrototype = modelCl***REMOVED***.prototype,
        ...
        getPrototypeBody: function() {
            return {
                 ...
                 * `true` in this cl***REMOVED*** to identify an object as an instantiated Node, or subcl***REMOVED*** thereof.
                 */
                isNode: true,
                ...
                /**
                 * Ensures that the p***REMOVED***ed object is an instance of a Record with the NodeInterface applied
                 ...
                 * @return {Ext.data.NodeInterface} The appended node if single append, or null if an array was p***REMOVED***ed
                 */
                appendChild : function(node, suppressEvents, commit) {
                    ...
                    // if p***REMOVED***ed an array do them one by one
                    if (Ext.isArray(node)) {
                 ...
                 * @param {Array} [args] The args to call the function with. Defaults to p***REMOVED***ing the current Node.
                 */
                ...
                /**
                 * Finds the first child by a custom function. The child matches if the function p***REMOVED***ed returns true.
                 * @param {Function} fn A function which must return true if the p***REMOVED***ed Node is the required Node.
                ...
                /**
                 * Returns true if this node is an ancestor (at any point) of the p***REMOVED***ed node.
                 * @param {Ext.data.NodeInterface} node
                 * @return {Boolean}
                 */
                ...
                /**
                 * Returns true if the p***REMOVED***ed node is an ancestor (at any point) of this node.
                 * @param {Ext.data.NodeInterface} node
                 * @return {Boolean}
                 */
                 ...
                 * @param {Function} fn A function which, when p***REMOVED***ed two Nodes, returns -1, 0 or 1 depending upon required sort order.
                    ...
                    if (!me.isLeaf()) {
                        ...
                        if (me.isLoading()) {
                            ...
                            if (!me.isExpanded()) {
                                ...
                                // first. Thats why we p***REMOVED*** a callback function to the event that the
