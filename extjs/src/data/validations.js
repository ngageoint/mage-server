...
Ext.define('Ext.data.validations', {
     ...
     * @return {Boolean} True if validation p***REMOVED***ed
     */
    presence: function(config, value) {
        // No configs read, so allow just value to be p***REMOVED***ed
     ...
     * @return {Boolean} True if the value p***REMOVED***es validation
     */
    ...
    /**
     * Returns true if the given value p***REMOVED***es validation against the configured `matcher` regex.
     * For example:
     *
     ...
     * @param {Object} config Config object
     * @param {String} value The value to validate
     * @return {Boolean} True if the value p***REMOVED***es the format validation
     */
