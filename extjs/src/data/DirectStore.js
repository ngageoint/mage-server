/**
 * Small helper cl***REMOVED*** to create an {@link Ext.data.Store} configured with an {@link Ext.data.proxy.Direct}
 ...
 *
 * **Note:** Although they are not listed, this cl***REMOVED*** inherits all of the config options of:
 *
