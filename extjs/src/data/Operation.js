...
Ext.define('Ext.data.Operation', {
    ...
    /**
     * @cfg {Object} params
     * Parameters to p***REMOVED*** along with the request when performing the operation.
     */
     ...
     * The error object p***REMOVED***ed when {@link #setException} was called. This could be any object or primitive.
     * @private
     */
    error: undefined,
        ...
        if (!me.actionSkipSyncRe.test(me.action)) {
            ...
            if (clientRecords && clientRecords.length) {
                if (clientRecords.length > 1) {
                    ...
                    // a clientIdProperty specified on the model and we've done a create, just ***REMOVED***ume the data is returned in order.
    ...
    /**
     * Returns the {@link Ext.data.Model record}s ***REMOVED***ociated with this operation.  For read operations the records as set by the {@link Ext.data.proxy.Proxy Proxy} will be returned (returns `null` if the proxy has not yet set the records).
