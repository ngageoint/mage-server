 ...
 * @author Ed Spencer
 *
 * AbstractStore is a supercl***REMOVED*** of {@link Ext.data.Store} and {@link Ext.data.TreeStore}. It's never used directly,
 * but offers a set of methods used by both of those subcl***REMOVED***es.
 *
 ...
 * respectively, p***REMOVED***ing the requests through the configured {@link #proxy}. Both built-in Store subcl***REMOVED***es add extra
 * behavior to each of these functions. Note also that each AbstractStore subcl***REMOVED*** has its own way of storing data -
...
Ext.define('Ext.data.AbstractStore', {
    ...
    statics: {
         ...
         * 
         * Alteratively p***REMOVED***ing an actual store to this method will
     ...
     * after creation. If the value of autoLoad is an Object, this Object will be p***REMOVED***ed to the store's load method.
     * Defaults to false.
     */
    autoLoad: undefined,
     ...
     * True if a model was created implicitly for this Store. This happens if a fields array is p***REMOVED***ed to the Store's
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Store, or subcl***REMOVED*** thereof.
     */
    isStore: true,
     ...
     * ***REMOVED***ociations, a {@link Ext.data.Model} should be defined and specified for the {@link #model}
     * config.
     */

    /**
     * @cfg {String} model
     * Name of the {@link Ext.data.Model Model} ***REMOVED***ociated with this store.
     * The string is used as an argument for {@link Ext.ModelManager#getModel}.
     */

    /**
     * @cfg {Object[]/Function[]} filters
     * Array of {@link Ext.util.Filter Filters} for this store. Can also be p***REMOVED***ed array of
    ...
    constructor: function(config) {
         ...
         * @param {Ext.data.Operation} operation The Ext.data.Operation object that will be p***REMOVED***ed to the Proxy to
         * load the Store
         */
         ...
         * via {@link Ext.data.Store#createModel createModel}. This is used internally by ***REMOVED***ociations to set foreign keys and
         * other fields. See the Association cl***REMOVED***es source code for examples. This should not need to be used by application developers.
         */
        Ext.applyIf(me, {
            modelDefaults: {}
        });

        //Supports the 3.x style of simply p***REMOVED***ing an array of fields to the store, implicitly creating a model
        ...
        if (!me.model && me.useModelWarning !== false) {
            ...
            var logMsg = [
                Ext.getCl***REMOVED***Name(me) || 'Store',
    ...
    onProxyWrite: function(operation) {
        ...
        //this is a callback that would have been p***REMOVED***ed to the 'create', 'update' or 'destroy' function and is optional
        Ext.callback(operation.callback, operation.scope || me, [records, operation, success]);
    },
    
    // may be implemented by store subcl***REMOVED***es
    ...
    decodeFilters: function(filters) {
        ...
        for (i = 0; i < length; i++) {
            ...
            if (!(config instanceof Filter)) {
                ...
                //support a function to be p***REMOVED***ed as a filter definition
     ...
     * p***REMOVED***ed along to the underlying proxy's {@link Ext.data.Proxy#batch batch} method):
     * 
     ...
     * The callback is called regardless of success or failure and is p***REMOVED***ed the following parameters:
     * @param {Ext.data.Batch} options.callback.batch The {@link Ext.data.Batch batch} that was processed,
     * containing all operations in their current state after processing
     * @param {Object} options.callback.options The options argument that was originally p***REMOVED***ed into sync
     * 
     ...
     * containing all operations in their current state after processing
     * @param {Object} options.success.options The options argument that was originally p***REMOVED***ed into sync
     * 
     ...
     * @param {Object} options.failure.options The options argument that was originally p***REMOVED***ed into sync
     * 
    ...
    /**
     * @private
     * Returns an object which is p***REMOVED***ed in as the listeners argument to proxy.batch inside this.sync.
     ...
     * @param {Object} options (optional) config object. This is p***REMOVED***ed into the {@link Ext.data.Operation Operation}
    ...
    /**
     * Reloads the store using the last options p***REMOVED***ed to the {@link #method-load} method.
     * @param {Object} options A config object which contains options which may override the options p***REMOVED***ed to the previous load call.
     */
    ...
    afterReject : function(record) {
        // Must p***REMOVED*** the 5th param (modifiedFieldNames) as null, otherwise the
    ...
    // to be implemented by subcl***REMOVED***es
    ...
    // individual store subcl***REMOVED***es should implement a "fast" remove
