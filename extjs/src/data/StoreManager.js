 ...
 *
 * Contains a collection of all stores that are created that have an identifier. An identifier can be ***REMOVED***igned by
...
Ext.define('Ext.data.StoreManager', {
    ...
    alternateCl***REMOVED***Name: ['Ext.StoreMgr', 'Ext.data.StoreMgr', 'Ext.StoreManager'],
    singleton: true,
