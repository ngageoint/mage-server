 ...
 * @author Ed Spencer
 *
 * Fields are used to define what a Model is. They aren't instantiated directly - instead, when we create a cl***REMOVED*** that
 ...
 * of different formats here; if we only p***REMOVED*** in the string name of the field (as with name and email), the field is set
 ...
 *
 * The {@link #type} is important - it's used to automatically convert data p***REMOVED***ed to the field into the correct format.
 * In our example above, the name and email fields used the 'auto' type and will just accept anything that is p***REMOVED***ed
 * into them. The 'age' field had an 'int' type however, so if we p***REMOVED***ed 25.4 this would be rounded to 25.
 *
...
Ext.define('Ext.data.Field', {
     ...
     * property in column definition objects p***REMOVED***ed to {@link Ext.grid.property.HeaderContainer}.
     *
     ...
     * - date
     *
     * This may also be specified by referencing a member of the {@link Ext.data.Types} cl***REMOVED***.
     *
     * Developers may create their own application-specific data types by defining new members of the {@link
     * Ext.data.Types} cl***REMOVED***.
     */
     ...
     * not *need* converting.
     * 
     * It is p***REMOVED***ed the following parameters:
     *
     * - **v** : Mixed
     *
     ...
     * function. This is p***REMOVED***ed the whole row object, and may interrogate it in whatever way is necessary in order to
