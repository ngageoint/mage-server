/**
 * The Editor cl***REMOVED*** is used to provide inline editing for elements on the page. The editor
...
Ext.define('Ext.Editor', {
    ...
    */
     ...
     * can be p***REMOVED***ed to indicate where to get each dimension. The available properties are 'boundEl' and
    ...
    completeEdit : function(remainVisible) {
        ...
        if (field.***REMOVED***ertValue) {
            field.***REMOVED***ertValue();
        }
