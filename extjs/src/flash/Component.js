...
Ext.define('Ext.flash.Component', {
    ...
    alternateCl***REMOVED***Name: 'Ext.FlashComponent',
    alias: 'widget.flash',
     ...
     * A set of key value pairs to be p***REMOVED***ed to the flash object as flash variables.
     */

    /**
     * @cfg {Object} flashParams
     * A set of key value pairs to be p***REMOVED***ed to the flash object as parameters. Possible parameters can be found here:
     * http://kb2.adobe.com/cps/127/tn_12701.html
     */

    /**
     * @cfg {Object} flashAttributes
     * A set of key value pairs to be p***REMOVED***ed to the flash object as attributes.
     */
     ...
     * @param {Object} e The event object p***REMOVED***ed by SWFObject - see http://code.google.com/p/swfobject/wiki/api
     */
