/**
 * @private
 * A month picker component. This cl***REMOVED*** is used by the {@link Ext.picker.Date Date picker} cl***REMOVED***
...
Ext.define('Ext.picker.Month', {
    ...
    alternateCl***REMOVED***Name: 'Ext.MonthPicker',
    ...
    renderTpl: [
        '<div id="{id}-bodyEl" cl***REMOVED***="{baseCls}-body">',
          '<div id="{id}-monthEl" cl***REMOVED***="{baseCls}-months">',
              '<tpl for="months">',
                  '<div cl***REMOVED***="{parent.baseCls}-item {parent.baseCls}-month"><a style="{parent.monthStyle}" href="#" hidefocus="on">{.}</a></div>',
              '</tpl>',
          '</div>',
          '<div id="{id}-yearEl" cl***REMOVED***="{baseCls}-years">',
              '<div cl***REMOVED***="{baseCls}-yearnav">',
                  '<button id="{id}-prevEl" cl***REMOVED***="{baseCls}-yearnav-prev"></button>',
                  '<button id="{id}-nextEl" cl***REMOVED***="{baseCls}-yearnav-next"></button>',
              '</div>',
              '<tpl for="years">',
                  '<div cl***REMOVED***="{parent.baseCls}-item {parent.baseCls}-year"><a href="#" hidefocus="on">{.}</a></div>',
              '</tpl>',
          '</div>',
          '<div cl***REMOVED***="' + Ext.baseCSSPrefix + 'clear"></div>',
        '</div>',
        '<tpl if="showButtons">',
            '<div id="{id}-buttonsEl" cl***REMOVED***="{baseCls}-buttons">{%',
     ...
     *  The base CSS cl***REMOVED*** to apply to the picker element.
     */
    ...
    /**
     * @cfg {String} [selectedCls='x-monthpicker-selected'] The cl***REMOVED*** to be added to selected items in the picker.
     */
    ...
    /**
     * Modify the year display by p***REMOVED***ing an offset.
