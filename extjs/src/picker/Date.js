/**
 * A date picker. This cl***REMOVED*** is used by the Ext.form.field.Date field to allow browsing and selection of valid
...
Ext.define('Ext.picker.Date', {
    ...
    renderTpl: [
        '<div id="{id}-innerEl" role="grid">',
            '<div role="presentation" cl***REMOVED***="{baseCls}-header">',
                ...
                '<div cl***REMOVED***="{baseCls}-month" id="{id}-middleBtnEl">{%this.renderMonthBtn(values, out)%}</div>',
                '<div cl***REMOVED***="{baseCls}-next"><a id="{id}-nextEl" href="#" role="button" title="{nextText}"></a></div>',
            '</div>',
            '<table id="{id}-eventEl" cl***REMOVED***="{baseCls}-inner" cellspacing="0" role="presentation">',
            ...
            '</table>',
            '<tpl if="showToday">',
                '<div id="{id}-footerEl" role="presentation" cl***REMOVED***="{baseCls}-footer">{%this.renderTodayBtn(values, out)%}</div>',
            '</tpl>',
        '</div>',
        {
     ...
     * Optional. A function that will handle the select event of this picker. The handler is p***REMOVED***ed the following
     * parameters:
     *
     ...
     * The base CSS cl***REMOVED*** to apply to this components element.
     */
    baseCls: Ext.baseCSSPrefix + 'datepicker',

    /**
     * @cfg {String} [selectedCls='x-datepicker-selected']
     * The cl***REMOVED*** to apply to the selected cell.
     */

    /**
     * @cfg {String} [disabledCellCls='x-datepicker-disabled']
     * The cl***REMOVED*** to apply to disabled cells.
     */
    ...
    beforeRender: function () {
        ...
        // If there's a Menu among our ancestors, then add the menu cl***REMOVED***.
