...
Ext.define('Ext.picker.Color', {
    ...
    alternateCl***REMOVED***Name: 'Ext.ColorPalette',

    /**
     * @cfg {String} [componentCls='x-color-picker']
     * The CSS cl***REMOVED*** to apply to the containing element.
     */
    componentCls : Ext.baseCSSPrefix + 'color-picker',

    /**
     * @cfg {String} [selectedCls='x-color-picker-selected']
     * The CSS cl***REMOVED*** to apply to the selected element
     */
     ...
     * of the 'x-color-picker' cl***REMOVED*** (or ***REMOVED***igning a custom cl***REMOVED***), so you can balance the number of colors with the
     ...
     * A function that will handle the select event of this picker. The handler is p***REMOVED***ed the following parameters:
     *
     * - `picker` : ColorPicker
     *
    ...
    renderTpl: [
        '<tpl for="colors">',
            '<a href="#" cl***REMOVED***="color-{.}" hidefocus="on">',
    ...
    handleClick : function(event, target){
        ...
        event.stopEvent();
        if (!me.disabled) {
            color = target.cl***REMOVED***Name.match(me.colorRe)[1];
