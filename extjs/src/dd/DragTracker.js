...
Ext.define('Ext.dd.DragTracker', {
    ...
    /**
     * @cfg {String} overCls
     * A CSS cl***REMOVED*** to add to the DragTracker's target element when the element (or, if the {@link #delegate}
     ...
     *
     * @param constrainMode {String} (Optional) If omitted the true mouse position is returned. May be p***REMOVED***ed
    ...
    constrainModes: {
        // Constrain the p***REMOVED***ed point to within the constrain region
        ...
        // Constrain the dragTarget to within the constrain region. Return the p***REMOVED***ed xy adjusted by the same delta.
        dragTarget: function(me, xy) {
            ...
            // See where the p***REMOVED***ed XY would put the dragTarget if translated by the unconstrained offset.
            // If it overflows, we constrain the p***REMOVED***ed XY to bring the potential
