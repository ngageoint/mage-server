/**
 * A simple cl***REMOVED*** that provides the basic implementation needed to make any element draggable.
 */
Ext.define('Ext.dd.DragSource', {
    ...
    /**
     * Returns the data object ***REMOVED***ociated with this drag source
    ...
    onInvalidDrop: function(target, e, id) {
        ...
        // To preserve backwards compat, it only p***REMOVED***es the event object
