 ...
 * directly by DOM node id, or by p***REMOVED***ing in the drag drop event that occurred and looking up the event target.
 */
Ext.define('Ext.dd.Registry', {
     ...
     * @param {Object} data An custom data object that will be p***REMOVED***ed between the elements that are involved in drag
     ...
     * @param {Boolean} data.isHandle True if the element p***REMOVED***ed in triggers dragging itself, else false.
     */
