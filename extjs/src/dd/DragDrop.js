/*
 * This is a derivative of the similarly named cl***REMOVED*** in the YUI Library.
 ...
 * Up to three html elements can be ***REMOVED***ociated with a DragDrop instance:
 *
 * - linked element: the element that is p***REMOVED***ed into the constructor.
 ...
 *
 * This cl***REMOVED*** should not be instantiated until the onload event to ensure that
 * the ***REMOVED***ociated elements are available.
 ...
 * override this cl***REMOVED*** or one of the default implementations, but you can
 * also override the methods you want on an instance of the cl***REMOVED***...
 *
...
Ext.define('Ext.dd.DragDrop', {
    ...
    /**
     * @property {String} id
     * The id of the element ***REMOVED***ociated with this object.  This is what we
     ...
     * Configuration attributes p***REMOVED***ed into the constructor
     */
    config: null,
    ...
    /**
     * @property {String[]} invalidHandleCl***REMOVED***es
     * An Array of CSS cl***REMOVED*** names for elements to be considered in valid as drag handles.
     */
    invalidHandleCl***REMOVED***es: null,
     ...
     * groups using a single DragDrop subcl***REMOVED*** if we want.
     *
     ...
     * the same as the html element, but it can be ***REMOVED***igned to another
    ...
    initTarget: function(id, sGroup, config) {
        ...
        // ***REMOVED***ume that we have an element reference instead of an id if the
        ...
        this.invalidHandleCl***REMOVED***es = [];
    ...
    /**
     * Applies the configuration parameters that were p***REMOVED***ed into the constructor.
     ...
     * Supports css-style shorthand; if only one parameter is p***REMOVED***ed, all sides
     * will have that padding, and if only two are p***REMOVED***ed, the top and bottom
    ...
    /**
     * Lets you specify a css cl***REMOVED*** of elements that will not initiate a drag
     * @param {String} cssCl***REMOVED*** the cl***REMOVED*** of the elements you wish to ignore
     */
    addInvalidHandleCl***REMOVED***: function(cssCl***REMOVED***) {
        this.invalidHandleCl***REMOVED***es.push(cssCl***REMOVED***);
    },
    ...
    /**
     * Unsets an invalid css cl***REMOVED***
     * @param {String} cssCl***REMOVED*** the cl***REMOVED*** of the element(s) you wish to
     * re-enable
     */
    removeInvalidHandleCl***REMOVED***: function(cssCl***REMOVED***) {
        for (var i=0, len=this.invalidHandleCl***REMOVED***es.length; i<len; ++i) {
            if (this.invalidHandleCl***REMOVED***es[i] == cssCl***REMOVED***) {
                delete this.invalidHandleCl***REMOVED***es[i];
            }
        }
    },
    ...
    isValidHandleChild: function(node) {
        ...
        for (i=0, len=this.invalidHandleCl***REMOVED***es.length; valid && i<len; ++i) {
            valid = !Ext.fly(node).hasCls(this.invalidHandleCl***REMOVED***es[i]);
        }
     ...
     * this method to limit the horizontal travel of the element.  P***REMOVED*** in
     ...
     * this to limit the vertical travel of the element.  P***REMOVED*** in 0,0 for the
    ...
    getTick: function(val, tickArray) {
        if (!tickArray) {
            ...
            // so we return the value p***REMOVED***ed to us.
            return val;
