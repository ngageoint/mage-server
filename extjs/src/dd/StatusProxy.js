...
Ext.define('Ext.dd.StatusProxy', {
    ...
    renderTpl: [
        '<div cl***REMOVED***="' + Ext.baseCSSPrefix + 'dd-drop-icon"></div>' +
        '<div id="{id}-ghost" cl***REMOVED***="' + Ext.baseCSSPrefix + 'dd-drag-ghost"></div>'
    ],
     ...
     * The CSS cl***REMOVED*** to apply to the status element when drop is allowed.
     */
    dropAllowed : Ext.baseCSSPrefix + 'dd-drop-ok',

    /**
     * @cfg {String} dropNotAllowed
     * The CSS cl***REMOVED*** to apply to the status element when drop is not allowed.
     */
     ...
     * @param {String} cssCl***REMOVED*** The css cl***REMOVED*** for the new drop status indicator image
     */
    setStatus : function(cssCl***REMOVED***){
        cssCl***REMOVED*** = cssCl***REMOVED*** || this.dropNotAllowed;
        if (this.dropStatus != cssCl***REMOVED***) {
            this.el.replaceCls(this.dropStatus, cssCl***REMOVED***);
            this.dropStatus = cssCl***REMOVED***;
        }
    },
