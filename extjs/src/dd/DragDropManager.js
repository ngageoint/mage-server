 ...
 * this cl***REMOVED*** directly, but it does have helper methods that could
...
Ext.define('Ext.dd.DragDropManager', {
    ...
    // shorter Cl***REMOVED***Name, to save bytes and use internally
    alternateCl***REMOVED***Name: ['Ext.dd.DragDropMgr', 'Ext.dd.DDM'],
     ...
     * p***REMOVED***ed in instance belongs to.
     ...
     * typeof DragDrop, and the exact subcl***REMOVED*** of DragDrop.  typeof
     * returns "object", oDD.constructor.toString() always returns
     * "DragDrop" and not the name of the subcl***REMOVED***.  So for now it just
    ...
    /**
     * @private
     * Collects the z-index of the p***REMOVED***ed element, looking up the parentNode axis to find an absolutely positioned ancestor
    ...
    /**
     * @private
     * Utility method to p***REMOVED*** to {@link Ext.Array#sort} when sorting potential drop targets by z-index.
     */
     ...
     *
     * @param {Object} groups an ***REMOVED***ociative array of groups to refresh
     */
    ...
    /**
     * @cl***REMOVED*** Ext.dd.DragDropManager.ElementWrapper
     * Deprecated inner cl***REMOVED*** for cached elements.
     * @private
     * @deprecated This wrapper isn't that useful
     */
    ...
    // Continue cl***REMOVED*** docs
    /** @cl***REMOVED*** Ext.dd.DragDropElement */
