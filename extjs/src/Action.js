 ...
 * - setHandler(function)
 *
 * This allows the Action to control its ***REMOVED***ociated Components.
 *
 * Example usage:
 *
...
Ext.define('Ext.Action', {
    ...
    /**
     * @cfg {String} [iconCls='']
     * The CSS cl***REMOVED*** selector that specifies a background image to be used as the header icon for
     * all components configured by this Action.
     *
     * An example of specifying a custom icon cl***REMOVED*** would be something like:
     *
     *     // specify the property in the config for the cl***REMOVED***:
     *          ...
     *          iconCls: 'do-something'
     *
     *     // css cl***REMOVED*** that specifies background image to be used as the icon image:
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Action, or subcl***REMOVED*** thereof.
     */
    isAction : true,
    ...
    /**
     * Sets the icon CSS cl***REMOVED*** for all components configured by this Action.  The cl***REMOVED*** should supply
     * a background image that will be used as the icon image.
     * @param {String} cls The CSS cl***REMOVED*** supplying the icon image
     */
    ...
    /**
     * Gets the icon CSS cl***REMOVED*** currently used by all components configured by this Action.
     */
    getIconCls : function(){
    ...
    /**
     * Executes the specified function once for each Component currently tied to this Action.  The function p***REMOVED***ed
     ...
     * or the handler function set with {@link #setHandler}.  Any arguments p***REMOVED***ed to this
     * function will be p***REMOVED***ed on to the handler function.
     * @param {Object...} args Variable number of arguments p***REMOVED***ed to the handler function
     */
    execute : function(){
