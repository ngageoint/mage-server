/**
 * Base cl***REMOVED*** for any Ext.Component that may contain other Components. Containers handle the basic behavior of
 * containing items, namely adding, inserting and removing items.
 *
 * The most commonly used Container cl***REMOVED***es are Ext.panel.Panel, Ext.window.Window and
 * Ext.tab.Panel. If you do not need the capabilities offered by the aforementioned cl***REMOVED***es you can create a
 ...
 * ## Layout
 *
 * Container cl***REMOVED***es delegate the rendering of child Components to a layout manager cl***REMOVED*** which must be configured into
 ...
 *     }
 *
 * When the above code fragment is p***REMOVED***ed through the `eval` function in the success handler of the Ajax request, the
...
Ext.define('Ext.container.Container', {
    ...
    alternateCl***REMOVED***Name: 'Ext.Container',

    /*
     * For more information on the following methods, see the note for the
     * hierarchyEventSource observer defined in the cl***REMOVED***' callback
     */
    ...
    /**
     * Return the immediate child Component in which the p***REMOVED***ed element is located.
     * @param {Ext.Element/HTMLElement/String} el The element to test (or ID of element).
     * @param {Boolean} deep If `true`, returns the deepest descendant Component which contains the p***REMOVED***ed element.
     * @return {Ext.Component} The child item which contains the p***REMOVED***ed element.
     */
