 ...
 *
 * An example showing a cl***REMOVED***ic application border layout:
 *
 *     @example
 ...
 *         items: [{
 *             region: 'north',
 *             html: '<h1 cl***REMOVED***="x-panel-header">Page Title</h1>',
 *             border: false,
 *             margins: '0 0 5 0'
 *         }, {
 *             region: 'west',
...
Ext.define('Ext.container.Viewport', {
    ...
    alternateCl***REMOVED***Name: 'Ext.Viewport',
     ...
     * `true` in this cl***REMOVED*** to identify an object as an instantiated Viewport, or subcl***REMOVED*** thereof.
     */
    isViewport: true,
