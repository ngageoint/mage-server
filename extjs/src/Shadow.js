/**
 * Simple cl***REMOVED*** that can provide a shadow effect for any element.  Note that the element
 ...
 * provide the same shadow effect, see the {@link Ext.Layer} cl***REMOVED***.
 */
