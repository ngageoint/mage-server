...
Ext.define('Ext.view.BoundList', {
    ...
    alternateCl***REMOVED***Name: 'Ext.BoundList',
    ...
    renderTpl: [
        '<div id="{id}-listEl" cl***REMOVED***="{baseCls}-list-ct" style="overflow:auto"></div>',
        '{%',
     ...
     *         }),
     *         listConfig : {
     *             tpl : '<tpl for="."><div cl***REMOVED***="x-boundlist-item">{abbr}</div></tpl>'
     *         }
     *     });
     *
     * Defaults to:
     ...
     *         '<ul><tpl for=".">',
     *             '<li role="option" cl***REMOVED***="' + itemCls + '">' + me.getInnerTpl(me.displayField) + '</li>',
     *         '</tpl></ul>'
     *     );
     *
     */
