...
Ext.define('Ext.view.DropZone', {
    ...
    indicatorHtml: '<div cl***REMOVED***="' + Ext.baseCSSPrefix + 'grid-drop-indicator-left"></div><div cl***REMOVED***="' + Ext.baseCSSPrefix + 'grid-drop-indicator-right"></div>',
...
//      If we fall through because the mouse is below the nodes (or there are no nodes), we'll get an onContainerOver call.
    ...
    /**
     * @private Determines whether the record at the specified offset from the p***REMOVED***ed record
