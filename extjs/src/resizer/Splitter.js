/**
 * This cl***REMOVED*** functions **between siblings of a {@link Ext.layout.container.VBox VBox} or {@link Ext.layout.container.HBox HBox}
...
Ext.define('Ext.resizer.Splitter', {
    ...
    renderTpl: [
        '<tpl if="collapsible===true">',
            '<div id="{id}-collapseEl" cl***REMOVED***="', Ext.baseCSSPrefix, 'collapse-el ',
    ...
    // Default to tree, allow internal cl***REMOVED***es to disable resizing
    canResize: true,
     ...
     * A cl***REMOVED*** to add to the splitter when it is collapsed. See {@link #collapsible}.
     */
    ...
    /**
     * Returns the config object (with an `xcl***REMOVED***` property) for the splitter tracker. This
    ...
    getTrackerConfig: function () {
        return {
            xcl***REMOVED***: 'Ext.resizer.SplitterTracker',
            el: this.el,
            splitter: this
        };
    },
