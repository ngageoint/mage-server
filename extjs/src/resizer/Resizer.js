...
Ext.define('Ext.resizer.Resizer', {
    ...
    alternateCl***REMOVED***Name: 'Ext.Resizable',
     ...
     * dragging. This is `true` by default, but the {@link Ext.Component Component} cl***REMOVED*** p***REMOVED***es `false` when it is
    ...
    constructor: function(config) {
        ...
        // Relay the ResizeTracker's supercl***REMOVED*** events as our own resize events
        me.resizeTracker.on({
        ...
        for (; i < len; i++){
            ...
            if (handles[i] && possibles[handles[i]]) {
                ...
                handleEls.push('<div id="' + me.el.id + '-' + pos + '-handle" cl***REMOVED***="' + handleCls + pos + ' ' + Ext.baseCSSPrefix + 'unselectable"' + style + '></div>');
            }
        }
