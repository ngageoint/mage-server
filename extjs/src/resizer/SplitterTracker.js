/**
 * Private utility cl***REMOVED*** for Ext.Splitter.
 * @private
 */
Ext.define('Ext.resizer.SplitterTracker', {
    ...
    // We move the splitter el. Add the proxy cl***REMOVED***.
    onStart: function(e) {
        var splitter = this.getSplitter();
    ...
    // perform the resize and remove the proxy cl***REMOVED*** from the splitter el
    onEnd: function(e) {
        var me = this,
            splitter = me.getSplitter();
