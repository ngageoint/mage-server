/**
 * The AbstractPlugin cl***REMOVED*** is the base cl***REMOVED*** from which user-implemented plugins should inherit.
 *
 * This cl***REMOVED*** defines the essential API of plugins as used by Components by defining the following methods:
 *
 *   - `init` : The plugin initialization method which the owning Component calls at Component initialization time.
 *
 *     The Component p***REMOVED***es itself as the sole parameter.
 *
 *     Subcl***REMOVED***es should set up bidirectional links between the plugin and its client Component here.
 *
...
Ext.define('Ext.AbstractPlugin', {
     ...
     *
     * The supplied implementation is empty. Subcl***REMOVED***es should perform plugin initialization, and set up bidirectional
     ...
     *
     * The supplied implementation is empty. Subcl***REMOVED***es should perform plugin cleanup in their own implementation of
     * this method.
     */
    destroy: Ext.emptyFn,
     ...
     *
     * Plugin subcl***REMOVED***es which need more complex processing may implement an overriding implementation.
     */
    enable: function() {
        this.disabled = false;
    },
