 ...
 * `Ext.util.Format` we p***REMOVED*** in, to have an `horizontal` orientation (as opposed to a vertical one) and we also set
...
Ext.define('Ext.chart.series.Bar', {
    ...
    alternateCl***REMOVED***Name: ['Ext.chart.BarSeries', 'Ext.chart.BarChart', 'Ext.chart.StackedBarChart'],
