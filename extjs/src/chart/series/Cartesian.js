/**
 * @cl***REMOVED*** Ext.chart.series.Cartesian
 *
 * Common base cl***REMOVED*** for series implementations which plot values using x/y coordinates.
 */
Ext.define('Ext.chart.series.Cartesian', {
    ...
    alternateCl***REMOVED***Name: ['Ext.chart.CartesianSeries', 'Ext.chart.CartesianChart'],
