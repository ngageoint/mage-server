/**
 * @cl***REMOVED*** Ext.chart.series.Line
...
Ext.define('Ext.chart.series.Line', {
    ...
    alternateCl***REMOVED***Name: ['Ext.chart.LineSeries', 'Ext.chart.LineChart'],
     ...
     * the Sprite cl***REMOVED***. For example, if we were to set red circles as markers to the line series we could
     * p***REMOVED*** the object:
     *
     <pre><code>
        markerConfig: {
            type: 'circle',
    ...
    drawSeries: function() {
        ...
        if (chart.animate) {
            fill = me.fill;
            line = me.line;
            //Add renderer to line. There is not unique record ***REMOVED***ociated with this.
