/**
 * @cl***REMOVED*** Ext.chart.series.Series
 *
 * Series is the abstract cl***REMOVED*** containing the common logic to all chart series. Series includes
 * methods from Labels, Highlights, Tips and Callouts mixins. This cl***REMOVED*** implements the logic of handling
 * mouse events, animating, hiding, showing all elements and returning the color of the series to be used as a legend item.
 *
 * ## Listeners
 *
 * The series cl***REMOVED*** supports listeners via the Observable syntax. Some of these listeners are:
 *
...
Ext.define('Ext.chart.series.Series', {
    ...
    /**
     * @cfg {String} type
     * The type of series. Set in subcl***REMOVED***es.
     */
    type: null,
     ...
     * P***REMOVED***es in (sprite, record, attributes, index, store) to the function.
     */
