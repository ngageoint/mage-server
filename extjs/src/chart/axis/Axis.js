/**
 * @cl***REMOVED*** Ext.chart.axis.Axis
 *
 * Defines axis for charts. The axis position, type, style can be configured.
 * The axes are defined in an axes array of configuration objects where the type,
 * field, grid and other configuration options can be set. To know more about how
 * to create a Chart please check the Chart cl***REMOVED*** documentation. Here's an example for the axes part:
...
Ext.define('Ext.chart.axis.Axis', {
    ...
    alternateCl***REMOVED***Name: 'Ext.chart.Axis',
    ...
    getRange: function () {
        var me = this,
            ...
            boundedAxes,
            seriesCl***REMOVED***es = Ext.chart.series,
            aggregations = [],
        ...
        for (i = 0, ln = series.length; i < ln; i++) {
            ...
            if (seriesCl***REMOVED***es.Bar && series[i] instanceof seriesCl***REMOVED***es.Bar && !series[i].column) {
            ...
            if (aggregates = series[i].stacked) {
                ...
                if (seriesCl***REMOVED***es.Bar && series[i] instanceof seriesCl***REMOVED***es.Bar) {
