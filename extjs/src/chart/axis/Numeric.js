/**
 * @cl***REMOVED*** Ext.chart.axis.Numeric
 *
...
Ext.define('Ext.chart.axis.Numeric', {
    ...
    alternateCl***REMOVED***Name: 'Ext.chart.NumericAxis',
    ...
    doConstrain: function() {
        ...
        me.chart.substore.loadData(data); // data records must be loaded (not p***REMOVED***ed as config above because it's not json)
    },
    /**
