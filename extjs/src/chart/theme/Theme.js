/**
 * @cl***REMOVED*** Ext.chart.theme.Theme
 * 
...
// This callback is executed right after when the cl***REMOVED*** is created. This scope refers to the newly created cl***REMOVED*** itself
function() {
