/**
 * A cl***REMOVED*** that manages a group of {@link Ext.Component#floating} Components and provides z-order management,
...
Ext.define('Ext.ZIndexManager', {
    alternateCl***REMOVED***Name: 'Ext.WindowGroup',
    ...
    constructor: function(container) {
        ...
        // No container p***REMOVED***ed means we are the global WindowManager. Our target is the doc body.
    ...
    setBase: function(baseZIndex) {
        ...
        var result = this.***REMOVED***ignZIndices();
        this._activateLast();
        return result;
    },

    // private
    ***REMOVED***ignZIndices: function() {
        ...
        for (; i < len; i++) {
            ...
            if (comp && !comp.hidden) {
                ...
                // return value is the p***REMOVED***ed value plus 10, ready for the next item.
   ...
   /**
    ...
    /**
     * Returns zero or more Components in this ZIndexManager using the custom search function p***REMOVED***ed to this method.
     ...
     * Defaults to the Component being tested. That gets p***REMOVED***ed to the function if not specified.
    ...
    /**
     * Executes the specified function once for every Component in this ZIndexManager, p***REMOVED***ing each
     ...
     * Executes the specified function once for every Component in this ZIndexManager, p***REMOVED***ing each
     * Component as the only parameter. Returning false from the function will stop the iteration.
     * The components are p***REMOVED***ed to the function starting at the bottom and proceeding to the top.
     * @param {Function} fn The function to execute for each item
     ...
     * Executes the specified function once for every Component in this ZIndexManager, p***REMOVED***ing each
     * Component as the only parameter. Returning false from the function will stop the iteration.
     * The components are p***REMOVED***ed to the function starting at the top and proceeding to the bottom.
     * @param {Function} fn The function to execute for each item
     * @param {Object} [scope] The scope (this reference) in which the function
     * is executed. Defaults to the current Component in the iteration.
     */
