...
Ext.onReady(function() {
    ...
    if (Ext.Updater) {
        Ext.Updater.defaults.indicatorText = '<div cl***REMOVED***="loading-indicator">Betöltés...</div>';
    }
    ...
    Ext.define("Ext.locale.hu.picker.Date", {
        ...
        monthYearText: 'Vál***REMOVED***z hónapot (Évválasztás: CTRL+Fel/Le)',
        todayTip: "{0} (Szóköz)",
        format: "y-m-d",
        startDay: 0
    });
    ...
    Ext.define("Ext.locale.hu.form.field.HtmlEditor", {
        ...
        Ext.apply(Ext.form.field.HtmlEditor.prototype, {
            buttonTips: {
                ...
                backcolor: {
                    title: 'Háttérszín',
                    text: 'A kijelölt szöveg háttérszínét mó***REMOVED***ítja.',
                    cls: Ext.baseCSSPrefix + 'html-editor-tip'
                },
                forecolor: {
                    title: 'Szövegszín',
                    text: 'A kijelölt szöveg színét mó***REMOVED***ítja.',
                    cls: Ext.baseCSSPrefix + 'html-editor-tip'
                },
                justifyleft: {
                    title: 'Balra zárt',
