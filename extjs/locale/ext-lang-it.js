...
Ext.onReady(function() {
    var cm = Ext.Cl***REMOVED***Manager,
        exists = Ext.Function.bind(cm.get, cm);

    if (Ext.Updater) {
        Ext.Updater.defaults.indicatorText = '<div cl***REMOVED***="loading-indicator">Caricamento in corso...</div>';
    }
    ...
    Ext.define("Ext.locale.it.picker.Date", {
        ...
        maxText: "Data successiva alla data m***REMOVED***ima",
        disabledDaysText: "",
        disabledDatesText: "",
    ...
    Ext.define("Ext.locale.it.form.field.Text", {
        ...
        maxLengthText: "La lunghezza m***REMOVED***ima \u00E8 {0}",
    ...
    Ext.define("Ext.locale.it.form.field.Number", {
        ...
        maxText: "Il valore m***REMOVED***imo \u00E8 {0}",
    ...
    Ext.define("Ext.locale.it.form.field.HtmlEditor", {
        ...
        Ext.apply(Ext.form.field.HtmlEditor.prototype, {
            buttonTips: {
                bold: {
                    title: 'Gr***REMOVED***etto (Ctrl+B)',
                    text: 'Rende il testo selezionato in gr***REMOVED***etto.',
                ...
                sourceedit: {
                    title: 'Sorgente',
                    text: 'P***REMOVED***a alla modalit\u00E0 editing del sorgente.',
                    cls: Ext.baseCSSPrefix + 'html-editor-tip'
                }
            }
        });
