...
Ext.onReady(function() {
    ...
    if (Ext.Updater) {
        Ext.Updater.defaults.indicatorText = '<div cl***REMOVED***="loading-indicator">Učitavanje...</div>';
    }
    ...
    Ext.define("Ext.locale.hr.grid.Panel", {
        override: "Ext.grid.Panel",
        ddText: "{0} odabranih redova"
    });
    ...
    Ext.define("Ext.locale.hr.grid.header.Container", {
        ...
        sortAscText: "Sortiraj rastućim re***REMOVED***lijedom",
        sortDescText: "Sortiraj padajućim re***REMOVED***lijedom",
