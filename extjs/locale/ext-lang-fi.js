...
Ext.onReady(function() {
    ...
    if (Ext.Updater) {
        Ext.Updater.defaults.indicatorText = '<div cl***REMOVED***="loading-indicator">Ladataan...</div>';
    }
    ...
    Ext.define("Ext.locale.fi.form.field.Date", {
        ...
        invalidText: "Päivämäärä {0} ei ole oike***REMOVED***a muo***REMOVED***sa - kirjoita päivämäärä muo***REMOVED***sa {1}",
        format: "j.n.Y",
