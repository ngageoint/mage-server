...
Ext.onReady(function() {
    ...
    if (Ext.Updater) {
        Ext.Updater.defaults.indicatorText = '<div cl***REMOVED***="loading-indicator">Bezig met laden...</div>';
    }
    ...
    Ext.define("Ext.locale.nl.form.field.HtmlEditor", {
        ...
        Ext.apply(Ext.form.field.HtmlEditor.prototype, {
            buttonTips: {
                ...
                sourceedit: {
                    title: 'Bron aanp***REMOVED***en',
                    text: 'Schakel modus over naar bron aanp***REMOVED***en.',
                    cls: Ext.baseCSSPrefix + 'html-editor-tip'
                }
            }
        });
