...
Ext.onReady(function() {
    ...
    if (Ext.Updater) {
        Ext.Updater.defaults.indicatorText = '<div cl***REMOVED***="loading-indicator">Učitavam...</div>';
    }
    ...
    Ext.define("Ext.locale.sr.grid.header.Container", {
        ...
        sortAscText: "Rastući re***REMOVED***led",
        sortDescText: "Opadajući re***REMOVED***led",
